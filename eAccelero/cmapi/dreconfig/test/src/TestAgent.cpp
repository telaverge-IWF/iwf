...
class ApiLibUser: public Runnable
{
    private:
        ...
        void Initialize()
        {
            ...
            pCMAPICMFConfigObj = new CMAPICMFConfig();
            pCMAPICMFConfigObj->InitializeLibrary();
        }
	...
	int SetPeerConfig()
	{
		...
		cout << "Transport Type SCTP / TCP  (blank to ignore) ";
        cin.ignore(256,'\n');
        getline(cin , InputVal); if (!InputVal.empty()) PC->set_transporttype(InputVal);
    ...
    int GetCmfActionAndTrigger()
    {
        CMFActionTriggerReq Req;
        CMFActionTriggerResp Resp;
        pCMAPICMFConfigObj->GetCMFActionsAndTriggers(Req,Resp);
        return 0;
    }
    int GetCmfTriggers()
    {
        ...
        cout <<"all";cin>>flag;
        if(!flag)
            cout << "Name:";cin>>TriggerName;
        RuleConfigResp Resp;
        pCMAPICMFConfigObj->GetCMFTriggers(TriggerName,Resp);
        return 0;
    }
    int GetCmfAction()
    {
        ...
        if(!flag)
        {
            cout << "Name:";cin>>ActionName;
        }
        RuleConfigResp Resp;
        pCMAPICMFConfigObj->GetCMFActions(ActionName,Resp);
        return 0;
    }
    int GetCmdLevel()
    {
        CMFLevelReq Req;
        CMFLevelResp Resp;
        pCMAPICMFConfigObj->GetCMFLevels(Req,Resp);
        return 0;
    }
    int GetCmdRule()
    {
        string RuleName;
        int ip;
        cout << "all yes/no (1/0)";cin>>ip;
        if(!ip)
        {
            cout << "RuleName: ";cin >>RuleName;
        }
        RuleConfigResp Resp;
        pCMAPICMFConfigObj->GetCMFRules(RuleName,Resp);
        return 0;
    }
    int AddCmgRule()
    {
        ...
        RuleConfigReq Req;
        RuleConfigResp Resp;
        RuleConfig *RuleConfig = Req.add_rules();

        string RuleName;
        string TriggerName;

        cout << "\nRuleName: " ;cin>>RuleName;

        RuleConfig->set_rulename(RuleName);
        RuleConfig->set_trigger(1);
        RuleConfig->set_level(1);

        if((retVal = pCMAPICMFConfigObj->AddCMFRule(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "Add CMF Rule Successfull" <<endl;
        }
        else
        {
    ...
    int AddPeerTemplate()
    {
        ...
        if((retVal = CMApiLibObj->AddCMFPeerTemplate(Req, &Resp)) == CMAPI_SUCCESS)
        {
            cout << "Add CMF Rule Successfull" <<endl;
        }
        else
    ...
    int ModCmfRule()
    {
        ...
        if((retVal = pCMAPICMFConfigObj->ModifyCMFRule(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "Add CMF Rule Successfull" <<endl;
        }
        else
    ...
    int DelCmfRule()
    {
        ...
        if((retVal = pCMAPICMFConfigObj->DeleteCMFRule(rulename, Resp)) == CMAPI_SUCCESS)
        {
            cout << "Add CMF Rule Successfull" <<endl;
        }
        else
    ...
    int SetCmfRuleStatus()
    {
        ...
        RuleConfig->set_rulename(RuleName);
        RuleConfig->set_rulestatus(1);

        if((retVal = pCMAPICMFConfigObj->SetCMFRuleStatus(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "Add CMF Rule Successfull" <<endl;
        }
        else
    ...
    int SetCmdCodePriority()
    {
        CCPriority Req;
        PriorityConfigResp Resp;
        pCMAPICMFConfigObj->SetCommandCodePriority(Req,Resp);
        return 0;
    }
    int SetAppPriority()
    {
        ...
        pCMAPICMFConfigObj->SetApplicationIdPriority(Req,Resp);
        return 0;
    }
    int GetCMFPeerTemp()
    {
        ...
        cout << "all/Individual (1/0)" << endl;
        cin >> input;
        if(!input)
        {
            string name;
            cout << "Enter name: ";cin >> name;
            ::CMFPeerTemplate *pCMFPeerTemplate=Request.add_peertemplates();
            pCMFPeerTemplate->set_peertemplatename(name);
        }
        if((retVal=CMApiLibObj->GetCMFPeerTemplate(Request,&Response)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
    ...
    int GetCMFrealmTemp()
    {
        ...
        if(!input)
        {
            string name;
            cout << "Enter name: ";cin >> name;
            ::CMFRealmTemplate *pCMFRealmTemplate=Request.add_realmtemplates();
            pCMFRealmTemplate->set_realmtemplatename(name);
        }
        if((retVal=CMApiLibObj->GetCMFRealmTemplate(Request, &Response)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Response.responseid(),Request.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int GetPriorityConfig()
    {
        int retVal;
        PriorityConfigReq Req;
        PriorityConfigResp Resp;

        if((retVal=pCMAPICMFConfigObj->GetCMFPriorityConfig(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
        }
        else
        {
    ...
    int GetSystemTriggerStates()
    {
        int retVal;
        TriggerStateRequest Req;
        TriggerStateResponse Resp;

        if((retVal=pCMAPICMFConfigObj->GetSystemTriggerStates(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int GetPeerTriggerStates()
    {
        int retVal;
        PeerTriggerStateResponse Resp;

        if((retVal=pCMAPICMFConfigObj->GetDiaPeerTriggerStates("","", Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int GetRealmTriggerStates()
    {
        int retVal;
        RealmTriggerStateResponse Resp;

        if((retVal=pCMAPICMFConfigObj->GetDiaRealmTriggerStates("",Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    {
        int retVal;
        CMFLevelConfigResponse Resp;

        if((retVal=pCMAPICMFConfigObj->GetCMFLevelConfig(0,Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int delPriorityConfig()
    {
        ...
        PriorityConfig *pPriorityConfig = Req.add_priorities();
        cout << "delete : CC/AppId (1/0)";cin>>input;
        if(input == 1)
        {
            int input;
            cout << "CC: ";cin>>input;
            CCPriority *pCCPriority =pPriorityConfig->add_ccpriorities();
            pCCPriority->set_cmdcode(input);
        }
        else
        {
            int input;
            cout << "AppId: ";cin>>input;
            AppIdPriority *pAppIdPriority =pPriorityConfig-> add_apppriorities();
            pAppIdPriority->set_appid(input);
        }

        if((retVal=pCMAPICMFConfigObj->DeletePriorityConfig(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int modPriorityConfig()
    {
        ...
        if(input == 1)
        {
            ...
            CCPriority *pCCPriority =pPriorityConfig->add_ccpriorities();
            pCCPriority->set_cmdcode(input);
            pCCPriority->set_description(desc);
        }
        else
        {
            int input;
            ...
            AppIdPriority *pAppIdPriority =pPriorityConfig-> add_apppriorities();
            pAppIdPriority->set_appid(input);
            pAppIdPriority->set_description(desc);
        }
         if((retVal=pCMAPICMFConfigObj->ModifyPriorityConfig(Req, Resp)) == CMAPI_SUCCESS)
        {
            cout << "=============== Success ====================" << endl;
            CLOG_DEBUG("retVal : %d Request = %s",Resp.responseid(),Resp.DebugString().c_str());
            cout << "============================================" << endl;
    ...
    int Menu()
	{
...
#endif
        cout << "#########  CMF Methods #########" << endl;

        cout << "160: GET_CMF_ACTIONS_AND_TRIGGERS " << endl;
        cout << "161: GET_CMF_LEVEL " << endl;
        cout << "162: GET_CMG_RULE " << endl;
        cout << "163: ADD_CMF_RULE " << endl;
        cout << "164: MODIFY_CMF_RULE " << endl;
        cout << "165: DELETE_CMF_RULE " << endl;
        cout << "166: SET_CMF_RULE_STATUS " << endl;
        cout << "167: SET_CMD_CODE_PRIORITY " << endl;
        cout << "168: SET_APP_PRIORITY " << endl;
        cout << "98: ADD_PEER_TEMPLATE " << endl;
        cout << "169: GET_CMF_TRIGGER " << endl;
        cout << "170: GET_CMF_ACTION" << endl;
        cout << "104: GET_PEER_TEMPLATE" << endl;
        cout << "105: GET_REALM_TEMPLATE" << endl;
        cout << "171: GET_CMF_DIA_PRIORITY" << endl;
        cout << "173: DEL_CMF_DIA_PRIORITY" << endl;
        cout << "174: MOD_CMF_DIA_PRIORITY" << endl;
        cout << "175: GET_CMF_SYSTEM_TRIGGER_STATES" << endl;
        cout << "176: GET_CMF_PEER_TRIGGER_STATES" << endl;
        cout << "177: GET_CMF_REALM_TRIGGER_STATES" << endl;
        cout << "178: GET_CMF_LEVEL_CONFIG" << endl;
        ...
        void CallCMAPI(int ch)
        {
            ...
            case ADD_PEER_TEMPLATE:
                cout<<"ADD_PEER_TEMPLATE"<<endl;
                AddPeerTemplate();
                break;

            case GET_CMF_ACTIONS_AND_TRIGGERS:
                cout<<"GET_CMF_ACTIONS_AND_TRIGGERS"<<endl;
                GetCmfActionAndTrigger();
                break;
            case GET_CMF_LEVEL:
                cout<<"GET_CMF_LEVEL"<<endl;
                GetCmdLevel();
                break;
            case GET_CMF_RULE:
                cout<<"GET_CMG_RULE"<<endl;
                GetCmdRule();
                break;
            case GET_CMF_TRIGGER:
                cout << "GET_CMF_TRIGGER"<<endl;
                GetCmfTriggers();
                break;

            case GET_CMF_ACTION:
                cout <<"GET_CMF_ACTION"<<endl;
                GetCmfAction();
                break;
            case ADD_CMF_RULE:
                cout<<"ADD_CMF_RULE"<<endl;
                AddCmgRule();
                break;
            ...
            case DELETE_CMF_RULE:
                cout<<"DELETE_CMF_RULE"<<endl;
                DelCmfRule();
                break;
            case SET_CMF_RULE_STATUS:
                cout<<"SET_CMF_RULE_STATUS"<<endl;
                SetCmfRuleStatus();
                break;
            case SET_CMD_CODE_PRIORITY:
                cout<<"SET_CMD_CODE_PRIORITY"<<endl;
                SetCmdCodePriority();
                break;
            case SET_APP_PRIORITY:
                cout<<"SET_APP_PRIORITY"<<endl;
                SetAppPriority();
                break;
            case GET_PEER_TEMPLATE:
                cout<<"GET_PEER_TEMPLATE"<<endl;
                GetCMFPeerTemp();
                break;
            case GET_REALM_TEMPLATE:
                cout<<"GET_REALM_TEMPLATE"<<endl;
                GetCMFrealmTemp();
                break;
            case GET_CMF_DIA_PRIORITY:
                cout<<"GET_CMF_DIA_PRIORITY"<<endl;
                GetPriorityConfig();
                break;
            case DEL_CMF_DIA_PRIORITY:
                cout<<"DEL_CMF_DIA_PRIORITY"<<endl;
                delPriorityConfig();
                break;
            case MOD_CMF_DIA_PRIORITY:
                cout<<"MOD_CMF_DIA_PRIORITY"<<endl;
                modPriorityConfig();
                break;
            case GET_CMF_SYSTEM_TRIGGER_STATES:
                cout<<"GET_CMF_SYSTEM_TRIGGER_STATES"<<endl;
                GetSystemTriggerStates();
                break;
            case GET_CMF_PEER_TRIGGER_STATES:
                cout<<"GET_CMF_PEER_TRIGGER_STATES"<<endl;
                GetPeerTriggerStates();
                break;
            case GET_CMF_REALM_TRIGGER_STATES:
                cout<<"GET_CMF_REALM_TRIGGER_STATES"<<endl;
                GetRealmTriggerStates();
                break;
            case GET_CMF_LEVEL_CONFIG:
                cout<<"GET_CMF_LEVEL_CONFIG"<<endl;
                GetLevelConfig();
                break;
    ...
    private:
       ...
       CMAPICMFConfig *pCMAPICMFConfigObj;
