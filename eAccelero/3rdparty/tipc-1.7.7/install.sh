...
if [ $? -eq 0 ];then
    ...
    mkdir -p /lib/modules/$KERNEL_REL/kernel/net/tipc
    cp tipc.ko /lib/modules/$KERNEL_REL/kernel/net/tipc
...
echo "TIPC Configuration completed."
