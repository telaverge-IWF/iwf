...
sql/CMakeFiles/distclean:
	cd /opt/checkout/eAccelero/3rdparty/mysql-cluster-gpl-7.2.8/sql && /usr/bin/cmake -E echo WARNING: distclean target is not functional
	cd /opt/checkout/eAccelero/3rdparty/mysql-cluster-gpl-7.2.8/sql && /usr/bin/cmake -E echo Use "'bzr" "clean-tree'" with --unknown and/or --ignored parameter instead
