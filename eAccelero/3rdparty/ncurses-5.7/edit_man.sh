...
TERMINFO="/opt/checkout/eAccelero/3rdparty/share/terminfo"

MKDIRS="sh /opt/checkout/eAccelero/3rdparty/ncurses-5.7/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /opt/checkout/eAccelero/3rdparty/ncurses-5.7/man_alias.sed ; then
cat >>/opt/checkout/eAccelero/3rdparty/ncurses-5.7/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /opt/checkout/eAccelero/3rdparty/ncurses-5.7/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /opt/checkout/eAccelero/3rdparty/ncurses-5.7/man_alias.sed | sort -u`
	...
	sed	-f /opt/checkout/eAccelero/3rdparty/ncurses-5.7/man_alias.sed \
		< $i >$TMP
