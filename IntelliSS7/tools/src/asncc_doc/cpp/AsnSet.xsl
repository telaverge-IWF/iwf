...
<!-- /////////////////////////////////////////////////////////////////////// -->
<!--                                                                         -->
<!-- ID: $Id: AsnSet.xsl,v 9.1 2005/03/23 12:54:12 cvsadmin Exp $ -->
<!--                                                                         -->
<!-- /////////////////////////////////////////////////////////////////////// -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  <xsl:template match="/">
    ...
    <head>
    <title>Class <xsl:value-of select="./asnType/asnSet/className"/>
    </title>
    </head>
    ...
    <p align="left">
      <u>
        <font size="6">Class <xsl:value-of select="./asnType/asnSet/className"/></font>
      </u>
    </p>

    <p>The ASN.1 type <xsl:value-of select="./asnType/asnSet/asnTypeName"/> is based on the ASN.1 SET built-in type,
    therefore the class <xsl:value-of select="./asnType/asnSet/className"/> inherits from the class 
    <b><a href="AsnSet.html">AsnSet</a></b>.</p>
    ...
    <p>
      <xsl:element name="a">
        <xsl:attribute name="href">#<xsl:value-of select="./asnType/asnSet/className"/></xsl:attribute>
        <xsl:value-of select="./asnType/asnSet/className"/>
      </xsl:element>
      -
      ...
      <xsl:for-each select="asnType/asnSet/memberFunctions/memberFunctionSetWithRef">
        <xsl:element name="a">
      ...
      -
      <xsl:element name="a">
        <xsl:attribute name="href">#Size</xsl:attribute>
        GetSize
      </xsl:element>
      -
      <xsl:element name="a">
      ...
      <table border="1" width="100%">
        <tr>
          <td valign="middle" align="center" bgcolor="#CCCCFF" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name"><xsl:value-of select="./asnType/asnSet/className"/></xsl:attribute>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnSet/className"/>()</b>
          </td>
          <td valign="middle" align="left">
            The first <b><xsl:value-of select="./asnType/asnSet/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnSet/className"/> object with an empty contents (default constructor).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select=
            "./asnType/asnSet/className"/>(Octets&amp; octets)</b>
          </td>
          <td valign="middle" align="left">
            The second <b><xsl:value-of select="./asnType/asnSet/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnSet/className"/> object from an ASN.1 encoded value (the <b>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnSet/className"/>(const 
            <xsl:value-of select="./asnType/asnSet/className"/>&amp; rhs)</b>
          </td>
          <td valign="middle" align="left">
            The third <b><xsl:value-of select="./asnType/asnSet/className"/></b> constructor is the standard 
            C++ copy constructor.
          </td>
        </tr>
      </table>
        ...
        <xsl:for-each select="asnType/asnSet/memberFunctions/memberFunctionSet">
          <tr>
            ...
            <td valign="middle" align="left">
              ...
              member function is deleted when the <xsl:value-of select="//asnType/asnSet/className"/> object is
              ...
              <xsl:if test="optional[.='no']">
                ...
                AsnEncodeError</a></b> exception is thrown when the <xsl:value-of select="//asnType/asnSet/className"/>
                object is encoded (call to the <b>Encode</b> member function).
              </xsl:if>
        ...
        <xsl:for-each select="asnType/asnSet/memberFunctions/memberFunctionGet">
          <tr>
            ...
            <td valign="middle" align="left">
              ...
              "asnElementName"/>" element of a <xsl:value-of select="//asnType/asnSet/className"/> object. If the 
        ...
        <xsl:for-each select="asnType/asnSet/memberFunctions/memberFunctionOption">
          <tr>
            ...
            <td valign="middle" align="left">
              ...
              "//asnType/asnSet/className"/> object is present.
            </td>
          </tr>
        </xsl:for-each>
    ...
    <ul type="square">
      <li>
        <font size="4">
          Public member functions inherited from <a href="AsnSet.html">AsnSet</a> and 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnSet/className"/> object to an ASN.1 encoded value. The ASN.1 encoded value is 
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnSet/className"/>). The ASN.1 encoded value is passed through an object of class 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnSet/className"/> object (including the optional elements that are or are not present).
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            ...
            "./asnType/asnSet/className"/> object. The end-user is responsible for deleting the clone object.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            ...
            <xsl:value-of select="./asnType/asnSet/className"/> objects. It is used to implement the comparison
        ...
        <tr>
          ...
          <td align="left">
            The <b>GetBaseName</b> member function returns the string <font color="#000080">&quot;SET&quot;
            </font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>AsnSet&amp; operator=(const AsnSet&amp; rhs)</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name">operator==</xsl:attribute>
              <b>bool operator==(const AsnSet&amp; rhs) const</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnSet/className"/> object to an output stream at any time.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
