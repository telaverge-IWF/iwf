...
<!-- /////////////////////////////////////////////////////////////////////// -->
<!--                                                                         -->
<!-- ID: $Id: AsnInteger.xsl,v 9.1 2005/03/23 12:54:12 cvsadmin Exp $ -->
<!--                                                                         -->
<!-- /////////////////////////////////////////////////////////////////////// -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  <xsl:template match="/">
    ...
    <head>
    <title>Class <xsl:value-of select="./asnType/asnInteger/className"/>
    </title>
    </head>
    ...
    <p align="left">
      <u>
        <font size="6">Class <xsl:value-of select="./asnType/asnInteger/className"/></font>
      </u>
    </p>

    <p>The ASN.1 type <xsl:value-of select="./asnType/asnInteger/asnTypeName"/> is based on the ASN.1 INTEGER
    built-in type, therefore the class <xsl:value-of select="./asnType/asnInteger/className"/> inherits from the
    class <b><a href="AsnInteger.html">AsnInteger</a></b>.</p>
    ...
    <p>
      <xsl:element name="a">
        <xsl:attribute name="href">#<xsl:value-of select="./asnType/asnInteger/className"/></xsl:attribute>
        <xsl:value-of select="./asnType/asnInteger/className"/>
      </xsl:element>
      -
      <xsl:element name="a">
      ...
      <table border="1" width="100%">
        <tr>
          <td valign="middle" align="center" bgcolor="#CCCCFF" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name"><xsl:value-of select="./asnType/asnInteger/className"/></xsl:attribute>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnInteger/className"/>()</b>
          </td>
          <td valign="middle" align="left">
            The first <b><xsl:value-of select="./asnType/asnInteger/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnInteger/className"/> object with a default value of 0 (default
            constructor).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnInteger/className"/>(long valueParam)</b>
          </td>
          <td valign="middle" align="left">
            The second <b><xsl:value-of select="./asnType/asnInteger/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnInteger/className"/> object with a specified value (<i>valueParam</i>
            parameter of C++ type long).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select=
            "./asnType/asnInteger/className"/>(Octets&amp; octets)</b>
          </td>
          <td valign="middle" align="left">
            The third <b><xsl:value-of select="./asnType/asnInteger/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnInteger/className"/> object from an ASN.1 encoded value (the <b>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnInteger/className"/>(const 
            <xsl:value-of select="./asnType/asnInteger/className"/>&amp; rhs)</b>
          </td>
          <td valign="middle" align="left">
            The fourth <b><xsl:value-of select="./asnType/asnInteger/className"/></b> constructor is the standard 
            C++ copy constructor.
          </td>
        </tr>
      </table>
    ...
    <ul type="square">
      <li>
        <font size="4">
          Public member functions inherited from <a href="AsnInteger.html">AsnInteger</a> and 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnInteger/className"/> object to an ASN.1 encoded value. The ASN.1 encoded value is 
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnInteger/className"/>). The ASN.1 encoded value is passed through an object of class 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnInteger/className"/> object. The end-user is responsible for deleting the clone object.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            ...
            <xsl:value-of select="./asnType/asnInteger/className"/> objects. It is used to implement the comparison
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnInteger/className"/>&quot;</font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            The <b>GetBaseName</b> member function returns the string <font color="#000080">&quot;INTEGER&quot;
            </font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>AsnInteger&amp; operator=(const AsnInteger&amp; rhs)</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name">operator==</xsl:attribute>
              <b>bool operator==(const AsnInteger&amp; rhs) const</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnInteger/className"/> object to an output stream at any time.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
