...
<!-- /////////////////////////////////////////////////////////////////////// -->
<!--                                                                         -->
<!-- ID: $Id: AsnOctetString.xsl,v 9.1 2005/03/23 12:54:12 cvsadmin Exp $ -->
<!--                                                                         -->
<!-- /////////////////////////////////////////////////////////////////////// -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  <xsl:template match="/">
    ...
    <head>
    <title>Class <xsl:value-of select="./asnType/asnOctetString/className"/>
    </title>
    </head>
    ...
    <p align="left">
      <u>
        <font size="6">Class <xsl:value-of select="./asnType/asnOctetString/className"/></font>
      </u>
    </p>

    <p>The ASN.1 type <xsl:value-of select="./asnType/asnOctetString/asnTypeName"/> is based on the ASN.1 OCTET STRING
    built-in type, therefore the class <xsl:value-of select="./asnType/asnOctetString/className"/> inherits from the
    class <b><a href="AsnOctetString.html">AsnOctetString</a></b>.</p>
    ...
    <p>
      <xsl:element name="a">
        <xsl:attribute name="href">#<xsl:value-of select="./asnType/asnOctetString/className"/></xsl:attribute>
        <xsl:value-of select="./asnType/asnOctetString/className"/>
      </xsl:element>
      -
      <xsl:element name="a">
      ...
      <table border="1" width="100%">
        <tr>
          <td valign="middle" align="center" bgcolor="#CCCCFF" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name"><xsl:value-of select="./asnType/asnOctetString/className"/></xsl:attribute>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnOctetString/className"/>()</b>
          </td>
          <td valign="middle" align="left">
            The first <b><xsl:value-of select="./asnType/asnOctetString/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnOctetString/className"/> object with an empty contents (default 
            constructor).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnOctetString/className"/>(const std::vector&lt;byte&gt;&amp; 
			array)</b>
          </td>
          <td valign="middle" align="left">
            The second <b><xsl:value-of select="./asnType/asnOctetString/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnOctetString/className"/> object with a specified contents (<i>array</i>
            parameter of C++ type const std::vector&lt;byte&gt;&amp;).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select=
            "./asnType/asnOctetString/className"/>(Octets&amp; octets)</b>
          </td>
          <td valign="middle" align="left">
            The third <b><xsl:value-of select="./asnType/asnOctetString/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnOctetString/className"/> object from an ASN.1 encoded value (the <b>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnOctetString/className"/>(const 
            <xsl:value-of select="./asnType/asnOctetString/className"/>&amp; rhs)</b>
          </td>
          <td valign="middle" align="left">
            The fourth <b><xsl:value-of select="./asnType/asnOctetString/className"/></b> constructor is the standard 
            C++ copy constructor.
          </td>
        </tr>
      </table>
    ...
    <ul type="square">
      <li>
        <font size="4">
          Public member functions inherited from <a href="AsnOctetString.html">AsnOctetString</a> and 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnOctetString/className"/> object to an ASN.1 encoded value. The ASN.1 encoded value is 
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnOctetString/className"/>). The ASN.1 encoded value is passed through an object of class 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>const std::vector&lt;byte&gt;&amp; GetArray() const</b>
            </xsl:element>
          </td>
          <td align="left">
            The <b>GetArray</b> member function returns the contents (vector of bytes, C++ type const 
            std::vector&lt;byte&gt;&amp;) of a <xsl:value-of select="./asnType/asnOctetString/className"/> object.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>void SetArray(const std::vector&lt;byte&gt;&amp; array)</b>
            </xsl:element>
          </td>
          <td align="left">
            The <b>SetArray</b> member function allows setting the contents from a vector of bytes (C++ type 
            const std::vector&lt;byte&gt;&amp;) of a <xsl:value-of select="./asnType/asnOctetString/className"/>
            object.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnOctetString/className"/> object. The end-user is responsible for deleting the clone object.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            ...
            <xsl:value-of select="./asnType/asnOctetString/className"/> objects. It is used to implement the comparison
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnOctetString/className"/>&quot;</font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            The <b>GetBaseName</b> member function returns the string <font color="#000080">&quot;OCTET STRING&quot;
            </font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>AsnOctetString&amp; operator=(const AsnOctetString&amp; rhs)</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name">operator==</xsl:attribute>
              <b>bool operator==(const AsnOctetString&amp; rhs) const</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnOctetString/className"/> object to an output stream at any time.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
