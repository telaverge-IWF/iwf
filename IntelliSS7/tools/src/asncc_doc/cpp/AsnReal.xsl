...
<!-- /////////////////////////////////////////////////////////////////////// -->
<!--                                                                         -->
<!-- ID: $Id: AsnReal.xsl,v 9.1 2005/03/23 12:54:12 cvsadmin Exp $ -->
<!--                                                                         -->
<!-- /////////////////////////////////////////////////////////////////////// -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  <xsl:template match="/">
    ...
    <head>
    <title>Class <xsl:value-of select="./asnType/asnReal/className"/>
    </title>
    </head>
    ...
    <p align="left">
      <u>
        <font size="6">Class <xsl:value-of select="./asnType/asnReal/className"/></font>
      </u>
    </p>

    <p>The ASN.1 type <xsl:value-of select="./asnType/asnReal/asnTypeName"/> is based on the ASN.1 REAL
    built-in type, therefore the class <xsl:value-of select="./asnType/asnReal/className"/> inherits from the
    class <b><a href="AsnReal.html">AsnReal</a></b>.</p>
    ...
    <p>
      <xsl:element name="a">
        <xsl:attribute name="href">#<xsl:value-of select="./asnType/asnReal/className"/></xsl:attribute>
        <xsl:value-of select="./asnType/asnReal/className"/>
      </xsl:element>
      -
      <xsl:element name="a">
      ...
      <table border="1" width="100%">
        <tr>
          <td valign="middle" align="center" bgcolor="#CCCCFF" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name"><xsl:value-of select="./asnType/asnReal/className"/></xsl:attribute>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnReal/className"/>()</b>
          </td>
          <td valign="middle" align="left">
            The first <b><xsl:value-of select="./asnType/asnReal/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnReal/className"/> object with a default value of 0 (default
            constructor).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnReal/className"/>(double valueParam)</b>
          </td>
          <td valign="middle" align="left">
            The second <b><xsl:value-of select="./asnType/asnReal/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnReal/className"/> object with a specified value (<i>valueParam</i>
            parameter of C++ type double).
          </td>
        </tr>
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select=
            "./asnType/asnReal/className"/>(Octets&amp; octets)</b>
          </td>
          <td valign="middle" align="left">
            The third <b><xsl:value-of select="./asnType/asnReal/className"/></b> constructor allows creating a
            <xsl:value-of select="./asnType/asnReal/className"/> object from an ASN.1 encoded value (the <b>
        ...
        <tr>
          <td valign="middle" align="left" width="33%">
            <b><xsl:value-of select="./asnType/asnReal/className"/>(const 
            <xsl:value-of select="./asnType/asnReal/className"/>&amp; rhs)</b>
          </td>
          <td valign="middle" align="left">
            The fourth <b><xsl:value-of select="./asnType/asnReal/className"/></b> constructor is the standard 
            C++ copy constructor.
          </td>
        </tr>
      </table>
    ...
    <ul type="square">
      <li>
        <font size="4">
          Public member functions inherited from <a href="AsnReal.html">AsnReal</a> and 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnReal/className"/> object to an ASN.1 encoded value. The ASN.1 encoded value is 
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnReal/className"/>). The ASN.1 encoded value is passed through an object of class 
      ...
      <table border="1" width="100%">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>double GetValue() const</b>
            </xsl:element>
          </td>
          <td align="left">
            The <b>GetValue</b> member function returns the value (C++ type double) of a <xsl:value-of select=
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>void SetValue(double valueParam)</b>
            </xsl:element>
          </td>
          <td align="left">
            The <b>SetValue</b> member function allows setting the value (C++ type double) of a <xsl:value-of select=
            "./asnType/asnReal/className"/> object.
          </td>
        </tr>
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnReal/className"/> object. The end-user is responsible for deleting the clone object.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            ...
            <xsl:value-of select="./asnType/asnReal/className"/> objects. It is used to implement the comparison
        ...
        <tr>
          ...
          <td align="left">
            ...
            "./asnType/asnReal/className"/>&quot;</font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
          ...
          <td align="left">
            The <b>GetBaseName</b> member function returns the string <font color="#000080">&quot;REAL&quot;
            </font>.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              ...
              <b>AsnReal&amp; operator=(const AsnReal&amp; rhs)</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          <td align="left" width="33%">
            <xsl:element name="a">
              <xsl:attribute name="name">operator==</xsl:attribute>
              <b>bool operator==(const AsnReal&amp; rhs) const</b>
            </xsl:element>
          </td>
          <td align="left">
        ...
        <tr>
          ...
          <td valign="middle" align="left">
            ...
            "./asnType/asnReal/className"/> object to an output stream at any time.
          </td>
        </tr>
        <tr>
          <td align="left" width="33%">
