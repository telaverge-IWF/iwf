...
///////////////////////////////////////////////////////////////////////////////
//
// LOG: $Log: asncc_check_semantic_visitor.h,v $
...
#if !defined(_ASNCC_CHECK_SEMANTIC_VISITOR_H_)
#define _ASNCC_CHECK_SEMANTIC_VISITOR_H_

#ident "$Id: asncc_check_semantic_visitor.h,v 9.1 2005/03/23 12:54:13 cvsadmin Exp $"
...
////////////////////////////////////////////////////////////////////////////////
//
//  CheckSemanticVisitor interface.
//

class CheckSemanticVisitor : public Visitor
{
public:

    CheckSemanticVisitor(AsnCC& asnCCParam, Module* moduleParam) 
    :   asnCC(asnCCParam),
        module(moduleParam)
    {
        REQUIRE(module != NULL);
...
#endif // !defined(_ASNCC_CHECK_SEMANTIC_VISITOR_H_)
