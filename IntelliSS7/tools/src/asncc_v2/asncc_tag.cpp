...
#ident "$Id: asncc_tag.cpp,v 9.1 2005/03/23 12:54:15 cvsadmin Exp $"
...
Tag::GetTagClassString() const
{
    ...
    case CLASS_UNIVERSAL:
        return "ASN_CLASS_UNIVERSAL";
    case CLASS_APPLICATION:
        return "ASN_CLASS_APPLICATION";
    case CLASS_CONTEXT_SPECIFIC:
        return "ASN_CLASS_CONTEXT_SPECIFIC";
    case CLASS_PRIVATE:
        return "ASN_CLASS_PRIVATE";
...
Tag::GetTagTypeString() const
{
    ...
    {
    case TYPE_PRIMITIVE:
        return "ASN_PRIMITIVE";
    case TYPE_CONSTRUCTED:
        return "ASN_CONSTRUCTED";
