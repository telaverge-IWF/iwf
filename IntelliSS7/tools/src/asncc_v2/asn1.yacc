...
////////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: asn1.yacc,v 9.1.154.1 2012/12/18 16:11:58 brajappa Exp $
//
////////////////////////////////////////////////////////////////////////////////

#ident "$Id: asn1.yacc,v 9.1.154.1 2012/12/18 16:11:58 brajappa Exp $"
...
%type <typeSemanticValue> BaseStringType
...
Module
    :   TK_MODULE_REFERENCE DefinitiveIdentifier TK_DEFINITIONS TagDefault TK_ASSIGNMENT TK_BEGIN
        ...
        ModuleBody TK_END
        {
            ...
            /* notused TypeList* currentImportListG = NULL; */
        }
    ;
...
ComponentType
    ...
    |   NamedType TK_DEFAULT '(' TK_CSTRING ')'
        {
            $1->SetDefaultValueWithCode(*$4);
        }
