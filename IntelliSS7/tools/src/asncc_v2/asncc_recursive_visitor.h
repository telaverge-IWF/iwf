...
///////////////////////////////////////////////////////////////////////////////
//
// LOG: $Log: asncc_recursive_visitor.h,v $
...
#if !defined(_ASNCC_RECURSIVE_VISITOR_H_)
#define _ASNCC_RECURSIVE_VISITOR_H_

#ident "$Id: asncc_recursive_visitor.h,v 9.1 2005/03/23 12:54:15 cvsadmin Exp $"
...
public:
    ...
    RecursiveVisitor(AsnCC& asnCCParam, Module* moduleParam)
    :   asnCC(asnCCParam),
        module(moduleParam)
    {
        REQUIRE(module != NULL);
...
#endif // !defined(_ASNCC_RECURSIVE_VISITOR_H_)
