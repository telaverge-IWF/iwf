...
///////////////////////////////////////////////////////////////////////////////
//
// LOG: $Log: asncc_print_visitor.cpp,v $
...
#ident "$Id: asncc_print_visitor.cpp,v 9.1 2005/03/23 12:54:15 cvsadmin Exp $"
...
PrintVisitor::VisitModuleBegin(Module* module)
{
    ...
    if (!(module->GetDefinitiveId()->empty()))
    {
        ...
        for (list<string*>::iterator iter = definitiveId->begin();
