...
SOURCE=.\test2_feature_request_rrl.cpp
# End Source File
# End Group
...
SOURCE=.\test2_feature_request_rrl.h
# End Source File
# End Group
...
BuildCmds= \
	$(ITS_ROOT)\tools\bin\asncc_v2 test2.asn -cpp -xmlCppDoc -u    $(ITS_ROOT)\tools\bin\asncc_useful.asn

".\test2_feature_request_rrl.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\test2_feature_request_rrl.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
