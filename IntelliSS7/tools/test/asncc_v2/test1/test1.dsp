...
SOURCE=.\test1_authentication_failure_report_rrl.cpp
# End Source File
# End Group
...
SOURCE=.\test1_authentication_failure_report_rrl.h
# End Source File
# End Group
...
BuildCmds= \
	$(ITS_ROOT)\tools\bin\asncc_v2 test1.asn -cpp -xmlCppDoc -u    $(ITS_ROOT)\tools\bin\asncc_useful.asn

".\test1_authentication_failure_report_rrl.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\test1_authentication_failure_report_rrl.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
