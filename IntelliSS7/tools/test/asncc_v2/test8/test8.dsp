...
SOURCE=.\test8_authentication_directive_rrl.cpp
# End Source File
# Begin Source File

SOURCE=.\test8_bar1.cpp
# End Source File
# Begin Source File

SOURCE=.\test8_bar2.cpp
# End Source File
# End Group
...
SOURCE=.\test8_authentication_directive_rrl.h
# End Source File
# Begin Source File
...
BuildCmds= \
	$(ITS_ROOT)\tools\bin\asncc_v2 -cpp -xmlCppDoc -u $(ITS_ROOT)\tools\bin\asncc_useful.asn test8.asn

"test8_authentication_directive_rrl.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"test8_bar1.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"test8_bar2.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"test8_authentication_directive_rrl.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"test8_bar1.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"test8_bar2.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
