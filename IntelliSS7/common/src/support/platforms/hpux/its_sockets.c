 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.5  2005/03/21 13:52:12  cvsadmin
 ...
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 6.2  2002/06/19 19:31:15  lbana
 ...
 * LOG: Ready to debug.
 * LOG:
 * LOG: Revision 3.6  2000/11/29 23:38:27  mmiers
 * LOG: Portability fixes.
 * LOG:
 * LOG: Revision 3.5  2000/11/13 19:28:30  mmiers
 * LOG: Try to recover
 * LOG:
 * LOG: Revision 3.7  2000/10/11 18:57:17  mmiers
 ...
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 1.15  2000/08/09 01:23:04  mmiers
 * LOG: Platform correction.
 * LOG:
 * LOG: Revision 1.14  2000/07/12 20:02:09  mmiers
 * LOG: getpeername() size is [in/out].  Docs on UNIX confirm this.
 * LOG:
 * LOG: Revision 1.13  2000/06/02 15:51:34  mmiers
 * LOG:
 * LOG:
 * LOG: More sockets testing.
 * LOG:
 * LOG: Revision 1.12  2000/05/24 22:13:09  mmiers
 * LOG:
 * LOG:
 * LOG: const modifier
 * LOG:
 * LOG: Revision 1.11  2000/05/24 22:01:12  mmiers
 * LOG:
 * LOG:
 * LOG: More fixes for raw sockets.  Now 3 platforms down.
 * LOG:
 * LOG: Revision 1.10  2000/05/24 19:59:40  mmiers
 * LOG:
 * LOG:
 * LOG: Back this change out.  Special case only the windows code, its
 * LOG: the oddball here.
 * LOG:
 * LOG: Revision 1.9  2000/05/24 19:46:44  mmiers
 * LOG:
 * LOG:
 * LOG: Work around an NT limitation.
 * LOG:
 * LOG: Revision 1.8  2000/05/23 18:53:12  mmiers
 * LOG:
 * LOG:
 * LOG: bind() on RawOpen
 * LOG:
 * LOG: Revision 1.7  2000/05/23 18:47:33  mmiers
 * LOG:
 * LOG:
 * LOG: Socket API update.
 * LOG:
 * LOG: Revision 1.6  2000/05/23 14:40:49  mmiers
 * LOG:
 * LOG:
 * LOG: Fix a few typo bugs.
 * LOG:
 * LOG: Revision 1.5  2000/05/22 23:48:21  mmiers
 * LOG:
 * LOG:
 * LOG: Unix domain datagram sockets.
 * LOG:
 * LOG: Revision 1.4  2000/05/22 16:01:55  mmiers
 * LOG:
 * LOG:
 * LOG: Add RAW socket type.
 * LOG:
 * LOG: Revision 1.3  2000/05/03 21:07:17  mmiers
 * LOG:
 * LOG:
 * LOG: Start adding support for reader/writer locks.
 * LOG: Add SOCK_GetPeerName().
 * LOG:
 * LOG: Revision 1.2  2000/02/10 14:57:53  mmiers
 * LOG:
 ...
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:28:07  mmiers
 * LOG:
 * LOG: Begin third iteration.
 * LOG:
 * LOG: Revision 1.21  1999/10/15 23:04:34  labuser
 * LOG:
 * LOG:
 * LOG: close() on UNIX, not closesocket().
 * LOG:
 * LOG: Revision 1.20  1999/10/14 15:38:37  mmiers
 * LOG:
 * LOG:
 * LOG: Remove memory leaks from socket creation.  Publish
 * LOG: ReConnect/ReAccept APIs.
 * LOG:
 * LOG: Revision 1.19  1999/10/05 15:53:32  mmiers
 * LOG:
 * LOG:
 * LOG: Add permission setting to UNIX domain sockets.
 * LOG:
 * LOG: Revision 1.18  1999/08/31 21:11:37  labuser
 * LOG:
 * LOG:
 * LOG: Fixes for UNIX domain sockets.
 * LOG:
 * LOG: Revision 1.17  1999/08/09 20:08:10  labuser
 * LOG:
 * LOG:
 * LOG: Be a little paranoid about cleaning up UNIX domain socket files.
 * LOG:
 * LOG: Revision 1.16  1999/06/24 00:59:13  mmiers
 * LOG:
 * LOG:
 * LOG: Add an IPC type semaphore
 * LOG:
 * LOG: Revision 1.15  1999/03/01 21:31:34  mmiers
 * LOG:
 * LOG:
 * LOG: Move the address variable for DNS config.
 * LOG:
 * LOG: Revision 1.14  1999/03/01 21:26:19  mmiers
 * LOG:
 * LOG:
 * LOG: Make DNS usage a configurable option for sockets.
 * LOG:
 * LOG: Revision 1.13  1999/02/25 23:03:45  mmiers
 * LOG:
 * LOG:
 * LOG: Fixes for CC.
 * LOG:
 * LOG: Revision 1.12  1999/02/25 22:57:12  mmiers
 * LOG:
 * LOG:
 * LOG: Update for C++ compilation.
 * LOG:
 * LOG: Revision 1.11  1999/01/05 16:46:50  jrao
 * LOG: Moved the declaration part to the beginning of SOCK_ReadyToRead()
 * LOG:
 * LOG: Revision 1.10  1998/12/11 21:58:19  rsonak
 * LOG: Fix some socket related bugs.
 * LOG:
 * LOG: Revision 1.9  1998/11/19 21:13:33  mmiers
 * LOG: Correct BSDism
 * LOG:
 * LOG: Revision 1.8  1998/11/19 02:18:03  mmiers
 * LOG: Straighten out a few potential bugs.
 * LOG:
 * LOG: Revision 1.7  1998/11/17 14:58:16  mmiers
 * LOG: #include <ctype.h>
 * LOG:
 * LOG: Revision 1.6  1998/11/17 03:30:50  mmiers
 ...
 * LOG:
 * LOG: Revision 1.3  1998/11/13 17:50:52  mmiers
...
/* HPUX is a little silly working with the resolver/bind library. */
extern int h_errno;
             ...
             ITS_BOOLEAN autoHeaders) 
{
    ...
    *sockInfo = NULL;
     ...
     * FIXME: is this on or off by default.
     */
    if (autoHeaders)
    {
        dummy = 0;

        /* FIXME: only testing will show if right now we're screwed on HP */
    }
...
{    
    ...
    if (select(info->socket + 1, (int *)&fds, NULL, NULL, NULL) > 0)
    {
        return (ITS_TRUE);
    }
    else
...
SOCK_Poll(ITS_SockPollInfo *socks, int nsocks, int usecs)
{
    ...
    {
        ret = select(max, (int *)&reads, (int *)&writes, NULL, NULL);
    }
    else
    {
        struct timeval tv;
        ...
        ret = select(max, (int *)&reads, (int *)&writes, NULL, &tv);
    }
