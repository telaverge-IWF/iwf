 ...
 * LOG: Revision 9.2.20.1.20.1  2014/09/16 09:34:54  jsarvesh
 * LOG: Changes done for removing warnings
 * LOG:
 * LOG: Revision 9.2.20.1.16.1  2014/09/15 07:20:42  jsarvesh
 * LOG: Changes done for removing Warnings
 * LOG:
 * LOG: Revision 9.2.20.1  2011/04/13 07:36:19  nvijikumar
 * LOG: Merging diamter branch changes
 * LOG:
 * LOG: Revision 9.2  2008/04/22 11:28:37  kramesh
 * LOG: Propagated Personeta issue 1714. Sigtran Solaris10 message send failure.
 * LOG:
 * LOG: Revision 9.1  2005/03/23 12:53:46  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.4  2005/03/21 13:52:15  cvsadmin
 * LOG: PR6.4.2 Source Propagated to Current
 * LOG:
 * LOG: Revision 7.2.2.1.6.1  2004/09/29 09:56:14  asingh
 * LOG: Changes for linux ES 30 operating system; compilation issue.
 * LOG:
 * LOG: Revision 7.2.2.1  2003/08/05 16:34:31  hcho
 * LOG: fix memory override in AddrToName(lb).
 * LOG:
 ...
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 6.3  2002/06/19 19:31:16  lbana
 * LOG: Missing SOCK_CreateAddr in SOCK_RawOpen call.
 * LOG:
 * LOG: Revision 6.2  2002/05/28 19:51:23  lbana
 * LOG: return False if two addresses are not equal, and also fix address to name
 * LOG: conevrsion.
 * LOG:
 ...
 * LOG:
 * LOG: Revision 3.14  2001/02/20 19:00:57  mmiers
 * LOG: Assert removal
 * LOG:
 * LOG: Revision 3.13  2001/02/07 22:12:56  mmiers
 * LOG: Convert RCSID to ident.
 * LOG:
 * LOG: Revision 3.12  2001/02/05 22:15:52  hxing
 * LOG: Remove dead local var.
 * LOG:
 ...
 * LOG: Ready to debug.
 * LOG:
 * LOG: Revision 3.6  2000/11/16 16:37:18  mmiers
 * LOG: Make this work for solaris.
 * LOG:
 * LOG: Revision 3.5  2000/11/13 19:28:30  mmiers
 * LOG: Try to recover
 * LOG:
 * LOG: Revision 3.7  2000/10/11 18:57:18  mmiers
 * LOG: Skip the loopback interface by default.
 * LOG:
 * LOG: Revision 3.6  2000/10/10 17:10:07  mmiers
 * LOG: Associations work!
 * LOG:
 * LOG: Revision 3.5  2000/10/09 22:02:55  mmiers
 * LOG: Correct bugs in addr fetch logic.
 * LOG:
 * LOG: Revision 3.4  2000/10/05 21:17:53  mmiers
 * LOG: Update other platforms.
 * LOG:
 * LOG: Revision 3.3  2000/09/28 22:10:26  mmiers
 * LOG: Build on UNIX.
 * LOG:
 ...
 * LOG:
 * LOG: Revision 3.1  2000/08/16 00:06:04  mmiers
 * LOG:
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 1.15  2000/07/12 20:02:10  mmiers
 * LOG: getpeername() size is [in/out].  Docs on UNIX confirm this.
 * LOG:
 * LOG: Revision 1.14  2000/06/02 15:51:35  mmiers
 * LOG:
 * LOG:
 * LOG: More sockets testing.
 * LOG:
 * LOG: Revision 1.13  2000/05/24 22:01:13  mmiers
 * LOG:
 * LOG:
 * LOG: More fixes for raw sockets.  Now 3 platforms down.
 * LOG:
 * LOG: Revision 1.12  2000/05/24 19:59:41  mmiers
 * LOG:
 * LOG:
 * LOG: Back this change out.  Special case only the windows code, its
 * LOG: the oddball here.
 * LOG:
 * LOG: Revision 1.11  2000/05/24 19:46:44  mmiers
 * LOG:
 * LOG:
 * LOG: Work around an NT limitation.
 * LOG:
 * LOG: Revision 1.10  2000/05/23 18:53:12  mmiers
 * LOG:
 * LOG:
 * LOG: bind() on RawOpen
 * LOG:
 * LOG: Revision 1.9  2000/05/23 18:47:34  mmiers
 * LOG:
 * LOG:
 * LOG: Socket API update.
 * LOG:
 * LOG: Revision 1.8  2000/05/23 14:40:49  mmiers
 * LOG:
 * LOG:
 * LOG: Fix a few typo bugs.
 * LOG:
 * LOG: Revision 1.7  2000/05/22 23:48:22  mmiers
 * LOG:
 * LOG:
 * LOG: Unix domain datagram sockets.
 * LOG:
 * LOG: Revision 1.6  2000/05/22 16:01:55  mmiers
 * LOG:
 * LOG:
 * LOG: Add RAW socket type.
 * LOG:
 * LOG: Revision 1.5  2000/05/03 21:07:18  mmiers
 * LOG:
 * LOG:
 * LOG: Start adding support for reader/writer locks.
 * LOG: Add SOCK_GetPeerName().
 * LOG:
 * LOG: Revision 1.4  2000/02/10 14:48:13  mmiers
 * LOG:
 * LOG: Add functions for network/host conversion so they're always in our
 * LOG: namespace.
 * LOG:
 * LOG: Revision 1.3  2000/01/06 02:34:42  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.25  1999/11/02 15:06:56  labuser
 * LOG: Deleted character that should not be there.
 * LOG:
 * LOG: Revision 1.24  1999/10/15 23:04:35  labuser
 * LOG:
 * LOG:
 * LOG: close() on UNIX, not closesocket().
 * LOG:
 * LOG: Revision 1.23  1999/10/14 15:38:38  mmiers
 * LOG:
 * LOG:
 * LOG: Remove memory leaks from socket creation.  Publish
 * LOG: ReConnect/ReAccept APIs.
 * LOG:
 * LOG: Revision 1.22  1999/10/05 15:53:33  mmiers
 * LOG:
 * LOG:
 * LOG: Add permission setting to UNIX domain sockets.
 * LOG:
 * LOG: Revision 1.21  1999/08/31 21:11:38  labuser
 * LOG:
 * LOG:
 * LOG: Fixes for UNIX domain sockets.
 * LOG:
 * LOG: Revision 1.20  1999/08/09 20:08:11  labuser
 * LOG:
 * LOG:
 * LOG: Be a little paranoid about cleaning up UNIX domain socket files.
 * LOG:
 * LOG: Revision 1.19  1999/06/24 00:59:13  mmiers
 * LOG:
 * LOG:
 * LOG: Add an IPC type semaphore
 * LOG:
 * LOG: Revision 1.18  1999/03/01 21:31:34  mmiers
 * LOG:
 * LOG:
 * LOG: Move the address variable for DNS config.
 * LOG:
 * LOG: Revision 1.17  1999/03/01 21:26:19  mmiers
 * LOG:
 * LOG:
 * LOG: Make DNS usage a configurable option for sockets.
 * LOG:
 * LOG: Revision 1.16  1999/02/26 15:41:09  mmiers
 * LOG:
 * LOG:
 * LOG: Fixes for Solaris C++ build.
 * LOG:
 * LOG: Revision 1.15  1999/02/25 23:03:46  mmiers
 * LOG:
 * LOG:
 * LOG: Fixes for CC.
 * LOG:
 * LOG: Revision 1.14  1998/12/11 21:58:35  rsonak
 * LOG: Fix some socket related bugs.
 * LOG:
 * LOG: Revision 1.13  1998/11/19 02:18:16  mmiers
 * LOG: Straighten out a few potential bugs.
 * LOG:
 * LOG: Revision 1.12  1998/11/19 00:36:29  mmiers
 * LOG: Remove warnings.
 * LOG:
 * LOG: Revision 1.11  1998/11/17 14:58:18  mmiers
 * LOG: #include <ctype.h>
 * LOG:
 * LOG: Revision 1.10  1998/11/17 03:31:05  mmiers
 * LOG: Deal with gethostbyaddr() when appropriate.
 * LOG:
 * LOG: Revision 1.9  1998/11/16 23:35:11  mmiers
 * LOG: Get the OS right.
 * LOG:
 * LOG: Revision 1.8  1998/11/16 23:24:55  mmiers
 * LOG: Remove some WIN curiosities.
 * LOG:
 * LOG: Revision 1.7  1998/11/13 17:50:53  mmiers
 * LOG: Add UDP sockets to the collection.
 * LOG:
 * LOG: Revision 1.6  1998/09/28 16:07:27  mmiers
...
#ident "$Id: its_sockets.c,v 9.2.20.1.20.1 2014/09/16 09:34:54 jsarvesh Exp $"
...
{    
     ...
     * Attempt connection 
     */
    if (connect(info->socket, (struct sockaddr *)info->addr, info->asize) < 0)
    {
        return (ITS_ECONNECTFAIL);
    }

    /**
     * Added check for NAGLE Algorithm as requested by
     * Bridewater.(This was local change earlier provided).
     * Porting from Dia-ProductionRelease2_1 to
     * B-IDIA-0100-00 branch.
     */
#ifndef _BRIDGEWATER
    /*
...
SOCK_ServerAccept(ITS_SocketInfo* info, ITS_SocketInfo **newInfo)
{
    ...
    *newInfo = NULL;
    ...
    tmp->socket = accept(info->socket,
                         (struct sockaddr *)tmp->addr, &tmp->asize);
...
SOCK_Recv(ITS_SocketInfo* info, char *buf, int nbytes, void* from, int* len) 
{
    ...
    /* Read something */ 
    return recvfrom(info->socket, buf, nbytes, 0,
...
SOCK_Send(ITS_SocketInfo* info, char *buf, int nbytes, void* to, int len) 
{
    ...
    /* Write some data */ 
    return sendto(info->socket, buf, nbytes, 0, (struct sockaddr *)to, len); 
}
...
SOCK_SetDscpMarking(ITS_SocketInfo *sockInfo, int dscp)
{
    ...
    if (sockInfo == NULL)
    {
        ITS_TRACE_CRITICAL((" Failed to set DSCP sockInfo NULL ptr"));
        return;
    }
    ...
    if( sockopt == -1 )
    {
        ITS_TRACE_CRITICAL((" Failed to set IPV4  DSCP option "));
        return;
    }
    return;
}
