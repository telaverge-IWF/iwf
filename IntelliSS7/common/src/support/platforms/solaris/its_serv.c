 ...
 * LOG: Revision 9.2  2008/07/17 14:38:16  ssingh
 * LOG: Warning removal for Solaris Compilation
 * LOG:
 * LOG: Revision 9.1  2005/03/23 12:53:46  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.2  2005/03/21 13:52:15  cvsadmin
 * LOG: PR6.4.2 Source Propagated to Current
 * LOG:
 * LOG: Revision 7.1.46.1  2005/01/05 07:21:28  craghavendra
 ...
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 6.5  2002/08/02 14:18:00  mmiers
 * LOG: Missing variable
 * LOG:
 * LOG: Revision 6.4  2002/08/01 15:46:24  mmiers
 * LOG: Add priority setting
 * LOG:
 * LOG: Revision 6.3  2002/04/30 19:22:41  mmiers
 ...
 * LOG: Begin PR5
 * LOG:
 * LOG: Revision 3.12  2001/04/03 23:56:47  mmiers
 * LOG: Debugging.
 * LOG:
 ...
 * LOG:
 * LOG: Revision 3.7  2001/02/05 22:11:09  hxing
 * LOG: Mispelled eventLog.
 * LOG:
 ...
 * LOG: RCSID addition.
 * LOG:
 * LOG: Revision 3.3  2001/01/18 18:46:29  mmiers
 * LOG: CPP service based on C service.
 * LOG:
 * LOG: Revision 3.2  2000/09/07 17:13:40  labuser
 * LOG:
 ...
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 1.1  1999/12/16 16:16:32  mmiers
 ...
 * LOG:
 * LOG: Revision 1.11  1999/10/12 19:00:32  mmiers
 * LOG:
 * LOG:
 * LOG: Instrument exit condition for services.
 * LOG:
 * LOG: Revision 1.10  1999/10/12 18:34:45  mmiers
 * LOG:
 * LOG:
 * LOG: Exit with non-zero code.
 * LOG:
 * LOG: Revision 1.9  1999/10/12 15:46:11  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.7  1999/08/23 01:56:12  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.4  1999/08/18 16:19:47  mmiers
 * LOG:
 * LOG:
 * LOG: Add in comments.
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.2  1999/08/18 02:34:28  mmiers
 * LOG:
 * LOG:
 * LOG: Tweaks to UNIX services and NT services.  Tomorrow will tell.
 * LOG:
 * LOG: Revision 1.1  1999/08/18 01:02:23  mmiers
 * LOG:
 * LOG:
...
#ident "$Id: its_serv.c,v 9.2 2008/07/17 14:38:16 ssingh Exp $"

#define SERV_SCHED_POLICY   SCHED_RR
...
SERVICE_SetPriority(ITS_UINT priority)
{
    ...
    if (priority > SERVICE_MAX_PRIORITY)
    {
        return (ITS_EOVERFLOW);
    }

    minp = sched_get_priority_min(SERV_SCHED_POLICY);
    maxp = sched_get_priority_max(SERV_SCHED_POLICY);

    /* convert to solaris range */
    /* use a fixed point conversion */
    scale = ((ITS_UINT)(maxp - minp + 1) * 100) /
                (SERVICE_MAX_PRIORITY - SERVICE_MIN_PRIORITY + 1);
    priority = (priority * scale) / 100;

    /* call in */
    sparm.sched_priority = priority;
    ret = sched_setscheduler(getpid(), SERV_SCHED_POLICY, &sparm);
    if (ret < 0)
    {
