 ...
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 1.4  2000/08/09 01:13:44  mmiers
 * LOG: Platform corrections.
 * LOG:
 * LOG: Revision 1.3  2000/08/09 00:08:25  mmiers
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.1  2000/04/25 14:52:54  mmiers
 * LOG:
 * LOG:
...
CONDVAR_WaitWithTimeOut(ITS_CONDVAR *cv, ITS_MUTEX *m, ITS_UINT millisecs)
{
    ...
    if ((ret = pthread_cond_timedwait(cv, m, &abstime)) != 0)
    {
        if (ret == ETIMEDOUT)
        {
            return (ITS_ETIMEOUT);
