 ...
 * LOG:
 * LOG: Revision 1.6  1999/10/11 16:07:44  mmiers
 * LOG:
 * LOG:
 * LOG: Correct mask initialization in sigaction struct.
 * LOG:
 * LOG: Revision 1.5  1999/10/07 22:28:00  labuser
 * LOG:
 * LOG:
 * LOG: Find the termination problem with Brite applications.  Due to
 * LOG: not so great signal handling and resource leak.
 * LOG:
 * LOG: Revision 1.4  1999/08/23 01:12:08  mmiers
 * LOG:
 * LOG:
 * LOG: Add signal mask handling correctly.
 * LOG:
 * LOG: Revision 1.3  1999/08/22 22:27:58  labuser
 * LOG:
 * LOG:
 * LOG: Modernize thread handling on these.
 * LOG:
 * LOG: Revision 1.2  1998/09/23 23:16:34  jrao
 * LOG: Finish platform updates.
 * LOG:
