 ...
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 1.1  2000/01/27 00:04:54  mmiers
 * LOG:
 * LOG: Make core lib smarter
 * LOG:
 * LOG: Revision 1.1  1999/12/16 16:16:24  mmiers
 ...
 * LOG:
 * LOG: Revision 1.3  1998/09/30 19:09:09  jrao
 * LOG: Mutex implementations MUST NOT include trace, or recursion problems
 * LOG: will result.
 * LOG:
 * LOG: Revision 1.2  1998/09/23 23:16:33  jrao
