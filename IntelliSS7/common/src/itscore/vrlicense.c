 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.3  2005/03/21 13:51:50  cvsadmin
 ...
 * LOG:
 * LOG: Revision 7.3.2.2  2003/07/07 12:16:59  mmanikandan
 * LOG: License capability is added for IS652, IS653, IS826, CAMEL, WIN, JSTD.
 * LOG:
 * LOG: Revision 7.3.2.1  2003/06/16 11:13:57  sjaddu
 ...
 * LOG: though.
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:27:24  mmiers
 * LOG:
...
#ident "$Id: vrlicense.c,v 9.2.34.1 2011/04/13 07:37:34 nvijikumar Exp $"
...
main(int argc, char **argv)
{
    ...
    ret = ITS_InitializeClass(itsLICENSE_Class);
    if (ret != ITS_SUCCESS)
    {
