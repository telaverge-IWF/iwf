 ...
 ****************************************************************************
 *
 * LOG: $Log: its_disp_ss7_ansi++.cpp,v $
 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.2  2005/03/21 13:51:27  cvsadmin
 ...
 * LOG: Begin PR5
 * LOG:
 * LOG: Revision 1.12  2001/04/19 20:43:10  mmiers
 * LOG: More error callbacks for the dispatchers.  Give the user an
 * LOG: option if ITS_Initialize fails.
 * LOG:
 * LOG: Revision 1.11  2001/04/19 19:31:18  labuser
 * LOG: Change NextEventFail logic to (by default - no func given)
 * LOG: terminate the event loop.
 * LOG:
 * LOG: Revision 1.10  2001/04/04 22:01:31  mmiers
 * LOG: Finish debugging.
 * LOG:
 * LOG: Revision 1.9  2001/04/03 23:56:47  mmiers
 * LOG: Debugging.
 * LOG:
 * LOG: Revision 1.8  2001/03/09 22:55:42  mmiers
 * LOG: Finish up the infrastructure changes.  The engine will get built
 * LOG: over the weekend.
 * LOG:
 * LOG: Revision 1.7  2001/03/09 18:33:24  mmiers
 * LOG: Convert to DLL modifier.
 * LOG:
 * LOG: Revision 1.6  2001/03/08 23:18:29  mmiers
 ...
 * LOG:
 * LOG: Revision 3.1  2000/08/16 00:05:23  mmiers
 * LOG:
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 2.2  2000/08/10 22:46:47  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:27:28  mmiers
 * LOG:
 * LOG: Begin third iteration.
 * LOG:
 * LOG: Revision 1.4  1999/09/24 14:25:51  mmiers
 * LOG:
 * LOG:
 * LOG: Correct a few behaviors here.
 * LOG:
 * LOG: Revision 1.3  1999/08/05 14:54:23  labuser
 * LOG:
 * LOG:
 * LOG: Make these files independent of the global protocol setting.
 * LOG:
 * LOG: Revision 1.2  1999/07/29 02:11:43  mmiers
 * LOG:
 * LOG:
 * LOG: Correct build errors after addressing Hubert's comments.
 * LOG:
 * LOG: Revision 1.1  1999/07/27 23:25:01  mmiers
 * LOG:
 * LOG:
...
#ident "$Id: its_disp_ss7_ansi++.cpp,v 9.2 2005/07/19 05:40:46 adutta Exp $"
...
DISP_Dispatch_SS7_ANSI_CPP(ThreadPoolThread *thr, void *arg)
{
    ...
    while (!self->GetExit())
    {
        ...
        case ITS_MTP2_ANSI_SRC:
            ...
            ret = Transport::PutEvent(ITS_MTP3_ANSI_SRC, event);
            if (ret != ITS_SUCCESS)
            {
