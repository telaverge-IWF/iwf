...
#ident "$Id: mnt_intern.h,v 9.1 2005/03/23 12:53:31 cvsadmin Exp $"

//
//
// mnt_intern.h: MNT intern (internal to MNT).
//
//


#if !defined(_MNT_INTERN_H_)
#define _MNT_INTERN_H_
