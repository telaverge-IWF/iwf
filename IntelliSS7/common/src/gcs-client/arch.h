...
#ifdef DEBUG
/* Debug flag in GCS is different from that one in Accelero 
 * Hence undef it */
#undef DEBUG
#endif

#ifdef NDEBUG
/* NDebug flag in GCS is different from that one in Accelero 
 * Hence undef it */
#undef NDEBUG
#endif
...
/* HLD fix to include config files for linux and solaris differently */
#ifdef solaris
