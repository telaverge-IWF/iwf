 ...
 * LOG:
 * LOG: Revision 1.5  1998/10/21 17:48:16  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 03:08:07  mmiers
 * LOG: Start removing the dependency on all the different NULL types.
 * LOG:
 * LOG: Revision 1.3  1998/10/20 23:31:14  mmiers
...
#ident "$Id: rcmd_srch.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"

char *
rcmd_srch(int val, CMD_TABLE *cmd)
{
    for (; cmd->cmd_key != NULL; cmd++)
    {
