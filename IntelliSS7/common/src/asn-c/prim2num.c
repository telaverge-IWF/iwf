 ...
 * LOG:
 * LOG: Revision 1.5  1998/10/21 04:30:51  mmiers
 * LOG: Cleaning up pepsy.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 02:40:58  mmiers
...
#ident "$Id: prim2num.c,v 9.1 2005/03/23 12:53:03 cvsadmin Exp $"
...
prim2num (PE pe)
{
    ...
    if (pe->pe_form != PE_FORM_PRIM || pe->pe_prim == NULL)
    {
