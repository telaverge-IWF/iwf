 ...
 * LOG:
 * LOG: Revision 1.1  1998/10/27 01:15:31  mmiers
 ...
 * LOG:
 * LOG: Revision 1.5  1998/10/21 17:48:28  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 02:40:51  mmiers
...
#ident "$Id: pe2ssdu.c,v 9.1 2005/03/23 12:53:03 cvsadmin Exp $"
...
pe2ssdu (PE pe, char** base, int* len)
{
    ...
    *base = Qcp;
    ...
    Len = 0;
    Ecp = Qcp + plen;
    if ((ret = pe2qb_f(pe, &Qcp, Ecp, &Len)) != plen)
    {
