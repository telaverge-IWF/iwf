 ...
 * LOG:
 * LOG: Revision 1.4  1998/10/21 17:48:17  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.3  1998/10/20 23:37:33  mmiers
...
#ident "$Id: smalloc.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"
...
set_smalloc_handler(VFP fnx)
{
    ...
    {
	smalloc_handler = default_smalloc_handler;
    }
...
smalloc(int size)
{
    ...
    if ((ptr = (char *)malloc((unsigned) size)) == (char *) 0)
    {
	(*smalloc_handler) ();
