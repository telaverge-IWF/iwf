...
#ident "$Id: flag2prim.c,v 9.1 2005/03/23 12:53:02 cvsadmin Exp $"

PE
flag2prim(int b, PElementClass pclass, PElementID id)

{
    ...
    if ((pe->pe_prim = PEDalloc (pe->pe_len = 1)) == NULL)
    {
        pe_free (pe);
        return NULL;
    }
    
    *pe->pe_prim = (byte)(b ? 0xff : 0x00);
