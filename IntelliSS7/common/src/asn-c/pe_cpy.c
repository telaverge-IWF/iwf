 ...
 * LOG:
 * LOG: Revision 1.4  1998/10/21 04:30:48  mmiers
 * LOG: Cleaning up pepsy.
 * LOG:
 * LOG: Revision 1.3  1998/10/21 02:40:53  mmiers
...
#ident "$Id: pe_cpy.c,v 9.1 2005/03/23 12:53:03 cvsadmin Exp $"
...
pe_cpy (PE pe)
{
    ...
    if ((p = pe_alloc (pe->pe_class, pe->pe_form, pe->pe_id)) == NULL)
    {
        return NULL;
    }
