 ...
 * LOG:
 * LOG: Revision 1.1  1998/10/27 01:15:39  mmiers
 ...
 *****************************************************************************/
/*
 * prim2set.c - presentation element to set
 */

#include <asn-c/AsnC.h>

#ident "$Id: prim2set.c,v 9.1 2005/03/23 12:53:03 cvsadmin Exp $"
...
prim2set (PE pe)
{
    ...
    {
        return (PE)pe_seterr (pe, PE_ERR_CONS, NULL);
    }
