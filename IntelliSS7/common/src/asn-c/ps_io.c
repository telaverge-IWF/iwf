 ...
 * LOG:
 * LOG: Revision 1.1  1998/10/27 01:15:54  mmiers
 ...
 * LOG:
 * LOG: Revision 1.4  1998/10/21 02:41:07  mmiers
 * LOG: More cleanup.  Eliminated most of the extra pollution headers.
 * LOG:
 * LOG: Revision 1.3  1998/10/20 23:33:03  mmiers
...
#ident "$Id: ps_io.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"

int
ps_io (PS ps, RWFP io, PElementData data, PElementLen n, int in_line)
{
    int    cc;
