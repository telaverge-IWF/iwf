 ...
 * LOG:
 * LOG: Revision 1.3  1998/10/21 17:48:17  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.2  1998/10/21 03:08:08  mmiers
 * LOG: Start removing the dependency on all the different NULL types.
 * LOG:
 * LOG: Revision 1.1  1998/10/21 00:37:22  mmiers
...
#ident "$Id: str2elem.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"
...
str2elem(char *s, unsigned int elements[])
{
    ...
    {
        for (dp = cp; isdigit((ITS_OCTET) * dp); dp++)
        {
            continue;
        }
