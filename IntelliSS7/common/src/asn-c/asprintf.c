 ...
 * LOG: Add ident
 * LOG:
 * LOG: Revision 3.1  2000/08/16 00:04:17  mmiers
 * LOG:
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 2.2  2000/03/18 21:03:35  mmiers
 ...
 * LOG: though.
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:26:20  mmiers
 * LOG:
 * LOG: Begin third iteration.
 * LOG:
 * LOG: Revision 1.1  1998/10/27 01:14:59  mmiers
 * LOG: Make a new library, combining all the old ISODE stuff under one
 * LOG: roof.  Use one, you have to use them all.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 17:48:16  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.3  1998/10/20 23:31:12  mmiers
...
#ident "$Id: asprintf.c,v 9.1 2005/03/23 12:53:01 cvsadmin Exp $"

#define VSPRINTF

void 
_asprintf(char *bp, char *what, va_list ap)		/* fmt, args, ... */
{
    int eindex;
    char *fmt;
