 ...
 * LOG:
 * LOG: Revision 1.1  1998/10/27 01:16:04  mmiers
 ...
 * LOG:
 * LOG: Revision 1.4  1998/10/21 04:31:04  mmiers
...
#ident "$Id: set_addon.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"

int
set_addon (PE pe, PE last, PE newPE)
{
    if (pe == NULL)
    {
	return NOTOK;
