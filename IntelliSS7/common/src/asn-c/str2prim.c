 ...
 * LOG:
 * LOG: Revision 1.5  1998/10/21 04:31:07  mmiers
...
#ident "$Id: str2prim.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"

PE
str2prim (char *s, int len, PElementClass pclass, PElementID id)
{
    PE	    pe;
    ...
    if (len && (pe -> pe_prim = PEDalloc (pe -> pe_len = len)) == NULL)
    {
        pe_free (pe);
