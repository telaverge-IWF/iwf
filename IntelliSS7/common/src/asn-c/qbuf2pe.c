 ...
 * LOG:
 * LOG: Revision 1.2  1999/07/22 00:34:38  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.6  1998/10/21 17:48:39  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.5  1998/10/21 04:31:00  mmiers
 * LOG: Cleaning up pepsy.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 02:41:12  mmiers
 * LOG: More cleanup.  Eliminated most of the extra pollution headers.
 * LOG:
 * LOG: Revision 1.3  1998/10/20 23:33:06  mmiers
...
#ident "$Id: qbuf2pe.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"

#undef	qbuf2pe

PE
qbuf2pe (struct qbuf *qb, int len, int *result)
{
    PE	    pe;
    PS	    ps;
    
    if ((ps = ps_alloc (qbuf_open)) == NULL)
    {
        *result = PS_ERR_NMEM;
        
        return NULL;
    }
    if (qbuf_setup (ps, qb) == NOTOK || (pe = ps2pe (ps)) == NULL)
    {
