 ...
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:26:46  mmiers
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.6  1998/10/22 16:28:34  mmiers
 * LOG: Getting pepsy thread-safe.
 * LOG:
 * LOG: Revision 1.5  1998/10/21 17:48:43  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 04:31:06  mmiers
 * LOG: Cleaning up pepsy.
 * LOG:
 * LOG: Revision 1.3  1998/10/21 02:41:17  mmiers
 * LOG: More cleanup.  Eliminated most of the extra pollution headers.
 * LOG:
 * LOG: Revision 1.2  1998/10/20 23:33:11  mmiers
...
#ident "$Id: str2oid.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"
...
str2oid (char *s)
{
    ...
    OID oids = (OID)smalloc(sizeof(OIDentifier));
    unsigned int* elements = (unsigned int *)malloc(sizeof(unsigned int) *
                                                    (NELEM + 1));
    
    if ((i = str2elem (s, elements)) < 1 || elements[0] > 2 ||
