 ...
 * LOG:
 * LOG: Revision 1.2  1999/07/22 00:34:39  mmiers
 * LOG:
 * LOG:
 ...
 * LOG:
 * LOG: Revision 1.4  1998/10/21 17:48:43  mmiers
 ...
 * LOG:
 * LOG: Revision 1.2  1998/10/20 23:33:10  mmiers
...
#ident "$Id: std2ps.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"
...
std_read (PS ps, PElementData data, PElementLen n, int in_line)
{
    ...
    if ((i = (int)fread ((char *) data, sizeof *data, (int) n,
...
std_write (PS ps, PElementData data, PElementLen n, int in_line)
{
    ...
    if ((i = (int)fwrite ((char *) data, sizeof *data, (int) n,
		     (FILE *) ps->ps_addr)) == NOTOK)
    {
	ps->ps_errno = PS_ERR_IO;
    }
