 ...
 * LOG:
 * LOG: Revision 1.5  1998/10/21 17:48:35  mmiers
 * LOG: Remove last vestiges of ISODE.
 * LOG:
 * LOG: Revision 1.4  1998/10/21 02:41:05  mmiers
...
#ident "$Id: ps_flush.c,v 9.1 2005/03/23 12:53:04 cvsadmin Exp $"
