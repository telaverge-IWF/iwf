 ...
 * LOG: Revision 9.4  2008/06/12 12:46:05  nvijikumar
 * LOG: Renaming from COT to CPOT (CCITT prime - 16bit)
 * LOG: ACC-CG-SDS-SS7-V1.0.02::ID:: D6030
 * LOG:
 * LOG: Revision 9.3  2008/06/11 11:53:57  ssingh
 ...
 * LOG:
 * LOG: Revision 9.1.10.1  2007/10/05 08:56:47  mshanmugam
 * LOG: CPOT stack class record is defined
 * LOG:
 * LOG: Revision 9.1  2005/03/23 12:52:50  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.5  2005/03/21 13:50:49  cvsadmin
 * LOG: PR6.4.2 Source Propagated to Current
 * LOG:
 * LOG: Revision 7.4.40.1  2004/12/16 03:26:18  randresol
 * LOG: Add JAPAN variant implementation
 * LOG:
 * LOG: Revision 7.4.36.1  2004/10/25 20:39:57  randresol
 ...
 * LOG:
 * LOG: Revision 7.3  2002/12/04 04:22:35  randresol
 * LOG: Add PRC Class for Adax
 * LOG:
 * LOG: Revision 7.2  2002/11/26 21:05:11  ngoel
 * LOG: merge prc changes from pr6.2
 * LOG:
 * LOG: Revision 7.1  2002/08/26 22:09:36  mmiers
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 6.3  2002/08/16 22:08:49  mmiers
 * LOG: Build the china variant
 * LOG:
 * LOG: Revision 6.2  2002/06/14 17:41:40  ngoel
 * LOG: add radisys vendor class
 * LOG:
...
#ident "$Id: its_ss7_trans.h,v 9.4 2008/06/12 12:46:05 nvijikumar Exp $"
...
ITSSS7DLLAPI extern SS7TRAN_Manager* ISS7_PRC_Stack;
ITSSS7DLLAPI extern SS7TRAN_Manager* ISS7_TTC_Stack;
...
SS7DLLAPI extern ITS_Class          itsSS7STACK_ClassPRC;
SS7DLLAPI extern ITS_Class          itsSS7STACK_ClassTTC;
SS7DLLAPI extern ITS_Class          itsSS7STACK_ClassCPOT;

SS7DLLAPI extern ITS_Class          itsTCAPSTACK_ClassANSI;  /* Only for ANSI TCAP */
SS7DLLAPI extern ITS_Class          itsTCAPSTACK_ClassCCITT; /* Only for ITU TCAP */

SS7DLLAPI extern SS7STACK_ClassRec  itsSS7STACK_ClassRecANSI;
SS7DLLAPI extern SS7STACK_ClassRec  itsSS7STACK_ClassRecCCITT;
SS7DLLAPI extern SS7STACK_ClassRec  itsSS7STACK_ClassRecPRC;
SS7DLLAPI extern SS7STACK_ClassRec  itsSS7STACK_ClassRecTTC;
SS7DLLAPI extern SS7STACK_ClassRec  itsSS7STACK_ClassRecCPOT;

SS7DLLAPI extern SS7STACK_ClassRec  itsTCAPSTACK_ClassRecANSI;  /* Only for ANSI TCAP */
SS7DLLAPI extern SS7STACK_ClassRec  itsTCAPSTACK_ClassRecCCITT; /* Only for ITU TCAP */
...
ITSSS7DLLAPI extern ITS_Class          itsINTELLISS7_ClassPRC;
ITSSS7DLLAPI extern ITS_Class          itsINTELLISS7_ClassTTC;

ITSSS7DLLAPI extern ITS_Class          itsINTELLITCAP_ClassANSI;  /* Only for ANSI TCAP */
ITSSS7DLLAPI extern ITS_Class          itsINTELLITCAP_ClassCCITT; /* Only for ITU TCAP */


VSS7DLLAPI extern ITS_Class          itsNMS_ClassANSI;
VSS7DLLAPI extern ITS_Class          itsNMS_ClassCCITT;
VSS7DLLAPI extern ITS_Class          itsNMS_ClassPRC;
VSS7DLLAPI extern ITS_Class          itsNMS_ClassTTC;
VSS7DLLAPI extern ITS_Class          itsADAX_ClassANSI;
VSS7DLLAPI extern ITS_Class          itsADAX_ClassCCITT;
VSS7DLLAPI extern ITS_Class          itsADAX_ClassPRC;
VSS7DLLAPI extern ITS_Class          itsADAX_ClassTTC;
VSS7DLLAPI extern ITS_Class          itsSBE_ClassANSI;
VSS7DLLAPI extern ITS_Class          itsSBE_ClassCCITT;
VSS7DLLAPI extern ITS_Class          itsRSYS_ClassANSI;
VSS7DLLAPI extern ITS_Class          itsRSYS_ClassCCITT;
