 ...
 * LOG: Revision 9.1.114.1  2011/04/13 07:42:16  nvijikumar
...
#ident "$Id: its_types.h,v 9.1.114.1 2011/04/13 07:42:16 nvijikumar Exp $"
...
typedef struct
{
    ...
    union
    {
        ...
        ITS_UINT    appId;        /* Diameter Application Id */
    }
    context;
}
ITS_HDR;
