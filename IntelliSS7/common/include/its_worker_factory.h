 ...
 ****************************************************************************
 *
 * LOG: $Log: its_worker_factory.h,v $
 ...
 * LOG: Begin round 4.
 * LOG:
 * LOG: Revision 2.0  1999/12/03 23:25:51  mmiers
 * LOG:
 * LOG: Begin third iteration.
 * LOG:
 * LOG: Revision 1.2  1999/10/25 19:17:27  mmiers
 * LOG: Add missing method.
 * LOG:
...
#ifndef ITS_WORKER_FACTORY_H
#define ITS_WORKER_FACTORY_H

#include <its_factory.h>
#include <its_worker.h>

#ident "$Id: its_worker_factory.h,v 9.1 2005/03/23 12:52:51 cvsadmin Exp $"
 ...
 * C binding.
 */
#define WORKER_FACTORY_CLASS_NAME    "WORKER Factory"

ITSDLLAPI extern FACTORY_ClassRec itsWORKER_FACTORY_ClassRec;
ITSDLLAPI extern ITS_Class        itsWORKER_FACTORY_Class;
