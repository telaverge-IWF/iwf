...
//
// ASN.1 runtime Packed Encoding Rules related class definitions.
//

#if !defined(_ASN_PACK_H_)
#define _ASN_PACK_H_

#ident "$Id: AsnPack.h,v 9.1 2005/03/23 12:52:53 cvsadmin Exp $"
