...
#if !defined(_ASN_USEFUL_EMBEDDED_PDV_H_)
#define _ASN_USEFUL_EMBEDDED_PDV_H_
...
class EMBEDDED_PDV : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    class Data_value : public its::AsnOctetString
    {
    public:

        Data_value() : its::AsnOctetString(false)
        {
            Initialize();
        }

        Data_value(const std::vector<byte>& array) : its::AsnOctetString(array, false)
        {
            Initialize();
        }

        Data_value(its::Octets& octets) : its::AsnOctetString(false)
        {
            Initialize();
            Decode(octets);
        }

        Data_value(const Data_value& rhs) : its::AsnOctetString(rhs)
        {
            // Nothing to do.
        }

        Data_value(its::AsnDescObject* description) : its::AsnOctetString(description)
        {
            // Nothing to do.
        }

        Data_value(its::AsnDescObject* description, const std::vector<byte>& array) : its::AsnOctetString(description, array)
        {
            // Nothing to do.
        }
...
////////// End Nested Class(es) //////////
    ...
    EMBEDDED_PDV() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    EMBEDDED_PDV(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    EMBEDDED_PDV(const EMBEDDED_PDV& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    EMBEDDED_PDV(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetData_valueStaticDescription();

public:

    virtual ~EMBEDDED_PDV()
    {
        // Nothing to do.
    }
    ...
    void SetData_value(Data_value* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetData_valueStaticDescription());
        AddElement(1, element);
    }

    void SetData_value(const Data_value& element)
    {
        its::AsnObject& asnObject = const_cast<Data_value&>(element);
        asnObject.SetDescription(GetData_valueStaticDescription());
        AddElement(1, element);
    }

    const Data_value& GetData_value() const
    {
        return static_cast<const Data_value&> (ElementAt(1));
    }
...
#endif    // !defined(_ASN_USEFUL_EMBEDDED_PDV_H_)
