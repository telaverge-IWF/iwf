...
///////////////////////////////////////////////////////////////////////////////
//
// LOG: $Log: AsnObjectIdentifier.h,v $
...
//
// ASN.1 runtime AsnObjectIdentifier class definition.
//

#if !defined(_ASN_OBJECT_IDENTIFIER_H_)
#define _ASN_OBJECT_IDENTIFIER_H_

#ident "$Id: AsnObjectIdentifier.h,v 9.2 2007/01/10 11:15:05 yranade Exp $"
...
public: 
    ...
    AsnObjectIdentifier(const std::vector<long>& array, bool initialize = true)
    :   _data(array)
    {
        if (initialize)
        {
    ...
    AsnObjectIdentifier(bool initialize = true)
    {
        if (initialize)
        {
            Initialize();
    ...
    AsnObjectIdentifier(const AsnObjectIdentifier& rhs)
    :   AsnObject(rhs)
    {
        _data = rhs._data;
    }

    AsnObjectIdentifier(AsnDescObject* description)
    {
...
public:
    ...
    AsnObjectIdentifier& 
    operator=(const AsnObjectIdentifier& rhs)
    {
        if (this == &rhs)
        {
            return *this;
    ...
    bool 
    operator==(const AsnObjectIdentifier& rhs) const
    { 
        return Equals(rhs); 
    }
    ...
    const AsnDescObjectIdentifier& 
    GetDescription() const
    {
        return *static_cast<AsnDescObjectIdentifier*>(_description);
    }

    void 
    SetDescription(AsnDescObjectIdentifier* description)
    {
        ITS_REQUIRE(description != NULL);
        _description = description;
    }
...
#endif // !defined(_ASN_OBJECT_IDENTIFIER_H_)
