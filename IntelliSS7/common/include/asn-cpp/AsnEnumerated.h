...
//
// ASN.1 runtime AsnEnumerated class definition.
//

#if !defined(_ASN_ENUMERATED_H_)
#define _ASN_ENUMERATED_H_

#ident "$Id: AsnEnumerated.h,v 9.2 2007/01/10 11:15:05 yranade Exp $"
...
public:
    ...
    AsnEnumerated(long value, bool initialize = true)
    :   _value(value)
    {
        if (initialize)
        {
    ...
    AsnEnumerated(bool initialize = true)
    :   _value(0)
    {
        if (initialize)
        {
    ...
    AsnEnumerated(const AsnEnumerated& rhs)
    :   AsnObject(rhs)
    {
        _value = rhs._value;
    }

    AsnEnumerated(AsnDescObject* description)
    :   _value(0)
    {
    ...
    AsnEnumerated(AsnDescObject* description, long value)
    :   _value(value)
    {
        ITS_REQUIRE(description != NULL);
        _description = description;
...
public:
    ...
    AsnEnumerated& 
    operator=(const AsnEnumerated& rhs)
    {
        if (this == &rhs)
        {
            return *this;
    ...
    bool 
    operator==(const AsnEnumerated& rhs) const
    { 
        return Equals(rhs); 
    }
    ...
    virtual long 
    Get(const std::string& valueName) const
    {
        bool must_be_redefined_in_all_heirs = false;
        ITS_ASSERT(must_be_redefined_in_all_heirs);
        return 0;
    }
    ...
    virtual std::string
    GetExt(long value) const
    {
        return "";
    }

    const AsnDescEnumerated& 
    GetDescription() const
    {
        return *static_cast<AsnDescEnumerated*>(_description);
    }

    void 
    SetDescription(AsnDescEnumerated* description)
    {
        ITS_REQUIRE(description != NULL);
        _description = description;
    }
...
#endif // !defined(_ASN_ENUMERATED_H_)
