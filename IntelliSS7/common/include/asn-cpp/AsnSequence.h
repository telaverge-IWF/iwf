...
#ident "$Id: AsnSequence.h,v 9.2 2007/01/10 11:15:05 yranade Exp $"
...
public:
    ...
    AsnSequence(size_t size, bool initialize = true, size_t esize = 0)
    :   _elementVect(size),
    ...
    AsnSequence(size_t size, AsnDescObject* description, size_t esize = 0)
    :   _elementVect(size),
        _elementExtVect(esize) 
    {
        ITS_REQUIRE(size >= 0);
