...
//
// ASN.1 runtime AsnDescNull class definition.
//

#if !defined(_ASN_DESC_NULL_H_)
#define _ASN_DESC_NULL_H_

#ident "$Id: AsnDescNull.h,v 9.1 2005/03/23 12:52:52 cvsadmin Exp $"
...
class AsnDescNull : public AsnDescObject
{
public:
    ...
    AsnDescNull(const AsnDescNull& rhs)
    {
...
#endif // !defined(_ASN_DESC_NULL_H_)
