...
//
// ASN.1 runtime AsnBoolean class definition.
//

#if !defined(_ASN_BOOLEAN_H_)
#define _ASN_BOOLEAN_H_

#ident "$Id: AsnBoolean.h,v 9.2 2007/01/10 11:15:04 yranade Exp $"
...
public:
    ...
    AsnBoolean(bool value = false, bool initialize = true)
    :   _value(value)
    {
        if (initialize)
        {
    ...
    AsnBoolean(const AsnBoolean& rhs)
    :   AsnObject(rhs)
    {
        _value = rhs._value;
    }

    AsnBoolean(AsnDescObject* description)
    :   _value(false)
    {
    ...
    AsnBoolean(AsnDescObject* description, bool value)
    :   _value(value)
    {
        ITS_REQUIRE(description != NULL);
        _description = description;
...
public:
    ...
    bool 
    operator==(const AsnBoolean& rhs) const
    { 
        return Equals(rhs); 
    }
    ...
    const AsnDescBoolean& 
    GetDescription() const
    {
        return *static_cast<AsnDescBoolean*>(_description);
    }

    void 
    SetDescription(AsnDescBoolean* description)
    {
        ITS_REQUIRE(description != NULL);
        _description = description;
    }
...
protected:
    ...
    // Relevant constants.
    static const long ASN_BOOLEAN_LENGTH;
    static const byte ASN_BOOLEAN_VALUE_TRUE;
    static const byte ASN_BOOLEAN_VALUE_FALSE;
