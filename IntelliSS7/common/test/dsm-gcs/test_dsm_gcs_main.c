...
#ident "$Id: test_dsm_gcs_main.c,v 9.1 2005/03/23 12:53:56 cvsadmin Exp $"
...
/*
 * DSM GCS quick tests (without unit testing framework).
 *
...
main(int argc, const char** argv)
{
    ...
    {
        APPL_SetName("TestDsmGcsNode1Win32");
    }
    else
    {
        APPL_SetName("TestDsmGcsNode2Win32");
    }
    ...
    if (strstr(argv[1], "Node1") != NULL)
    {
        APPL_SetName("TestDsmGcsNode1Unix");
    }
    else
    {
        APPL_SetName("TestDsmGcsNode2Unix");
    }
 ...
 * and obviously everything must be a release build (including GCS Daemon).
 */
