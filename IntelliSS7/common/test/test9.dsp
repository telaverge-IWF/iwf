...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(ITS_ROOT)/common/include" /I "$(ITS_ROOT)/TCAP/include" /I "$(ITS_ROOT)/SCCP/include" /I "$(ITS_ROOT)/MTP3/include" /I "$(ITS_ROOT)/MTP2/include" /D "ANSI" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "ITS_IMPLEMENTATION" /YX /FD /c
