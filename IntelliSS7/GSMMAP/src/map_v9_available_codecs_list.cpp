...
AsnDescObject* AvailableCodecsList::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("AvailableCodecsList");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* AvailableCodecsList::GetUtranCodecListStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* AvailableCodecsList::GetGeranCodecListStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(9);
...
AsnDescObject* AvailableCodecsList::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
