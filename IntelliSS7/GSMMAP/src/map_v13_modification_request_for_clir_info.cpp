...
AsnDescObject* ModificationRequestFor_CLIR_Info::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("ModificationRequestFor-CLIR-Info");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ModificationRequestFor_CLIR_Info::GetSs_StatusStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_CLIR_Info::GetCliRestrictionOptionStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_CLIR_Info::GetModifyNotificationToCSEStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescEnumerated staticDesc;
...
AsnDescObject* ModificationRequestFor_CLIR_Info::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
