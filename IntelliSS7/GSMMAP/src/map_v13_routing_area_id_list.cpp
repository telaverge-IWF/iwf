...
AsnDescObject* RoutingAreaId_List::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._element = GetRAIdentityStaticDescription();
        staticDesc.SetTypeName("RoutingAreaId-List");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* RoutingAreaId_List::GetRAIdentityStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
