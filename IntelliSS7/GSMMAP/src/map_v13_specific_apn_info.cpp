...
AsnDescObject* SpecificAPNInfo::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("SpecificAPNInfo");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SpecificAPNInfo::GetApnStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SpecificAPNInfo::GetPdn_gw_IdentityStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SpecificAPNInfo::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
