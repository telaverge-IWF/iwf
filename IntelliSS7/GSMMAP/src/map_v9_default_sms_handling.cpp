...
AsnDescObject* DefaultSMS_Handling::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("DefaultSMS-Handling");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long DefaultSMS_Handling::Get(const std::string& valueName) const
{
...
std::string DefaultSMS_Handling::Get(long value) const
{
    if (value == 0)
    {
...
std::string DefaultSMS_Handling::GetExt(long value) const
{
    return "";
}
