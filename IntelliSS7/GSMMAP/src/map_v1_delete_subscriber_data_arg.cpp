...
#include <map_v1_delete_subscriber_data_arg.h>
...
// Type SS_CodeList is a reference => no code generated.
...
AsnDescObject* DeleteSubscriberDataArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[2] = GetSs_CodeStaticDescription();
...
AsnDescObject* DeleteSubscriberDataArg::GetBasicServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* DeleteSubscriberDataArg::GetSs_CodeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequenceOf staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new SS_CodeList(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_CONSTRUCTED, 2));
        staticDesc._clauseOptional = true;
        staticDesc._clauseSize = true;
        staticDesc._minSize = 1;
        staticDesc._maxSize = 30;
        staticDesc._element = SS_CodeList::GetSS_CodeStaticDescription();
