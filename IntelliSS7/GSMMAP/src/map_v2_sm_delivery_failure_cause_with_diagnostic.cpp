...
AsnDescObject* SM_DeliveryFailureCauseWithDiagnostic::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("SM-DeliveryFailureCauseWithDiagnostic");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SM_DeliveryFailureCauseWithDiagnostic::GetSm_EnumeratedDeliveryFailureCauseStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SM_DeliveryFailureCauseWithDiagnostic::GetDiagnosticInfoStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
