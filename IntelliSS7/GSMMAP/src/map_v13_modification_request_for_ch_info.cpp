...
AsnDescObject* ModificationRequestFor_CH_Info::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("ModificationRequestFor-CH-Info");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ModificationRequestFor_CH_Info::GetSs_StatusStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_CH_Info::GetModifyNotificationToCSEStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_CH_Info::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
