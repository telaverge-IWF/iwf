...
#include <map_v13_lcs_requestor_id.h>
...
// Type RequestorIDString is a reference => no code generated.

// Type LCS_FormatIndicator is a reference => no code generated.

////////// End Nested Class(es) //////////

AsnDescObject* LCSRequestorID::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[1] = GetRequestorIDStringStaticDescription();
        staticDesc._elementVect[2] = GetLcs_FormatIndicatorStaticDescription();
        staticDesc.SetTypeName("LCSRequestorID");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* LCSRequestorID::GetDataCodingSchemeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* LCSRequestorID::GetRequestorIDStringStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new RequestorIDString(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 1));
        staticDesc._clauseSize = true;
        staticDesc._minSize = 1;
        staticDesc._maxSize = 160;
        staticDesc.SetNamedTypeName("requestorIDString");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* LCSRequestorID::GetLcs_FormatIndicatorStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
