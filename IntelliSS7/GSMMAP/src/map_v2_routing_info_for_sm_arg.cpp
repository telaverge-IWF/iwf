...
#include <map_v2_routing_info_for_sm_arg.h>
...
AsnDescObject* RoutingInfoForSM_Arg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[3] = GetTeleserviceStaticDescription();
...
AsnDescObject* RoutingInfoForSM_Arg::GetTeleserviceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
