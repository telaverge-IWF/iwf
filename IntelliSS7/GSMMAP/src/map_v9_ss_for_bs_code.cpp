...
AsnDescObject* SS_ForBS_Code::LongFTN_Supported::GetStaticDescription()
{
...
AsnDescObject* SS_ForBS_Code::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[2] = GetLongFTN_SupportedStaticDescription();
...
AsnDescObject* SS_ForBS_Code::GetLongFTN_SupportedStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
