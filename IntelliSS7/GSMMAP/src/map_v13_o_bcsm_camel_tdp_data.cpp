...
#include <map_v13_o_bcsm_camel_tdp_data.h>
...
AsnDescObject* O_BcsmCamelTDPData::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("O-BcsmCamelTDPData");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* O_BcsmCamelTDPData::GetO_BcsmTriggerDetectionPointStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* O_BcsmCamelTDPData::GetServiceKeyStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* O_BcsmCamelTDPData::GetGsmSCF_AddressStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* O_BcsmCamelTDPData::GetDefaultCallHandlingStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescEnumerated staticDesc;
...
AsnDescObject* O_BcsmCamelTDPData::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
