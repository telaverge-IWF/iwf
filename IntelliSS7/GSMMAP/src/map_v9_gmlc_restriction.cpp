...
AsnDescObject* GMLC_Restriction::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("GMLC-Restriction");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long GMLC_Restriction::Get(const std::string& valueName) const
{
    if (valueName == "gmlc-List")
    {
        return 0;
    }
    else if (valueName == "home-Country")
    {
        return 1;
    }
    else
...
std::string GMLC_Restriction::Get(long value) const
{
    if (value == 0)
    {
        return "gmlc-List";
...
std::string GMLC_Restriction::GetExt(long value) const
{
    return "";
}
