...
AsnDescObject* CallBarringFeature::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[0] = GetBasicServiceCodeStaticDescription();
...
AsnDescObject* CallBarringFeature::GetBasicServiceCodeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("basicServiceCode");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
