...
#include <map_v2_forward_sm_arg.h>
...
AsnDescObject* ForwardSM_Arg::MoreMessagesToSend::GetStaticDescription()
{
...
AsnDescObject* ForwardSM_Arg::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ForwardSM_Arg(&staticDesc));
        ...
        staticDesc.SetTypeName("ForwardSM-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ForwardSM_Arg::GetSm_RP_DAStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ForwardSM_Arg::GetSm_RP_OAStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescChoice staticDesc;
...
AsnDescObject* ForwardSM_Arg::GetSm_RP_UIStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ForwardSM_Arg::GetMoreMessagesToSendStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
