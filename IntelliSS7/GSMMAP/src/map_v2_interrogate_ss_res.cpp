...
#include <map_v2_interrogate_ss_res.h>
...
// Type Cli_RestrictionInfo is a reference => no code generated.
...
AsnDescObject* InterrogateSS_Res::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GetCli_RestrictionInfoStaticDescription());
...
AsnDescObject* InterrogateSS_Res::GetCli_RestrictionInfoStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._elementVect[0] = Cli_RestrictionInfo::GetSs_StatusStaticDescription();
        staticDesc._elementVect[1] = Cli_RestrictionInfo::GetCliRestrictionOptionStaticDescription();
        staticDesc.SetNamedTypeName("cli-RestrictionInfo");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
