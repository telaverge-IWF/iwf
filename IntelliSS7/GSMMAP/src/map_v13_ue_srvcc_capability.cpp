...
AsnDescObject* UE_SRVCC_Capability::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("UE-SRVCC-Capability");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long UE_SRVCC_Capability::Get(const std::string& valueName) const
{
    if (valueName == "ue-srvcc-not-supported")
    {
        return 0;
    }
    else if (valueName == "ue-srvcc-supported")
    {
        return 1;
    }
    else
...
std::string UE_SRVCC_Capability::Get(long value) const
{
    if (value == 0)
    {
        return "ue-srvcc-not-supported";
    }
    else if (value == 1)
    {
        return "ue-srvcc-supported";
    }
    else
    {
...
std::string UE_SRVCC_Capability::GetExt(long value) const
{
    return "";
}
