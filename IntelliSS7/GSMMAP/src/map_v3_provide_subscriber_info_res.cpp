...
#include <map_v3_provide_subscriber_info_res.h>
...
AsnDescObject* ProvideSubscriberInfoRes::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ProvideSubscriberInfoRes(&staticDesc));
        ...
        staticDesc.SetTypeName("ProvideSubscriberInfoRes");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ProvideSubscriberInfoRes::GetSubscriberInfoStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ProvideSubscriberInfoRes::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
