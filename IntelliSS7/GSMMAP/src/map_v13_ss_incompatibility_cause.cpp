...
#include <map_v13_ss_incompatibility_cause.h>
...
AsnDescObject* SS_IncompatibilityCause::GetStaticDescription()
{
    ...
    {
        staticDesc.SetCloneForFactory(new SS_IncompatibilityCause(&staticDesc));
        ...
        staticDesc.SetTypeName("SS-IncompatibilityCause");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SS_IncompatibilityCause::GetSs_CodeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SS_IncompatibilityCause::GetBasicServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SS_IncompatibilityCause::GetSs_StatusStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
