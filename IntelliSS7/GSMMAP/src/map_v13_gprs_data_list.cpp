...
AsnDescObject* GPRSDataList::GetPDP_ContextStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[10] = PDP_Context::GetExt3_QoS_SubscribedStaticDescription();
        staticDesc._elementVect[11] = PDP_Context::GetExt4_QoS_SubscribedStaticDescription();
        staticDesc._elementVect[12] = PDP_Context::GetApn_oi_ReplacementStaticDescription();
        staticDesc._elementVect[13] = PDP_Context::GetExt_pdp_TypeStaticDescription();
        staticDesc._elementVect[14] = PDP_Context::GetExt_pdp_AddressStaticDescription();
        staticDesc._elementVect[15] = PDP_Context::GetAmbrStaticDescription();
        staticDesc._elementVect[16] = PDP_Context::GetSipto_PermissionStaticDescription();
        staticDesc._elementVect[17] = PDP_Context::GetLipa_PermissionStaticDescription();
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
