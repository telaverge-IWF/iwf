...
#include <map_v1_trace_subscriber_activity_arg.h>
...
AsnDescObject* TraceSubscriberActivityArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[3] = GetOmcIdStaticDescription();
...
AsnDescObject* TraceSubscriberActivityArg::GetOmcIdStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("omcId");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
