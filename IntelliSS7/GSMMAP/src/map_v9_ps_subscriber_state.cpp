...
AsnDescObject* PS_SubscriberState::NotProvidedFromSGSN::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new NotProvidedFromSGSN(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 0));
        staticDesc.SetNamedTypeName("notProvidedFromSGSN");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* PS_SubscriberState::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GetNotProvidedFromSGSNStaticDescription());
...
AsnDescObject* PS_SubscriberState::GetNotProvidedFromSGSNStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
