...
AsnDescObject* InterrogationType::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("InterrogationType");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long InterrogationType::Get(const std::string& valueName) const
{
    if (valueName == "basicCall")
    {
        return 0;
    }
    else if (valueName == "forwarding")
    {
        return 1;
    }
    else
...
std::string InterrogationType::Get(long value) const
{
    if (value == 0)
    {
        return "basicCall";
...
std::string InterrogationType::GetExt(long value) const
{
    return "";
}
