...
#include <map_v2_guidance_info.h>
...
AsnDescObject* GuidanceInfo::GetStaticDescription()
{
    ...
    else
    {
        ...
        static AsnDescEnumerated::NamedNumber namedNumberList[] = {{"enterPW", 0}, {"enterNewPW", 1}, {"enterNewPW-Again", 2}, {"badPW-TryAgain", 3}, {"badPW-FormatTryAgain", 4}, {NULL, 0}};
...
long GuidanceInfo::Get(const std::string& valueName) const
{
    ...
    else if (valueName == "badPW-TryAgain")
    {
        return 3;
    }
    else if (valueName == "badPW-FormatTryAgain")
    {
        return 4;
    }
    else
...
std::string GuidanceInfo::Get(long value) const
{
    ...
    {
        return "badPW-TryAgain";
    }
    else if (value == 4)
    {
        return "badPW-FormatTryAgain";
    }
    else
    {
