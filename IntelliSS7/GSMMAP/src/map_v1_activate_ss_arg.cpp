...
#include <map_v1_activate_ss_arg.h>
...
AsnDescObject* ActivateSS_Arg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ActivateSS_Arg(&staticDesc));
        ...
        staticDesc.SetTypeName("ActivateSS-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ActivateSS_Arg::GetSs_CodeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ActivateSS_Arg::GetBasicServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
