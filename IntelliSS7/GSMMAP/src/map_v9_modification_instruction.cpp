...
AsnDescObject* ModificationInstruction::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("ModificationInstruction");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long ModificationInstruction::Get(const std::string& valueName) const
{
    if (valueName == "deactivate")
    {
        return 0;
    }
    else if (valueName == "activate")
    {
        return 1;
    }
    else
...
std::string ModificationInstruction::Get(long value) const
{
    if (value == 0)
    {
        return "deactivate";
...
std::string ModificationInstruction::GetExt(long value) const
{
    return "";
}
