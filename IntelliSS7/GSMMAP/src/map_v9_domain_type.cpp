...
AsnDescObject* DomainType::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("DomainType");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long DomainType::Get(const std::string& valueName) const
{
    if (valueName == "cs-Domain")
    {
        return 0;
    }
    else if (valueName == "ps-Domain")
    {
        return 1;
    }
    else
...
std::string DomainType::Get(long value) const
{
    if (value == 0)
    {
        return "cs-Domain";
...
std::string DomainType::GetExt(long value) const
{
    return "";
}
