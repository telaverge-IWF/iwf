...
#include <map_v13_forwarding_feature.h>
...
AsnDescObject* ForwardingFeature::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[6] = GetLongForwardedToNumberStaticDescription();
...
AsnDescObject* ForwardingFeature::GetLongForwardedToNumberStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
