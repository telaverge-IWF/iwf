...
#include <map_v13_any_time_subscription_interrogation_res.h>
...
// Type MSISDN_BS_List is a reference => no code generated.
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[9] = GetMsisdn_BS_ListStaticDescription();
        staticDesc._elementVect[10] = GetCsg_SubscriptionDataListStaticDescription();
        staticDesc._elementVect[11] = GetCw_DataStaticDescription();
        staticDesc._elementVect[12] = GetCh_DataStaticDescription();
        staticDesc._elementVect[13] = GetClip_DataStaticDescription();
        staticDesc._elementVect[14] = GetClir_DataStaticDescription();
        staticDesc._elementVect[15] = GetEct_dataStaticDescription();
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetMsisdn_BS_ListStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._element = MSISDN_BS_List::GetMSISDN_BSStaticDescription();
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetCsg_SubscriptionDataListStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequenceOf staticDesc;
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetCw_DataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetCh_DataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetClip_DataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(3);
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetClir_DataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(3);
...
AsnDescObject* AnyTimeSubscriptionInterrogationRes::GetEct_dataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
