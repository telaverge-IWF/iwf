...
#include <map_v1_provide_roaming_number_arg.h>
...
AsnDescObject* ProvideRoamingNumberArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[4] = GetLMsIdStaticDescription();
...
AsnDescObject* ProvideRoamingNumberArg::GetMscNumberStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ProvideRoamingNumberArg::GetLMsIdStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
