...
AsnDescObject* CallOutcome::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("CallOutcome");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long CallOutcome::Get(const std::string& valueName) const
{
    if (valueName == "success")
    {
        return 0;
    }
    else if (valueName == "failure")
    {
        return 1;
    }
...
std::string CallOutcome::Get(long value) const
{
    if (value == 0)
    {
        return "success";
...
std::string CallOutcome::GetExt(long value) const
{
    return "";
}
