...
AsnDescObject* VGCSDataList::GetVoiceGroupCallDataStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[2] = VoiceGroupCallData::GetAdditionalSubscriptionsStaticDescription();
        staticDesc._elementVect[3] = VoiceGroupCallData::GetAdditionalInfoStaticDescription();
        staticDesc._elementVect[4] = VoiceGroupCallData::GetLongGroupIdStaticDescription();
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
