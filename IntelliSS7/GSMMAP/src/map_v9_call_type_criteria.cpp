...
AsnDescObject* CallTypeCriteria::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("CallTypeCriteria");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long CallTypeCriteria::Get(const std::string& valueName) const
{
    if (valueName == "forwarded")
    {
        return 0;
    }
    else if (valueName == "notForwarded")
    {
        return 1;
    }
    else
...
std::string CallTypeCriteria::Get(long value) const
{
    if (value == 0)
    {
        return "forwarded";
...
std::string CallTypeCriteria::GetExt(long value) const
{
    return "";
}
