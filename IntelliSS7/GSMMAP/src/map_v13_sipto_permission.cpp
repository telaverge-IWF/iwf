...
AsnDescObject* SIPTO_Permission::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("SIPTO-Permission");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long SIPTO_Permission::Get(const std::string& valueName) const
{
    if (valueName == "siptoAllowed")
    {
        return 0;
    }
    else if (valueName == "siptoNotAllowed")
    {
        return 1;
    }
    else
...
std::string SIPTO_Permission::Get(long value) const
{
    if (value == 0)
    {
        return "siptoAllowed";
...
std::string SIPTO_Permission::GetExt(long value) const
{
    return "";
}
