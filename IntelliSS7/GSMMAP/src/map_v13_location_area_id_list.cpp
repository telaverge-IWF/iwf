...
AsnDescObject* LocationAreaId_List::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._element = GetLAIFixedLengthStaticDescription();
        staticDesc.SetTypeName("LocationAreaId-List");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* LocationAreaId_List::GetLAIFixedLengthStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
