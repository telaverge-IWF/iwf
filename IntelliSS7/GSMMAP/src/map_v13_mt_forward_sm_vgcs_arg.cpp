...
#include <map_v13_mt_forward_sm_vgcs_arg.h>
...
AsnDescObject* MT_ForwardSM_VGCS_Arg::GetStaticDescription()
{
    ...
    {
        staticDesc.SetCloneForFactory(new MT_ForwardSM_VGCS_Arg(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_UNIVERSAL, Tag::ASN_CONSTRUCTED, 16));
        staticDesc._clauseExtensible = true;
        staticDesc._elementVect[0] = GetAsciCallReferenceStaticDescription();
        ...
        staticDesc.SetTypeName("MT-ForwardSM-VGCS-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* MT_ForwardSM_VGCS_Arg::GetAsciCallReferenceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* MT_ForwardSM_VGCS_Arg::GetSm_RP_OAStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* MT_ForwardSM_VGCS_Arg::GetSm_RP_UIStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* MT_ForwardSM_VGCS_Arg::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
