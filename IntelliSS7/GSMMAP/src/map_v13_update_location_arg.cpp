...
AsnDescObject* UpdateLocationArg::SkipSubscriberDataUpdate::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* UpdateLocationArg::RestorationIndicator::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* UpdateLocationArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[10] = GetPagingAreaStaticDescription();
        staticDesc._elementVect[11] = GetSkipSubscriberDataUpdateStaticDescription();
        staticDesc._elementVect[12] = GetRestorationIndicatorStaticDescription();
...
AsnDescObject* UpdateLocationArg::GetPagingAreaStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* UpdateLocationArg::GetSkipSubscriberDataUpdateStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* UpdateLocationArg::GetRestorationIndicatorStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
