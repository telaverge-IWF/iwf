...
AsnDescObject* CUG_CheckInfo::Cug_OutgoingAccess::GetStaticDescription()
{
...
AsnDescObject* CUG_CheckInfo::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetTypeName("CUG-CheckInfo");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* CUG_CheckInfo::GetCug_InterlockStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* CUG_CheckInfo::GetCug_OutgoingAccessStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* CUG_CheckInfo::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
