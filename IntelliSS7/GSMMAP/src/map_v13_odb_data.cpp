...
// Type ODB_HPLMN_Data is a reference => no code generated.

// Type ExtensionContainer is a reference => no code generated.

////////// End Nested Class(es) //////////

AsnDescObject* ODB_Data::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[0] = GetOdb_GeneralDataStaticDescription();
        staticDesc._elementVect[1] = GetOdb_HPLMN_DataStaticDescription();
        staticDesc._elementVect[2] = GetExtensionContainerStaticDescription();
        staticDesc.SetTypeName("ODB-Data");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ODB_Data::GetOdb_GeneralDataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ODB_Data::GetOdb_HPLMN_DataStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescBitString staticDesc;
    ...
    else
    {
        ...
        staticDesc._maxSize = 32;
        staticDesc.SetNamedTypeName("odb-HPLMN-Data");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ODB_Data::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
