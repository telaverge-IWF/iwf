...
#include <map_v13_prepare_group_call_arg.h>
...
AsnDescObject* PrepareGroupCallArg::TalkerChannelParameter::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new TalkerChannelParameter(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 7));
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("talkerChannelParameter");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* PrepareGroupCallArg::UplinkReplyIndicator::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new UplinkReplyIndicator(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 8));
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("uplinkReplyIndicator");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* PrepareGroupCallArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[4] = GetGroupKeyNumber_Vk_IdStaticDescription();
        ...
        staticDesc._elementVect[11] = GetTalkerChannelParameterStaticDescription();
        staticDesc._elementVect[12] = GetUplinkReplyIndicatorStaticDescription();
...
AsnDescObject* PrepareGroupCallArg::GetGroupKeyNumber_Vk_IdStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("groupKeyNumber-Vk-Id");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* PrepareGroupCallArg::GetTalkerChannelParameterStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* PrepareGroupCallArg::GetUplinkReplyIndicatorStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
