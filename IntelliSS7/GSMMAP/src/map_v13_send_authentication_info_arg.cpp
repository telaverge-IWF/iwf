...
AsnDescObject* SendAuthenticationInfoArg::AdditionalVectorsAreForEPS::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new AdditionalVectorsAreForEPS(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 6));
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("additionalVectorsAreForEPS");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SendAuthenticationInfoArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[8] = GetNumberOfRequestedAdditional_VectorsStaticDescription();
        staticDesc._elementVect[9] = GetAdditionalVectorsAreForEPSStaticDescription();
...
AsnDescObject* SendAuthenticationInfoArg::GetNumberOfRequestedAdditional_VectorsStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescInteger staticDesc;
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("numberOfRequestedAdditional-Vectors");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SendAuthenticationInfoArg::GetAdditionalVectorsAreForEPSStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
