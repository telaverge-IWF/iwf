...
AsnDescObject* SS_Data::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[2] = GetSs_SubscriptionStaticDescription();
...
AsnDescObject* SS_Data::GetSs_SubscriptionStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc._choiceList.push_back(SS_SubscriptionOption::GetPerCallBasisStaticDescription());
        staticDesc._choiceList.push_back(SS_SubscriptionOption::GetNotificationToHeldRetrievedPartyStaticDescription());
        staticDesc._choiceList.push_back(SS_SubscriptionOption::GetUserToUserServiceIndicatorStaticDescription());
        staticDesc._choiceList.push_back(SS_SubscriptionOption::GetMaximumConfereesNumberStaticDescription());
        staticDesc._choiceList.push_back(SS_SubscriptionOption::GetHuntGroupAccessSelectionOrderStaticDescription());
        staticDesc.SetNamedTypeName("ss-Subscription");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
