...
AsnDescObject* ProtocolId::GetStaticDescription()
{
    ...
    else
    {
        ...
        static AsnDescEnumerated::NamedNumber namedNumberList[] = {{"gsm-0408", 1}, {"gsm-0806", 2}, {"gsm-0808-bssmap", 3}, {"isup-Q763", 4}, {NULL, 0}};
...
long ProtocolId::Get(const std::string& valueName) const
{
    ...
    else if (valueName == "gsm-0808-bssmap")
    {
        return 3;
    }
    else if (valueName == "isup-Q763")
    {
        return 4;
    }
    else
