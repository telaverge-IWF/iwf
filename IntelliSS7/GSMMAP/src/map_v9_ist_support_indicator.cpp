...
AsnDescObject* IST_SupportIndicator::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("IST-SupportIndicator");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long IST_SupportIndicator::Get(const std::string& valueName) const
{
    if (valueName == "basicISTSupported")
    {
        return 0;
    }
    else if (valueName == "istCommandSupported")
    {
        return 1;
    }
    else
...
std::string IST_SupportIndicator::Get(long value) const
{
    if (value == 0)
    {
...
std::string IST_SupportIndicator::GetExt(long value) const
{
    return "";
}
