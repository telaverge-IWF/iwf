...
#include <map_v2_note_internal_ho_arg.h>
...
AsnDescObject* NoteInternalHO_Arg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new NoteInternalHO_Arg(&staticDesc));
        ...
        staticDesc._elementVect[2] = GetChannelIdStaticDescription();
        staticDesc.SetTypeName("NoteInternalHO-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* NoteInternalHO_Arg::GetHandoverTypeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* NoteInternalHO_Arg::GetTargetCellIdStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* NoteInternalHO_Arg::GetChannelIdStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("channelId");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
