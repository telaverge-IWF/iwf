...
#include <map_v13_send_end_signal_arg.h>
...
AsnDescObject* SendEndSignal_Arg::GetStaticDescription()
{
    ...
    {
        staticDesc.SetCloneForFactory(new SendEndSignal_Arg(&staticDesc));
        ...
        staticDesc.SetTypeName("SendEndSignal-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* SendEndSignal_Arg::GetAn_APDUStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* SendEndSignal_Arg::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
