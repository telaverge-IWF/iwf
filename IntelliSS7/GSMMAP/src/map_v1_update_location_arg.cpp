...
#include <map_v1_update_location_arg.h>
...
AsnDescObject* UpdateLocationArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[2] = GetVlrNumberStaticDescription();
...
AsnDescObject* UpdateLocationArg::GetVlrNumberStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("vlrNumber");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* UpdateLocationArg::GetLmsidStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
