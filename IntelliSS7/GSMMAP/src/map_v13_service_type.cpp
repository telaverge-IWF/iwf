...
#include <map_v13_service_type.h>
...
AsnDescObject* ServiceType::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[0] = GetServiceTypeIdentityStaticDescription();
        ...
        staticDesc.SetTypeName("ServiceType");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ServiceType::GetServiceTypeIdentityStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("serviceTypeIdentity");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ServiceType::GetGmlc_RestrictionStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ServiceType::GetNotificationToMSUserStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescEnumerated staticDesc;
...
AsnDescObject* ServiceType::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
