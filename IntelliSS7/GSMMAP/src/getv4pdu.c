 ...
 *
 *
 * $Id: getv4pdu.c,v 9.1 2005/03/23 12:51:26 cvsadmin Exp $
 *
 * $Log: getv4pdu.c,v $
 * Revision 9.1  2005/03/23 12:51:26  cvsadmin
 * Begin PR6.5
 *
 ...
 * Begin PR5
 *
 * Revision 3.1  2000/08/15 23:56:46  mmiers
 *
 * Begin round 4.
 *
 * Revision 1.1  2000/06/15 20:17:50  npopov
 * OSS-related code for testing MAP V4.
 *
 *
 */
...
#include "map_v4_lrfvn.h"	/* OSS-generated header */
				...
				int *encodedPDULength, int valueNumber)
{
    ...
    if (rc = ossinit(world, map_v4_lrfvn)) {
