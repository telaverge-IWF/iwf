...
#include <map_v1_deactivate_ss_arg.h>
...
AsnDescObject* DeactivateSS_Arg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new DeactivateSS_Arg(&staticDesc));
        ...
        staticDesc.SetTypeName("DeactivateSS-Arg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* DeactivateSS_Arg::GetSs_CodeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* DeactivateSS_Arg::GetBasicServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
