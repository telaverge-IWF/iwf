...
#include <map_v13_report_sm_delivery_status_arg.h>
...
AsnDescObject* ReportSM_DeliveryStatusArg::Ip_sm_gw_Indicator::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
    ...
    {
        staticDesc.SetCloneForFactory(new Ip_sm_gw_Indicator(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_CONTEXT_SPECIFIC, Tag::ASN_PRIMITIVE, 6));
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("ip-sm-gw-Indicator");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ReportSM_DeliveryStatusArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[9] = GetIp_sm_gw_IndicatorStaticDescription();
        staticDesc._elementVect[10] = GetIp_sm_gw_sm_deliveryOutcomeStaticDescription();
        staticDesc._elementVect[11] = GetIp_sm_gw_absentSubscriberDiagnosticSMStaticDescription();
...
AsnDescObject* ReportSM_DeliveryStatusArg::GetIp_sm_gw_IndicatorStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescNull staticDesc;
...
AsnDescObject* ReportSM_DeliveryStatusArg::GetIp_sm_gw_sm_deliveryOutcomeStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescEnumerated staticDesc;
    ...
    else
    {
        ...
        static AsnDescEnumerated::NamedNumber namedNumberList[] = {{"memoryCapacityExceeded", 0}, {"absentSubscriber", 1}, {"successfulTransfer", 2}, {NULL, 0}};
        staticDesc.SetNamedNumberList(namedNumberList);
        staticDesc.SetNamedTypeName("ip-sm-gw-sm-deliveryOutcome");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ReportSM_DeliveryStatusArg::GetIp_sm_gw_absentSubscriberDiagnosticSMStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescInteger staticDesc;
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc.SetNamedTypeName("ip-sm-gw-absentSubscriberDiagnosticSM");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
