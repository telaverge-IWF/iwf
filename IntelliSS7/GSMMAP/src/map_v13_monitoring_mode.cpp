...
AsnDescObject* MonitoringMode::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("MonitoringMode");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long MonitoringMode::Get(const std::string& valueName) const
{
    if (valueName == "a-side")
    {
        return 0;
    }
    else if (valueName == "b-side")
    {
        return 1;
    }
    else
...
std::string MonitoringMode::Get(long value) const
{
    if (value == 0)
    {
        return "a-side";
...
std::string MonitoringMode::GetExt(long value) const
{
    return "";
}
