...
AsnDescObject* AuthenticationTriplet::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("AuthenticationTriplet");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* AuthenticationTriplet::GetRandStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* AuthenticationTriplet::GetSresStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* AuthenticationTriplet::GetKcStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
