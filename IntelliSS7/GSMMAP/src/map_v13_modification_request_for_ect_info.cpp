...
AsnDescObject* ModificationRequestFor_ECT_Info::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("ModificationRequestFor-ECT-Info");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ModificationRequestFor_ECT_Info::GetSs_StatusStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_ECT_Info::GetModifyNotificationToCSEStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ModificationRequestFor_ECT_Info::GetExtensionContainerStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
