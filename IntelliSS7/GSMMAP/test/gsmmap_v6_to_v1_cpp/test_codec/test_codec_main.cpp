...
////////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_codec_main.cpp,v 9.1 2005/03/23 12:51:41 cvsadmin Exp $
//
////////////////////////////////////////////////////////////////////////////////

//
//  MAP V5 ASN.1 codec example using MAP V6 TO V1 to highlight backward
//  compatibility between MAP V6 TO V1 and MAP V5. 
//
...
BuildOperationInsertSubscriberDataArg()
{
    ...
    map_v5::InsertSubscriberDataArg* 
        insertSubscriberDataArg = 
            new map_v5::InsertSubscriberDataArg();
    ...
    Ext_BearerServiceCode* ext_bearerServiceCode2 = 
     ...
     Ext_BearerServiceCode* ext_bearerServiceCode3 = 
        new Ext_BearerServiceCode(FixedByteArrayToVector(fixedArray5));
    ...
    bearerServiceList->AddElement(ext_bearerServiceCode2);
      bearerServiceList->AddElement(ext_bearerServiceCode3
          );
...
{
    cout << endl;
    cout << "Begin MAP V5 ASN.1 with MAP V6 TO V1 codec example...";
    cout << endl;
    ...
    cout << endl;
    cout << "End of MAP V5 ASN.1 with MAP V6 TO V1 codec example.";
    cout << endl;
