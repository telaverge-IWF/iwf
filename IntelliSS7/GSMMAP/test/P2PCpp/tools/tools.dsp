...
# ADD CPP /nologo /MDd /W3 /GX /Z7 /Od /I "$(ITS_ROOT)\GSMMAP\include\itu" /I "$(ITS_ROOT)\common\include" /I "$(ITS_ROOT)\common\include\asn-cpp" /I "$(ITS_ROOT)\tools\include" /I "..\tools" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /c
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"tools.lib"
