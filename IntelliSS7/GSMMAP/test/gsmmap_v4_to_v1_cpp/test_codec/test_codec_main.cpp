...
//
//  MAP V4 ASN.1 codec example using MAP V4 TO V1 to highlight backward
//  compatibility between MAP V4 TO V1 and MAP V4. 
//
...
BuildOperationInsertSubscriberDataArg()
{
    ...
    map_common::InsertSubscriberDataArg* 
        insertSubscriberDataArg = 
            new map_common::InsertSubscriberDataArg();
