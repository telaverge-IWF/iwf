...
{
    cout << endl << "Begin MAP V6 ASN.1 codec example..." << endl;

    try
    {
        // IntelliSS7 initialization (including licensing).

        // TODO: re-enable (temporary commented out for test under current).
    ...
    cout << endl << "End of MAP V6 ASN.1 codec example." << endl;
