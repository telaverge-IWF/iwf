...
////////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_send_sctp.cpp,v 9.1 2005/03/23 12:51:41 cvsadmin Exp $
//
////////////////////////////////////////////////////////////////////////////////
...
BorderTransportThread::DispatchFunction(void* arg)
{
    ...
    while (!current->stopRequested)
    {
        ...
        else
        {
            ...
            ITS_Transport::PutEvent(ITS_SCCP_ANSI_SRC, event);
        }
    }
...
void CreateBorder(ITS_POINTER object, ITS_POINTER userData, 
                  ITS_POINTER callData)
{
    ...
    ret = SCCP_Decode(ies, &ieCount, evt, &SCCP_UDT_Desc);
    if (ret != ITS_SUCCESS)
    {
        cout << "***** CreateBorder: could not decode SCCP message \n";
    }
    ...
    if (scmgData.type == SCCP_SCMG_SS_UIS && borderInit == ITS_FALSE)
    {
...
{
    cout << endl << "Begin MAP v6 send example..." << endl;
    ...
    try
    {
        ...
        ITS_Application::SetName("SCTP");


        ////////////////////////////////////////////////////////////////////////
        //
        //  Using IntelliSS7 stack, with SUA, SCTP add all the features 
        //
        ...
        res = ITS_GlobalStart(ITS_TCAP_CCITT | ITS_SCCP_ANSI | ITS_MTP3_ANSI);
        ...
        //
        CALLBACK_AddCallback(SCCP_ManagementCallbacks, CreateBorder, NULL);
        ...
        ///////////////////////////////////////////////////////////////////////////
        //
        // This wait timer is used to allow all configuration messages to be
        // exanged  before TCAP traffic is being sent. If not, the remote might
        // disgard the message.
        //
        ...
        while (!stop)
	{
        ...
        ITS_RemFeature(itsSCTPTRAN_Class);
        ITS_RemFeature(itsSUA_Class);
        ITS_RemFeature(itsUAL_Class);
    ...
    cout << endl << "End of MAP v6 send example." << endl;
