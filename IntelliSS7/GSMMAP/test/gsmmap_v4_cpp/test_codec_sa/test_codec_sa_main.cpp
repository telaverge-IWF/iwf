...
////////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_codec_sa_main.cpp,v 9.1 2005/03/23 12:51:35 cvsadmin Exp $
//
////////////////////////////////////////////////////////////////////////////////

//
//  MAP V4 ASN.1 codec example (using stack allocation).
//
...
BuildOperationInsertSubscriberDataArg()
{
    ...
    insertSubscriberDataArg.UnsetDeleteSubcomponentsAutomatically();

    ////////////////////////////////////////////////////////////////////////////

    //  Memory management note: since the option to not delete subcomponents
    //  automatically is used with the InsertSubscriberDataArg object all the 
    //  parameter objects can be allocated in the stack. To be consistent the 
    //  same should be done for all other ASN.1 container based types (types 
    //  based on SEQUENCE, SEQUENCE OF, SET, SET OF, CHOICE and ANY).
    ...
    IMSI imsi(FixedByteArrayToVector(fixedArray1));
    ...
    ISDN_AddressString iSDN_AddressString(FixedByteArrayToVector(fixedArray2));
    ...
    Category category(FixedByteArrayToVector(fixedArray3));
    ...
    bearerServiceList.UnsetDeleteSubcomponentsAutomatically();
    ...
    teleserviceList.UnsetDeleteSubcomponentsAutomatically();
    ...
    Ext_TeleserviceCode 
        ext_teleserviceCode2(
            FixedByteArrayToVector(fixedArray7));
    ...
    Ext_TeleserviceCode 
        ext_teleserviceCode3(
            FixedByteArrayToVector(fixedArray8));
    ...
    Ext_SS_InfoList ext_SS_InfoList;

    ext_SS_InfoList.UnsetDeleteSubcomponentsAutomatically();
	...
	Ext_SS_Info ext_SS_Info1;

    ext_SS_Info1.UnsetDeleteSubcomponentsAutomatically();
    ...
    Ext_ForwInfo ext_forwInfo;

    ext_forwInfo.UnsetDeleteSubcomponentsAutomatically();
    ...
    SS_Code 
        sS_Code1(
            FixedByteArrayToVector(fixedArray9));
    ...
    ext_forwFeatureList.UnsetDeleteSubcomponentsAutomatically();
    ...
    Ext_ForwFeature ext_forwFeature;

    ext_forwFeature.UnsetDeleteSubcomponentsAutomatically();
    ...
    Ext_SS_Status 
        ext_SS_Status1(
            FixedByteArrayToVector(fixedArray10));

    //  [8-1-1-1-3-1-2] Create Ext_BasicServiceCode object.
    
	Ext_BasicServiceCode ext_basicServiceCode;

    ext_basicServiceCode.UnsetDeleteSubcomponentsAutomatically();

    byte fixedArray11[] = { 0x44U };

    Ext_BearerServiceCode 
        ext_bearerServiceCode(
            FixedByteArrayToVector(fixedArray11));
    ...
    ISDN_SubaddressString
        iSDN_SubaddressString(
            FixedByteArrayToVector(fixedArray12));
	...
	Ext_SS_Info ext_SS_Info2;

    ext_SS_Info2.UnsetDeleteSubcomponentsAutomatically();
    ...
    cUG_Info.UnsetDeleteSubcomponentsAutomatically();

    //  [8-1-2-1-1] Create CUG_SubscriptionList object.

    CUG_SubscriptionList cUG_SubscriptionList;

    cUG_SubscriptionList.UnsetDeleteSubcomponentsAutomatically();
	...
	CUG_Subscription cUG_Subscription1;

    cUG_Subscription1.UnsetDeleteSubcomponentsAutomatically();

    CUG_Index cUG_Index1(1999l);
    ...
    CUG_Interlock 
        cUG_Interlock1(
            FixedByteArrayToVector(fixedArray13));

    cUG_Subscription1.SetCug_Interlock(cUG_Interlock1);

    IntraCUG_Options intraCUG_Options1;
	...
	CUG_Subscription cUG_Subscription2;

    cUG_Subscription2.UnsetDeleteSubcomponentsAutomatically();

    CUG_Index cUG_Index2(2001l);
    ...
    CUG_Interlock 
        cUG_Interlock2(
            FixedByteArrayToVector(fixedArray14));

    cUG_Subscription2.SetCug_Interlock(cUG_Interlock2);

    IntraCUG_Options intraCUG_Options2;
	...
	Ext_SS_Info ext_SS_Info3;

    ext_SS_Info3.UnsetDeleteSubcomponentsAutomatically();
    ...
    Ext_SS_Data ext_SS_Data;

    ext_SS_Data.UnsetDeleteSubcomponentsAutomatically();
    ...
    SS_Code 
        sS_Code2(
            FixedByteArrayToVector(fixedArray15));
    ...
    Ext_SS_Status 
        ext_SS_Status2(
            FixedByteArrayToVector(fixedArray16));

    //  [8-1-3-1-3] Create SS_SubscriptionOption object.
    
	SS_SubscriptionOption sS_SubscriptionOption;

    sS_SubscriptionOption.UnsetDeleteSubcomponentsAutomatically();
    ...
    oDB_Data.UnsetDeleteSubcomponentsAutomatically();
    ...
    ODB_GeneralData 
        oDB_GeneralData(
            FixedBooleanArrayToVector(fixedArray17));
    ...
    ODB_HPLMN_Data 
        oDB_HPLMN_Data(
            FixedBooleanArrayToVector(fixedArray18));
    ...
    //  [12-1] Delete Octets object created by the call to Encode.
                            ...
                            const vector<byte>& encodedInsertSubscriberDataArg)
{
    ...
    Octets octets(encodedInsertSubscriberDataArg);
