...
BuildOperationInsertSubscriberDataArg()
{
 ...
 cout << "BLABLA" << &encodedInsertSubscriberDataArg;
...
{
    cout << endl << "Begin MAP V3 ASN.1 codec example..." << endl;
    ...
    cout << endl << "End of MAP V3 ASN.1 codec example." << endl;
