...
#if !defined(_MAP_V1_SS_CODE_LIST_H_)
#define _MAP_V1_SS_CODE_LIST_H_
...
class SS_CodeList : public its::AsnSequenceOf
{
public:
...
////////// End Nested Class //////////
    ...
    SS_CodeList() : its::AsnSequenceOf(false)
    {
        Initialize();
    }

    SS_CodeList(its::Octets& octets) : its::AsnSequenceOf(false)
    {
        Initialize();
        Decode(octets);
    }

    SS_CodeList(const SS_CodeList& rhs) : its::AsnSequenceOf(rhs)
    {
        // Nothing to do.
    }

    SS_CodeList(its::AsnDescObject* description) : its::AsnSequenceOf(description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V1_SS_CODE_LIST_H_)
