...
#if !defined(_MAP_V9_SEND_GROUP_CALL_END_SIGNAL_ARG_H_)
#define _MAP_V9_SEND_GROUP_CALL_END_SIGNAL_ARG_H_
...
////////// End Nested Class(es) //////////
    ...
    SendGroupCallEndSignalArg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    SendGroupCallEndSignalArg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    SendGroupCallEndSignalArg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_SEND_GROUP_CALL_END_SIGNAL_ARG_H_)
