...
#if !defined(_MAP_V3_REPORT_SM_DELIVERY_STATUS_RES_H_)
#define _MAP_V3_REPORT_SM_DELIVERY_STATUS_RES_H_
...
#endif    // !defined(_MAP_V3_REPORT_SM_DELIVERY_STATUS_RES_H_)
