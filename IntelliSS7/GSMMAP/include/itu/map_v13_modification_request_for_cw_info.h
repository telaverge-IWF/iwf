...
#if !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CW_INFO_H_)
#define _MAP_V13_MODIFICATION_REQUEST_FOR_CW_INFO_H_
...
class ModificationRequestFor_CW_Info : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ModificationRequestFor_CW_Info() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    ModificationRequestFor_CW_Info(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }

    ModificationRequestFor_CW_Info(const ModificationRequestFor_CW_Info& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ModificationRequestFor_CW_Info(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~ModificationRequestFor_CW_Info()
    {
        // Nothing to do.
    }
    ...
    {
        return new ModificationRequestFor_CW_Info(*this);
    }

    virtual std::string GetName() const
    { return "ModificationRequestFor_CW_Info"; }
...
#endif    // !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CW_INFO_H_)
