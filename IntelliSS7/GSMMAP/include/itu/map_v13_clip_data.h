...
#if !defined(_MAP_V13_CLIP_DATA_H_)
#define _MAP_V13_CLIP_DATA_H_
...
class ClipData : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ClipData() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    ClipData(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }

    ClipData(const ClipData& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ClipData(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V13_CLIP_DATA_H_)
