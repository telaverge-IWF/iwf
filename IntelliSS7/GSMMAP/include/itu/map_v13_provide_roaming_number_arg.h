...
#if !defined(_MAP_V13_PROVIDE_ROAMING_NUMBER_ARG_H_)
#define _MAP_V13_PROVIDE_ROAMING_NUMBER_ARG_H_
...
////////// Begin Nested Class(es) //////////
    ...
    class Mtrf_Indicator : public its::AsnNull
    {
    public:

        Mtrf_Indicator() : its::AsnNull(false)
        {
            Initialize();
        }

        Mtrf_Indicator(its::Octets& octets) : its::AsnNull(false)
        {
            Initialize();
            Decode(octets);
        }

        Mtrf_Indicator(const Mtrf_Indicator& rhs) : its::AsnNull(rhs)
        {
            // Nothing to do.
        }

        Mtrf_Indicator(its::AsnDescObject* description) : its::AsnNull(description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        virtual its::AsnObject* Clone() const
        {
            return new Mtrf_Indicator(*this);
        }

        virtual std::string GetName() const
        { return "Mtrf_Indicator"; }
        ...
        typedef map_v13::PagingArea PagingArea;
...
////////// End Nested Class(es) //////////
    ...
    ProvideRoamingNumberArg() : its::AsnSequence(25, false)
    {
        Initialize();
    }

    ProvideRoamingNumberArg(its::Octets& octets) : its::AsnSequence(25, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ProvideRoamingNumberArg(its::AsnDescObject* description) : its::AsnSequence(25, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetPagingAreaStaticDescription();
    static its::AsnDescObject* GetCallPriorityStaticDescription();
    static its::AsnDescObject* GetMtrf_IndicatorStaticDescription();
    static its::AsnDescObject* GetOldMSC_NumberStaticDescription();
...
public:
    ...
    const MtRoamingRetrySupported& GetMtRoamingRetrySupported() const
    {
        ...
        return static_cast<const MtRoamingRetrySupported&> (ElementAt(20));
    }

    void SetPagingArea(PagingArea* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetPagingAreaStaticDescription());
        AddElement(21, element);
    }

    void SetPagingArea(const PagingArea& element)
    {
        its::AsnObject& asnObject = const_cast<PagingArea&>(element);
        asnObject.SetDescription(GetPagingAreaStaticDescription());
        AddElement(21, element);
    }

    bool OptionPagingArea() const
    {
        return Contains(21);
    }

    const PagingArea& GetPagingArea() const
    {
        ITS_REQUIRE(OptionPagingArea());
        return static_cast<const PagingArea&> (ElementAt(21));
    }
    ...
    const EMLPP_Priority& GetCallPriority() const
    {
        ...
        return static_cast<const EMLPP_Priority&> (ElementAt(22));
    }

    void SetMtrf_Indicator(Mtrf_Indicator* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetMtrf_IndicatorStaticDescription());
        AddElement(23, element);
    }

    void SetMtrf_Indicator(const Mtrf_Indicator& element)
    {
        its::AsnObject& asnObject = const_cast<Mtrf_Indicator&>(element);
        asnObject.SetDescription(GetMtrf_IndicatorStaticDescription());
        AddElement(23, element);
    }

    bool OptionMtrf_Indicator() const
    {
        return Contains(23);
    }

    const Mtrf_Indicator& GetMtrf_Indicator() const
    {
        ITS_REQUIRE(OptionMtrf_Indicator());
        return static_cast<const Mtrf_Indicator&> (ElementAt(23));
    }

    void SetOldMSC_Number(ISDN_AddressString* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetOldMSC_NumberStaticDescription());
        AddElement(24, element);
    }

    void SetOldMSC_Number(const ISDN_AddressString& element)
    {
        its::AsnObject& asnObject = const_cast<ISDN_AddressString&>(element);
        asnObject.SetDescription(GetOldMSC_NumberStaticDescription());
        AddElement(24, element);
    }

    bool OptionOldMSC_Number() const
    {
        return Contains(24);
    }

    const ISDN_AddressString& GetOldMSC_Number() const
    {
        ITS_REQUIRE(OptionOldMSC_Number());
        return static_cast<const ISDN_AddressString&> (ElementAt(24));
    }
...
#endif    // !defined(_MAP_V13_PROVIDE_ROAMING_NUMBER_ARG_H_)
