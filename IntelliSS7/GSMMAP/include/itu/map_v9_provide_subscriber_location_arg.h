...
#if !defined(_MAP_V9_PROVIDE_SUBSCRIBER_LOCATION_ARG_H_)
#define _MAP_V9_PROVIDE_SUBSCRIBER_LOCATION_ARG_H_
...
#include <map_v9_location_type.h>
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::LocationType LocationType;
        ...
        typedef map_v9::LCS_Priority LCS_Priority;


        typedef map_v9::LCS_QoS LCS_QoS;


        typedef map_v9::ExtensionContainer ExtensionContainer;


        typedef map_v9::SupportedGADShapes SupportedGADShapes;
        ...
        typedef map_v9::LCSCodeword LCSCodeword;


        typedef map_v9::LCS_PrivacyCheck LCS_PrivacyCheck;


        typedef map_v9::AreaEventInfo AreaEventInfo;
...
////////// End Nested Class(es) //////////
    ...
    ProvideSubscriberLocation_Arg() : its::AsnSequence(18, false)
    {
        Initialize();
    }

    ProvideSubscriberLocation_Arg(its::Octets& octets) : its::AsnSequence(18, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ProvideSubscriberLocation_Arg(its::AsnDescObject* description) : its::AsnSequence(18, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_PROVIDE_SUBSCRIBER_LOCATION_ARG_H_)
