...
#if !defined(_MAP_V13_SS_EVENT_LIST_H_)
#define _MAP_V13_SS_EVENT_LIST_H_
...
class SS_EventList : public its::AsnSequenceOf
{
public:
...
////////// End Nested Class //////////
    ...
    SS_EventList() : its::AsnSequenceOf(false)
    {
        Initialize();
    }

    SS_EventList(its::Octets& octets) : its::AsnSequenceOf(false)
    {
        Initialize();
        Decode(octets);
    }

    SS_EventList(const SS_EventList& rhs) : its::AsnSequenceOf(rhs)
    {
        // Nothing to do.
    }

    SS_EventList(its::AsnDescObject* description) : its::AsnSequenceOf(description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V13_SS_EVENT_LIST_H_)
