...
#if !defined(_MAP_V9_EXT_CALL_BARRING_INFO_FOR_CSE_H_)
#define _MAP_V9_EXT_CALL_BARRING_INFO_FOR_CSE_H_
...
#endif    // !defined(_MAP_V9_EXT_CALL_BARRING_INFO_FOR_CSE_H_)
