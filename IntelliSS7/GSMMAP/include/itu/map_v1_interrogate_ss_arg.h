...
#if !defined(_MAP_V1_INTERROGATE_SS_ARG_H_)
#define _MAP_V1_INTERROGATE_SS_ARG_H_
...
class InterrogateSS_Arg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    InterrogateSS_Arg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    InterrogateSS_Arg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    InterrogateSS_Arg(const InterrogateSS_Arg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    InterrogateSS_Arg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    {
        return new InterrogateSS_Arg(*this);
    }

    virtual std::string GetName() const
    { return "InterrogateSS_Arg"; }
...
#endif    // !defined(_MAP_V1_INTERROGATE_SS_ARG_H_)
