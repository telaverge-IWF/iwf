...
#if !defined(_MAP_V13_PROVIDE_SUBSCRIBER_INFO_RES_H_)
#define _MAP_V13_PROVIDE_SUBSCRIBER_INFO_RES_H_
...
class ProvideSubscriberInfoRes : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ProvideSubscriberInfoRes() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    ProvideSubscriberInfoRes(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    ProvideSubscriberInfoRes(const ProvideSubscriberInfoRes& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ProvideSubscriberInfoRes(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~ProvideSubscriberInfoRes()
    {
        // Nothing to do.
    }
    ...
    {
        return new ProvideSubscriberInfoRes(*this);
    }
...
#endif    // !defined(_MAP_V13_PROVIDE_SUBSCRIBER_INFO_RES_H_)
