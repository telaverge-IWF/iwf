...
#if !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CH_INFO_H_)
#define _MAP_V13_MODIFICATION_REQUEST_FOR_CH_INFO_H_
...
class ModificationRequestFor_CH_Info : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ModificationRequestFor_CH_Info() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    ModificationRequestFor_CH_Info(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }

    ModificationRequestFor_CH_Info(const ModificationRequestFor_CH_Info& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ModificationRequestFor_CH_Info(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~ModificationRequestFor_CH_Info()
    {
        // Nothing to do.
    }
    ...
    {
        return new ModificationRequestFor_CH_Info(*this);
    }

    virtual std::string GetName() const
    { return "ModificationRequestFor_CH_Info"; }
...
#endif    // !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CH_INFO_H_)
