...
#if !defined(_MAP_V13_PERMITTED_INTEGRITY_PROTECTION_ALGORITHMS_H_)
#define _MAP_V13_PERMITTED_INTEGRITY_PROTECTION_ALGORITHMS_H_
...
#endif    // !defined(_MAP_V13_PERMITTED_INTEGRITY_PROTECTION_ALGORITHMS_H_)
