...
#if !defined(_MAP_V3_VLR_CAMEL_SUBSCRIPTION_INFO_H_)
#define _MAP_V3_VLR_CAMEL_SUBSCRIPTION_INFO_H_
...
////////// End Nested Class(es) //////////
    ...
    VlrCamelSubscriptionInfo() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    VlrCamelSubscriptionInfo(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    VlrCamelSubscriptionInfo(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V3_VLR_CAMEL_SUBSCRIPTION_INFO_H_)
