...
#if !defined(_MAP_V9_T_CSI_H_)
#define _MAP_V9_T_CSI_H_
...
#include <map_v9_t_bcsm_camel_tdp_data_list.h>
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::T_BcsmCamelTDPDataList T_BcsmCamelTDPDataList;
...
////////// End Nested Class(es) //////////
    ...
    T_CSI() : its::AsnSequence(5, false)
    {
        Initialize();
    }

    T_CSI(its::Octets& octets) : its::AsnSequence(5, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    T_CSI(its::AsnDescObject* description) : its::AsnSequence(5, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_T_CSI_H_)
