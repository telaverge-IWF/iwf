...
#if !defined(_MAP_V13_SM_ENUMERATED_DELIVERY_FAILURE_CAUSE_H_)
#define _MAP_V13_SM_ENUMERATED_DELIVERY_FAILURE_CAUSE_H_
...
#endif    // !defined(_MAP_V13_SM_ENUMERATED_DELIVERY_FAILURE_CAUSE_H_)
