...
#if !defined(_MAP_V9_UMTS_SECURITY_CONTEXT_DATA_H_)
#define _MAP_V9_UMTS_SECURITY_CONTEXT_DATA_H_
...
#endif    // !defined(_MAP_V9_UMTS_SECURITY_CONTEXT_DATA_H_)
