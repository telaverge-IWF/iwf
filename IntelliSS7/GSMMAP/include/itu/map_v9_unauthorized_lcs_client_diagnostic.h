...
#if !defined(_MAP_V9_UNAUTHORIZED_LCS_CLIENT_DIAGNOSTIC_H_)
#define _MAP_V9_UNAUTHORIZED_LCS_CLIENT_DIAGNOSTIC_H_
...
#endif    // !defined(_MAP_V9_UNAUTHORIZED_LCS_CLIENT_DIAGNOSTIC_H_)
