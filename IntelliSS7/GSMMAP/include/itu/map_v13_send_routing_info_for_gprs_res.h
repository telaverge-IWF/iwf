...
#if !defined(_MAP_V13_SEND_ROUTING_INFO_FOR_GPRS_RES_H_)
#define _MAP_V13_SEND_ROUTING_INFO_FOR_GPRS_RES_H_
...
#endif    // !defined(_MAP_V13_SEND_ROUTING_INFO_FOR_GPRS_RES_H_)
