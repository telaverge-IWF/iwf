...
#if !defined(_MAP_V1_ERASE_SS_ARG_H_)
#define _MAP_V1_ERASE_SS_ARG_H_
...
class EraseSS_Arg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    EraseSS_Arg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    EraseSS_Arg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    EraseSS_Arg(const EraseSS_Arg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    EraseSS_Arg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V1_ERASE_SS_ARG_H_)
