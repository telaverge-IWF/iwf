...
#if !defined(_MAP_V13_PW_REGISTRATION_FAILURE_CAUSE_H_)
#define _MAP_V13_PW_REGISTRATION_FAILURE_CAUSE_H_
...
#endif    // !defined(_MAP_V13_PW_REGISTRATION_FAILURE_CAUSE_H_)
