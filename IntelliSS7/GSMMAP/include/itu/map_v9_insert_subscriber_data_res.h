...
#if !defined(_MAP_V9_INSERT_SUBSCRIBER_DATA_RES_H_)
#define _MAP_V9_INSERT_SUBSCRIBER_DATA_RES_H_
...
#include <map_v9_regional_subscription_response.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v9::RegionalSubscriptionResponse RegionalSubscriptionResponse;
...
////////// End Nested Class(es) //////////
    ...
    InsertSubscriberDataRes() : its::AsnSequence(8, false)
    {
        Initialize();
    }

    InsertSubscriberDataRes(its::Octets& octets) : its::AsnSequence(8, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    InsertSubscriberDataRes(its::AsnDescObject* description) : its::AsnSequence(8, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_INSERT_SUBSCRIBER_DATA_RES_H_)
