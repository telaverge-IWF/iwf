...
#if !defined(_MAP_V9_O_BCSM_CAMEL_TDP_CRITERIA_H_)
#define _MAP_V9_O_BCSM_CAMEL_TDP_CRITERIA_H_
...
#include <map_v9_o_bcsm_trigger_detection_point.h>
#include <map_v9_destination_number_criteria.h>
#include <map_v9_basic_service_criteria.h>
#include <map_v9_call_type_criteria.h>
#include <map_v9_o_cause_value_criteria.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v9::O_BcsmTriggerDetectionPoint O_BcsmTriggerDetectionPoint;


        typedef map_v9::DestinationNumberCriteria DestinationNumberCriteria;


        typedef map_v9::BasicServiceCriteria BasicServiceCriteria;


        typedef map_v9::CallTypeCriteria CallTypeCriteria;


        typedef map_v9::O_CauseValueCriteria O_CauseValueCriteria;
...
#endif    // !defined(_MAP_V9_O_BCSM_CAMEL_TDP_CRITERIA_H_)
