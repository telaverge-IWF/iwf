...
#if !defined(_MAP_V9_ERROR_CODE_H_)
#define _MAP_V9_ERROR_CODE_H_
...
class ErrorCode : public its::AsnChoice
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ErrorCode() : its::AsnChoice(false)
    {
        Initialize();
    }

    ErrorCode(its::Octets& octets) : its::AsnChoice(false)
    {
        Initialize();
        Decode(octets);
    }

    ErrorCode(const ErrorCode& rhs) : its::AsnChoice(rhs)
    {
        // Nothing to do.
    }

    ErrorCode(its::AsnDescObject* description) : its::AsnChoice(description)
    {
        // Nothing to do.
    }

    ErrorCode(its::AsnDescObject* description, its::AsnObject* choice) : its::AsnChoice(description, choice)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_ERROR_CODE_H_)
