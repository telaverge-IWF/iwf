...
#if !defined(_MAP_V1_ACTIVATE_SS_ARG_H_)
#define _MAP_V1_ACTIVATE_SS_ARG_H_
...
class ActivateSS_Arg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ActivateSS_Arg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    ActivateSS_Arg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    ActivateSS_Arg(const ActivateSS_Arg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ActivateSS_Arg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    {
        return new ActivateSS_Arg(*this);
    }

    virtual std::string GetName() const
    { return "ActivateSS_Arg"; }
...
#endif    // !defined(_MAP_V1_ACTIVATE_SS_ARG_H_)
