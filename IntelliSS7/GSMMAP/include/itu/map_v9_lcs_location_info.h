...
#if !defined(_MAP_V9_LCS_LOCATION_INFO_H_)
#define _MAP_V9_LCS_LOCATION_INFO_H_
...
////////// End Nested Class(es) //////////
    ...
    LCSLocationInfo() : its::AsnSequence(7, false)
    {
        Initialize();
    }

    LCSLocationInfo(its::Octets& octets) : its::AsnSequence(7, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    LCSLocationInfo(its::AsnDescObject* description) : its::AsnSequence(7, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_LCS_LOCATION_INFO_H_)
