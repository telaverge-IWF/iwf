...
#if !defined(_MAP_V3_MAP_REFUSE_INFO_H_)
#define _MAP_V3_MAP_REFUSE_INFO_H_
...
////////// End Nested Class(es) //////////
    ...
    MAP_RefuseInfo() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    MAP_RefuseInfo(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    MAP_RefuseInfo(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V3_MAP_REFUSE_INFO_H_)
