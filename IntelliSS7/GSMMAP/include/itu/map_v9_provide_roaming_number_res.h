...
#if !defined(_MAP_V9_PROVIDE_ROAMING_NUMBER_RES_H_)
#define _MAP_V9_PROVIDE_ROAMING_NUMBER_RES_H_
...
////////// End Nested Class(es) //////////
    ...
    ProvideRoamingNumberRes() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    ProvideRoamingNumberRes(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ProvideRoamingNumberRes(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_PROVIDE_ROAMING_NUMBER_RES_H_)
