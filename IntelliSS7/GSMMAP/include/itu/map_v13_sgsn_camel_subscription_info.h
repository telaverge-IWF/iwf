...
#if !defined(_MAP_V13_SGSN_CAMEL_SUBSCRIPTION_INFO_H_)
#define _MAP_V13_SGSN_CAMEL_SUBSCRIPTION_INFO_H_
...
#endif    // !defined(_MAP_V13_SGSN_CAMEL_SUBSCRIPTION_INFO_H_)
