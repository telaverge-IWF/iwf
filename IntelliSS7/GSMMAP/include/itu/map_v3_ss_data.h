...
#if !defined(_MAP_V3_SS_DATA_H_)
#define _MAP_V3_SS_DATA_H_
...
////////// End Nested Class(es) //////////
    ...
    SS_Data() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    SS_Data(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    SS_Data(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V3_SS_DATA_H_)
