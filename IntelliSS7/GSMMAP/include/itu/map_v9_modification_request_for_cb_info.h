...
#if !defined(_MAP_V9_MODIFICATION_REQUEST_FOR_CB_INFO_H_)
#define _MAP_V9_MODIFICATION_REQUEST_FOR_CB_INFO_H_
...
#endif    // !defined(_MAP_V9_MODIFICATION_REQUEST_FOR_CB_INFO_H_)
