...
#if !defined(_MAP_V9_EXTENSIBLE_SYSTEM_FAILURE_PARAM_H_)
#define _MAP_V9_EXTENSIBLE_SYSTEM_FAILURE_PARAM_H_
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v9::NetworkResource NetworkResource;
...
////////// End Nested Class(es) //////////
    ...
    ExtensibleSystemFailureParam() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    ExtensibleSystemFailureParam(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ExtensibleSystemFailureParam(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_EXTENSIBLE_SYSTEM_FAILURE_PARAM_H_)
