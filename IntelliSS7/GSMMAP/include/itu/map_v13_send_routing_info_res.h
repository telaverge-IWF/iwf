...
#if !defined(_MAP_V13_SEND_ROUTING_INFO_RES_H_)
#define _MAP_V13_SEND_ROUTING_INFO_RES_H_
...
#include <map_v13_routing_info.h>
#include <map_v13_allowed_services.h>
#include <map_v13_unavailability_cause.h>
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v13::ExtendedRoutingInfo ExtendedRoutingInfo;
        ...
        typedef map_v13::CCBS_Indicators CCBS_Indicators;


        typedef map_v13::NumberPortabilityStatus NumberPortabilityStatus;
        ...
        typedef map_v13::RoutingInfo RoutingInfo;


        typedef map_v13::AllowedServices AllowedServices;


        typedef map_v13::UnavailabilityCause UnavailabilityCause;
...
////////// End Nested Class(es) //////////
    ...
    SendRoutingInfoRes() : its::AsnSequence(24, false)
    {
        Initialize();
    }

    SendRoutingInfoRes(its::Octets& octets) : its::AsnSequence(24, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    SendRoutingInfoRes(its::AsnDescObject* description) : its::AsnSequence(24, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    const ExternalSignalInfo& GetGsm_BearerCapability() const
    {
        ...
        return static_cast<const ExternalSignalInfo&> (ElementAt(23));
    }
...
#endif    // !defined(_MAP_V13_SEND_ROUTING_INFO_RES_H_)
