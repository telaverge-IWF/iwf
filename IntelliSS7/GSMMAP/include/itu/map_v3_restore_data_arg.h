...
#if !defined(_MAP_V3_RESTORE_DATA_ARG_H_)
#define _MAP_V3_RESTORE_DATA_ARG_H_
...
////////// End Nested Class(es) //////////
    ...
    RestoreDataArg() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    RestoreDataArg(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    RestoreDataArg(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V3_RESTORE_DATA_ARG_H_)
