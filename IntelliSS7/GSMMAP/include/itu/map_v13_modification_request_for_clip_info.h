...
#if !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CLIP_INFO_H_)
#define _MAP_V13_MODIFICATION_REQUEST_FOR_CLIP_INFO_H_
...
class ModificationRequestFor_CLIP_Info : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v13::OverrideCategory OverrideCategory;
...
////////// End Nested Class(es) //////////
    ...
    ModificationRequestFor_CLIP_Info() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    ModificationRequestFor_CLIP_Info(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }

    ModificationRequestFor_CLIP_Info(const ModificationRequestFor_CLIP_Info& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ModificationRequestFor_CLIP_Info(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~ModificationRequestFor_CLIP_Info()
    {
        // Nothing to do.
    }
    ...
    {
        return new ModificationRequestFor_CLIP_Info(*this);
    }

    virtual std::string GetName() const
    { return "ModificationRequestFor_CLIP_Info"; }
    ...
    void SetOverrideCategory(OverrideCategory* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetOverrideCategoryStaticDescription());
        AddElement(1, element);
    }

    void SetOverrideCategory(const OverrideCategory& element)
    {
        its::AsnObject& asnObject = const_cast<OverrideCategory&>(element);
        asnObject.SetDescription(GetOverrideCategoryStaticDescription());
        AddElement(1, element);
    }

    bool OptionOverrideCategory() const
    {
        return Contains(1);
    }

    const OverrideCategory& GetOverrideCategory() const
    {
        ITS_REQUIRE(OptionOverrideCategory());
        return static_cast<const OverrideCategory&> (ElementAt(1));
    }
...
#endif    // !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CLIP_INFO_H_)
