...
#if !defined(_MAP_V9_D_CSI_H_)
#define _MAP_V9_D_CSI_H_
...
class D_CSI : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::DP_AnalysedInfoCriteriaList DP_AnalysedInfoCriteriaList;
...
////////// End Nested Class(es) //////////
    ...
    D_CSI() : its::AsnSequence(5, false)
    {
        Initialize();
    }

    D_CSI(its::Octets& octets) : its::AsnSequence(5, false)
    {
        Initialize();
        Decode(octets);
    }

    D_CSI(const D_CSI& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    D_CSI(its::AsnDescObject* description) : its::AsnSequence(5, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetDp_AnalysedInfoCriteriaListStaticDescription();
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new D_CSI(*this);
    }

    virtual std::string GetName() const
    { return "D_CSI"; }

    void SetDp_AnalysedInfoCriteriaList(DP_AnalysedInfoCriteriaList* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetDp_AnalysedInfoCriteriaListStaticDescription());
        AddElement(0, element);
    }

    void SetDp_AnalysedInfoCriteriaList(const DP_AnalysedInfoCriteriaList& element)
    {
        its::AsnObject& asnObject = const_cast<DP_AnalysedInfoCriteriaList&>(element);
        asnObject.SetDescription(GetDp_AnalysedInfoCriteriaListStaticDescription());
        AddElement(0, element);
    }

    bool OptionDp_AnalysedInfoCriteriaList() const
    {
        return Contains(0);
    }

    const DP_AnalysedInfoCriteriaList& GetDp_AnalysedInfoCriteriaList() const
    {
        ITS_REQUIRE(OptionDp_AnalysedInfoCriteriaList());
        return static_cast<const DP_AnalysedInfoCriteriaList&> (ElementAt(0));
    }
...
#endif    // !defined(_MAP_V9_D_CSI_H_)
