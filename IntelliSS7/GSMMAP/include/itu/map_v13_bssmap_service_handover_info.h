...
#if !defined(_MAP_V13_BSSMAP_SERVICE_HANDOVER_INFO_H_)
#define _MAP_V13_BSSMAP_SERVICE_HANDOVER_INFO_H_
...
#endif    // !defined(_MAP_V13_BSSMAP_SERVICE_HANDOVER_INFO_H_)
