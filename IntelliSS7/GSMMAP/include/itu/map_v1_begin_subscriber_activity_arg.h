...
#if !defined(_MAP_V1_BEGIN_SUBSCRIBER_ACTIVITY_ARG_H_)
#define _MAP_V1_BEGIN_SUBSCRIBER_ACTIVITY_ARG_H_
...
#endif    // !defined(_MAP_V1_BEGIN_SUBSCRIBER_ACTIVITY_ARG_H_)
