...
#if !defined(_MAP_V9_GPRS_CSI_H_)
#define _MAP_V9_GPRS_CSI_H_
...
#include <map_v9_gprs_camel_tdp_data_list.h>
...
class GPRS_CSI : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::GPRS_CamelTDPDataList GPRS_CamelTDPDataList;
...
////////// End Nested Class(es) //////////
    ...
    GPRS_CSI() : its::AsnSequence(5, false)
    {
        Initialize();
    }

    GPRS_CSI(its::Octets& octets) : its::AsnSequence(5, false)
    {
        Initialize();
        Decode(octets);
    }

    GPRS_CSI(const GPRS_CSI& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    GPRS_CSI(its::AsnDescObject* description) : its::AsnSequence(5, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetGprs_CamelTDPDataListStaticDescription();
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new GPRS_CSI(*this);
    }

    virtual std::string GetName() const
    { return "GPRS_CSI"; }

    void SetGprs_CamelTDPDataList(GPRS_CamelTDPDataList* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetGprs_CamelTDPDataListStaticDescription());
        AddElement(0, element);
    }

    void SetGprs_CamelTDPDataList(const GPRS_CamelTDPDataList& element)
    {
        its::AsnObject& asnObject = const_cast<GPRS_CamelTDPDataList&>(element);
        asnObject.SetDescription(GetGprs_CamelTDPDataListStaticDescription());
        AddElement(0, element);
    }

    bool OptionGprs_CamelTDPDataList() const
    {
        return Contains(0);
    }

    const GPRS_CamelTDPDataList& GetGprs_CamelTDPDataList() const
    {
        ITS_REQUIRE(OptionGprs_CamelTDPDataList());
        return static_cast<const GPRS_CamelTDPDataList&> (ElementAt(0));
    }
...
#endif    // !defined(_MAP_V9_GPRS_CSI_H_)
