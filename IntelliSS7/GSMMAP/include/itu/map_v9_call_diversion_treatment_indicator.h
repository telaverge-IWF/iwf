...
#if !defined(_MAP_V9_CALL_DIVERSION_TREATMENT_INDICATOR_H_)
#define _MAP_V9_CALL_DIVERSION_TREATMENT_INDICATOR_H_
...
#endif    // !defined(_MAP_V9_CALL_DIVERSION_TREATMENT_INDICATOR_H_)
