...
#if !defined(_MAP_V13_SEND_ROUTING_INFO_ARG_H_)
#define _MAP_V13_SEND_ROUTING_INFO_ARG_H_
...
#include <map_v13_number_of_forwarding.h>
#include <map_v13_interrogation_type.h>
#include <map_v13_or_phase.h>
#include <map_v13_call_reference_number.h>
#include <map_v13_forwarding_reason.h>
#include <map_v13_ext_basic_service_code.h>
#include <map_v13_external_signal_info.h>
#include <map_v13_camel_info.h>
#include <map_v13_suppression_of_announcement.h>
...
#include <map_v13_call_diversion_treatment_indicator.h>
#include <map_v13_suppress_mtss.h>
...
////////// Begin Nested Class(es) //////////
    ...
    class MtRoamingRetrySupported : public its::AsnNull
    {
    public:

        MtRoamingRetrySupported() : its::AsnNull(false)
        {
            Initialize();
        }

        MtRoamingRetrySupported(its::Octets& octets) : its::AsnNull(false)
        {
            Initialize();
            Decode(octets);
        }

        MtRoamingRetrySupported(const MtRoamingRetrySupported& rhs) : its::AsnNull(rhs)
        {
            // Nothing to do.
        }

        MtRoamingRetrySupported(its::AsnDescObject* description) : its::AsnNull(description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        virtual ~MtRoamingRetrySupported()
        {
            // Nothing to do.
        }
        ...
        virtual its::AsnObject* Clone() const
        {
            return new MtRoamingRetrySupported(*this);
        }
        ...
        typedef map_v13::NumberOfForwarding NumberOfForwarding;


        typedef map_v13::InterrogationType InterrogationType;


        typedef map_v13::OR_Phase OR_Phase;


        typedef map_v13::CallReferenceNumber CallReferenceNumber;


        typedef map_v13::ForwardingReason ForwardingReason;
        ...
        typedef map_v13::CamelInfo CamelInfo;


        typedef map_v13::SuppressionOfAnnouncement SuppressionOfAnnouncement;
        ...
        typedef map_v13::SupportedCCBS_Phase SupportedCCBS_Phase;


        typedef map_v13::Ext_ExternalSignalInfo Ext_ExternalSignalInfo;


        typedef map_v13::IST_SupportIndicator IST_SupportIndicator;


        typedef map_v13::CallDiversionTreatmentIndicator CallDiversionTreatmentIndicator;


        typedef map_v13::SuppressMTSS SuppressMTSS;
...
////////// End Nested Class(es) //////////
    ...
    SendRoutingInfoArg() : its::AsnSequence(30, false)
    {
        Initialize();
    }

    SendRoutingInfoArg(its::Octets& octets) : its::AsnSequence(30, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    SendRoutingInfoArg(its::AsnDescObject* description) : its::AsnSequence(30, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetSuppressMTSSStaticDescription();
    static its::AsnDescObject* GetMtRoamingRetrySupportedStaticDescription();
...
public:
    ...
    void SetSuppressMTSS(SuppressMTSS* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetSuppressMTSSStaticDescription());
        AddElement(27, element);
    }

    void SetSuppressMTSS(const SuppressMTSS& element)
    {
        its::AsnObject& asnObject = const_cast<SuppressMTSS&>(element);
        asnObject.SetDescription(GetSuppressMTSSStaticDescription());
        AddElement(27, element);
    }

    bool OptionSuppressMTSS() const
    {
        return Contains(27);
    }

    const SuppressMTSS& GetSuppressMTSS() const
    {
        ITS_REQUIRE(OptionSuppressMTSS());
        return static_cast<const SuppressMTSS&> (ElementAt(27));
    }

    void SetMtRoamingRetrySupported(MtRoamingRetrySupported* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetMtRoamingRetrySupportedStaticDescription());
        AddElement(28, element);
    }

    void SetMtRoamingRetrySupported(const MtRoamingRetrySupported& element)
    {
        its::AsnObject& asnObject = const_cast<MtRoamingRetrySupported&>(element);
        asnObject.SetDescription(GetMtRoamingRetrySupportedStaticDescription());
        AddElement(28, element);
    }

    bool OptionMtRoamingRetrySupported() const
    {
        return Contains(28);
    }

    const MtRoamingRetrySupported& GetMtRoamingRetrySupported() const
    {
        ITS_REQUIRE(OptionMtRoamingRetrySupported());
        return static_cast<const MtRoamingRetrySupported&> (ElementAt(28));
    }
    ...
    const EMLPP_Priority& GetCallPriority() const
    {
        ...
        return static_cast<const EMLPP_Priority&> (ElementAt(29));
    }
...
#endif    // !defined(_MAP_V13_SEND_ROUTING_INFO_ARG_H_)
