...
#if !defined(_MAP_V13_FAILURE_REPORT_ARG_H_)
#define _MAP_V13_FAILURE_REPORT_ARG_H_
...
class FailureReportArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    FailureReportArg() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    FailureReportArg(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }

    FailureReportArg(const FailureReportArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    FailureReportArg(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    {
        return new FailureReportArg(*this);
    }
...
#endif    // !defined(_MAP_V13_FAILURE_REPORT_ARG_H_)
