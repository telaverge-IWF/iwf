...
#if !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CF_INFO_H_)
#define _MAP_V13_MODIFICATION_REQUEST_FOR_CF_INFO_H_
...
#endif    // !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CF_INFO_H_)
