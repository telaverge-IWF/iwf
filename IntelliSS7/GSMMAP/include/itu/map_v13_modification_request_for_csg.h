...
#if !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CSG_H_)
#define _MAP_V13_MODIFICATION_REQUEST_FOR_CSG_H_
...
class ModificationRequestFor_CSG : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    ModificationRequestFor_CSG() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    ModificationRequestFor_CSG(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    ModificationRequestFor_CSG(const ModificationRequestFor_CSG& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    ModificationRequestFor_CSG(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~ModificationRequestFor_CSG()
    {
        // Nothing to do.
    }
    ...
    {
        return new ModificationRequestFor_CSG(*this);
    }

    virtual std::string GetName() const
    { return "ModificationRequestFor_CSG"; }
...
#endif    // !defined(_MAP_V13_MODIFICATION_REQUEST_FOR_CSG_H_)
