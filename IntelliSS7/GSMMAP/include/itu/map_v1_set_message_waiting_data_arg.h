...
#if !defined(_MAP_V1_SET_MESSAGE_WAITING_DATA_ARG_H_)
#define _MAP_V1_SET_MESSAGE_WAITING_DATA_ARG_H_
...
class SetMessageWaitingDataArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    SetMessageWaitingDataArg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    SetMessageWaitingDataArg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    SetMessageWaitingDataArg(const SetMessageWaitingDataArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    SetMessageWaitingDataArg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~SetMessageWaitingDataArg()
    {
        // Nothing to do.
    }
    ...
    {
        return new SetMessageWaitingDataArg(*this);
    }

    virtual std::string GetName() const
    { return "SetMessageWaitingDataArg"; }
...
#endif    // !defined(_MAP_V1_SET_MESSAGE_WAITING_DATA_ARG_H_)
