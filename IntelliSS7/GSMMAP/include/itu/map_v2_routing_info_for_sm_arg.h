...
#if !defined(_MAP_V2_ROUTING_INFO_FOR_SM_ARG_H_)
#define _MAP_V2_ROUTING_INFO_FOR_SM_ARG_H_
...
public:
    ...
    const TeleserviceCode& GetTeleservice() const
    {
        ...
        return static_cast<const TeleserviceCode&> (ElementAt(3));
    }
...
#endif    // !defined(_MAP_V2_ROUTING_INFO_FOR_SM_ARG_H_)
