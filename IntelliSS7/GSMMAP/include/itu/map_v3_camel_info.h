...
#if !defined(_MAP_V3_CAMEL_INFO_H_)
#define _MAP_V3_CAMEL_INFO_H_
...
////////// End Nested Class(es) //////////
    ...
    CamelInfo() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    CamelInfo(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    CamelInfo(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V3_CAMEL_INFO_H_)
