...
#if !defined(_MAP_V9_POSITION_METHOD_FAILURE_DIAGNOSTIC_H_)
#define _MAP_V9_POSITION_METHOD_FAILURE_DIAGNOSTIC_H_
...
#endif    // !defined(_MAP_V9_POSITION_METHOD_FAILURE_DIAGNOSTIC_H_)
