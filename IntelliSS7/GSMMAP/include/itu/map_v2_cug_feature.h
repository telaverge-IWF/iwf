...
#if !defined(_MAP_V2_CUG_FEATURE_H_)
#define _MAP_V2_CUG_FEATURE_H_
...
#include <map_v2_inter_cug_restrictions.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v2::InterCUG_Restrictions InterCUG_Restrictions;


////////// End Nested Class(es) //////////

    CUG_Feature() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    CUG_Feature(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    CUG_Feature(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V2_CUG_FEATURE_H_)
