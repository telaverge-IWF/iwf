...
#if !defined(_MAP_V13_CHOSEN_INTEGRITY_PROTECTION_ALGORITHM_H_)
#define _MAP_V13_CHOSEN_INTEGRITY_PROTECTION_ALGORITHM_H_
...
#endif    // !defined(_MAP_V13_CHOSEN_INTEGRITY_PROTECTION_ALGORITHM_H_)
