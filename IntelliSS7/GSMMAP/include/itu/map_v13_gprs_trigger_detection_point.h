...
#if !defined(_MAP_V13_GPRS_TRIGGER_DETECTION_POINT_H_)
#define _MAP_V13_GPRS_TRIGGER_DETECTION_POINT_H_
...
#endif    // !defined(_MAP_V13_GPRS_TRIGGER_DETECTION_POINT_H_)
