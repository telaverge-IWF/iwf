...
#if !defined(_MAP_V9_SIWFS_SIGNALLING_MODIFY_RES_H_)
#define _MAP_V9_SIWFS_SIGNALLING_MODIFY_RES_H_
...
class SIWFSSignallingModifyRes : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    SIWFSSignallingModifyRes() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    SIWFSSignallingModifyRes(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    SIWFSSignallingModifyRes(const SIWFSSignallingModifyRes& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    SIWFSSignallingModifyRes(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~SIWFSSignallingModifyRes()
    {
        // Nothing to do.
    }
    ...
    {
        return new SIWFSSignallingModifyRes(*this);
    }
...
#endif    // !defined(_MAP_V9_SIWFS_SIGNALLING_MODIFY_RES_H_)
