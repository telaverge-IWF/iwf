...
#if !defined(_MAP_V2_FORWARDING_FEATURE_H_)
#define _MAP_V2_FORWARDING_FEATURE_H_
...
////////// End Nested Class(es) //////////
    ...
    ForwardingFeature() : its::AsnSequence(6, false)
    {
        Initialize();
    }

    ForwardingFeature(its::Octets& octets) : its::AsnSequence(6, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ForwardingFeature(its::AsnDescObject* description) : its::AsnSequence(6, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V2_FORWARDING_FEATURE_H_)
