...
#if !defined(_MAP_V9_LCS_PRIVACY_CLASS_H_)
#define _MAP_V9_LCS_PRIVACY_CLASS_H_
...
#include <map_v9_service_type_list.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v9::ExternalClientList ExternalClientList;


        typedef map_v9::PLMNClientList PLMNClientList;


        typedef map_v9::ExtensionContainer ExtensionContainer;


        typedef map_v9::Ext_ExternalClientList Ext_ExternalClientList;


        typedef map_v9::ServiceTypeList ServiceTypeList;
...
#endif    // !defined(_MAP_V9_LCS_PRIVACY_CLASS_H_)
