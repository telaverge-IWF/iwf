...
#if !defined(_MAP_V2_SS_INFO_H_)
#define _MAP_V2_SS_INFO_H_
...
#include <map_v2_forwarding_info.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v2::ForwardingInfo ForwardingInfo;


        typedef map_v2::CallBarringInfo CallBarringInfo;


        typedef map_v2::CUG_Info CUG_Info;


        typedef map_v2::SS_Data SS_Data;
...
#endif    // !defined(_MAP_V2_SS_INFO_H_)
