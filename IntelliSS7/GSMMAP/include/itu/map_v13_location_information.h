...
#if !defined(_MAP_V13_LOCATION_INFORMATION_H_)
#define _MAP_V13_LOCATION_INFORMATION_H_
...
#include <map_v13_location_number.h>
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v13::LocationNumber LocationNumber;
...
////////// End Nested Class(es) //////////
    ...
    LocationInformation() : its::AsnSequence(13, false)
    {
        Initialize();
    }

    LocationInformation(its::Octets& octets) : its::AsnSequence(13, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    LocationInformation(its::AsnDescObject* description) : its::AsnSequence(13, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    const LocationInformationEPS& GetLocationInformationEPS() const
    {
        ...
        return static_cast<const LocationInformationEPS&> (ElementAt(11));
    }
    ...
    const UserCSGInformation& GetUserCSGInformation() const
    {
        ...
        return static_cast<const UserCSGInformation&> (ElementAt(12));
    }
...
#endif    // !defined(_MAP_V13_LOCATION_INFORMATION_H_)
