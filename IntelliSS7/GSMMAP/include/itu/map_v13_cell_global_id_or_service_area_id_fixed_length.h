...
#if !defined(_MAP_V13_CELL_GLOBAL_ID_OR_SERVICE_AREA_ID_FIXED_LENGTH_H_)
#define _MAP_V13_CELL_GLOBAL_ID_OR_SERVICE_AREA_ID_FIXED_LENGTH_H_
...
#endif    // !defined(_MAP_V13_CELL_GLOBAL_ID_OR_SERVICE_AREA_ID_FIXED_LENGTH_H_)
