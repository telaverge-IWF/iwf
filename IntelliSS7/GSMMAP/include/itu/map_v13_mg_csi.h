...
#if !defined(_MAP_V13_MG_CSI_H_)
#define _MAP_V13_MG_CSI_H_
...
#include <map_v13_mobility_triggers.h>
...
class MG_CSI : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v13::MobilityTriggers MobilityTriggers;
...
////////// End Nested Class(es) //////////
    ...
    MG_CSI() : its::AsnSequence(6, false)
    {
        Initialize();
    }

    MG_CSI(its::Octets& octets) : its::AsnSequence(6, false)
    {
        Initialize();
        Decode(octets);
    }

    MG_CSI(const MG_CSI& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    MG_CSI(its::AsnDescObject* description) : its::AsnSequence(6, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V13_MG_CSI_H_)
