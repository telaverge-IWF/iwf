...
#if !defined(_MAP_V9_LOCATION_INFORMATION_GPRS_H_)
#define _MAP_V9_LOCATION_INFORMATION_GPRS_H_
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::RAIdentity RAIdentity;
...
////////// End Nested Class(es) //////////
    ...
    LocationInformationGPRS() : its::AsnSequence(10, false)
    {
        Initialize();
    }

    LocationInformationGPRS(its::Octets& octets) : its::AsnSequence(10, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    LocationInformationGPRS(its::AsnDescObject* description) : its::AsnSequence(10, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_LOCATION_INFORMATION_GPRS_H_)
