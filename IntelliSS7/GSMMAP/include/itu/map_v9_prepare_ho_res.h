...
#if !defined(_MAP_V9_PREPARE_HO_RES_H_)
#define _MAP_V9_PREPARE_HO_RES_H_
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef map_v9::RelocationNumberList RelocationNumberList;


        typedef map_v9::AccessNetworkSignalInfo AccessNetworkSignalInfo;


        typedef map_v9::MulticallBearerInfo MulticallBearerInfo;
...
////////// End Nested Class(es) //////////
    ...
    PrepareHO_Res() : its::AsnSequence(10, false)
    {
        Initialize();
    }

    PrepareHO_Res(its::Octets& octets) : its::AsnSequence(10, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    PrepareHO_Res(its::AsnDescObject* description) : its::AsnSequence(10, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V9_PREPARE_HO_RES_H_)
