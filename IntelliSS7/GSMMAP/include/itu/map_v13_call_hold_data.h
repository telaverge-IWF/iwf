...
#if !defined(_MAP_V13_CALL_HOLD_DATA_H_)
#define _MAP_V13_CALL_HOLD_DATA_H_
...
class CallHoldData : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    CallHoldData() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    CallHoldData(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    CallHoldData(const CallHoldData& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    CallHoldData(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_MAP_V13_CALL_HOLD_DATA_H_)
