...
#if !defined(_MAP_V13_READY_FOR_SM_ARG_H_)
#define _MAP_V13_READY_FOR_SM_ARG_H_
...
#include <map_v13_alert_reason.h>
...
////////// Begin Nested Class(es) //////////
    ...
    class AdditionalAlertReasonIndicator : public its::AsnNull
    {
    public:

        AdditionalAlertReasonIndicator() : its::AsnNull(false)
        {
            Initialize();
        }

        AdditionalAlertReasonIndicator(its::Octets& octets) : its::AsnNull(false)
        {
            Initialize();
            Decode(octets);
        }

        AdditionalAlertReasonIndicator(const AdditionalAlertReasonIndicator& rhs) : its::AsnNull(rhs)
        {
            // Nothing to do.
        }

        AdditionalAlertReasonIndicator(its::AsnDescObject* description) : its::AsnNull(description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        virtual ~AdditionalAlertReasonIndicator()
        {
            // Nothing to do.
        }
        ...
        virtual its::AsnObject* Clone() const
        {
            return new AdditionalAlertReasonIndicator(*this);
        }
        ...
        typedef map_v13::AlertReason AlertReason;
...
////////// End Nested Class(es) //////////
    ...
    ReadyForSM_Arg() : its::AsnSequence(5, false)
    {
        Initialize();
    }

    ReadyForSM_Arg(its::Octets& octets) : its::AsnSequence(5, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    ReadyForSM_Arg(its::AsnDescObject* description) : its::AsnSequence(5, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetAdditionalAlertReasonIndicatorStaticDescription();
...
public:
    ...
    void SetAdditionalAlertReasonIndicator(AdditionalAlertReasonIndicator* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetAdditionalAlertReasonIndicatorStaticDescription());
        AddElement(4, element);
    }

    void SetAdditionalAlertReasonIndicator(const AdditionalAlertReasonIndicator& element)
    {
        its::AsnObject& asnObject = const_cast<AdditionalAlertReasonIndicator&>(element);
        asnObject.SetDescription(GetAdditionalAlertReasonIndicatorStaticDescription());
        AddElement(4, element);
    }

    bool OptionAdditionalAlertReasonIndicator() const
    {
        return Contains(4);
    }

    const AdditionalAlertReasonIndicator& GetAdditionalAlertReasonIndicator() const
    {
        ITS_REQUIRE(OptionAdditionalAlertReasonIndicator());
        return static_cast<const AdditionalAlertReasonIndicator&> (ElementAt(4));
    }
...
#endif    // !defined(_MAP_V13_READY_FOR_SM_ARG_H_)
