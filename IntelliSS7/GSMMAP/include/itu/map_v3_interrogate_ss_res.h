...
#if !defined(_MAP_V3_INTERROGATE_SS_RES_H_)
#define _MAP_V3_INTERROGATE_SS_RES_H_
...
#include <map_v3_basic_service_group_list.h>
#include <map_v3_forwarding_feature_list.h>
#include <map_v3_generic_service_info.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef map_v3::BasicServiceGroupList BasicServiceGroupList;


        typedef map_v3::ForwardingFeatureList ForwardingFeatureList;


        typedef map_v3::GenericServiceInfo GenericServiceInfo;
...
#endif    // !defined(_MAP_V3_INTERROGATE_SS_RES_H_)
