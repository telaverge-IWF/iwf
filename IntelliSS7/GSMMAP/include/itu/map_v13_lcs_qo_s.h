...
#if !defined(_MAP_V13_LCS_QO_S_H_)
#define _MAP_V13_LCS_QO_S_H_
...
#include <map_v13_horizontal_accuracy.h>
#include <map_v13_vertical_accuracy.h>
#include <map_v13_response_time.h>
...
////////// Begin Nested Class(es) //////////
    ...
    class VelocityRequest : public its::AsnNull
    {
    public:

        VelocityRequest() : its::AsnNull(false)
        {
            Initialize();
        }

        VelocityRequest(its::Octets& octets) : its::AsnNull(false)
        {
            Initialize();
            Decode(octets);
        }

        VelocityRequest(const VelocityRequest& rhs) : its::AsnNull(rhs)
        {
            // Nothing to do.
        }

        VelocityRequest(its::AsnDescObject* description) : its::AsnNull(description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        virtual its::AsnObject* Clone() const
        {
            return new VelocityRequest(*this);
        }
        ...
        typedef map_v13::Horizontal_Accuracy Horizontal_Accuracy;


        typedef map_v13::Vertical_Accuracy Vertical_Accuracy;


        typedef map_v13::ResponseTime ResponseTime;
...
////////// End Nested Class(es) //////////
    ...
    LCS_QoS() : its::AsnSequence(6, false)
    {
        Initialize();
    }

    LCS_QoS(its::Octets& octets) : its::AsnSequence(6, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    LCS_QoS(its::AsnDescObject* description) : its::AsnSequence(6, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetVelocityRequestStaticDescription();
...
public:
    ...
    void SetVelocityRequest(VelocityRequest* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetVelocityRequestStaticDescription());
        AddElement(5, element);
    }

    void SetVelocityRequest(const VelocityRequest& element)
    {
        its::AsnObject& asnObject = const_cast<VelocityRequest&>(element);
        asnObject.SetDescription(GetVelocityRequestStaticDescription());
        AddElement(5, element);
    }

    bool OptionVelocityRequest() const
    {
        return Contains(5);
    }

    const VelocityRequest& GetVelocityRequest() const
    {
        ITS_REQUIRE(OptionVelocityRequest());
        return static_cast<const VelocityRequest&> (ElementAt(5));
    }
...
#endif    // !defined(_MAP_V13_LCS_QO_S_H_)
