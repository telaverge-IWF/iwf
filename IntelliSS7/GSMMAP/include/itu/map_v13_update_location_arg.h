...
#if !defined(_MAP_V13_UPDATE_LOCATION_ARG_H_)
#define _MAP_V13_UPDATE_LOCATION_ARG_H_
...
////////// End Nested Class(es) //////////
    ...
    UpdateLocationArg() : its::AsnSequence(13, false)
    {
        Initialize();
    }

    UpdateLocationArg(its::Octets& octets) : its::AsnSequence(13, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    UpdateLocationArg(its::AsnDescObject* description) : its::AsnSequence(13, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    const PagingArea& GetPagingArea() const
    {
        ...
        return static_cast<const PagingArea&> (ElementAt(10));
    }
    ...
    const RestorationIndicator& GetRestorationIndicator() const
    {
        ...
        return static_cast<const RestorationIndicator&> (ElementAt(12));
    }
...
#endif    // !defined(_MAP_V13_UPDATE_LOCATION_ARG_H_)
