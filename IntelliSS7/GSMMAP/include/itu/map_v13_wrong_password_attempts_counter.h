...
#if !defined(_MAP_V13_WRONG_PASSWORD_ATTEMPTS_COUNTER_H_)
#define _MAP_V13_WRONG_PASSWORD_ATTEMPTS_COUNTER_H_
...
#endif    // !defined(_MAP_V13_WRONG_PASSWORD_ATTEMPTS_COUNTER_H_)
