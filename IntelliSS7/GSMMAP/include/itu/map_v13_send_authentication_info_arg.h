...
#if !defined(_MAP_V13_SEND_AUTHENTICATION_INFO_ARG_H_)
#define _MAP_V13_SEND_AUTHENTICATION_INFO_ARG_H_
...
#include <map_v13_re_synchronisation_info.h>
...
////////// Begin Nested Class(es) //////////
    ...
    class AdditionalVectorsAreForEPS : public its::AsnNull
    {
    public:

        AdditionalVectorsAreForEPS() : its::AsnNull(false)
        {
            Initialize();
        }

        AdditionalVectorsAreForEPS(its::Octets& octets) : its::AsnNull(false)
        {
            Initialize();
            Decode(octets);
        }

        AdditionalVectorsAreForEPS(const AdditionalVectorsAreForEPS& rhs) : its::AsnNull(rhs)
        {
            // Nothing to do.
        }

        AdditionalVectorsAreForEPS(its::AsnDescObject* description) : its::AsnNull(description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        virtual ~AdditionalVectorsAreForEPS()
        {
            // Nothing to do.
        }
        ...
        virtual its::AsnObject* Clone() const
        {
            return new AdditionalVectorsAreForEPS(*this);
        }
        ...
        typedef map_v13::Re_synchronisationInfo Re_synchronisationInfo;


        typedef map_v13::ExtensionContainer ExtensionContainer;


        typedef map_v13::RequestingNodeType RequestingNodeType;
...
////////// End Nested Class(es) //////////
    ...
    SendAuthenticationInfoArg() : its::AsnSequence(10, false)
    {
        Initialize();
    }

    SendAuthenticationInfoArg(its::Octets& octets) : its::AsnSequence(10, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    SendAuthenticationInfoArg(its::AsnDescObject* description) : its::AsnSequence(10, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    static its::AsnDescObject* GetNumberOfRequestedAdditional_VectorsStaticDescription();
    static its::AsnDescObject* GetAdditionalVectorsAreForEPSStaticDescription();
...
public:
    ...
    void SetNumberOfRequestedAdditional_Vectors(NumberOfRequestedVectors* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetNumberOfRequestedAdditional_VectorsStaticDescription());
        AddElement(8, element);
    }

    void SetNumberOfRequestedAdditional_Vectors(const NumberOfRequestedVectors& element)
    {
        its::AsnObject& asnObject = const_cast<NumberOfRequestedVectors&>(element);
        asnObject.SetDescription(GetNumberOfRequestedAdditional_VectorsStaticDescription());
        AddElement(8, element);
    }

    bool OptionNumberOfRequestedAdditional_Vectors() const
    {
        return Contains(8);
    }

    const NumberOfRequestedVectors& GetNumberOfRequestedAdditional_Vectors() const
    {
        ITS_REQUIRE(OptionNumberOfRequestedAdditional_Vectors());
        return static_cast<const NumberOfRequestedVectors&> (ElementAt(8));
    }

    void SetAdditionalVectorsAreForEPS(AdditionalVectorsAreForEPS* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetAdditionalVectorsAreForEPSStaticDescription());
        AddElement(9, element);
    }

    void SetAdditionalVectorsAreForEPS(const AdditionalVectorsAreForEPS& element)
    {
        its::AsnObject& asnObject = const_cast<AdditionalVectorsAreForEPS&>(element);
        asnObject.SetDescription(GetAdditionalVectorsAreForEPSStaticDescription());
        AddElement(9, element);
    }

    bool OptionAdditionalVectorsAreForEPS() const
    {
        return Contains(9);
    }

    const AdditionalVectorsAreForEPS& GetAdditionalVectorsAreForEPS() const
    {
        ITS_REQUIRE(OptionAdditionalVectorsAreForEPS());
        return static_cast<const AdditionalVectorsAreForEPS&> (ElementAt(9));
    }
...
#endif    // !defined(_MAP_V13_SEND_AUTHENTICATION_INFO_ARG_H_)
