...
#if !defined(_MAP_V1_DEACTIVATE_SS_ARG_H_)
#define _MAP_V1_DEACTIVATE_SS_ARG_H_
...
class DeactivateSS_Arg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    DeactivateSS_Arg() : its::AsnSequence(2, false)
    {
        Initialize();
    }

    DeactivateSS_Arg(its::Octets& octets) : its::AsnSequence(2, false)
    {
        Initialize();
        Decode(octets);
    }

    DeactivateSS_Arg(const DeactivateSS_Arg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    DeactivateSS_Arg(its::AsnDescObject* description) : its::AsnSequence(2, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    {
        return new DeactivateSS_Arg(*this);
    }

    virtual std::string GetName() const
    { return "DeactivateSS_Arg"; }
...
#endif    // !defined(_MAP_V1_DEACTIVATE_SS_ARG_H_)
