 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.3  2005/03/21 13:50:21  cvsadmin
 ...
 * LOG:
 * LOG: Revision 7.2  2003/01/06 22:27:42  mmiers
 * LOG: Tandem port.
 * LOG:
 * LOG: Revision 7.1  2002/08/26 22:09:23  mmiers
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 6.3  2002/05/29 22:39:35  mmiers
 * LOG: Change signature
 * LOG:
 * LOG: Revision 6.2  2002/03/21 20:57:40  mmiers
 * LOG: Add CPC API for SCCP.  Let DSM have duplicate keys (albeit
 * LOG: under user management).
 * LOG:
...
SS7DLLAPI int  SCCP_GetSharedLocalRef_ANSI(void *ctxtData,
                                           int len);
...
SS7DLLAPI int SCCP_PPrint_ANSI(RINGBUF_Manager *rb, ITS_UINT *bCount,
                                ITS_OCTET mType,
 ...
 */
SS7DLLAPI int SCCP_SendUserInService_ANSI(ITS_HANDLE handle, ITS_OCTET ni,
                                          ITS_UINT pc, ITS_OCTET ssn);
SS7DLLAPI int SCCP_SendUserOutOfService_ANSI(ITS_HANDLE handle, ITS_OCTET ni,
                                             ITS_UINT pc, ITS_OCTET ssn);
SS7DLLAPI int SCCP_SendSetCongestion_ANSI(ITS_HANDLE handle, ITS_OCTET ni,
                                          ITS_UINT pc, ITS_OCTET ssn,
                                          ITS_OCTET cong);
 ...
 */
ITSSS7DLLAPI int SCCP_AddConcernedSubSystem_ANSI(ROUTE_Info *linfo,
                                                 ROUTE_Info *cinfo);
ITSSS7DLLAPI int SCCP_RemConcernedSubSystem_ANSI(ROUTE_Info *linfo,
                                                 ROUTE_Info *cinfo);
ITSSS7DLLAPI int SCCP_AddDuplicatedSubSystem_ANSI(ROUTE_Info *rinfo);
ITSSS7DLLAPI int SCCP_RemDuplicatedSubSystem_ANSI(ROUTE_Info *rinfo);
