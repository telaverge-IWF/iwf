 ...
 * LOG:
 * LOG: Revision 7.1.14.1  2004/09/21 06:50:23  mmanikandan
...
#define MTP2_GET_SPARE_ANSI(x) \
    ((x).len & 0xC0U)
#define MTP2_SET_SPARE_ANSI(x, v) \
...
SS7DLLAPI int MTP2_Decode_ANSI(ITS_EVENT *ev, MTP2_HEADER_ANSI* hdr,
                               ITS_OCTET* sif, ITS_USHORT* len);
SS7DLLAPI int MTP2_PPrint_ANSI(RINGBUF_Manager *rb, ITS_UINT *bCount,
                                MTP2_HEADER_ANSI *hdr);
#ifdef __cplusplus
}
#endif
