...
//////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: packetchanneldesc.h,v 1.1.2.1 2010/03/23 05:40:44 rajeshak Exp $
//
//  LOG:$Log: packetchanneldesc.h,v $
//  LOG:Revision 1.1.2.1  2010/03/23 05:40:44  rajeshak
//  LOG:Release-8 Codec changes.
//  LOG:
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: packetchanneldesc.h,v 1.1.2.1 2010/03/23 05:40:44 rajeshak Exp $"

#ifndef BSSLAP_IE_PACKET_CHANNEL_DESCRIPTION_H
#define BSSLAP_IE_PACKET_CHANNEL_DESCRIPTION_H
...
class PacketChannelDesc : public InfoElement
{
...
protected:
     ...
     */
    PacketChannelDesc(const ITS_OCTET* buf, int& len);
    ...
    Clone() const
    {
        return new PacketChannelDesc(*this);
    }
