...
//////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: pollingrepetition.h,v 1.1.2.1 2010/03/23 05:40:44 rajeshak Exp $
//
//  LOG:$Log: pollingrepetition.h,v $
//  LOG:Revision 1.1.2.1  2010/03/23 05:40:44  rajeshak
//  LOG:Release-8 Codec changes.
//  LOG:
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: pollingrepetition.h,v 1.1.2.1 2010/03/23 05:40:44 rajeshak Exp $"

#ifndef BSSLAP_IE_POLLING_REPETITION_H
#define BSSLAP_IE_POLLING_REPETITION_H
...
class PollingRepetition : public InfoElement
{
...
protected:
     ...
     */
    PollingRepetition(const ITS_OCTET* buf, int& len);
    ...
    Clone() const
    {
        return new PollingRepetition(*this);
    }
