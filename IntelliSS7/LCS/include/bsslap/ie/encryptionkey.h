...
//////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: encryptionkey.h,v 1.1.2.1 2010/03/23 05:39:43 rajeshak Exp $
//
//  LOG:$Log: encryptionkey.h,v $
//  LOG:Revision 1.1.2.1  2010/03/23 05:39:43  rajeshak
//  LOG:Release-8 Codec changes.
//  LOG:
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: encryptionkey.h,v 1.1.2.1 2010/03/23 05:39:43 rajeshak Exp $"

#ifndef BSSLAP_IE_ENCRYPTION_KEY_H
#define BSSLAP_IE_ENCRYPTION_KEY_H
...
class EncryptionKey : public InfoElement
{
...
protected:
     ...
     */
    EncryptionKey(const ITS_OCTET* buf, int& len);
