...
//////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: frequencylist.h,v 1.1.2.1 2009/12/22 10:41:42 rajeshak Exp $
//
//  LOG:$Log: frequencylist.h,v $
...
#ifndef BSSLAP_IE_FREQUENCYLIST_H
#define BSSLAP_IE_FREQUENCYLIST_H
...
class FrequencyList : public InfoElement
{
...
public :
    ...
    FrequencyList(ITS_OCTET lowId = 0xFFU,
...
protected :
     ...
     *
     */
    FrequencyList(const ITS_OCTET* buf, int& len);
