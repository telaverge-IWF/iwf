...
//////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: tfi.h,v 1.1.2.1 2010/03/23 05:41:53 rajeshak Exp $
//
//  LOG:$Log: tfi.h,v $
...
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: tfi.h,v 1.1.2.1 2010/03/23 05:41:53 rajeshak Exp $"

#ifndef BSSLAP_IE_TFI_H
#define BSSLAP_IE_TFI_H
...
public :
     ...
     * 
     */
    Tfi(ITS_OCTET value = 0)
    :InfoElement(TFI), tfiVal(value)
    {
    }

    void
    SetValue(ITS_OCTET value)
    {
        tfiVal = value;
    }
...
protected:
     ...
     */
    Tfi(const ITS_OCTET* buf, int& len);
