...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: releasecomplete.h,v 1.1.2.1 2009/12/22 10:41:42 rajeshak Exp $
//
//   LOG: $Log: releasecomplete.h,v $
...
class ReleaseComplete : public DTAPMessage
{
    /**
     *  Default constructor
     *
...
protected:
     ...
     *
     */
    ReleaseComplete(const ITS_OCTET *buf, int len);
...
private:
    ...
    ReleaseComplete &operator=(const ReleaseComplete&);
};
