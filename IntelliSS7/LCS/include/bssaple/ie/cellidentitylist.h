...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: cellidentitylist.h,v 1.1.2.3 2010/04/26 12:28:43 rajeshak Exp $
//
//  LOG: $Log: cellidentitylist.h,v $
//  LOG: Revision 1.1.2.3  2010/04/26 12:28:43  rajeshak
//  LOG: Fix for Issue 2676(Remove Set/Get API for 2 digit MNC)
//  LOG:
//  LOG: Revision 1.1.2.2  2010/04/21 06:30:56  rajeshak
...
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: cellidentitylist.h,v 1.1.2.3 2010/04/26 12:28:43 rajeshak Exp $"

#ifndef BSSAPLE_IE_CELLIDENTITY_LIST_H
#define BSSAPLE_IE_CELLIDENTITY_LIST_H 
...
public:
     ...
     *
     */
    void SetMNC(ITS_OCTET dig1,ITS_OCTET dig2,ITS_OCTET dig3)
    {
        mnc[0] &= ~0x0FU;
        mnc[0] |= dig1 & 0x0FU;
        mnc[0] &= ~0xF0U;
        ...
        mnc[1] = 0xF0; //all 1 1 1 1
        mnc[1] &= ~0x0FU;
        mnc[1] |= dig3 & 0x0FU;
    }

    /**
     *  Purpose: Get MNC 3 digits
     *
     *  Input Parameters:
     *
     *
     ...
     *
     */
    void GetMNC(ITS_OCTET &dig1,ITS_OCTET &dig2,ITS_OCTET &dig3) const
    {
        dig1 = mnc[0] & 0x0FU;
        dig2 = mnc[0] >> 4 & 0x0FU;
        dig3 = mnc[1] & 0x0FU;
...
public:
     ...
     */
    void AddCellId(CellIdDiscriminator cid)
    {
        cellVector.push_back(cid);
    }

    CellIdentityList()
    : InfoElement(CELL_IDENTITY_LIST, 0)
    {
    }
