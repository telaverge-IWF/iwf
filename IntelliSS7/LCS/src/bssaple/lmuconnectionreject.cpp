...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: lmuconnectionreject.cpp,v 1.1.2.1 2009/12/22 10:41:43 rajeshak Exp $
//
//  LOG: $Log: lmuconnectionreject.cpp,v $
...
ie::InfoElement::Type LMUConnectionReject::mandatory[] =
{
    ie::InfoElement::LMU_CAUSE
};

LMUConnectionReject::Checker LMUConnectionReject::checker(mandatory,0);

LMUConnectionReject::LMUConnectionReject(const ITS_OCTET *buf,int len)
:Message(LMU_CONNECTION_REJECT)
{
    try
    {
...
void LMUConnectionReject::CheckForMandatoryParams () const
{
    switch(LMUConnectionReject::checker.CheckParameters(ies))
    {
