...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: register.cpp,v 1.1.2.1 2009/12/22 10:41:43 rajeshak Exp $
//
//  LOG: $Log: register.cpp,v $
...
ie::InfoElement::Type Register::mandatory[]=
{
    ie::InfoElement::FACILITY
};

ie::InfoElement::Type Register::optional[]=
{
    ie::InfoElement::RELEASE_FORBIDDEN
};

Register::Checker Register::checker(mandatory,optional);

Register::Register(const ITS_OCTET* buf,int len)
:DTAPMessage(DTAPMessage::FACILITY)
{
    try
    {
        ...
        //buf[2] is Message ID;
        //Facility IE deost have Tag , add the Tag.
...
void Register::CheckForMandatoryParams () const
{
    switch(Register::checker.CheckParameters(ies))
    {
