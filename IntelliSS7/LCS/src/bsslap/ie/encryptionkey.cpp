...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: encryptionkey.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $
//
//  LOG: $Log: encryptionkey.cpp,v $
...
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: encryptionkey.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $"
...
EncryptionKey::EncryptionKey(const ITS_OCTET* buf, int& len)
:    InfoElement(ENCRYPTION_KEY)
{
    int ielen =0;
    if (len >= 8 * sizeof(ITS_OCTET))
    {
        ielen = 8;
    }
    else
 ...
 */
void 
EncryptionKey::Encode(ITS_OCTET* buf, int& len) const
{
...
void EncryptionKey:: Print(std::ostream& out) const
{
    out << "\tEncryptionKey " ;
    out << "\t[\n" ;
    out << "\t]\n" ;
