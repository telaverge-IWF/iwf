...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: frequencylistrel8.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $
//
//  LOG: $Log: frequencylistrel8.cpp,v $
...
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: frequencylistrel8.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $"
...
FrequencyListRel8::FrequencyListRel8(const ITS_OCTET* buf, int &len)
...
void FrequencyListRel8::DecodeBitMapFormat(const ITS_OCTET* buf, int& len)
{
...
void FrequencyListRel8::DecodeRange1024Format(const ITS_OCTET* buf, int& len)
{
    int index = 1023;
    int M = 10;
    int ielen = 1;
...
void FrequencyListRel8::RetreiveValueOfW (ITS_USHORT* W, 
...
ITS_USHORT FrequencyListRel8::GetCalculationOfW (int bits, 
                                       const ITS_OCTET* byte_offset, 
                                       int& bit_offset)
{
    ITS_USHORT  value;
...
void FrequencyListRel8::ComputeFrequency (int size,
                                      ITS_USHORT* W,
                                      int indicator )
{
...
void FrequencyListRel8::DecodeRange512Format(const ITS_OCTET* buf, int& len)
{
    int index = 512;
    int M = 9;
    int ielen = 1;
...
void FrequencyListRel8::DecodeRange256Format(const ITS_OCTET* buf, int& len)
{
    int index = 256;
    int M = 8;
    int ielen = 1;
...
void FrequencyListRel8::DecodeRange128Format(const ITS_OCTET* buf, int& len)
{
    int index = 128;
    int M = 7;
    int ielen = 1;
...
void FrequencyListRel8::DecodeVariableBitMapFormat(const ITS_OCTET* buf, int& len)
{
    ITS_USHORT orig_arfcn;
    int ielen = 1;
    orig_arfcn = ((((buf[1] << 8) | buf[2]) << 7) | (buf[3] >> 1)) >> 6;
...
void FrequencyListRel8::Encode(ITS_OCTET *buf, int& len) const
{
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    buf[0] = param_id;
...
void FrequencyListRel8::Print(std::ostream& out) const
{
