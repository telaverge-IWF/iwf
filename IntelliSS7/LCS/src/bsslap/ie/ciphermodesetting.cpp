...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: ciphermodesetting.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $
//
//  LOG: $Log: ciphermodesetting.cpp,v $
...
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: ciphermodesetting.cpp,v 1.1.2.2 2010/08/12 08:17:10 rajeshak Exp $"
...
CipherModeSetting::CipherModeSetting(const ITS_OCTET* buf, int& len)
 ...
 */
void 
CipherModeSetting::Encode(ITS_OCTET* buf, int& len) const
{
...
void CipherModeSetting:: Print(std::ostream& out) const
{
    out << "\tCipherModeSetting " ; 
    out << "\t[\n" ;
    out << "\t]\n" ;
}
