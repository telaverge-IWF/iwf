...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: timingadvance.cpp,v 1.1.2.5 2010/05/17 14:16:44 rajeshak Exp $
//
//  LOG: $Log: timingadvance.cpp,v $
//  LOG: Revision 1.1.2.5  2010/05/17 14:16:44  rajeshak
//  LOG: Fix for Issue Id-2822
//  LOG:
//  LOG: Revision 1.1.2.4  2010/05/10 13:05:03  rajeshak
//  LOG: Fix for Issue-ID: 2803, 2802, 2800, 2791
//  LOG:
//  LOG: Revision 1.1.2.3  2010/05/03 04:23:42  rajeshak
...
TimingAdvance::TimingAdvance(const ITS_OCTET* buf, int& len)
:    InfoElement(TIMING_ADVANCE)
{
    int ielen = 0;
    ...
    ITS_OCTET * tmpPtr = (ITS_OCTET*)buf-1;
    int j=0;
 ...
 */
void 
TimingAdvance::Encode(ITS_OCTET* buf, int& len) const
{
    len = 2 * sizeof(ITS_OCTET);

    buf[0] = param_id;
    buf[1] = timingAdvance & 0x3FU;
...
void TimingAdvance::Print(std::ostream& out) const
{
    out << "\tTimingAdvance ( 0x" << std::hex << (int)timingAdvance << " )\n"; 
}
