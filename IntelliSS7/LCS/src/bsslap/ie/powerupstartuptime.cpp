...
//////////////////////////////////////////////////////////////////////////////
//
//   ID: $Id: powerupstartuptime.cpp,v 1.1.2.1 2010/03/23 05:50:21 rajeshak Exp $
//
//  LOG: $Log: powerupstartuptime.cpp,v $
//  LOG: Revision 1.1.2.1  2010/03/23 05:50:21  rajeshak
//  LOG: Release-8 Codec changes.
//  LOG:
//
//////////////////////////////////////////////////////////////////////////////
#ident "$Id: powerupstartuptime.cpp,v 1.1.2.1 2010/03/23 05:50:21 rajeshak Exp $"
...
PowerupStartupTime::PowerupStartupTime(const ITS_OCTET* buf, int& len)
:InfoElement(POWERUP_STARTING_TIME)
{
    int ielen = 0;
 ...
 */
void 
PowerupStartupTime::Encode(ITS_OCTET* buf, int& len) const
{
...
void 
PowerupStartupTime::Print(std::ostream& out) const
{
    out << "\tPowerupStartupTime = {\n";
