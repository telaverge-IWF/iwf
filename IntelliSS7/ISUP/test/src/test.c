 ...
 ****************************************************************************
 *
 *  ID: $Id: test.c,v 9.1 2005/03/23 12:52:05 cvsadmin Exp $
 *
 * LOG: $Log: test.c,v $
 ...
 * LOG: Begin PR5
 * LOG:
 * LOG: Revision 1.3  2000/09/18 18:55:29  labuser
 * LOG: Don't send CGBA and CGUA automatically--have the user send the
 * LOG: messages
 * LOG:
 * LOG: Revision 1.2  2000/09/13 15:56:58  labuser
 * LOG: Send UBA only for ITU
 * LOG:
