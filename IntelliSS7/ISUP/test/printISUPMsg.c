 ...
 ****************************************************************************
 *
 *  ID: $Id: printISUPMsg.c,v 9.1 2005/03/23 12:52:02 cvsadmin Exp $
 *
 ...
 * LOG:
 * LOG: Revision 7.1.4.2.2.2  2003/10/21 06:31:31  akumar
 * LOG: To print Management Indications.
 * LOG:
 * LOG: Revision 7.1.4.2.2.1  2003/09/11 06:09:29  akumar
 * LOG: Modified to work for ANSI'92 Variant.
 * LOG:
 * LOG: Revision 7.1.4.2  2003/06/26 04:50:52  sjaddu
 * LOG: Print chnaged for bussiness group.
 * LOG:
 * LOG: Revision 7.1.4.1  2003/06/18 09:10:25  tsanthosh
...
/* ITU Specific Parameters */
        ...
        case ISUP_PRM_MGMTIND_DATA:
            PrintMgmtIndication(&ie[i]);
            break;
...

{
    ...
    case ISUP_MSG_STAT:
        printf("\nReceived PAUSE/RESUME/STATUS msg \n");
        recvResult = ISUP_ReceiveMgmtIndication(handle, event, &hdr,
                                                ies, &ieCount);
        break;
...
void
PrintMgmtIndication(const ITS_ISUP_IE *ie)
{
    printf("\n");
    printf("Mgmt Indication Data \n");
    printf("Parameter Id: 0x%02x \n", ie->param_id);
    printf("Length: %d octets \n", ie->param_length);
    printf("Mgmt Indication Id: 0x%04x \n", ie->param_data.indData.indId);
    printf("SIO: 0x%04x \n", ie->param_data.indData.sio);
    printf("CIC: 0x%04x \n", ie->param_data.indData.cic);
    printf("OPC: 0x%04x \n", ie->param_data.indData.opc);
    printf("DPC: 0x%04x \n", ie->param_data.indData.dpc);
