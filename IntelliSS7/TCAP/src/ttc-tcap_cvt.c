 ...
 ****************************************************************************
 *
 *  ID: $Id: ttc-tcap_cvt.c,v 9.2.52.1 2014/09/16 09:34:53 jsarvesh Exp $
 *
 * LOG: $Log: ttc-tcap_cvt.c,v $
 ...
 * LOG: Changes done for removing Warnings
 * LOG:
 * LOG: Revision 9.2  2008/06/24 07:26:08  ssingh
 * LOG: porting of Bug ID:1024 in support with fix for issue #1005/#1006
 * LOG:
 * LOG: Revision 9.1  2007/01/10 11:15:03  yranade
 * LOG: Merge changes from 6.5.3 and Lucent branches
 * LOG:
 * LOG: Revision 1.1.2.1  2006/12/23 09:46:19  randresol
...
#ident "$Id: ttc-tcap_cvt.c,v 9.2.52.1 2014/09/16 09:34:53 jsarvesh Exp $"
                     ...
                     ITS_BOOLEAN causeACName, ITS_BOOLEAN includePV)
{
    ...
    case TCPPT_TC_UNI:
        {
            struct type_TTC__TCAP__APDU_AUDT__apdu* audt;

            audt = (struct type_TTC__TCAP__APDU_AUDT__apdu *)
                calloc(1, sizeof(struct type_TTC__TCAP__APDU_AUDT__apdu));
            ...
            if (includePV)
            {
                int2strb(1 << bit_TTC__TCAP__APDU_protocol__version_version1,
                         1, buf, 8);
            ...
            if (uiLen)
            {
                ...
                if (decode_TTC__TCAP__APDU_UserInformation(ui, 1, NULL, NULL,
                                                     (char **)&audt->
                                                        user__information) ==
                    NOTOK)
                {
            ...
            if (encode_TTC__TCAP__APDU_AUDT__apdu(&dp->encoding->
            ...
            free_TTC__TCAP__APDU_AUDT__apdu(audt);
        }
    ...
    case TCPPT_TC_BEGIN:
        {
            struct type_TTC__TCAP__APDU_AARQ__apdu* aarq;

            aarq = (struct type_TTC__TCAP__APDU_AARQ__apdu *)
                calloc(1, sizeof(struct type_TTC__TCAP__APDU_AARQ__apdu));
            ...
            if (encode_TTC__TCAP__APDU_AARQ__apdu(&dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char *)aarq) == NOTOK)
            {
            ...
            free_TTC__TCAP__APDU_AARQ__apdu(aarq);
        }
    ...
    case TCPPT_TC_END:
        {
            struct type_TTC__TCAP__APDU_AARE__apdu* aare;

            aare = (struct type_TTC__TCAP__APDU_AARE__apdu *)
                calloc(1, sizeof(struct type_TTC__TCAP__APDU_AARE__apdu));
            ...
            /* result */
            aare->result = (struct type_TTC__TCAP__APDU_Associate__result *)
                calloc(1,
                       sizeof(struct type_TTC__TCAP__APDU_Associate__result));
            if (aare->result == NULL)
            {
            ...
            {
                aare->result->parm =
                    int_TTC__TCAP__APDU_Associate__result_accepted;
            }
            else
            {
                aare->result->parm =
                    int_TTC__TCAP__APDU_Associate__result_reject__permanent;
            }

            /* result source diagnostic */
            aare->result__source__diagnostic =
                (struct type_TTC__TCAP__APDU_Associate__source__diagnostic *)
                    calloc(1, sizeof(struct type_TTC__TCAP__APDU_Associate__source__diagnostic));
            ...
            if (fromUser)
            {
                aare->result__source__diagnostic->offset =
                    type_TTC__TCAP__APDU_Associate__source__diagnostic_dialogue__service__user;

                if (!causeACName)
                {
                    aare->result__source__diagnostic->un.dialogue__service__user =
                        int_TTC__TCAP__APDU_dialogue__service__user_null;
                }
                else
                {
                    aare->result__source__diagnostic->
                        un.dialogue__service__user =
                            int_TTC__TCAP__APDU_dialogue__service__user_application__context__name__not__supported;
                }
            }
            else
            {
                aare->result__source__diagnostic->offset =
                    type_TTC__TCAP__APDU_Associate__source__diagnostic_dialogue__service__provider;

                if (accept)
                {
                    aare->result__source__diagnostic->
                        un.dialogue__service__provider =
                            int_TTC__TCAP__APDU_dialogue__service__provider_null;
                }
                else
                {
                    aare->result__source__diagnostic->
                        un.dialogue__service__provider =
                            int_TTC__TCAP__APDU_dialogue__service__provider_no__common__dialogue__portion;
                }
            }
            ...
            if (encode_TTC__TCAP__APDU_AARE__apdu(&dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char *)aare) == NOTOK)
            {
            ...
            free_TTC__TCAP__APDU_AARE__apdu(aare);
        }
    ...
    case TCPPT_TC_U_ABORT:
        {
            struct type_TTC__TCAP__APDU_ABRT__apdu* abrt;

            abrt = (struct type_TTC__TCAP__APDU_ABRT__apdu *)
                calloc(1, sizeof(struct type_TTC__TCAP__APDU_ABRT__apdu));
            ...
            /* abort source */
            abrt->abort__source = (struct type_TTC__TCAP__APDU_ABRT__source *)
                calloc(1, sizeof(struct type_TTC__TCAP__APDU_ABRT__source));
            ...
            if (fromUser)
            {
                abrt->abort__source->parm =
                    int_TTC__TCAP__APDU_ABRT__source_dialogue__service__user;
            }
            else
            {
                abrt->abort__source->parm =
                    int_TTC__TCAP__APDU_ABRT__source_dialogue__service__provider;
            }
            ...
            if (encode_TTC__TCAP__APDU_ABRT__apdu(&dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char *)abrt) == NOTOK)
            {
            ...
            free_TTC__TCAP__APDU_ABRT__apdu(abrt);
        }
    ...
    case TCPPT_TC_UNI:
        {
            ...
            if (decode_TTC__TCAP__APDU_AUDT__apdu(dp->encoding->
                                                      un.single__ASN1__type,
                                                      1, 0, NULL,
                                                      (char **)&audt) == NOTOK)
            {
            ...
            {
                if (encode_TTC__TCAP__APDU_UserInformation(&ui, 1, 0, NULL,
    ...
    case TCPPT_TC_BEGIN:
        {
            ...
            if (decode_TTC__TCAP__APDU_AARQ__apdu(dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char **)&aarq) == NOTOK)
            {
    ...
    case TCPPT_TC_END:
        {
            ...
            if (decode_TTC__TCAP__APDU_AARE__apdu(dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char **)&aare) == NOTOK)
            {
    ...
    case TCPPT_TC_U_ABORT:
        {
            ...
            if (decode_TTC__TCAP__APDU_ABRT__apdu(dp->encoding->
                                                      un.single__ASN1__type,
                                                  1, 0, NULL,
                                                  (char **)&abrt) == NOTOK)
            {
...
{
    struct type_TTC__TCAP_ComponentPDU *ret;
    int i;

    /* allocate the component */
    ret = (struct type_TTC__TCAP_ComponentPDU *)
         calloc(1, sizeof(struct type_TTC__TCAP_ComponentPDU));
    if (ret == NULL)
    {
        return ret;
    }
    ...
    case TCPPT_TC_INVOKE:
        ret->offset = type_TTC__TCAP_ComponentPDU_invoke;

        /* allocate the invoke */
        ret->un.invoke = (struct type_TTC__TCAP_Invoke *)
            calloc(1, sizeof(struct type_TTC__TCAP_Invoke));
        if (ret == NULL)
        {
            free(ret);
        ...
        ret->un.invoke->invokeID = (struct type_TTC__TCAP_InvokeIdType *)
            calloc(1, sizeof(struct type_TTC__TCAP_InvokeIdType));
        if (ret == NULL)
        {
            free(ret->un.invoke);
            free(ret);
        ...
        if (cpt->u.invoke.linked_id.len != 0)
        {
            ...
            ret->un.invoke->linkedID = (struct type_TTC__TCAP_InvokeIdType *)
                calloc(1, sizeof(struct type_TTC__TCAP_InvokeIdType));
            if (ret == NULL)
            {
        ...
        ret->un.invoke->operationCode =
            (struct type_TTC__TCAP_Operation *)
            calloc(1, sizeof(struct type_TTC__TCAP_Operation));
        if (ret == NULL)
        {
            free(ret->un.invoke->invokeID);
            ...
            TCPPN_LOCAL_OP_TAG)
        {
            ret->un.invoke->operationCode->offset =
                type_TTC__TCAP_Operation_localCode;
                 ...
                 TCPPN_GLOBAL_OP_TAG)
        {
            ...
            ret->un.invoke->operationCode->offset =
                type_TTC__TCAP_Operation_globalCode;
    ...
    case TCPPT_TC_RESULT_L:
        ret->offset = type_TTC__TCAP_ComponentPDU_returnResultLast;
        goto skipit;

    case TCPPT_TC_RESULT_NL:
        ret->offset = type_TTC__TCAP_ComponentPDU_returnResultNotLast;

skipit:
        ret->un.returnResultLast = (struct type_TTC__TCAP_ReturnResult *)
            calloc(1, sizeof(struct type_TTC__TCAP_ReturnResult));
        ...
        /* allocate the invokeID */
        ret->un.returnResultLast->invokeID = (struct type_TTC__TCAP_InvokeIdType *)
            calloc(1, sizeof(struct type_TTC__TCAP_InvokeIdType));
        if (ret == NULL)
        {
        ...
        {
            ret->un.returnResultLast->result = (struct element_TTC__TCAP_0 *)
                calloc(1, sizeof(struct element_TTC__TCAP_0));
    ...
    case TCPPT_TC_U_ERROR:
        ret->offset = type_TTC__TCAP_ComponentPDU_returnError;

        ret->un.returnError = (struct type_TTC__TCAP_ReturnError *)
            calloc(1, sizeof(struct type_TTC__TCAP_ReturnError));
        ...
        ret->un.returnError->invokeID =
            (struct type_TTC__TCAP_InvokeIdType *)
                calloc(1, sizeof(struct type_TTC__TCAP_InvokeIdType));
        ...
        ret->un.returnError->errorCode =
            (struct type_TTC__TCAP_Error *)
                calloc(1, sizeof(struct type_TTC__TCAP_Error));
        if (ret == NULL)
        {
                 ...
                 TCPPN_LOCAL_ERR_TAG)
        {
            ret->un.returnError->errorCode->offset =
                type_TTC__TCAP_Error_localCode;
            for (i = 0;
                 ...
                 TCPPN_GLOBAL_OP_TAG)
        {
            ...
            ret->un.returnError->errorCode->offset =
                type_TTC__TCAP_Error_globalCode;
    ...
    case TCPPT_TC_U_REJECT:
        ret->offset = type_TTC__TCAP_ComponentPDU_reject;

        ret->un.reject = (struct type_TTC__TCAP_Reject *)
            calloc(1, sizeof(struct type_TTC__TCAP_Reject));
        ...
        ret->un.reject->invokeID = (struct choice_TTC__TCAP_0 *)
            calloc(1, sizeof(struct choice_TTC__TCAP_0));
        ...
        {
            ret->un.reject->invokeID->offset = choice_TTC__TCAP_0_derivable;
        ...
        else
        {
            ret->un.reject->invokeID->offset =
                choice_TTC__TCAP_0_not__derivable;
        }

        /* allocate the problem */
        ret->un.reject->problem =
            (struct choice_TTC__TCAP_1 *)
                calloc(1, sizeof(struct choice_TTC__TCAP_1));
        if (ret == NULL)
        {
            free(ret->un.reject->invokeID);
            free(ret->un.reject);
        ...
        case TCPPROB_GENERAL:
            ret->un.reject->problem->un.generalProblem =
                (struct type_TTC__TCAP_GeneralProblem *)
                    calloc(1, sizeof(struct type_TTC__TCAP_GeneralProblem));
            ...
            ret->un.reject->problem->offset = choice_TTC__TCAP_1_generalProblem;
            /*
        ...
        case TCPPROB_INVOKE:
            ret->un.reject->problem->un.invokeProblem =
                (struct type_TTC__TCAP_InvokeProblem *)
                    calloc(1, sizeof(struct type_TTC__TCAP_InvokeProblem));
            ...
            ret->un.reject->problem->offset = choice_TTC__TCAP_1_invokeProblem;
            /*
             * hack to indicate source is local.  Note that this must not be
             * set if this component is to be encoded by the ASN runtime
             * (valid only for our stack).
        ...
        case TCPPROB_RETURN_RES:
            ret->un.reject->problem->un.returnResultProblem =
                (struct type_TTC__TCAP_ReturnResultProblem *)
                    calloc(1, sizeof(struct type_TTC__TCAP_ReturnResultProblem));
            ...
            ret->un.reject->problem->offset = choice_TTC__TCAP_1_returnResultProblem;
            /*
             * hack to indicate source is local.  Note that this must not be
             * set if this component is to be encoded by the ASN runtime
             * (valid only for our stack).
        ...
        case TCPPROB_RETURN_ERR:
            ret->un.reject->problem->un.returnErrorProblem =
                (struct type_TTC__TCAP_ReturnErrorProblem *)
                    calloc(1, sizeof(struct type_TTC__TCAP_ReturnErrorProblem));
            ...
            ret->un.reject->problem->offset = choice_TTC__TCAP_1_returnErrorProblem;
            /*
             * hack to indicate source is local.  Note that this must not be
             * set if this component is to be encoded by the ASN runtime
             * (valid only for our stack).
                           ...
                           int variant)
{
    ...
    case TCPPT_TC_BEGIN:
        ...
        ret->un.begin->otid =
            (struct type_TTC__TCAP_OrigTransactionID *)
                calloc(1, sizeof(struct type_TTC__TCAP_OrigTransactionID) + 8);
    ...
    case TCPPT_TC_CONTINUE:
        ...
        /* build the transactionID */
        ret->un.contin->dtid =
            (struct type_TTC__TCAP_DestTransactionID *)
                calloc(1, sizeof(struct type_TTC__TCAP_DestTransactionID) + 8);
    ...
    case TCPPT_TC_P_ABORT:
        ...
        if (dlg->ptype == TCPPT_TC_P_ABORT)
        {
            ...
            ret->un.abort->reason->offset = choice_TTC__TCAP_2_p__abort__cause;

            ret->un.abort->reason->un.p__abort__cause =
                (struct type_TTC__TCAP_P__AbortCause *)
                    calloc(1, sizeof(struct type_TTC__TCAP_P__AbortCause));
        ...
        else /* U-ABORT */
        {
            ...
            ret->un.abort->reason->offset = choice_TTC__TCAP_2_dialoguePortion;
...
{
    struct type_TTC__TCAP_InvokeIdType *cid;
    char *tmp;
    int len;
    PE param;
    ...
    switch (comp->offset)
    {
    case type_TTC__TCAP_ComponentPDU_invoke:
        /* set the ptype */
    ...
    case type_TTC__TCAP_ComponentPDU_returnResultLast:
        /* set the ptype */
        cpt->ptype = TCPPT_TC_RESULT_L;
        goto skipit;

    case type_TTC__TCAP_ComponentPDU_returnResultNotLast:
        /* set the ptype */
...
skipit:
    ...
    case type_TTC__TCAP_ComponentPDU_returnError:
        /* set the ptype */
    ...
    case type_TTC__TCAP_ComponentPDU_reject:
        /* set the ptype */
        ...
        if (comp->un.reject->problem != NULL)
        {
            ...
            {
            default:
            case choice_TTC__TCAP_1_generalProblem:
            ...
            case choice_TTC__TCAP_1_invokeProblem:
            ...
            case choice_TTC__TCAP_1_returnResultProblem:
            ...
            case choice_TTC__TCAP_1_returnErrorProblem:
    ...
    case type_TTC__TCAP_MessageType_abort:
        ...
        if (dialog->un.abort->reason != NULL)
        {
            if (dialog->un.abort->reason->offset ==
                choice_TTC__TCAP_2_p__abort__cause)
            {
                dlg->u.abort.abort_reason =
