 ...
 ****************************************************************************
 *
 *  ID: $Id: test.cpp,v 9.1 2005/03/23 12:52:40 cvsadmin Exp $
 *
 * LOG: $Log: test.cpp,v $
 ...
 * LOG: Start PR6.
 * LOG:
 * LOG: Revision 4.2  2001/07/13 15:12:30  mmiers
 * LOG: some bugs Hubert noticed, snapshot before digging into diff.
 * LOG:
 * LOG: Revision 4.1  2001/05/01 00:53:12  mmiers
 * LOG: Begin PR5
 * LOG:
 * LOG: Revision 3.7  2000/09/02 01:39:30  mmiers
 * LOG: Use default value for MAKE, update tests.
 * LOG:
 * LOG: Revision 3.6  2000/09/01 23:31:37  lbana
 * LOG:
 * LOG:
 * LOG: Tracking down bugs.
 * LOG:
 * LOG: Revision 3.5  2000/09/01 20:56:29  mmiers
 * LOG: Debugging zero copy.
 * LOG:
 * LOG: Revision 3.4  2000/08/31 19:18:38  lbana
 * LOG: Something foul here.
 * LOG:
 * LOG: Revision 3.3  2000/08/24 23:06:33  mmiers
 * LOG:
 * LOG: Zero copy is in.  So is FASTCALL.  Also a bug fix to core.
 * LOG:
 * LOG: Revision 3.2  2000/08/22 18:53:27  mmiers
...
repeat:
        ...
        {
            TCAP_Component::Receive((ITS_HANDLE)trin->GetTransport(), ev, &end, &cpt);
...
#error "Protocol family not defined."
        ...
        TCAP_Component::Send((ITS_HANDLE)trin->GetTransport(), &end, &inv);
        TCAP_Dialogue::Send((ITS_HANDLE)trin->GetTransport(), &end);
    }
}
...
main(int argc, char **argv)
{
    ...
    try
    {
        ...
        trout = new ITS_Worker(0, "User 2", ITS_DEFAULT_USER_SRC+1,
                               ITS_TCAP|ITS_TRANSPORT_CSOCKET|
