...
# PROP BASE Output_Dir "test4___"
# PROP BASE Intermediate_Dir "test4___"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../include" /I "$(ITS_ROOT)/SCCP/include" /I "$(ITS_ROOT)/MTP3/include" /I "$(ITS_ROOT)/common/include" /I "$(ITS_ROOT)/tools/include" /I "../../MTP2/include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "ANSI" /YX /FD /c
