...
#include <cap_v2_camel_sci_billing_charging_characteristics.h>
...
AsnDescObject* CAMEL_SCIBillingChargingCharacteristics::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GetAOCBeforeAnswerStaticDescription());
        staticDesc._choiceList.push_back(GetAOCAfterAnswerStaticDescription());
