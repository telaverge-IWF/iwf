...
// Type ChargingResult is a reference => no code generated.

// Type QualityOfService is a reference => no code generated.


AsnDescObject* ApplyChargingReportGPRSArg::Active::GetStaticDescription()
{
...
AsnDescObject* ApplyChargingReportGPRSArg::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ApplyChargingReportGPRSArg(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_UNIVERSAL, Tag::ASN_CONSTRUCTED, 16));
        staticDesc._elementVect[0] = GetGPRS_ReferenceNumberStaticDescription();
        staticDesc._elementVect[1] = GetChargingResultStaticDescription();
        staticDesc._elementVect[2] = GetQualityOfServiceStaticDescription();
        staticDesc._elementVect[3] = GetActiveStaticDescription();
        staticDesc._elementVect[4] = GetPDPIDStaticDescription();
        staticDesc.SetTypeName("ApplyChargingReportGPRSArg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ApplyChargingReportGPRSArg::GetGPRS_ReferenceNumberStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ApplyChargingReportGPRSArg::GetChargingResultStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(ChargingResult::GetTransferredVolumeStaticDescription());
        staticDesc._choiceList.push_back(ChargingResult::GetElapsedTimeStaticDescription());
        staticDesc.SetNamedTypeName("chargingResult");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ApplyChargingReportGPRSArg::GetQualityOfServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ApplyChargingReportGPRSArg::GetActiveStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescBoolean staticDesc;
...
AsnDescObject* ApplyChargingReportGPRSArg::GetPDPIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
