...
AsnDescObject* LegID::GetStaticDescription()
{
...
AsnDescObject* LegID::GetSendingSideIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* LegID::GetReceivingSideIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
