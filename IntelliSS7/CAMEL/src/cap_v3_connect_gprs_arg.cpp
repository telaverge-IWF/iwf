...
AsnDescObject* ConnectGPRSArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ConnectGPRSArg(&staticDesc));
        ...
        staticDesc.SetTypeName("ConnectGPRSArg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ConnectGPRSArg::GetAccessPointNameStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ConnectGPRSArg::GetPdpIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
