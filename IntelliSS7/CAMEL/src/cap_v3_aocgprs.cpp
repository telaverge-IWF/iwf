...
AsnDescObject* AOCGPRS::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("AOCGPRS");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* AOCGPRS::GetAOCInitialStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* AOCGPRS::GetAOCSubsequentStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
