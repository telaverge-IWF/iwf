...
// Type CellIdOrLAI is a reference => no code generated.
...
AsnDescObject* LocationInformation::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[4] = GetCellIdOrLAIStaticDescription();
...
AsnDescObject* LocationInformation::GetCellIdOrLAIStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc._choiceList.push_back(CellIdOrLAI::GetCellIdFixedLengthStaticDescription());
        staticDesc._choiceList.push_back(CellIdOrLAI::GetLaiFixedLengthStaticDescription());
        staticDesc.SetNamedTypeName("cellIdOrLAI");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
