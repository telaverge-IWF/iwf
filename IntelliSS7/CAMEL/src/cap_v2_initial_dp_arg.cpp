...
AsnDescObject* InitialDPArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[4] = GetIPSSPCapabilitiesStaticDescription();
        staticDesc._elementVect[5] = GetLocationNumberStaticDescription();
        ...
        staticDesc._elementVect[8] = GetHighLayerCompatibilityStaticDescription();
        staticDesc._elementVect[9] = GetAdditionalCallingPartyNumberStaticDescription();
        staticDesc._elementVect[10] = GetBearerCapabilityStaticDescription();
        staticDesc._elementVect[11] = GetEventTypeBCSMStaticDescription();
        staticDesc._elementVect[12] = GetRedirectingPartyIDStaticDescription();
        staticDesc._elementVect[13] = GetRedirectionInformationStaticDescription();
        staticDesc._elementVect[14] = GetIMSIStaticDescription();
        staticDesc._elementVect[15] = GetSubscriberStateStaticDescription();
        staticDesc._elementVect[16] = GetLocationInformationStaticDescription();
        staticDesc._elementVect[17] = GetExt_basicServiceCodeStaticDescription();
        staticDesc._elementVect[18] = GetCallReferenceNumberStaticDescription();
        staticDesc._elementVect[19] = GetMscAddressStaticDescription();
        staticDesc._elementVect[20] = GetCalledPartyBCDNumberStaticDescription();
        staticDesc._elementVect[21] = GetTimeAndTimezoneStaticDescription();
        staticDesc._elementVect[22] = GetGsm_ForwardingPendingStaticDescription();
        staticDesc._elementVect[23] = GetInitialDPArgExtensionStaticDescription();
...
AsnDescObject* InitialDPArg::GetInitialDPArgExtensionStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._clauseOptional = true;
        staticDesc._clauseExtensible = true;
        staticDesc._elementVect[0] = InitialDPArgExtension::GetNaCarrierInformationStaticDescription();
        staticDesc._elementVect[1] = InitialDPArgExtension::GetGmscAddressStaticDescription();
