...
#include <cap_v3_basic_gap_criteria.h>
...
AsnDescObject* BasicGapCriteria::CalledAddressAndService::GetStaticDescription()
{
...
AsnDescObject* BasicGapCriteria::CalledAddressAndService::GetCalledAddressValueStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* BasicGapCriteria::CalledAddressAndService::GetServiceKeyStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* BasicGapCriteria::CallingAddressAndService::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
...
AsnDescObject* BasicGapCriteria::CallingAddressAndService::GetCallingAddressValueStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* BasicGapCriteria::CallingAddressAndService::GetServiceKeyStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescInteger staticDesc;
...
AsnDescObject* BasicGapCriteria::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new BasicGapCriteria(&staticDesc));
        ...
        staticDesc.SetTypeName("BasicGapCriteria");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* BasicGapCriteria::GetCalledAddressValueStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* BasicGapCriteria::GetGapOnServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* BasicGapCriteria::GetCalledAddressAndServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
...
AsnDescObject* BasicGapCriteria::GetCallingAddressAndServiceStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequence staticDesc(2);
