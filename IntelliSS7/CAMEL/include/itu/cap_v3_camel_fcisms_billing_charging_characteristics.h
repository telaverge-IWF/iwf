...
#if !defined(_CAP_V3_CAMEL_FCISMS_BILLING_CHARGING_CHARACTERISTICS_H_)
#define _CAP_V3_CAMEL_FCISMS_BILLING_CHARGING_CHARACTERISTICS_H_
...
class CAMEL_FCISMSBillingChargingCharacteristics : public its::AsnChoice
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    ////////// End Nested Class(es) //////////
        ...
        FCIBCCCAMELsequence1() : its::AsnSequence(2, false)
        {
            Initialize();
        }

        FCIBCCCAMELsequence1(its::Octets& octets) : its::AsnSequence(2, false)
        {
            Initialize();
            Decode(octets);
        }
        ...
        FCIBCCCAMELsequence1(its::AsnDescObject* description) : its::AsnSequence(2, description)
        {
            // Nothing to do.
        }
    ...
    public:
        ...
        {
            return static_cast<const AppendFreeFormatData&> (ElementAt(1));
        }
...
////////// End Nested Class(es) //////////
    ...
    CAMEL_FCISMSBillingChargingCharacteristics() : its::AsnChoice(false)
    {
        Initialize();
    }

    CAMEL_FCISMSBillingChargingCharacteristics(its::Octets& octets) : its::AsnChoice(false)
    {
        Initialize();
        Decode(octets);
    }

    CAMEL_FCISMSBillingChargingCharacteristics(const CAMEL_FCISMSBillingChargingCharacteristics& rhs) : its::AsnChoice(rhs)
    {
        // Nothing to do.
    }

    CAMEL_FCISMSBillingChargingCharacteristics(its::AsnDescObject* description) : its::AsnChoice(description)
    {
        // Nothing to do.
    }

    CAMEL_FCISMSBillingChargingCharacteristics(its::AsnDescObject* description, its::AsnObject* choice) : its::AsnChoice(description, choice)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~CAMEL_FCISMSBillingChargingCharacteristics()
    {
        // Nothing to do.
    }
    ...
    virtual its::AsnObject* Clone() const
    {
        return new CAMEL_FCISMSBillingChargingCharacteristics(*this);
    }

    virtual std::string GetName() const
    { return "CAMEL_FCISMSBillingChargingCharacteristics"; }
...
#endif    // !defined(_CAP_V3_CAMEL_FCISMS_BILLING_CHARGING_CHARACTERISTICS_H_)
