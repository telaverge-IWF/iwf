...
#if !defined(_CAP_V2_BOTHWAY_THROUGH_CONNECTION_IND_H_)
#define _CAP_V2_BOTHWAY_THROUGH_CONNECTION_IND_H_
...
#endif    // !defined(_CAP_V2_BOTHWAY_THROUGH_CONNECTION_IND_H_)
