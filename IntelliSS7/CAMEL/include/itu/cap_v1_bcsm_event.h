...
#if !defined(_CAP_V1_BCSM_EVENT_H_)
#define _CAP_V1_BCSM_EVENT_H_
...
#include <cap_v1_monitor_mode.h>
#include <cap_v1_leg_id.h>
...
////////// Begin Nested Class(es) //////////
        ...
        typedef cap_v1::MonitorMode MonitorMode;


        typedef cap_v1::LegID LegID;


////////// End Nested Class(es) //////////

    BCSMEvent() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    BCSMEvent(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    BCSMEvent(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_CAP_V1_BCSM_EVENT_H_)
