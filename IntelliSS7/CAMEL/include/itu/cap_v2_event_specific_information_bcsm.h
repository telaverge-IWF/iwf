...
#if !defined(_CAP_V2_EVENT_SPECIFIC_INFORMATION_BCSM_H_)
#define _CAP_V2_EVENT_SPECIFIC_INFORMATION_BCSM_H_
...
////////// Begin Nested Class(es) //////////
    ...
    ////////// End Nested Class(es) //////////
        ...
        OAnswerSpecificInfo() : its::AsnSequence(0, false)
        {
            Initialize();
        }

        OAnswerSpecificInfo(its::Octets& octets) : its::AsnSequence(0, false)
        {
            Initialize();
            Decode(octets);
        }
        ...
        OAnswerSpecificInfo(its::AsnDescObject* description) : its::AsnSequence(0, description)
        {
            // Nothing to do.
        }
    ...
    ////////// End Nested Class(es) //////////
        ...
        TBusySpecificInfo() : its::AsnSequence(2, false)
        {
            Initialize();
        }

        TBusySpecificInfo(its::Octets& octets) : its::AsnSequence(2, false)
        {
            Initialize();
            Decode(octets);
        }
        ...
        TBusySpecificInfo(its::AsnDescObject* description) : its::AsnSequence(2, description)
        {
            // Nothing to do.
        }
...
#endif    // !defined(_CAP_V2_EVENT_SPECIFIC_INFORMATION_BCSM_H_)
