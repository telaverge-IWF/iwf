...
#if !defined(_CAP_V2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_)
#define _CAP_V2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_
...
#endif    // !defined(_CAP_V2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_)
