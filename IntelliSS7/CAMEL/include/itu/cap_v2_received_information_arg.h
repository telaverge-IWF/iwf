...
#if !defined(_CAP_V2_RECEIVED_INFORMATION_ARG_H_)
#define _CAP_V2_RECEIVED_INFORMATION_ARG_H_
...
#endif    // !defined(_CAP_V2_RECEIVED_INFORMATION_ARG_H_)
