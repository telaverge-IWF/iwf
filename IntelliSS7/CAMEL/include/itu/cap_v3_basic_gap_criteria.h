...
#if !defined(_CAP_V3_BASIC_GAP_CRITERIA_H_)
#define _CAP_V3_BASIC_GAP_CRITERIA_H_
...
class BasicGapCriteria : public its::AsnChoice
{
public:
...
////////// End Nested Class(es) //////////
    ...
    BasicGapCriteria() : its::AsnChoice(false)
    {
        Initialize();
    }

    BasicGapCriteria(its::Octets& octets) : its::AsnChoice(false)
    {
        Initialize();
        Decode(octets);
    }

    BasicGapCriteria(const BasicGapCriteria& rhs) : its::AsnChoice(rhs)
    {
        // Nothing to do.
    }

    BasicGapCriteria(its::AsnDescObject* description) : its::AsnChoice(description)
    {
        // Nothing to do.
    }

    BasicGapCriteria(its::AsnDescObject* description, its::AsnObject* choice) : its::AsnChoice(description, choice)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new BasicGapCriteria(*this);
    }
...
#endif    // !defined(_CAP_V3_BASIC_GAP_CRITERIA_H_)
