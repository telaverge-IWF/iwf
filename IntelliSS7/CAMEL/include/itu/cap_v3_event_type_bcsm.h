...
#if !defined(_CAP_V3_EVENT_TYPE_BCSM_H_)
#define _CAP_V3_EVENT_TYPE_BCSM_H_
...
public:
    ...
    enum {
        ...
        EVENT_TYPE_BCSM_ANALYZED_INFORMATION = 3,
    ...
    void SetAnalyzedInformation()
    { _value = 3; }

    bool IsAnalyzedInformation() const
    { return _value == 3; }
...
#endif    // !defined(_CAP_V3_EVENT_TYPE_BCSM_H_)
