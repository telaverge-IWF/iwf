...
#if !defined(_CAP_V2_CAMEL_CALL_RESULT_H_)
#define _CAP_V2_CAMEL_CALL_RESULT_H_
...
////////// Begin Nested Class(es) //////////
    ...
    ////////// Begin Nested Class(es) //////////
        ...
        public:
            ...
            typedef cap_v2::TimeInformation TimeInformation;


    ////////// End Nested Class(es) //////////

        TimeDurationChargingResult() : its::AsnSequence(3, false)
        {
            Initialize();
        }

        TimeDurationChargingResult(its::Octets& octets) : its::AsnSequence(3, false)
        {
            Initialize();
            Decode(octets);
        }
        ...
        TimeDurationChargingResult(its::AsnDescObject* description) : its::AsnSequence(3, description)
        {
            // Nothing to do.
        }
...
#endif    // !defined(_CAP_V2_CAMEL_CALL_RESULT_H_)
