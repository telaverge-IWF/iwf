...
#if !defined(_CAP_V3_SPECIALIZED_RESOURCE_REPORT_ARG_H_)
#define _CAP_V3_SPECIALIZED_RESOURCE_REPORT_ARG_H_
...
#endif    // !defined(_CAP_V3_SPECIALIZED_RESOURCE_REPORT_ARG_H_)
