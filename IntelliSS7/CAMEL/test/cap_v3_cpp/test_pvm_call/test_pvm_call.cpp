...
////////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_pvm_call.cpp,v 9.1 2005/03/23 12:51:15 cvsadmin Exp $
//
////////////////////////////////////////////////////////////////////////////////
...

{
	...
	ForwardServiceInteractionInd:: CallCompletionTreatmentIndicator* ccti =
        new ForwardServiceInteractionInd:: CallCompletionTreatmentIndicator(FixedByteArrayToVector(cmpTreatmentIndicatorarray)); 
    ...
    ForwardServiceInteractionInd:: CallingPartyRestrictionIndicator* cpri =
       ...
       printf("\n test print3");
   const_cast<ForwardServiceInteractionInd&>(fsi2).SetCallCompletionTreatmentIndicator(ccti);
       printf("\n test print4");
...
***************************************************************************************/

    {
        ...
        // Encode message
        EncodeMsg(connectToResourceArg, &encOctets);
