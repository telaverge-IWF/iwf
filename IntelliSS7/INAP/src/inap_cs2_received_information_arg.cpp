...
AsnDescObject* ReceivedInformationArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GetIA5ResponseStaticDescription());
...
AsnDescObject* ReceivedInformationArg::GetIA5ResponseStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetNamedTypeName("iA5Response");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
