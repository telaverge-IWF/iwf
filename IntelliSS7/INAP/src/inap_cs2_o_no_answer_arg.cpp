...
AsnDescObject* ONoAnswerArg::Extensions::GetStaticDescription()
{
...
AsnDescObject* ONoAnswerArg::Extensions::GetExtensionFieldStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ONoAnswerArg::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ONoAnswerArg(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_UNIVERSAL, Tag::ASN_CONSTRUCTED, 16));
        ...
        staticDesc._elementVect[6] = GetPrefixStaticDescription();
        staticDesc._elementVect[7] = GetRedirectingPartyIDStaticDescription();
        staticDesc._elementVect[8] = GetRedirectionInformationStaticDescription();
        staticDesc._elementVect[9] = GetRouteListStaticDescription();
        ...
        staticDesc._elementVect[12] = GetCarrierStaticDescription();
        staticDesc.SetTypeName("ONoAnswerArg");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* ONoAnswerArg::GetDpSpecificCommonParametersStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ONoAnswerArg::GetCallingPartyBusinessGroupIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ONoAnswerArg::GetCallingPartySubaddressStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetCallingFacilityGroupStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ONoAnswerArg::GetCallingFacilityGroupMemberStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* ONoAnswerArg::GetOriginalCalledPartyIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetPrefixStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetRedirectingPartyIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetRedirectionInformationStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetRouteListStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequenceOf staticDesc;
...
AsnDescObject* ONoAnswerArg::GetTravellingClassMarkStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
...
AsnDescObject* ONoAnswerArg::GetExtensionsStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequenceOf staticDesc;
...
AsnDescObject* ONoAnswerArg::GetCarrierStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescOctetString staticDesc;
