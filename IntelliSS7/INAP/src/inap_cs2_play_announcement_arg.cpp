...
AsnDescObject* PlayAnnouncementArg::ConnectedParty::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new ConnectedParty(&staticDesc));
        staticDesc._clauseOptional = true;
        ...
        staticDesc.SetNamedTypeName("connectedParty");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* PlayAnnouncementArg::ConnectedParty::GetLegIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescChoice staticDesc;
...
AsnDescObject* PlayAnnouncementArg::ConnectedParty::GetCallSegmentIDStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* PlayAnnouncementArg::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._elementVect[4] = GetConnectedPartyStaticDescription();
...
AsnDescObject* PlayAnnouncementArg::GetConnectedPartyStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescChoice staticDesc;
    ...
    else
    {
        staticDesc.SetCloneForFactory(new ConnectedParty(&staticDesc));
        staticDesc._clauseOptional = true;
        staticDesc._choiceList.push_back(ConnectedParty::GetLegIDStaticDescription());
        staticDesc._choiceList.push_back(ConnectedParty::GetCallSegmentIDStaticDescription());
        staticDesc.SetNamedTypeName("connectedParty");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
