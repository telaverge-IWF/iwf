...
AsnDescObject* Media::GetStaticDescription()
{
...
long Media::Get(const std::string& valueName) const
{
    if (valueName == "voiceMail")
    {
        return 0;
    }
    else if (valueName == "faxGroup3")
    {
        return 1;
    }
    else if (valueName == "faxGroup4")
    {
        return 2;
    }
    else
...
std::string Media::Get(long value) const
{
    if (value == 0)
    {
        return "voiceMail";
...
std::string Media::GetExt(long value) const
{
    return "";
}
