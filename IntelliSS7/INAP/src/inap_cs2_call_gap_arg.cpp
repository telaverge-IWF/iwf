...
AsnDescObject* CallGapArg::GetGapCriteriaStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GapCriteria::GetGapAllInTrafficStaticDescription());
...
AsnDescObject* CallGapArg::GetGapTreatmentStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc._choiceList.push_back(GapTreatment::GetBothStaticDescription());
