...
#include <inap_cs2_remove_entry_argument.h>
...
AsnDescObject* RemoveEntryArgument::Extensions::GetStaticDescription()
{
...
AsnDescObject* RemoveEntryArgument::Extensions::GetExtensionStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* RemoveEntryArgument::GetStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    ...
    else
    {
        ...
        staticDesc.SetCloneForFactory(new RemoveEntryArgument(&staticDesc));
        staticDesc.TagAddLevel(new Tag(Tag::ASN_CLASS_UNIVERSAL, Tag::ASN_CONSTRUCTED, 17));
        staticDesc._elementVect[0] = GetObjectStaticDescription();
        staticDesc._elementVect[1] = GetServiceControlsStaticDescription();
        staticDesc._elementVect[2] = GetSecurityParametersStaticDescription();
        staticDesc._elementVect[3] = GetRequestorStaticDescription();
        staticDesc._elementVect[4] = GetOperationProgressStaticDescription();
        staticDesc._elementVect[5] = GetExtensionsStaticDescription();
        staticDesc.SetTypeName("RemoveEntryArgument");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
AsnDescObject* RemoveEntryArgument::GetObjectStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* RemoveEntryArgument::GetServiceControlsStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* RemoveEntryArgument::GetSecurityParametersStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
...
AsnDescObject* RemoveEntryArgument::GetRequestorStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSequenceOf staticDesc;
...
AsnDescObject* RemoveEntryArgument::GetOperationProgressStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSet staticDesc(2);
...
AsnDescObject* RemoveEntryArgument::GetExtensionsStaticDescription()
{
    static volatile bool initialized = false;
    static AsnDescObject* result = NULL;
    static AsnDescSetOf staticDesc;
