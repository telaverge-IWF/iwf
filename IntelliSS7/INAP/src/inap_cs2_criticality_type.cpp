...
#include <inap_cs2_criticality_type.h>
...
AsnDescObject* CriticalityType::GetStaticDescription()
{
    ...
    else
    {
        ...
        staticDesc.SetTypeName("CriticalityType");
        result = &staticDesc;
        initialized = true;
        Asn::Unlock();
        return result;
...
long CriticalityType::Get(const std::string& valueName) const
{
    if (valueName == "ignore")
    {
        return 0;
...
std::string CriticalityType::Get(long value) const
{
    if (value == 0)
    {
        return "ignore";
...
std::string CriticalityType::GetExt(long value) const
{
    return "";
}
