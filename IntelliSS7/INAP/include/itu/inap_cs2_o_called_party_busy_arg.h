...
#if !defined(_INAP_CS2_O_CALLED_PARTY_BUSY_ARG_H_)
#define _INAP_CS2_O_CALLED_PARTY_BUSY_ARG_H_
...
class OCalledPartyBusyArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    OCalledPartyBusyArg() : its::AsnSequence(14, false)
    {
        Initialize();
    }

    OCalledPartyBusyArg(its::Octets& octets) : its::AsnSequence(14, false)
    {
        Initialize();
        Decode(octets);
    }

    OCalledPartyBusyArg(const OCalledPartyBusyArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    OCalledPartyBusyArg(its::AsnDescObject* description) : its::AsnSequence(14, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new OCalledPartyBusyArg(*this);
    }

    virtual std::string GetName() const
    { return "OCalledPartyBusyArg"; }
    ...
    const Carrier& GetCarrier() const
    {
        ...
        return static_cast<const Carrier&> (ElementAt(13));
    }
...
#endif    // !defined(_INAP_CS2_O_CALLED_PARTY_BUSY_ARG_H_)
