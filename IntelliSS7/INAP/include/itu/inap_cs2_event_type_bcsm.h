...
#if !defined(_INAP_CS2_EVENT_TYPE_BCSM_H_)
#define _INAP_CS2_EVENT_TYPE_BCSM_H_
...
public:
    ...
    enum {
        EVENT_TYPE_BCSM_ORIG_ATTEMPT_AUTHORIZED = 1,
        EVENT_TYPE_BCSM_COLLECTED_INFO = 2,
        EVENT_TYPE_BCSM_ANALYSED_INFORMATION = 3,
        ...
        EVENT_TYPE_BCSM_TMID_CALL = 16,
        EVENT_TYPE_BCSM_TDISCONNECT = 17,
        EVENT_TYPE_BCSM_TABANDON = 18,
        EVENT_TYPE_BCSM_OTERM_SEIZED = 19,
        EVENT_TYPE_BCSM_OSUSPENDED = 20,
        EVENT_TYPE_BCSM_TSUSPENDED = 21,
        EVENT_TYPE_BCSM_ORIG_ATTEMPT = 22,
        EVENT_TYPE_BCSM_TERM_ATTEMPT = 23,
        EVENT_TYPE_BCSM_ORE_ANSWER = 24,
        EVENT_TYPE_BCSM_TRE_ANSWER = 25,
        EVENT_TYPE_BCSM_FACILITY_SELECTED_AND_AVAILABLE = 26,
        EVENT_TYPE_BCSM_CALL_ACCEPTED = 27

    };

    void SetOrigAttemptAuthorized()
    { _value = 1; }

    bool IsOrigAttemptAuthorized() const
    { return _value == 1; }
    ...
    void SetAnalysedInformation()
    { _value = 3; }

    bool IsAnalysedInformation() const
    { return _value == 3; }
    ...
    bool IsOTermSeized() const
    { return _value == 19; }

    void SetOSuspended()
    { _value = 20; }

    bool IsOSuspended() const
    { return _value == 20; }

    void SetTSuspended()
    { _value = 21; }

    bool IsTSuspended() const
    { return _value == 21; }

    void SetOrigAttempt()
    { _value = 22; }

    bool IsOrigAttempt() const
    { return _value == 22; }

    void SetTermAttempt()
    { _value = 23; }

    bool IsTermAttempt() const
    { return _value == 23; }

    void SetOReAnswer()
    { _value = 24; }

    bool IsOReAnswer() const
    { return _value == 24; }

    void SetTReAnswer()
    { _value = 25; }

    bool IsTReAnswer() const
    { return _value == 25; }

    void SetFacilitySelectedAndAvailable()
    { _value = 26; }

    bool IsFacilitySelectedAndAvailable() const
    { return _value == 26; }

    void SetCallAccepted()
    { _value = 27; }

    bool IsCallAccepted() const
    { return _value == 27; }
...
#endif    // !defined(_INAP_CS2_EVENT_TYPE_BCSM_H_)
