...
#if !defined(_INAP_CS2_T_DISCONNECT_ARG_H_)
#define _INAP_CS2_T_DISCONNECT_ARG_H_
...
class TDisconnectArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    TDisconnectArg() : its::AsnSequence(10, false)
    {
        Initialize();
    }

    TDisconnectArg(its::Octets& octets) : its::AsnSequence(10, false)
    {
        Initialize();
        Decode(octets);
    }

    TDisconnectArg(const TDisconnectArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    TDisconnectArg(its::AsnDescObject* description) : its::AsnSequence(10, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new TDisconnectArg(*this);
    }

    virtual std::string GetName() const
    { return "TDisconnectArg"; }
    ...
    const Integer4& GetConnectTime() const
    {
        ...
        return static_cast<const Integer4&> (ElementAt(7));
    }
...
#endif    // !defined(_INAP_CS2_T_DISCONNECT_ARG_H_)
