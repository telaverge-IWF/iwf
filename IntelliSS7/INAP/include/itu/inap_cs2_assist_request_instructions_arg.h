...
#if !defined(_INAP_CS2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_)
#define _INAP_CS2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_
...
////////// End Nested Class(es) //////////
    ...
    AssistRequestInstructionsArg() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    AssistRequestInstructionsArg(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }
    ...
    AssistRequestInstructionsArg(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    const IPAvailable& GetIPAvailable() const
    {
        ...
        return static_cast<const IPAvailable&> (ElementAt(1));
    }
    ...
    const IPSSPCapabilities& GetIPSSPCapabilities() const
    {
        ...
        return static_cast<const IPSSPCapabilities&> (ElementAt(2));
    }
...
#endif    // !defined(_INAP_CS2_ASSIST_REQUEST_INSTRUCTIONS_ARG_H_)
