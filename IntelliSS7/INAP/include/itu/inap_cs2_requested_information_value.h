...
#if !defined(_INAP_CS2_REQUESTED_INFORMATION_VALUE_H_)
#define _INAP_CS2_REQUESTED_INFORMATION_VALUE_H_
...
#endif    // !defined(_INAP_CS2_REQUESTED_INFORMATION_VALUE_H_)
