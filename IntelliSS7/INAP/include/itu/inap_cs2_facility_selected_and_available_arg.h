...
#if !defined(_INAP_CS2_FACILITY_SELECTED_AND_AVAILABLE_ARG_H_)
#define _INAP_CS2_FACILITY_SELECTED_AND_AVAILABLE_ARG_H_
...
class FacilitySelectedAndAvailableArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    FacilitySelectedAndAvailableArg() : its::AsnSequence(13, false)
    {
        Initialize();
    }

    FacilitySelectedAndAvailableArg(its::Octets& octets) : its::AsnSequence(13, false)
    {
        Initialize();
        Decode(octets);
    }

    FacilitySelectedAndAvailableArg(const FacilitySelectedAndAvailableArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    FacilitySelectedAndAvailableArg(its::AsnDescObject* description) : its::AsnSequence(13, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual ~FacilitySelectedAndAvailableArg()
    {
        // Nothing to do.
    }
    ...
    virtual its::AsnObject* Clone() const
    {
        return new FacilitySelectedAndAvailableArg(*this);
    }

    virtual std::string GetName() const
    { return "FacilitySelectedAndAvailableArg"; }
    ...
    const RouteList& GetRouteList() const
    {
        ...
        return static_cast<const RouteList&> (ElementAt(8));
    }
    ...
    const ComponentType& GetComponentType() const
    {
        ...
        return static_cast<const ComponentType&> (ElementAt(11));
    }
    ...
    const ComponentCorrelationID& GetComponentCorrelationID() const
    {
        ...
        return static_cast<const ComponentCorrelationID&> (ElementAt(12));
    }
...
#endif    // !defined(_INAP_CS2_FACILITY_SELECTED_AND_AVAILABLE_ARG_H_)
