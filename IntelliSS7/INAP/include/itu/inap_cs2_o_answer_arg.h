...
#if !defined(_INAP_CS2_O_ANSWER_ARG_H_)
#define _INAP_CS2_O_ANSWER_ARG_H_
...
class OAnswerArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    OAnswerArg() : its::AsnSequence(11, false)
    {
        Initialize();
    }

    OAnswerArg(its::Octets& octets) : its::AsnSequence(11, false)
    {
        Initialize();
        Decode(octets);
    }

    OAnswerArg(const OAnswerArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    OAnswerArg(its::AsnDescObject* description) : its::AsnSequence(11, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_INAP_CS2_O_ANSWER_ARG_H_)
