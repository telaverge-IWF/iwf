...
#if !defined(_INAP_CS2_SEND_STUI_ARG_H_)
#define _INAP_CS2_SEND_STUI_ARG_H_
...
class SendSTUIArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    SendSTUIArg() : its::AsnSequence(4, false)
    {
        Initialize();
    }

    SendSTUIArg(its::Octets& octets) : its::AsnSequence(4, false)
    {
        Initialize();
        Decode(octets);
    }

    SendSTUIArg(const SendSTUIArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    SendSTUIArg(its::AsnDescObject* description) : its::AsnSequence(4, description)
    {
        // Nothing to do.
    }
...
#endif    // !defined(_INAP_CS2_SEND_STUI_ARG_H_)
