...
#if !defined(_INAP_CS2_DISCONNECT_LEG_ARG_H_)
#define _INAP_CS2_DISCONNECT_LEG_ARG_H_
...
class DisconnectLegArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    DisconnectLegArg() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    DisconnectLegArg(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }

    DisconnectLegArg(const DisconnectLegArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    DisconnectLegArg(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new DisconnectLegArg(*this);
    }

    virtual std::string GetName() const
    { return "DisconnectLegArg"; }

    void SetLegToBeReleased(LegID* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetLegToBeReleasedStaticDescription());
        AddElement(0, element);
    }

    void SetLegToBeReleased(const LegID& element)
    {
        its::AsnObject& asnObject = const_cast<LegID&>(element);
        asnObject.SetDescription(GetLegToBeReleasedStaticDescription());
        AddElement(0, element);
    }

    const LegID& GetLegToBeReleased() const
    {
...
#endif    // !defined(_INAP_CS2_DISCONNECT_LEG_ARG_H_)
