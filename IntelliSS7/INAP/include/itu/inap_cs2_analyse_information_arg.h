...
#if !defined(_INAP_CS2_ANALYSE_INFORMATION_ARG_H_)
#define _INAP_CS2_ANALYSE_INFORMATION_ARG_H_
...
class AnalyseInformationArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    AnalyseInformationArg() : its::AsnSequence(20, false)
    {
        Initialize();
    }

    AnalyseInformationArg(its::Octets& octets) : its::AsnSequence(20, false)
    {
        Initialize();
        Decode(octets);
    }

    AnalyseInformationArg(const AnalyseInformationArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    AnalyseInformationArg(its::AsnDescObject* description) : its::AsnSequence(20, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new AnalyseInformationArg(*this);
    }

    virtual std::string GetName() const
    { return "AnalyseInformationArg"; }
    ...
    const OriginalCalledPartyID& GetOriginalCalledPartyID() const
    {
        ...
        return static_cast<const OriginalCalledPartyID&> (ElementAt(3));
    }
    ...
    const CallingPartysCategory& GetCallingPartysCategory() const
    {
        ...
        return static_cast<const CallingPartysCategory&> (ElementAt(6));
    }
    ...
    const CalledPartyNumber& GetCalledPartyNumber() const
    {
        ...
        return static_cast<const CalledPartyNumber&> (ElementAt(7));
    }
    ...
    const ChargeNumber& GetChargeNumber() const
    {
        ...
        return static_cast<const ChargeNumber&> (ElementAt(8));
    }
    ...
    const Carrier& GetCarrier() const
    {
        ...
        return static_cast<const Carrier&> (ElementAt(10));
    }
    ...
    const ServiceInteractionIndicators& GetServiceInteractionIndicators() const
    {
        ...
        return static_cast<const ServiceInteractionIndicators&> (ElementAt(11));
    }
    ...
    const INServiceCompatibilityResponse& GetINServiceCompatibilityResponse() const
    {
        ...
        return static_cast<const INServiceCompatibilityResponse&> (ElementAt(12));
    }
    ...
    const ForwardGVNS& GetForwardGVNS() const
    {
        ...
        return static_cast<const ForwardGVNS&> (ElementAt(13));
    }
    ...
    const BackwardGVNS& GetBackwardGVNS() const
    {
        ...
        return static_cast<const BackwardGVNS&> (ElementAt(14));
    }
    ...
    const ServiceInteractionIndicatorsTwo& GetServiceInteractionIndicatorsTwo() const
    {
        ...
        return static_cast<const ServiceInteractionIndicatorsTwo&> (ElementAt(15));
    }
    ...
    const CorrelationID& GetCorrelationID() const
    {
        ...
        return static_cast<const CorrelationID&> (ElementAt(16));
    }
    ...
    const ScfID& GetScfID() const
    {
        ...
        return static_cast<const ScfID&> (ElementAt(17));
    }
    ...
    const CallSegmentID& GetCallSegmentID() const
    {
        ...
        return static_cast<const CallSegmentID&> (ElementAt(18));
    }
    ...
    const LegID& GetLegToBeCreated() const
    {
        ...
        return static_cast<const LegID&> (ElementAt(19));
    }
...
#endif    // !defined(_INAP_CS2_ANALYSE_INFORMATION_ARG_H_)
