...
#if !defined(_INAP_CS2_BOTHWAY_THROUGH_CONNECTION_IND_H_)
#define _INAP_CS2_BOTHWAY_THROUGH_CONNECTION_IND_H_
...
#endif    // !defined(_INAP_CS2_BOTHWAY_THROUGH_CONNECTION_IND_H_)
