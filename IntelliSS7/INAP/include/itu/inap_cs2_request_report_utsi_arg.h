...
#if !defined(_INAP_CS2_REQUEST_REPORT_UTSI_ARG_H_)
#define _INAP_CS2_REQUEST_REPORT_UTSI_ARG_H_
...
class RequestReportUTSIArg : public its::AsnSequence
{
public:
...
////////// Begin Nested Class(es) //////////
    ...
    public:
        ...
        typedef inap_cs2::RequestedUTSIList RequestedUTSIList;
...
////////// End Nested Class(es) //////////
    ...
    RequestReportUTSIArg() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    RequestReportUTSIArg(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }

    RequestReportUTSIArg(const RequestReportUTSIArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    RequestReportUTSIArg(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new RequestReportUTSIArg(*this);
    }

    virtual std::string GetName() const
    { return "RequestReportUTSIArg"; }

    void SetRequestedUTSIList(RequestedUTSIList* element)
    {
        ITS_REQUIRE(element != NULL);
        element->AsnObject::SetDescription(GetRequestedUTSIListStaticDescription());
        AddElement(0, element);
    }

    void SetRequestedUTSIList(const RequestedUTSIList& element)
    {
        its::AsnObject& asnObject = const_cast<RequestedUTSIList&>(element);
        asnObject.SetDescription(GetRequestedUTSIListStaticDescription());
        AddElement(0, element);
    }

    const RequestedUTSIList& GetRequestedUTSIList() const
    {
        return static_cast<const RequestedUTSIList&> (ElementAt(0));
    }
...
#endif    // !defined(_INAP_CS2_REQUEST_REPORT_UTSI_ARG_H_)
