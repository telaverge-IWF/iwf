...
#if !defined(_INAP_CS2_CONNECTED_NUMBER_TREATMENT_IND_H_)
#define _INAP_CS2_CONNECTED_NUMBER_TREATMENT_IND_H_
...
#endif    // !defined(_INAP_CS2_CONNECTED_NUMBER_TREATMENT_IND_H_)
