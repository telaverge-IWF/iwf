...
#if !defined(_INAP_CS2_O_SUSPENDED_ARG_H_)
#define _INAP_CS2_O_SUSPENDED_ARG_H_
...
class OSuspendedArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    OSuspendedArg() : its::AsnSequence(3, false)
    {
        Initialize();
    }

    OSuspendedArg(its::Octets& octets) : its::AsnSequence(3, false)
    {
        Initialize();
        Decode(octets);
    }

    OSuspendedArg(const OSuspendedArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    OSuspendedArg(its::AsnDescObject* description) : its::AsnSequence(3, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new OSuspendedArg(*this);
    }

    virtual std::string GetName() const
    { return "OSuspendedArg"; }
...
#endif    // !defined(_INAP_CS2_O_SUSPENDED_ARG_H_)
