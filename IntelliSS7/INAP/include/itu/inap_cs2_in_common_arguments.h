...
#if !defined(_INAP_CS2_IN_COMMON_ARGUMENTS_H_)
#define _INAP_CS2_IN_COMMON_ARGUMENTS_H_
...
class InCommonArguments : public its::AsnSet
{
public:
...
////////// End Nested Class(es) //////////
    ...
    InCommonArguments() : its::AsnSet(5, false)
    {
        Initialize();
    }

    InCommonArguments(its::Octets& octets) : its::AsnSet(5, false)
    {
        Initialize();
        Decode(octets);
    }

    InCommonArguments(const InCommonArguments& rhs) : its::AsnSet(rhs)
    {
        // Nothing to do.
    }

    InCommonArguments(its::AsnDescObject* description) : its::AsnSet(5, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new InCommonArguments(*this);
    }

    virtual std::string GetName() const
    { return "InCommonArguments"; }
    ...
    const InServiceControls& GetServiceControls() const
    {
        ...
        return static_cast<const InServiceControls&> (ElementAt(0));
    }
    ...
    const SecurityParameters& GetSecurityParameters() const
    {
        ...
        return static_cast<const SecurityParameters&> (ElementAt(1));
    }
    ...
    const DistinguishedName& GetRequestor() const
    {
        ...
        return static_cast<const DistinguishedName&> (ElementAt(2));
    }
    ...
    const OperationProgress& GetOperationProgress() const
    {
        ...
        return static_cast<const OperationProgress&> (ElementAt(3));
    }
...
#endif    // !defined(_INAP_CS2_IN_COMMON_ARGUMENTS_H_)
