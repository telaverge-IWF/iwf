...
#if !defined(_INAP_CS2_TERMINATION_ATTEMPT_ARG_H_)
#define _INAP_CS2_TERMINATION_ATTEMPT_ARG_H_
...
class TerminationAttemptArg : public its::AsnSequence
{
public:
...
////////// End Nested Class(es) //////////
    ...
    TerminationAttemptArg() : its::AsnSequence(11, false)
    {
        Initialize();
    }

    TerminationAttemptArg(its::Octets& octets) : its::AsnSequence(11, false)
    {
        Initialize();
        Decode(octets);
    }

    TerminationAttemptArg(const TerminationAttemptArg& rhs) : its::AsnSequence(rhs)
    {
        // Nothing to do.
    }

    TerminationAttemptArg(its::AsnDescObject* description) : its::AsnSequence(11, description)
    {
        // Nothing to do.
    }
...
public:
    ...
    virtual its::AsnObject* Clone() const
    {
        return new TerminationAttemptArg(*this);
    }

    virtual std::string GetName() const
    { return "TerminationAttemptArg"; }
...
#endif    // !defined(_INAP_CS2_TERMINATION_ATTEMPT_ARG_H_)
