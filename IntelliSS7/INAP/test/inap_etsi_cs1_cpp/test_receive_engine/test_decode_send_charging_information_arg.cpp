...
///////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_decode_send_charging_information_arg.cpp,v 9.1 2005/03/23 12:51:47 cvsadmin Exp $
//
///////////////////////////////////////////////////////////////////////////////
...
//  SendChargingInformation operation argument.
//
...
//
//  o   Decode a SendChargingInformationArg encoded value (i.e. create a
//      SendChargingInformationArg object from a SendChargingInformationArg encoded value).
//
//  o   Retrieve Data from a SendChargingInformationArg object.
//

void
InterpretOperationSendChargingInformationArg(const vector<byte>& encodedSendChargingInformationArg)
{
    //  [1] Create an Octets object from the SendChargingInformationArg ASN.1 encoded
    //  value.

    Octets* octets = new Octets(encodedSendChargingInformationArg);

    ////////////////////////////////////////////////////////////////////////////

    //  [2] Create SendChargingInformationArg object (used by the decode
    //  phase).
    ...
    //  [3] Decode the SendChargingInformationArg ASN.1 encoded value and
    //  therefore  populate previously created SendChargingInformationArg
    //  object.
    ...
    try
    {
        ...
        sendChargingInformationArg->Decode(*octets);
    }
    ...
    cout << endl;
    cout << "Printing decoded SendChargingInformationArg object...\n";
    cout << *sendChargingInformationArg;
    cout << endl;
    ...
    //  [7-2] Delete SendChargingInformationArg object.
