...
///////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_decode_play_announcement_arg.cpp,v 9.1 2005/03/23 12:51:47 cvsadmin Exp $
//
///////////////////////////////////////////////////////////////////////////////
...
//      PlayAnnouncementArg object from a PlayAnnouncementArg encoded value).
//
//  o   Retrieve Data from a PlayAnnouncementArg object.
//

void
InterpretOperationPlayAnnouncementArg(const vector<byte>& encodedPlayAnnouncementArg)
{
    //  [1] Create an Octets object from the PlayAnnouncementArg ASN.1 encoded
    //  value.
    ...
    //  [2] Create PlayAnnouncementArg object (used by the decode
    //  phase).
    ...
    //  [3] Decode the PlayAnnouncementArg ASN.1 encoded value and
    //  therefore  populate previously created PlayAnnouncementArg
    //  object.
    ...
    cout << endl;
    cout << "Printing decoded PlayAnnouncementArg object...\n";
    ...
    //  [7-2] Delete PlayAnnouncementArg object.
