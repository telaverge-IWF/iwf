...
///////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_decode_prompt_and_collect_user_information_arg.cpp,v 9.1 2005/03/23 12:51:47 cvsadmin Exp $
//
///////////////////////////////////////////////////////////////////////////////
...
//  PromptAndCollectUserInformation operation argument.
//
...
//
//  o   Decode a PromptAndCollectUserInformationArg encoded value (i.e. create a
//      PromptAndCollectUserInformationArg object from a PromptAndCollectUserInformationArg encoded value).
//
//  o   Retrieve Data from a PromptAndCollectUserInformationArg object.
//

void
InterpretOperationPromptAndCollectUserInformationArg(const vector<byte>& encodedPromptAndCollectUserInformationArg)
{
    ...
    //  [2] Create PromptAndCollectUserInformationArg object (used by the decode
    //  phase).

    PromptAndCollectUserInformationArg* promptAndCollectUserInformation
    ...
    try
    {
        ...
        promptAndCollectUserInformation->Decode(*octets);
    }
    ...
    cout << *promptAndCollectUserInformation;
    cout << endl;
    ...
    //  [7-2] Delete PromptAndCollectUserInformationArg object.

    delete promptAndCollectUserInformation;
}
