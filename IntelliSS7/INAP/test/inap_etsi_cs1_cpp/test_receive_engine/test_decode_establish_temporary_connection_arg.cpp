...
///////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_decode_establish_temporary_connection_arg.cpp,v 9.1 2005/03/23 12:51:47 cvsadmin Exp $
//
///////////////////////////////////////////////////////////////////////////////
...
//
//  o   Decode a ConnectToResourceArg encoded value (i.e. create a
//      ConnectToResourceArg object from a ConnectToResourceArg encoded value).
//
//  o   Retrieve Data from a ConnectToResourceArg object.
//

void
InterpretOperationEstablishTemporaryConnectionArg(const vector<byte>& encodedEstablishTemporaryConnectionArg)
{
    //  [1] Create an Octets object from the
    //  ConnectToResourceArtablishTemporaryConnectionArg ASN.1 encoded value.

    Octets* octets = new Octets(encodedEstablishTemporaryConnectionArg);

    ////////////////////////////////////////////////////////////////////////////

    //  [2] Create EstablishTemporaryConnectionArg object (used by the decode
    //  phase).
    ...
    //  [3] Decode the EstablishTemporaryConnectionArg ASN.1 encoded value and
    //  therefore  populate previously created EstablishTemporaryConnectionArg
    //  object.
    ...
    try
    {
        ...
        establishTemporaryConnectionArg->Decode(*octets);
    }
    ...
    cout << endl;
    cout << "Printing decoded EstablishTemporaryConnectionArg object...\n";
    cout << *establishTemporaryConnectionArg;
    cout << endl;
    ...
    //  [7-2] Delete EstablishTemporaryConnectionArg object.
