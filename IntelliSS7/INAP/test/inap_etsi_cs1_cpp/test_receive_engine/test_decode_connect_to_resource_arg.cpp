...
///////////////////////////////////////////////////////////////////////////////
//
//  ID: $Id: test_decode_connect_to_resource_arg.cpp,v 9.1 2005/03/23 12:51:47 cvsadmin Exp $
//
///////////////////////////////////////////////////////////////////////////////
...
void
InterpretOperationConnectToResourceArg(const vector<byte>& encodedConnectArg)
{
    //  [1] Create an Octets object from the ConnectToResourceArg ASN.1
    //  encoded value.
    ...
    //  [2] Create ConnectToResourceArg object (used by the decode phase).

    ConnectToResourceArg* connectToResourceArg = new ConnectToResourceArg();

    ////////////////////////////////////////////////////////////////////////////

    //  [3] Decode the ConnectToResourceArg ASN.1 encoded value and therefore
    //  populate previously created ConnectToResourceArg object.

    try
    {
        //  Can throw and AsnDecodeError exception.

        connectToResourceArg->Decode(*octets);
    }
    ...
    cout << endl;
    cout << "Printing decoded ConnectToResourceArg object..." << endl;
    cout << *connectToResourceArg;
    cout << endl;
    ...
    //  [7-2] Delete ConnectToResourceArg object.
