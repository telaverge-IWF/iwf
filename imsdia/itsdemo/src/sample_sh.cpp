 ...
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 1.10  2008/03/27 11:58:28  hbhatnagar
 * LOG: Converting 2.1 branch to CURRENT
 * LOG:
 * LOG: Revision 1.8.8.5  2008/03/04 06:37:58  avinashks
 * LOG: Logs from CVS updated.
 * LOG:
 * LOG: Revision 1.8.8.4  2008/03/04 06:16:01  avinashks
 * LOG: Added CVS Logs
 * LOG: 
 * LOG: Revision 1.8.8.3  2008/03/03 06:44:54  avinashks
 * LOG: Modified the AVP index as per new changes in PUR and PUA
 * LOG:
 * LOG: Revision 1.7  2006/11/22 11:28:23  nvijikumar
 * LOG: Loadtest settings ( dont set optional AVPs for load).
 * LOG:
 * LOG: Revision 1.6  2006/11/14 13:36:36  nvijikumar
 * LOG: Set Optional AVPs only if not LOAD MODE.
 * LOG:
 * LOG: Revision 1.5  2006/10/24 09:15:13  tpanda
 * LOG: Fix for correct updation for statistics for base mesg
 * LOG:
 * LOG: Revision 1.4  2006/10/23 06:42:12  nvijikumar
 * LOG: Menu to send Base Protocol Messages from Application.
 * LOG:
 * LOG: Revision 1.3  2006/10/17 17:28:14  tpanda
 * LOG: SetSessionIndex changed to setSessionIndex
 * LOG:
 * LOG: Revision 1.2  2006/10/17 09:20:40  yranade
 ...
 * LOG:
 *
 * ID: $Id: sample_sh.cpp,v 3.1 2008/03/31 10:33:26 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: sample_sh.cpp,v 3.1 2008/03/31 10:33:26 nvijikumar Exp $"
    ...
    if (diaFrame)
    {
        ...
        case ITS_DIA_MSG_TYPE_DATA:case ITS_DIA_MSG_TYPE_IND_WITH_DATA:
        {
            ...
            try
            {
                ...
                {
                   APPStats::GetAPPStats()->UpdateRecvStats(impl->getCommandCode(), isReq);
...
int SendProfileUpdateRequest()
{
    ...
    if (appMode == UNIT_TEST)
    {
       ...
       AddressAvp extAvpAddress(1207, 0,addr);
       pur.addExtra(extAvpAddress);

       //Creating AVP of OctetString Type
       TimeAvp extAvpTime(1208,0, 6062816);
       ...
       DerivedGroupedAVP mygrouped(1214,0);
