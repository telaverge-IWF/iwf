...
public class DeleteSubscriberDataRequest extends com.intellinet.diameter.Command {
    ...
    public DSRFlags getDSRFlags() throws NoSuchAttributeException {
        return (DSRFlags)_data.getContainer().get(S6a_r11AttributeName.DSRFlags, 0);
    }
    ...
    public void setDSRFlags(DSRFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.DSRFlags, avp.getData(), true);
    }
    ...
    public boolean containsTraceReference() {
        return _data.getContainer().contains(S6a_r11AttributeName.TraceReference);
    }
    ...
    public int countContextIdentifier() {
        return _data.getContainer().count(S6a_r11AttributeName.ContextIdentifier);
    }
    ...
    public ContextIdentifier getContextIdentifier(int index) throws NoSuchAttributeException {
        return (ContextIdentifier)_data.getContainer().get(S6a_r11AttributeName.ContextIdentifier, index);
    }
    ...
    public void addContextIdentifier(ContextIdentifier avp) {
        _data.getContainer().add(S6a_r11AttributeName.ContextIdentifier, avp.getData(), false);
    }
