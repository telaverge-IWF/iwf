...
public class MMELocationInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsEUTRANCellGlobalIdentity() {
        return _data.getContainer().contains(S6a_r11AttributeName.EUTRANCellGlobalIdentity);
    }
    ...
    public EUTRANCellGlobalIdentity getEUTRANCellGlobalIdentity() throws NoSuchAttributeException {
        return (EUTRANCellGlobalIdentity)_data.getContainer().get(S6a_r11AttributeName.EUTRANCellGlobalIdentity, 0);
    }
    ...
    public void setEUTRANCellGlobalIdentity(EUTRANCellGlobalIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.EUTRANCellGlobalIdentity, avp.getData(), true);
    }
    ...
    public boolean containsTrackingAreaIdentity() {
        return _data.getContainer().contains(S6a_r11AttributeName.TrackingAreaIdentity);
    }
    ...
    public TrackingAreaIdentity getTrackingAreaIdentity() throws NoSuchAttributeException {
        return (TrackingAreaIdentity)_data.getContainer().get(S6a_r11AttributeName.TrackingAreaIdentity, 0);
    }
    ...
    public void setTrackingAreaIdentity(TrackingAreaIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.TrackingAreaIdentity, avp.getData(), true);
    }
