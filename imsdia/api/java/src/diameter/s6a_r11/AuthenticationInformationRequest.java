...
public class AuthenticationInformationRequest extends com.intellinet.diameter.Command {
    ...
    public boolean containsRequestedEUTRANAuthenticationInfo() {
        return _data.getContainer().contains(S6a_r11AttributeName.RequestedEUTRANAuthenticationInfo);
    }
    ...
    public RequestedEUTRANAuthenticationInfo getRequestedEUTRANAuthenticationInfo() throws NoSuchAttributeException {
        return (RequestedEUTRANAuthenticationInfo)_data.getContainer().get(S6a_r11AttributeName.RequestedEUTRANAuthenticationInfo, 0);
    }
    ...
    public void setRequestedEUTRANAuthenticationInfo(RequestedEUTRANAuthenticationInfo avp) {
        _data.getContainer().add(S6a_r11AttributeName.RequestedEUTRANAuthenticationInfo, avp.getData(), true);
    }
    ...
    public boolean containsRequestedUTRANGERANAuthenticationInfo() {
        return _data.getContainer().contains(S6a_r11AttributeName.RequestedUTRANGERANAuthenticationInfo);
    }
    ...
    public RequestedUTRANGERANAuthenticationInfo getRequestedUTRANGERANAuthenticationInfo() throws NoSuchAttributeException {
        return (RequestedUTRANGERANAuthenticationInfo)_data.getContainer().get(S6a_r11AttributeName.RequestedUTRANGERANAuthenticationInfo, 0);
    }
    ...
    public void setRequestedUTRANGERANAuthenticationInfo(RequestedUTRANGERANAuthenticationInfo avp) {
        _data.getContainer().add(S6a_r11AttributeName.RequestedUTRANGERANAuthenticationInfo, avp.getData(), true);
    }
