...
public class LCSPrivacyException extends com.intellinet.diameter.GroupedAVP {
    ...
    public SSCode getSSCode() throws NoSuchAttributeException {
        return (SSCode)_data.getContainer().get(S6a_r11AttributeName.SSCode, 0);
    }
    ...
    public void setSSCode(SSCode avp) {
        _data.getContainer().add(S6a_r11AttributeName.SSCode, avp.getData(), true);
    }
    ...
    public SSStatus getSSStatus() throws NoSuchAttributeException {
        return (SSStatus)_data.getContainer().get(S6a_r11AttributeName.SSStatus, 0);
    }
    ...
    public void setSSStatus(SSStatus avp) {
        _data.getContainer().add(S6a_r11AttributeName.SSStatus, avp.getData(), true);
    }
    ...
    public int countExternalClient() {
        return _data.getContainer().count(S6a_r11AttributeName.ExternalClient);
    }
    ...
    public ExternalClient getExternalClient(int index) throws NoSuchAttributeException {
        return (ExternalClient)_data.getContainer().get(S6a_r11AttributeName.ExternalClient, index);
    }
    ...
    public void addExternalClient(ExternalClient avp) {
        _data.getContainer().add(S6a_r11AttributeName.ExternalClient, avp.getData(), false);
    }
    ...
    public int countPLMNClient() {
        return _data.getContainer().count(S6a_r11AttributeName.PLMNClient);
    }
    ...
    public PLMNClient getPLMNClient(int index) throws NoSuchAttributeException {
        return (PLMNClient)_data.getContainer().get(S6a_r11AttributeName.PLMNClient, index);
    }
    ...
    public void addPLMNClient(PLMNClient avp) {
        _data.getContainer().add(S6a_r11AttributeName.PLMNClient, avp.getData(), false);
    }
    ...
    public int countServiceType() {
        return _data.getContainer().count(S6a_r11AttributeName.ServiceType);
    }
    ...
    public ServiceType getServiceType(int index) throws NoSuchAttributeException {
        return (ServiceType)_data.getContainer().get(S6a_r11AttributeName.ServiceType, index);
    }
    ...
    public void addServiceType(ServiceType avp) {
        _data.getContainer().add(S6a_r11AttributeName.ServiceType, avp.getData(), false);
    }
