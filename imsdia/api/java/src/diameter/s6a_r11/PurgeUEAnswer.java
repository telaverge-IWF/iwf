...
public class PurgeUEAnswer extends com.intellinet.diameter.Command {
    ...
    public boolean containsPUAFlags() {
        return _data.getContainer().contains(S6a_r11AttributeName.PUAFlags);
    }
    ...
    public PUAFlags getPUAFlags() throws NoSuchAttributeException {
        return (PUAFlags)_data.getContainer().get(S6a_r11AttributeName.PUAFlags, 0);
    }
    ...
    public void setPUAFlags(PUAFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.PUAFlags, avp.getData(), true);
    }
