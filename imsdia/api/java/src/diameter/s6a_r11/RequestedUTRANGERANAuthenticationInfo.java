...
public class RequestedUTRANGERANAuthenticationInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsNumberOfRequestedVectors() {
        return _data.getContainer().contains(S6a_r11AttributeName.NumberOfRequestedVectors);
    }
    ...
    public NumberOfRequestedVectors getNumberOfRequestedVectors() throws NoSuchAttributeException {
        return (NumberOfRequestedVectors)_data.getContainer().get(S6a_r11AttributeName.NumberOfRequestedVectors, 0);
    }
    ...
    public void setNumberOfRequestedVectors(NumberOfRequestedVectors avp) {
        _data.getContainer().add(S6a_r11AttributeName.NumberOfRequestedVectors, avp.getData(), true);
    }
    ...
    public boolean containsImmediateResponsePreferred() {
        return _data.getContainer().contains(S6a_r11AttributeName.ImmediateResponsePreferred);
    }
    ...
    public ImmediateResponsePreferred getImmediateResponsePreferred() throws NoSuchAttributeException {
        return (ImmediateResponsePreferred)_data.getContainer().get(S6a_r11AttributeName.ImmediateResponsePreferred, 0);
    }
    ...
    public void setImmediateResponsePreferred(ImmediateResponsePreferred avp) {
        _data.getContainer().add(S6a_r11AttributeName.ImmediateResponsePreferred, avp.getData(), true);
    }
    ...
    public boolean containsReSynchronizationInfo() {
        return _data.getContainer().contains(S6a_r11AttributeName.ReSynchronizationInfo);
    }
    ...
    public ReSynchronizationInfo getReSynchronizationInfo() throws NoSuchAttributeException {
        return (ReSynchronizationInfo)_data.getContainer().get(S6a_r11AttributeName.ReSynchronizationInfo, 0);
    }
    ...
    public void setReSynchronizationInfo(ReSynchronizationInfo avp) {
        _data.getContainer().add(S6a_r11AttributeName.ReSynchronizationInfo, avp.getData(), true);
    }
