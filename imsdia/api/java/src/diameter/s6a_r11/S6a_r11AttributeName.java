...
/**
 * This class defines singleton AttributeName instances for all attributes in <i><b>s6a_r11</b></i>.
 */
public abstract class S6a_r11AttributeName {
    ...
    private static class SubscriptionDataFlagsAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new SubscriptionDataFlags((com.intellinet.diameter.Unsigned32Data)impl);
        }
    }

    public static final AttributeName SubscriptionDataFlags = new com.intellinet.diameter.Unsigned32Name("Subscription-Data-Flags", new SubscriptionDataFlagsAVPBuilder());

    private static class LocalTimeZoneAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new LocalTimeZone((com.intellinet.diameter.GroupedData)impl);
        }
    }

    public static final AttributeName LocalTimeZone = new com.intellinet.diameter.GroupedName("Local-Time-Zone", new LocalTimeZoneAVPBuilder());
    ...
    private static class UserIdAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new UserId((com.intellinet.diameter.UTF8StringData)impl);
        }
    }

    public static final AttributeName UserId = new com.intellinet.diameter.UTF8StringName("User-Id", new UserIdAVPBuilder());
    ...
    private static class S6A3GPPMSTimeZoneAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new S6A3GPPMSTimeZone((com.intellinet.diameter.OctetStringData)impl);
        }
    }

    public static final AttributeName S6A3GPPMSTimeZone = new com.intellinet.diameter.OctetStringName("S6A-3GPP-MS-TimeZone", new S6A3GPPMSTimeZoneAVPBuilder());
    ...
    private static class AMSISDNAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new AMSISDN((com.intellinet.diameter.OctetStringData)impl);
        }
    }

    public static final AttributeName AMSISDN = new com.intellinet.diameter.OctetStringName("A-MSISDN", new AMSISDNAVPBuilder());
    ...
    private static class SubscribedVSRVCCAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new SubscribedVSRVCC((com.intellinet.diameter.EnumeratedData)impl);
        }
    }

    public static final AttributeName SubscribedVSRVCC = new com.intellinet.diameter.EnumeratedName("Subscribed-VSRVCC", new SubscribedVSRVCCAVPBuilder());
    ...
    private static class SMSReqisterRequestAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new SMSReqisterRequest((com.intellinet.diameter.EnumeratedData)impl);
        }
    }

    public static final AttributeName SMSReqisterRequest = new com.intellinet.diameter.EnumeratedName("SMS-Reqister-Request", new SMSReqisterRequestAVPBuilder());
    ...
    private static class EquivalentPLMNListAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new EquivalentPLMNList((com.intellinet.diameter.GroupedData)impl);
        }
    }

    public static final AttributeName EquivalentPLMNList = new com.intellinet.diameter.GroupedName("Equivalent-PLMN-List", new EquivalentPLMNListAVPBuilder());
    ...
    private static class MMENumberforMTSMSAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new MMENumberforMTSMS((com.intellinet.diameter.OctetStringData)impl);
        }
    }

    public static final AttributeName MMENumberforMTSMS = new com.intellinet.diameter.OctetStringName("MME-Number-for-MT-SMS", new MMENumberforMTSMSAVPBuilder());
    ...
    private static class DaylightSavingTimeAVPBuilder implements com.intellinet.diameter.AVPBuilder {
        public AVP build(com.intellinet.diameter.Data impl) {
            return new DaylightSavingTime((com.intellinet.diameter.EnumeratedData)impl);
        }
    }

    public static final AttributeName DaylightSavingTime = new com.intellinet.diameter.EnumeratedName("Daylight-Saving-Time", new DaylightSavingTimeAVPBuilder());
