...
public class PurgeUERequest extends com.intellinet.diameter.Command {
    ...
    public boolean containsPURFlags() {
        return _data.getContainer().contains(S6a_r11AttributeName.PURFlags);
    }
    ...
    public PURFlags getPURFlags() throws NoSuchAttributeException {
        return (PURFlags)_data.getContainer().get(S6a_r11AttributeName.PURFlags, 0);
    }
    ...
    public void setPURFlags(PURFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.PURFlags, avp.getData(), true);
    }
