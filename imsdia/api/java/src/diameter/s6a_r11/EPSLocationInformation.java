...
public class EPSLocationInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsMMELocationInformation() {
        return _data.getContainer().contains(S6a_r11AttributeName.MMELocationInformation);
    }
    ...
    public MMELocationInformation getMMELocationInformation() throws NoSuchAttributeException {
        return (MMELocationInformation)_data.getContainer().get(S6a_r11AttributeName.MMELocationInformation, 0);
    }
    ...
    public void setMMELocationInformation(MMELocationInformation avp) {
        _data.getContainer().add(S6a_r11AttributeName.MMELocationInformation, avp.getData(), true);
    }
    ...
    public boolean containsSGSNLocationInformation() {
        return _data.getContainer().contains(S6a_r11AttributeName.SGSNLocationInformation);
    }
    ...
    public SGSNLocationInformation getSGSNLocationInformation() throws NoSuchAttributeException {
        return (SGSNLocationInformation)_data.getContainer().get(S6a_r11AttributeName.SGSNLocationInformation, 0);
    }
    ...
    public void setSGSNLocationInformation(SGSNLocationInformation avp) {
        _data.getContainer().add(S6a_r11AttributeName.SGSNLocationInformation, avp.getData(), true);
    }
