...
/**
   ...
   */
public class DeleteSubscriberDataAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new DeleteSubscriberDataAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public DeleteSubscriberDataAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 320, 16777251);
    }

    /**
     * Constructs a DeleteSubscriberDataAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public DeleteSubscriberDataAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a DeleteSubscriberDataAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public DeleteSubscriberDataAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    DeleteSubscriberDataAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any DSAFlags.
     */
    public boolean containsDSAFlags() {
        return _data.getContainer().contains(S6a_r11AttributeName.DSAFlags);
    }

    /**
     * Gets the DSAFlags.
     */
    public DSAFlags getDSAFlags() throws NoSuchAttributeException {
        return (DSAFlags)_data.getContainer().get(S6a_r11AttributeName.DSAFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setDSAFlags(DSAFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.DSAFlags, avp.getData(), true);
    }
