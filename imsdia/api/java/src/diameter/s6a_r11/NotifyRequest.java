...
public class NotifyRequest extends com.intellinet.diameter.Command {
    ...
    public boolean containsNORFlags() {
        return _data.getContainer().contains(S6a_r11AttributeName.NORFlags);
    }
    ...
    public NORFlags getNORFlags() throws NoSuchAttributeException {
        return (NORFlags)_data.getContainer().get(S6a_r11AttributeName.NORFlags, 0);
    }
    ...
    public void setNORFlags(NORFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.NORFlags, avp.getData(), true);
    }
    ...
    public boolean containsContextIdentifier() {
        return _data.getContainer().contains(S6a_r11AttributeName.ContextIdentifier);
    }
    ...
    public boolean containsAlertReason() {
        return _data.getContainer().contains(S6a_r11AttributeName.AlertReason);
    }
    ...
    public AlertReason getAlertReason() throws NoSuchAttributeException {
        return (AlertReason)_data.getContainer().get(S6a_r11AttributeName.AlertReason, 0);
    }
    ...
    public void setAlertReason(AlertReason avp) {
        _data.getContainer().add(S6a_r11AttributeName.AlertReason, avp.getData(), true);
    }
