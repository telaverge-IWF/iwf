...
public class APNConfigurationProfile extends com.intellinet.diameter.GroupedAVP {
    ...
    public AllAPNConfigurationsIncludedIndicator getAllAPNConfigurationsIncludedIndicator() throws NoSuchAttributeException {
        return (AllAPNConfigurationsIncludedIndicator)_data.getContainer().get(S6a_r11AttributeName.AllAPNConfigurationsIncludedIndicator, 0);
    }
    ...
    public void setAllAPNConfigurationsIncludedIndicator(AllAPNConfigurationsIncludedIndicator avp) {
        _data.getContainer().add(S6a_r11AttributeName.AllAPNConfigurationsIncludedIndicator, avp.getData(), true);
    }
    ...
    public int countAPNConfiguration() {
        return _data.getContainer().count(S6a_r11AttributeName.APNConfiguration);
    }
    ...
    public APNConfiguration getAPNConfiguration(int index) throws NoSuchAttributeException {
        return (APNConfiguration)_data.getContainer().get(S6a_r11AttributeName.APNConfiguration, index);
    }
    ...
    public void addAPNConfiguration(APNConfiguration avp) {
        _data.getContainer().add(S6a_r11AttributeName.APNConfiguration, avp.getData(), false);
    }
