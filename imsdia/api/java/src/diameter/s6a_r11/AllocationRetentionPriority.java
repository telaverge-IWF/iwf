...
public class AllocationRetentionPriority extends com.intellinet.diameter.GroupedAVP {
    ...
    public PriorityLevel getPriorityLevel() throws NoSuchAttributeException {
        return (PriorityLevel)_data.getContainer().get(S6a_r11AttributeName.PriorityLevel, 0);
    }
    ...
    public void setPriorityLevel(PriorityLevel avp) {
        _data.getContainer().add(S6a_r11AttributeName.PriorityLevel, avp.getData(), true);
    }
    ...
    public boolean containsPreemptionCapability() {
        return _data.getContainer().contains(S6a_r11AttributeName.PreemptionCapability);
    }
    ...
    public PreemptionCapability getPreemptionCapability() throws NoSuchAttributeException {
        return (PreemptionCapability)_data.getContainer().get(S6a_r11AttributeName.PreemptionCapability, 0);
    }
    ...
    public void setPreemptionCapability(PreemptionCapability avp) {
        _data.getContainer().add(S6a_r11AttributeName.PreemptionCapability, avp.getData(), true);
    }
    ...
    public boolean containsPreemptionVulnerability() {
        return _data.getContainer().contains(S6a_r11AttributeName.PreemptionVulnerability);
    }
    ...
    public PreemptionVulnerability getPreemptionVulnerability() throws NoSuchAttributeException {
        return (PreemptionVulnerability)_data.getContainer().get(S6a_r11AttributeName.PreemptionVulnerability, 0);
    }
    ...
    public void setPreemptionVulnerability(PreemptionVulnerability avp) {
        _data.getContainer().add(S6a_r11AttributeName.PreemptionVulnerability, avp.getData(), true);
    }
