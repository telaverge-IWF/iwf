...
public class MDTConfiguration extends com.intellinet.diameter.GroupedAVP {
    ...
    public JobType getJobType() throws NoSuchAttributeException {
        return (JobType)_data.getContainer().get(S6a_r11AttributeName.JobType, 0);
    }
    ...
    public void setJobType(JobType avp) {
        _data.getContainer().add(S6a_r11AttributeName.JobType, avp.getData(), true);
    }
    ...
    public boolean containsAreaScope() {
        return _data.getContainer().contains(S6a_r11AttributeName.AreaScope);
    }
    ...
    public AreaScope getAreaScope() throws NoSuchAttributeException {
        return (AreaScope)_data.getContainer().get(S6a_r11AttributeName.AreaScope, 0);
    }
    ...
    public void setAreaScope(AreaScope avp) {
        _data.getContainer().add(S6a_r11AttributeName.AreaScope, avp.getData(), true);
    }
    ...
    public boolean containsListOfMeasurements() {
        return _data.getContainer().contains(S6a_r11AttributeName.ListOfMeasurements);
    }
    ...
    public ListOfMeasurements getListOfMeasurements() throws NoSuchAttributeException {
        return (ListOfMeasurements)_data.getContainer().get(S6a_r11AttributeName.ListOfMeasurements, 0);
    }
    ...
    public void setListOfMeasurements(ListOfMeasurements avp) {
        _data.getContainer().add(S6a_r11AttributeName.ListOfMeasurements, avp.getData(), true);
    }
    ...
    public boolean containsReportingTrigger() {
        return _data.getContainer().contains(S6a_r11AttributeName.ReportingTrigger);
    }
    ...
    public ReportingTrigger getReportingTrigger() throws NoSuchAttributeException {
        return (ReportingTrigger)_data.getContainer().get(S6a_r11AttributeName.ReportingTrigger, 0);
    }
    ...
    public void setReportingTrigger(ReportingTrigger avp) {
        _data.getContainer().add(S6a_r11AttributeName.ReportingTrigger, avp.getData(), true);
    }
    ...
    public boolean containsReportInterval() {
        return _data.getContainer().contains(S6a_r11AttributeName.ReportInterval);
    }
    ...
    public ReportInterval getReportInterval() throws NoSuchAttributeException {
        return (ReportInterval)_data.getContainer().get(S6a_r11AttributeName.ReportInterval, 0);
    }
    ...
    public void setReportInterval(ReportInterval avp) {
        _data.getContainer().add(S6a_r11AttributeName.ReportInterval, avp.getData(), true);
    }
    ...
    public boolean containsReportAmount() {
        return _data.getContainer().contains(S6a_r11AttributeName.ReportAmount);
    }
    ...
    public ReportAmount getReportAmount() throws NoSuchAttributeException {
        return (ReportAmount)_data.getContainer().get(S6a_r11AttributeName.ReportAmount, 0);
    }
    ...
    public void setReportAmount(ReportAmount avp) {
        _data.getContainer().add(S6a_r11AttributeName.ReportAmount, avp.getData(), true);
    }
    ...
    public boolean containsEventThresholdRSRP() {
        return _data.getContainer().contains(S6a_r11AttributeName.EventThresholdRSRP);
    }
    ...
    public EventThresholdRSRP getEventThresholdRSRP() throws NoSuchAttributeException {
        return (EventThresholdRSRP)_data.getContainer().get(S6a_r11AttributeName.EventThresholdRSRP, 0);
    }
    ...
    public void setEventThresholdRSRP(EventThresholdRSRP avp) {
        _data.getContainer().add(S6a_r11AttributeName.EventThresholdRSRP, avp.getData(), true);
    }
    ...
    public boolean containsEventThresholdRSRQ() {
        return _data.getContainer().contains(S6a_r11AttributeName.EventThresholdRSRQ);
    }
    ...
    public EventThresholdRSRQ getEventThresholdRSRQ() throws NoSuchAttributeException {
        return (EventThresholdRSRQ)_data.getContainer().get(S6a_r11AttributeName.EventThresholdRSRQ, 0);
    }
    ...
    public void setEventThresholdRSRQ(EventThresholdRSRQ avp) {
        _data.getContainer().add(S6a_r11AttributeName.EventThresholdRSRQ, avp.getData(), true);
    }
    ...
    public boolean containsLoggingInterval() {
        return _data.getContainer().contains(S6a_r11AttributeName.LoggingInterval);
    }
    ...
    public LoggingInterval getLoggingInterval() throws NoSuchAttributeException {
        return (LoggingInterval)_data.getContainer().get(S6a_r11AttributeName.LoggingInterval, 0);
    }
    ...
    public void setLoggingInterval(LoggingInterval avp) {
        _data.getContainer().add(S6a_r11AttributeName.LoggingInterval, avp.getData(), true);
    }
    ...
    public boolean containsLoggingDuration() {
        return _data.getContainer().contains(S6a_r11AttributeName.LoggingDuration);
    }
    ...
    public LoggingDuration getLoggingDuration() throws NoSuchAttributeException {
        return (LoggingDuration)_data.getContainer().get(S6a_r11AttributeName.LoggingDuration, 0);
    }
    ...
    public void setLoggingDuration(LoggingDuration avp) {
        _data.getContainer().add(S6a_r11AttributeName.LoggingDuration, avp.getData(), true);
    }
