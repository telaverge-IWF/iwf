...
public class AuthenticationInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countEUTRANVector() {
        return _data.getContainer().count(S6a_r11AttributeName.EUTRANVector);
    }
    ...
    public EUTRANVector getEUTRANVector(int index) throws NoSuchAttributeException {
        return (EUTRANVector)_data.getContainer().get(S6a_r11AttributeName.EUTRANVector, index);
    }
    ...
    public void addEUTRANVector(EUTRANVector avp) {
        _data.getContainer().add(S6a_r11AttributeName.EUTRANVector, avp.getData(), false);
    }
    ...
    public int countUTRANVector() {
        return _data.getContainer().count(S6a_r11AttributeName.UTRANVector);
    }
    ...
    public UTRANVector getUTRANVector(int index) throws NoSuchAttributeException {
        return (UTRANVector)_data.getContainer().get(S6a_r11AttributeName.UTRANVector, index);
    }
    ...
    public void addUTRANVector(UTRANVector avp) {
        _data.getContainer().add(S6a_r11AttributeName.UTRANVector, avp.getData(), false);
    }
    ...
    public int countGERANVector() {
        return _data.getContainer().count(S6a_r11AttributeName.GERANVector);
    }
    ...
    public GERANVector getGERANVector(int index) throws NoSuchAttributeException {
        return (GERANVector)_data.getContainer().get(S6a_r11AttributeName.GERANVector, index);
    }
    ...
    public void addGERANVector(GERANVector avp) {
        _data.getContainer().add(S6a_r11AttributeName.GERANVector, avp.getData(), false);
    }
