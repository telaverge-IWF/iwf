...
public class TerminalInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsIMEI() {
        return _data.getContainer().contains(S6a_r11AttributeName.IMEI);
    }
    ...
    public IMEI getIMEI() throws NoSuchAttributeException {
        return (IMEI)_data.getContainer().get(S6a_r11AttributeName.IMEI, 0);
    }
    ...
    public void setIMEI(IMEI avp) {
        _data.getContainer().add(S6a_r11AttributeName.IMEI, avp.getData(), true);
    }
    ...
    public boolean containsS6a3GPP2MEID() {
        return _data.getContainer().contains(S6a_r11AttributeName.S6a3GPP2MEID);
    }
    ...
    public S6a3GPP2MEID getS6a3GPP2MEID() throws NoSuchAttributeException {
        return (S6a3GPP2MEID)_data.getContainer().get(S6a_r11AttributeName.S6a3GPP2MEID, 0);
    }
    ...
    public void setS6a3GPP2MEID(S6a3GPP2MEID avp) {
        _data.getContainer().add(S6a_r11AttributeName.S6a3GPP2MEID, avp.getData(), true);
    }
    ...
    public boolean containsSoftwareVersion() {
        return _data.getContainer().contains(S6a_r11AttributeName.SoftwareVersion);
    }
    ...
    public SoftwareVersion getSoftwareVersion() throws NoSuchAttributeException {
        return (SoftwareVersion)_data.getContainer().get(S6a_r11AttributeName.SoftwareVersion, 0);
    }
    ...
    public void setSoftwareVersion(SoftwareVersion avp) {
        _data.getContainer().add(S6a_r11AttributeName.SoftwareVersion, avp.getData(), true);
    }
