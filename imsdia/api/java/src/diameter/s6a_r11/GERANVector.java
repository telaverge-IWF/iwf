...
public class GERANVector extends com.intellinet.diameter.GroupedAVP {
    ...
    public SRES getSRES() throws NoSuchAttributeException {
        return (SRES)_data.getContainer().get(S6a_r11AttributeName.SRES, 0);
    }
    ...
    public void setSRES(SRES avp) {
        _data.getContainer().add(S6a_r11AttributeName.SRES, avp.getData(), true);
    }
    ...
    public Kc getKc() throws NoSuchAttributeException {
        return (Kc)_data.getContainer().get(S6a_r11AttributeName.Kc, 0);
    }
    ...
    public void setKc(Kc avp) {
        _data.getContainer().add(S6a_r11AttributeName.Kc, avp.getData(), true);
    }
