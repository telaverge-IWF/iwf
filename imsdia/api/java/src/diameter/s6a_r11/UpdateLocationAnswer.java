...
/**
   * The Update-Location-Answer (ULA) command, indicated by the Command-Code 
   * field set to 316 and the 'R' bit cleared in the Command Flags field, 
   * is sent from HSS to MME or SGSN.
   */
public class UpdateLocationAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new UpdateLocationAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public UpdateLocationAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 316, 16777251);
    }

    /**
     * Constructs a UpdateLocationAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public UpdateLocationAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a UpdateLocationAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public UpdateLocationAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    UpdateLocationAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any ULAFlags.
     */
    public boolean containsULAFlags() {
        return _data.getContainer().contains(S6a_r11AttributeName.ULAFlags);
    }

    /**
     * Gets the ULAFlags.
     */
    public ULAFlags getULAFlags() throws NoSuchAttributeException {
        return (ULAFlags)_data.getContainer().get(S6a_r11AttributeName.ULAFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setULAFlags(ULAFlags avp) {
        _data.getContainer().add(S6a_r11AttributeName.ULAFlags, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any ErrorDiagnostic.
     */
    public boolean containsErrorDiagnostic() {
        return _data.getContainer().contains(S6a_r11AttributeName.ErrorDiagnostic);
    }

    /**
     * Gets the ErrorDiagnostic.
     */
    public ErrorDiagnostic getErrorDiagnostic() throws NoSuchAttributeException {
        return (ErrorDiagnostic)_data.getContainer().get(S6a_r11AttributeName.ErrorDiagnostic, 0);
    }

    /**
     * Sets the ErrorDiagnostic.
     *
     * @param avp - the attribute value
     */
    public void setErrorDiagnostic(ErrorDiagnostic avp) {
        _data.getContainer().add(S6a_r11AttributeName.ErrorDiagnostic, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any SubscriptionData.
     */
    public boolean containsSubscriptionData() {
        return _data.getContainer().contains(S6a_r11AttributeName.SubscriptionData);
    }

    /**
     * Gets the SubscriptionData.
     */
    public SubscriptionData getSubscriptionData() throws NoSuchAttributeException {
        return (SubscriptionData)_data.getContainer().get(S6a_r11AttributeName.SubscriptionData, 0);
    }

    /**
     * Sets the SubscriptionData.
     *
     * @param avp - the attribute value
     */
    public void setSubscriptionData(SubscriptionData avp) {
        _data.getContainer().add(S6a_r11AttributeName.SubscriptionData, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        if (containsErrorDiagnostic()) {
            sb.append("    ErrorDiagnostic:");
            try {
                sb.append(getErrorDiagnostic()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
        ...
        if (containsSubscriptionData()) {
            sb.append("    SubscriptionData:");
            try {
                sb.append(getSubscriptionData()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
