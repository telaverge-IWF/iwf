...
public class PDPContext extends com.intellinet.diameter.GroupedAVP {
    ...
    public PDPType getPDPType() throws NoSuchAttributeException {
        return (PDPType)_data.getContainer().get(S6a_r11AttributeName.PDPType, 0);
    }
    ...
    public void setPDPType(PDPType avp) {
        _data.getContainer().add(S6a_r11AttributeName.PDPType, avp.getData(), true);
    }
    ...
    public QoSSubscribed getQoSSubscribed() throws NoSuchAttributeException {
        return (QoSSubscribed)_data.getContainer().get(S6a_r11AttributeName.QoSSubscribed, 0);
    }
    ...
    public void setQoSSubscribed(QoSSubscribed avp) {
        _data.getContainer().add(S6a_r11AttributeName.QoSSubscribed, avp.getData(), true);
    }
    ...
    public boolean containsPDPAddress() {
        return _data.getContainer().contains(S6a_r11AttributeName.PDPAddress);
    }
    ...
    public PDPAddress getPDPAddress() throws NoSuchAttributeException {
        return (PDPAddress)_data.getContainer().get(S6a_r11AttributeName.PDPAddress, 0);
    }
    ...
    public void setPDPAddress(PDPAddress avp) {
        _data.getContainer().add(S6a_r11AttributeName.PDPAddress, avp.getData(), true);
    }
    ...
    public boolean containsVPLMNDynamicAddressAllowed() {
        return _data.getContainer().contains(S6a_r11AttributeName.VPLMNDynamicAddressAllowed);
    }
    ...
    public VPLMNDynamicAddressAllowed getVPLMNDynamicAddressAllowed() throws NoSuchAttributeException {
        return (VPLMNDynamicAddressAllowed)_data.getContainer().get(S6a_r11AttributeName.VPLMNDynamicAddressAllowed, 0);
    }
    ...
    public void setVPLMNDynamicAddressAllowed(VPLMNDynamicAddressAllowed avp) {
        _data.getContainer().add(S6a_r11AttributeName.VPLMNDynamicAddressAllowed, avp.getData(), true);
    }
    ...
    public boolean containsExtPDPType() {
        return _data.getContainer().contains(S6a_r11AttributeName.ExtPDPType);
    }
    ...
    public ExtPDPType getExtPDPType() throws NoSuchAttributeException {
        return (ExtPDPType)_data.getContainer().get(S6a_r11AttributeName.ExtPDPType, 0);
    }
    ...
    public void setExtPDPType(ExtPDPType avp) {
        _data.getContainer().add(S6a_r11AttributeName.ExtPDPType, avp.getData(), true);
    }
    ...
    public boolean containsExtPDPAddress() {
        return _data.getContainer().contains(S6a_r11AttributeName.ExtPDPAddress);
    }
    ...
    public ExtPDPAddress getExtPDPAddress() throws NoSuchAttributeException {
        return (ExtPDPAddress)_data.getContainer().get(S6a_r11AttributeName.ExtPDPAddress, 0);
    }
    ...
    public void setExtPDPAddress(ExtPDPAddress avp) {
        _data.getContainer().add(S6a_r11AttributeName.ExtPDPAddress, avp.getData(), true);
    }
    ...
    public boolean containsSIPTOPermission() {
        return _data.getContainer().contains(S6a_r11AttributeName.SIPTOPermission);
    }
    ...
    public SIPTOPermission getSIPTOPermission() throws NoSuchAttributeException {
        return (SIPTOPermission)_data.getContainer().get(S6a_r11AttributeName.SIPTOPermission, 0);
    }
    ...
    public void setSIPTOPermission(SIPTOPermission avp) {
        _data.getContainer().add(S6a_r11AttributeName.SIPTOPermission, avp.getData(), true);
    }
    ...
    public boolean containsLIPAPermission() {
        return _data.getContainer().contains(S6a_r11AttributeName.LIPAPermission);
    }
    ...
    public LIPAPermission getLIPAPermission() throws NoSuchAttributeException {
        return (LIPAPermission)_data.getContainer().get(S6a_r11AttributeName.LIPAPermission, 0);
    }
    ...
    public void setLIPAPermission(LIPAPermission avp) {
        _data.getContainer().add(S6a_r11AttributeName.LIPAPermission, avp.getData(), true);
    }
