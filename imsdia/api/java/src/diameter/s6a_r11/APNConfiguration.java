...
public class APNConfiguration extends com.intellinet.diameter.GroupedAVP {
    ...
    public PDNType getPDNType() throws NoSuchAttributeException {
        return (PDNType)_data.getContainer().get(S6a_r11AttributeName.PDNType, 0);
    }
    ...
    public void setPDNType(PDNType avp) {
        _data.getContainer().add(S6a_r11AttributeName.PDNType, avp.getData(), true);
    }
    ...
    public int countServedPartyIPAddress() {
        return _data.getContainer().count(S6a_r11AttributeName.ServedPartyIPAddress);
    }
    ...
    public ServedPartyIPAddress getServedPartyIPAddress(int index) throws NoSuchAttributeException {
        return (ServedPartyIPAddress)_data.getContainer().get(S6a_r11AttributeName.ServedPartyIPAddress, index);
    }
    ...
    public void addServedPartyIPAddress(ServedPartyIPAddress avp) {
        _data.getContainer().add(S6a_r11AttributeName.ServedPartyIPAddress, avp.getData(), false);
    }
    ...
    public boolean containsEPSSubscribedQoSProfile() {
        return _data.getContainer().contains(S6a_r11AttributeName.EPSSubscribedQoSProfile);
    }
    ...
    public EPSSubscribedQoSProfile getEPSSubscribedQoSProfile() throws NoSuchAttributeException {
        return (EPSSubscribedQoSProfile)_data.getContainer().get(S6a_r11AttributeName.EPSSubscribedQoSProfile, 0);
    }
    ...
    public void setEPSSubscribedQoSProfile(EPSSubscribedQoSProfile avp) {
        _data.getContainer().add(S6a_r11AttributeName.EPSSubscribedQoSProfile, avp.getData(), true);
    }
    ...
    public boolean containsPDNGWAllocationType() {
        return _data.getContainer().contains(S6a_r11AttributeName.PDNGWAllocationType);
    }
    ...
    public PDNGWAllocationType getPDNGWAllocationType() throws NoSuchAttributeException {
        return (PDNGWAllocationType)_data.getContainer().get(S6a_r11AttributeName.PDNGWAllocationType, 0);
    }
    ...
    public void setPDNGWAllocationType(PDNGWAllocationType avp) {
        _data.getContainer().add(S6a_r11AttributeName.PDNGWAllocationType, avp.getData(), true);
    }
