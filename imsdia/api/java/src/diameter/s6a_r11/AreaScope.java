...
public class AreaScope extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countCellGlobalIdentity() {
        return _data.getContainer().count(S6a_r11AttributeName.CellGlobalIdentity);
    }
    ...
    public CellGlobalIdentity getCellGlobalIdentity(int index) throws NoSuchAttributeException {
        return (CellGlobalIdentity)_data.getContainer().get(S6a_r11AttributeName.CellGlobalIdentity, index);
    }
    ...
    public void addCellGlobalIdentity(CellGlobalIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.CellGlobalIdentity, avp.getData(), false);
    }
    ...
    public int countEUTRANCellGlobalIdentity() {
        return _data.getContainer().count(S6a_r11AttributeName.EUTRANCellGlobalIdentity);
    }
    ...
    public EUTRANCellGlobalIdentity getEUTRANCellGlobalIdentity(int index) throws NoSuchAttributeException {
        return (EUTRANCellGlobalIdentity)_data.getContainer().get(S6a_r11AttributeName.EUTRANCellGlobalIdentity, index);
    }
    ...
    public void addEUTRANCellGlobalIdentity(EUTRANCellGlobalIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.EUTRANCellGlobalIdentity, avp.getData(), false);
    }
    ...
    public int countRoutingAreaIdentity() {
        return _data.getContainer().count(S6a_r11AttributeName.RoutingAreaIdentity);
    }
    ...
    public RoutingAreaIdentity getRoutingAreaIdentity(int index) throws NoSuchAttributeException {
        return (RoutingAreaIdentity)_data.getContainer().get(S6a_r11AttributeName.RoutingAreaIdentity, index);
    }
    ...
    public void addRoutingAreaIdentity(RoutingAreaIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.RoutingAreaIdentity, avp.getData(), false);
    }
    ...
    public int countLocationAreaIdentity() {
        return _data.getContainer().count(S6a_r11AttributeName.LocationAreaIdentity);
    }
    ...
    public LocationAreaIdentity getLocationAreaIdentity(int index) throws NoSuchAttributeException {
        return (LocationAreaIdentity)_data.getContainer().get(S6a_r11AttributeName.LocationAreaIdentity, index);
    }
    ...
    public void addLocationAreaIdentity(LocationAreaIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.LocationAreaIdentity, avp.getData(), false);
    }
    ...
    public int countTrackingAreaIdentity() {
        return _data.getContainer().count(S6a_r11AttributeName.TrackingAreaIdentity);
    }
    ...
    public TrackingAreaIdentity getTrackingAreaIdentity(int index) throws NoSuchAttributeException {
        return (TrackingAreaIdentity)_data.getContainer().get(S6a_r11AttributeName.TrackingAreaIdentity, index);
    }
    ...
    public void addTrackingAreaIdentity(TrackingAreaIdentity avp) {
        _data.getContainer().add(S6a_r11AttributeName.TrackingAreaIdentity, avp.getData(), false);
    }
