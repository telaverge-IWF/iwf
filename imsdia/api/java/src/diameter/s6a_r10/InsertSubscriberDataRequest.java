...
/**
   ...
   * Command-Code field set to 319 and the 'R' bit set in the Command Flags 
   * field, is sent from HSS to MME or SGSN. 
   */
public class InsertSubscriberDataRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new InsertSubscriberDataRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public InsertSubscriberDataRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 319, 16777251);
    }

    /**
     * Constructs a InsertSubscriberDataRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public InsertSubscriberDataRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a InsertSubscriberDataRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public InsertSubscriberDataRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    InsertSubscriberDataRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any IDRFlags.
     */
    public boolean containsIDRFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.IDRFlags);
    }

    /**
     * Gets the IDRFlags.
     */
    public IDRFlags getIDRFlags() throws NoSuchAttributeException {
        return (IDRFlags)_data.getContainer().get(S6a_r10AttributeName.IDRFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setIDRFlags(IDRFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.IDRFlags, avp.getData(), true);
    }
