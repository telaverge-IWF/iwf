...
public class SupportedFeatures extends com.intellinet.diameter.GroupedAVP {
    ...
    public FeatureListID getFeatureListID() throws NoSuchAttributeException {
        return (FeatureListID)_data.getContainer().get(S6a_r10AttributeName.FeatureListID, 0);
    }
    ...
    public void setFeatureListID(FeatureListID avp) {
        _data.getContainer().add(S6a_r10AttributeName.FeatureListID, avp.getData(), true);
    }
    ...
    public FeatureList getFeatureList() throws NoSuchAttributeException {
        return (FeatureList)_data.getContainer().get(S6a_r10AttributeName.FeatureList, 0);
    }
    ...
    public void setFeatureList(FeatureList avp) {
        _data.getContainer().add(S6a_r10AttributeName.FeatureList, avp.getData(), true);
    }
