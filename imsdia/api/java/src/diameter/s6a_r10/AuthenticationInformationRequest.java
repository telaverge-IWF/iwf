...
/**
* The Authentication-Information-Request (AIR) command, indicated by the Command-Code 
* field set to 318 and the 'R' bit set in the Command Flags field, is sent from 
* MME or SGSN to HSS.  
*/
public class AuthenticationInformationRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new AuthenticationInformationRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public AuthenticationInformationRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 318, 16777251);
    }

    /**
     * Constructs a AuthenticationInformationRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public AuthenticationInformationRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a AuthenticationInformationRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public AuthenticationInformationRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    AuthenticationInformationRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    public VisitedPLMNId getVisitedPLMNId() throws NoSuchAttributeException {
        return (VisitedPLMNId)_data.getContainer().get(S6a_r10AttributeName.VisitedPLMNId, 0);
    }
    ...
    public void setVisitedPLMNId(VisitedPLMNId avp) {
        _data.getContainer().add(S6a_r10AttributeName.VisitedPLMNId, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any RequestedEUTRANAuthenticationInfo.
     */
    public boolean containsRequestedEUTRANAuthenticationInfo() {
        return _data.getContainer().contains(S6a_r10AttributeName.RequestedEUTRANAuthenticationInfo);
    }

    /**
     * Gets the RequestedEUTRANAuthenticationInfo.
     */
    public RequestedEUTRANAuthenticationInfo getRequestedEUTRANAuthenticationInfo() throws NoSuchAttributeException {
        return (RequestedEUTRANAuthenticationInfo)_data.getContainer().get(S6a_r10AttributeName.RequestedEUTRANAuthenticationInfo, 0);
    }

    /**
     * Sets the RequestedEUTRANAuthenticationInfo.
     *
     * @param avp - the attribute value
     */
    public void setRequestedEUTRANAuthenticationInfo(RequestedEUTRANAuthenticationInfo avp) {
        _data.getContainer().add(S6a_r10AttributeName.RequestedEUTRANAuthenticationInfo, avp.getData(), true);
    }

    /**
     * Tests whether there is any RequestedUTRANGERANAuthenticationInfo.
     */
    public boolean containsRequestedUTRANGERANAuthenticationInfo() {
        return _data.getContainer().contains(S6a_r10AttributeName.RequestedUTRANGERANAuthenticationInfo);
    }

    /**
     * Gets the RequestedUTRANGERANAuthenticationInfo.
     */
    public RequestedUTRANGERANAuthenticationInfo getRequestedUTRANGERANAuthenticationInfo() throws NoSuchAttributeException {
        return (RequestedUTRANGERANAuthenticationInfo)_data.getContainer().get(S6a_r10AttributeName.RequestedUTRANGERANAuthenticationInfo, 0);
    }

    /**
     * Sets the RequestedUTRANGERANAuthenticationInfo.
     *
     * @param avp - the attribute value
     */
    public void setRequestedUTRANGERANAuthenticationInfo(RequestedUTRANGERANAuthenticationInfo avp) {
        _data.getContainer().add(S6a_r10AttributeName.RequestedUTRANGERANAuthenticationInfo, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        if (containsRequestedEUTRANAuthenticationInfo()) {
            sb.append("    RequestedEUTRANAuthenticationInfo:");
            try {
                sb.append(getRequestedEUTRANAuthenticationInfo()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
        if (containsRequestedUTRANGERANAuthenticationInfo()) {
            sb.append("    RequestedUTRANGERANAuthenticationInfo:");
            try {
                sb.append(getRequestedUTRANGERANAuthenticationInfo()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
