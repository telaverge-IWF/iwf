...
public class UpdateLocationRequest extends com.intellinet.diameter.Command {
    ...
    public ULRFlags getULRFlags() throws NoSuchAttributeException {
        return (ULRFlags)_data.getContainer().get(S6a_r10AttributeName.ULRFlags, 0);
    }
    ...
    public void setULRFlags(ULRFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.ULRFlags, avp.getData(), true);
    }
    ...
    public boolean containsSGSNNumber() {
        return _data.getContainer().contains(S6a_r10AttributeName.SGSNNumber);
    }
    ...
    public SGSNNumber getSGSNNumber() throws NoSuchAttributeException {
        return (SGSNNumber)_data.getContainer().get(S6a_r10AttributeName.SGSNNumber, 0);
    }
    ...
    public void setSGSNNumber(SGSNNumber avp) {
        _data.getContainer().add(S6a_r10AttributeName.SGSNNumber, avp.getData(), true);
    }
    ...
    public boolean containsHomogeneousSupportofIMSVoiceOverPSSessions() {
        return _data.getContainer().contains(S6a_r10AttributeName.HomogeneousSupportofIMSVoiceOverPSSessions);
    }
    ...
    public HomogeneousSupportofIMSVoiceOverPSSessions getHomogeneousSupportofIMSVoiceOverPSSessions() throws NoSuchAttributeException {
        return (HomogeneousSupportofIMSVoiceOverPSSessions)_data.getContainer().get(S6a_r10AttributeName.HomogeneousSupportofIMSVoiceOverPSSessions, 0);
    }
    ...
    public void setHomogeneousSupportofIMSVoiceOverPSSessions(HomogeneousSupportofIMSVoiceOverPSSessions avp) {
        _data.getContainer().add(S6a_r10AttributeName.HomogeneousSupportofIMSVoiceOverPSSessions, avp.getData(), true);
    }
    ...
    public boolean containsGMLCAddress() {
        return _data.getContainer().contains(S6a_r10AttributeName.GMLCAddress);
    }
    ...
    public GMLCAddress getGMLCAddress() throws NoSuchAttributeException {
        return (GMLCAddress)_data.getContainer().get(S6a_r10AttributeName.GMLCAddress, 0);
    }
    ...
    public void setGMLCAddress(GMLCAddress avp) {
        _data.getContainer().add(S6a_r10AttributeName.GMLCAddress, avp.getData(), true);
    }
    ...
    public int countActiveAPN() {
        return _data.getContainer().count(S6a_r10AttributeName.ActiveAPN);
    }
    ...
    public ActiveAPN getActiveAPN(int index) throws NoSuchAttributeException {
        return (ActiveAPN)_data.getContainer().get(S6a_r10AttributeName.ActiveAPN, index);
    }
    ...
    public void addActiveAPN(ActiveAPN avp) {
        _data.getContainer().add(S6a_r10AttributeName.ActiveAPN, avp.getData(), false);
    }
