...
public class EPSUserState extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsMMEUserState() {
        return _data.getContainer().contains(S6a_r10AttributeName.MMEUserState);
    }
    ...
    public MMEUserState getMMEUserState() throws NoSuchAttributeException {
        return (MMEUserState)_data.getContainer().get(S6a_r10AttributeName.MMEUserState, 0);
    }
    ...
    public void setMMEUserState(MMEUserState avp) {
        _data.getContainer().add(S6a_r10AttributeName.MMEUserState, avp.getData(), true);
    }
    ...
    public boolean containsSGSNUserState() {
        return _data.getContainer().contains(S6a_r10AttributeName.SGSNUserState);
    }
    ...
    public SGSNUserState getSGSNUserState() throws NoSuchAttributeException {
        return (SGSNUserState)_data.getContainer().get(S6a_r10AttributeName.SGSNUserState, 0);
    }
    ...
    public void setSGSNUserState(SGSNUserState avp) {
        _data.getContainer().add(S6a_r10AttributeName.SGSNUserState, avp.getData(), true);
    }
