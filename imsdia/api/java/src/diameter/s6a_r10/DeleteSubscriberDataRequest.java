...
/**
   ...
   */
public class DeleteSubscriberDataRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new DeleteSubscriberDataRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public DeleteSubscriberDataRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 320, 16777251);
    }

    /**
     * Constructs a DeleteSubscriberDataRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public DeleteSubscriberDataRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a DeleteSubscriberDataRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public DeleteSubscriberDataRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    DeleteSubscriberDataRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
     ...
     * Gets the DSRFlags.
     */
    public DSRFlags getDSRFlags() throws NoSuchAttributeException {
        return (DSRFlags)_data.getContainer().get(S6a_r10AttributeName.DSRFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setDSRFlags(DSRFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.DSRFlags, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any TraceReference.
     */
    public boolean containsTraceReference() {
        return _data.getContainer().contains(S6a_r10AttributeName.TraceReference);
    }
    ...
    public TraceReference getTraceReference() throws NoSuchAttributeException {
        return (TraceReference)_data.getContainer().get(S6a_r10AttributeName.TraceReference, 0);
    }
    ...
    public void setTraceReference(TraceReference avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceReference, avp.getData(), true);
    }
    ...
    public int countTSCode() {
        return _data.getContainer().count(S6a_r10AttributeName.TSCode);
    }
    ...
    public TSCode getTSCode(int index) throws NoSuchAttributeException {
        return (TSCode)_data.getContainer().get(S6a_r10AttributeName.TSCode, index);
    }
    ...
    public void addTSCode(TSCode avp) {
        _data.getContainer().add(S6a_r10AttributeName.TSCode, avp.getData(), false);
    }
    ...
    public int countSSCode() {
        return _data.getContainer().count(S6a_r10AttributeName.SSCode);
    }
    ...
    public SSCode getSSCode(int index) throws NoSuchAttributeException {
        return (SSCode)_data.getContainer().get(S6a_r10AttributeName.SSCode, index);
    }
    ...
    public void addSSCode(SSCode avp) {
        _data.getContainer().add(S6a_r10AttributeName.SSCode, avp.getData(), false);
    }
    ...
    /**
     * Returns number of ContextIdentifier instances.
     */
    public int countContextIdentifier() {
        return _data.getContainer().count(S6a_r10AttributeName.ContextIdentifier);
    }

    /**
     * Gets one ContextIdentifier.
     *
     * @param index - the index of the attribute to return
     */
    public ContextIdentifier getContextIdentifier(int index) throws NoSuchAttributeException {
        return (ContextIdentifier)_data.getContainer().get(S6a_r10AttributeName.ContextIdentifier, index);
    }

    /**
     * Adds one ContextIdentifier.
     *
     * @param avp - the attribute value
     */
    public void addContextIdentifier(ContextIdentifier avp) {
        _data.getContainer().add(S6a_r10AttributeName.ContextIdentifier, avp.getData(), false);
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < countContextIdentifier(); ++i) {
            sb.append("    ContextIdentifier:");
            try {
                sb.append(getContextIdentifier(i)).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
    ...
    private void validate() throws WrongCommandTypeException {
        if (getCommandCode() != 320 || !isRequest()) {
