...
public class CancelLocationRequest extends com.intellinet.diameter.Command {
    ...
    public CancellationType getCancellationType() throws NoSuchAttributeException {
        return (CancellationType)_data.getContainer().get(S6a_r10AttributeName.CancellationType, 0);
    }
    ...
    public void setCancellationType(CancellationType avp) {
        _data.getContainer().add(S6a_r10AttributeName.CancellationType, avp.getData(), true);
    }
    ...
    public boolean containsCLRFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.CLRFlags);
    }
    ...
    public CLRFlags getCLRFlags() throws NoSuchAttributeException {
        return (CLRFlags)_data.getContainer().get(S6a_r10AttributeName.CLRFlags, 0);
    }
    ...
    public void setCLRFlags(CLRFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.CLRFlags, avp.getData(), true);
    }
