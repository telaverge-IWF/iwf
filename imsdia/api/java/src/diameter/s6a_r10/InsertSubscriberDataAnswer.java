...
public class InsertSubscriberDataAnswer extends com.intellinet.diameter.Command {
    ...
    public boolean containsIMSVoiceOverPSSessionsSupported() {
        return _data.getContainer().contains(S6a_r10AttributeName.IMSVoiceOverPSSessionsSupported);
    }
    ...
    public IMSVoiceOverPSSessionsSupported getIMSVoiceOverPSSessionsSupported() throws NoSuchAttributeException {
        return (IMSVoiceOverPSSessionsSupported)_data.getContainer().get(S6a_r10AttributeName.IMSVoiceOverPSSessionsSupported, 0);
    }
    ...
    public void setIMSVoiceOverPSSessionsSupported(IMSVoiceOverPSSessionsSupported avp) {
        _data.getContainer().add(S6a_r10AttributeName.IMSVoiceOverPSSessionsSupported, avp.getData(), true);
    }
    ...
    public boolean containsLastUEActivityTime() {
        return _data.getContainer().contains(S6a_r10AttributeName.LastUEActivityTime);
    }
    ...
    public LastUEActivityTime getLastUEActivityTime() throws NoSuchAttributeException {
        return (LastUEActivityTime)_data.getContainer().get(S6a_r10AttributeName.LastUEActivityTime, 0);
    }
    ...
    public void setLastUEActivityTime(LastUEActivityTime avp) {
        _data.getContainer().add(S6a_r10AttributeName.LastUEActivityTime, avp.getData(), true);
    }
    ...
    public boolean containsRATType() {
        return _data.getContainer().contains(S6a_r10AttributeName.RATType);
    }
    ...
    public RATType getRATType() throws NoSuchAttributeException {
        return (RATType)_data.getContainer().get(S6a_r10AttributeName.RATType, 0);
    }
    ...
    public void setRATType(RATType avp) {
        _data.getContainer().add(S6a_r10AttributeName.RATType, avp.getData(), true);
    }
    ...
    public boolean containsIDAFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.IDAFlags);
    }
    ...
    public IDAFlags getIDAFlags() throws NoSuchAttributeException {
        return (IDAFlags)_data.getContainer().get(S6a_r10AttributeName.IDAFlags, 0);
    }
    ...
    public void setIDAFlags(IDAFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.IDAFlags, avp.getData(), true);
    }
    ...
    public boolean containsEPSUserState() {
        return _data.getContainer().contains(S6a_r10AttributeName.EPSUserState);
    }
    ...
    public EPSUserState getEPSUserState() throws NoSuchAttributeException {
        return (EPSUserState)_data.getContainer().get(S6a_r10AttributeName.EPSUserState, 0);
    }
    ...
    public void setEPSUserState(EPSUserState avp) {
        _data.getContainer().add(S6a_r10AttributeName.EPSUserState, avp.getData(), true);
    }
    ...
    public boolean containsEPSLocationInformation() {
        return _data.getContainer().contains(S6a_r10AttributeName.EPSLocationInformation);
    }
    ...
    public EPSLocationInformation getEPSLocationInformation() throws NoSuchAttributeException {
        return (EPSLocationInformation)_data.getContainer().get(S6a_r10AttributeName.EPSLocationInformation, 0);
    }
    ...
    public void setEPSLocationInformation(EPSLocationInformation avp) {
        _data.getContainer().add(S6a_r10AttributeName.EPSLocationInformation, avp.getData(), true);
    }
