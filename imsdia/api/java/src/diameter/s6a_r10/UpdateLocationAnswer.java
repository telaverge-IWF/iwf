...
public class UpdateLocationAnswer extends com.intellinet.diameter.Command {
    ...
    public boolean containsULAFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.ULAFlags);
    }
    ...
    public ULAFlags getULAFlags() throws NoSuchAttributeException {
        return (ULAFlags)_data.getContainer().get(S6a_r10AttributeName.ULAFlags, 0);
    }
    ...
    public void setULAFlags(ULAFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.ULAFlags, avp.getData(), true);
    }
    ...
    public boolean containsErrorDiagnostic() {
        return _data.getContainer().contains(S6a_r10AttributeName.ErrorDiagnostic);
    }
    ...
    public ErrorDiagnostic getErrorDiagnostic() throws NoSuchAttributeException {
        return (ErrorDiagnostic)_data.getContainer().get(S6a_r10AttributeName.ErrorDiagnostic, 0);
    }
    ...
    public void setErrorDiagnostic(ErrorDiagnostic avp) {
        _data.getContainer().add(S6a_r10AttributeName.ErrorDiagnostic, avp.getData(), true);
    }
    ...
    public boolean containsSubscriptionData() {
        return _data.getContainer().contains(S6a_r10AttributeName.SubscriptionData);
    }
    ...
    public SubscriptionData getSubscriptionData() throws NoSuchAttributeException {
        return (SubscriptionData)_data.getContainer().get(S6a_r10AttributeName.SubscriptionData, 0);
    }
    ...
    public void setSubscriptionData(SubscriptionData avp) {
        _data.getContainer().add(S6a_r10AttributeName.SubscriptionData, avp.getData(), true);
    }
