...
public class ResetRequest extends com.intellinet.diameter.Command {
    ...
    public int countUserId() {
        return _data.getContainer().count(S6a_r10AttributeName.UserId);
    }
    ...
    public UserId getUserId(int index) throws NoSuchAttributeException {
        return (UserId)_data.getContainer().get(S6a_r10AttributeName.UserId, index);
    }
    ...
    public void addUserId(UserId avp) {
        _data.getContainer().add(S6a_r10AttributeName.UserId, avp.getData(), false);
    }
