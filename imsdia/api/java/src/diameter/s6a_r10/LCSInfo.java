...
public class LCSInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countGMLCNumber() {
        return _data.getContainer().count(S6a_r10AttributeName.GMLCNumber);
    }
    ...
    public GMLCNumber getGMLCNumber(int index) throws NoSuchAttributeException {
        return (GMLCNumber)_data.getContainer().get(S6a_r10AttributeName.GMLCNumber, index);
    }
    ...
    public void addGMLCNumber(GMLCNumber avp) {
        _data.getContainer().add(S6a_r10AttributeName.GMLCNumber, avp.getData(), false);
    }
    ...
    public int countLCSPrivacyException() {
        return _data.getContainer().count(S6a_r10AttributeName.LCSPrivacyException);
    }
    ...
    public LCSPrivacyException getLCSPrivacyException(int index) throws NoSuchAttributeException {
        return (LCSPrivacyException)_data.getContainer().get(S6a_r10AttributeName.LCSPrivacyException, index);
    }
    ...
    public void addLCSPrivacyException(LCSPrivacyException avp) {
        _data.getContainer().add(S6a_r10AttributeName.LCSPrivacyException, avp.getData(), false);
    }
    ...
    public int countMOLR() {
        return _data.getContainer().count(S6a_r10AttributeName.MOLR);
    }
    ...
    public MOLR getMOLR(int index) throws NoSuchAttributeException {
        return (MOLR)_data.getContainer().get(S6a_r10AttributeName.MOLR, index);
    }
    ...
    public void addMOLR(MOLR avp) {
        _data.getContainer().add(S6a_r10AttributeName.MOLR, avp.getData(), false);
    }
