...
public class UTRANVector extends com.intellinet.diameter.GroupedAVP {
    ...
    public CK getCK() throws NoSuchAttributeException {
        return (CK)_data.getContainer().get(S6a_r10AttributeName.CK, 0);
    }
    ...
    public void setCK(CK avp) {
        _data.getContainer().add(S6a_r10AttributeName.CK, avp.getData(), true);
    }
    ...
    public IK getIK() throws NoSuchAttributeException {
        return (IK)_data.getContainer().get(S6a_r10AttributeName.IK, 0);
    }
    ...
    public void setIK(IK avp) {
        _data.getContainer().add(S6a_r10AttributeName.IK, avp.getData(), true);
    }
