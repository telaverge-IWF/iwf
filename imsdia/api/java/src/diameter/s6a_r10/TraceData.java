...
public class TraceData extends com.intellinet.diameter.GroupedAVP {
    ...
    public TraceDepth getTraceDepth() throws NoSuchAttributeException {
        return (TraceDepth)_data.getContainer().get(S6a_r10AttributeName.TraceDepth, 0);
    }
    ...
    public void setTraceDepth(TraceDepth avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceDepth, avp.getData(), true);
    }
    ...
    public TraceNETypeList getTraceNETypeList() throws NoSuchAttributeException {
        return (TraceNETypeList)_data.getContainer().get(S6a_r10AttributeName.TraceNETypeList, 0);
    }
    ...
    public void setTraceNETypeList(TraceNETypeList avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceNETypeList, avp.getData(), true);
    }
    ...
    public TraceEventList getTraceEventList() throws NoSuchAttributeException {
        return (TraceEventList)_data.getContainer().get(S6a_r10AttributeName.TraceEventList, 0);
    }
    ...
    public void setTraceEventList(TraceEventList avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceEventList, avp.getData(), true);
    }
    ...
    public TraceCollectionEntity getTraceCollectionEntity() throws NoSuchAttributeException {
        return (TraceCollectionEntity)_data.getContainer().get(S6a_r10AttributeName.TraceCollectionEntity, 0);
    }
    ...
    public void setTraceCollectionEntity(TraceCollectionEntity avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceCollectionEntity, avp.getData(), true);
    }
    ...
    public boolean containsTraceInterfaceList() {
        return _data.getContainer().contains(S6a_r10AttributeName.TraceInterfaceList);
    }
    ...
    public TraceInterfaceList getTraceInterfaceList() throws NoSuchAttributeException {
        return (TraceInterfaceList)_data.getContainer().get(S6a_r10AttributeName.TraceInterfaceList, 0);
    }
    ...
    public void setTraceInterfaceList(TraceInterfaceList avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceInterfaceList, avp.getData(), true);
    }
    ...
    public boolean containsOMCId() {
        return _data.getContainer().contains(S6a_r10AttributeName.OMCId);
    }
    ...
    public OMCId getOMCId() throws NoSuchAttributeException {
        return (OMCId)_data.getContainer().get(S6a_r10AttributeName.OMCId, 0);
    }
    ...
    public void setOMCId(OMCId avp) {
        _data.getContainer().add(S6a_r10AttributeName.OMCId, avp.getData(), true);
    }
    ...
    public boolean containsMDTConfiguration() {
        return _data.getContainer().contains(S6a_r10AttributeName.MDTConfiguration);
    }
    ...
    public MDTConfiguration getMDTConfiguration() throws NoSuchAttributeException {
        return (MDTConfiguration)_data.getContainer().get(S6a_r10AttributeName.MDTConfiguration, 0);
    }
    ...
    public void setMDTConfiguration(MDTConfiguration avp) {
        _data.getContainer().add(S6a_r10AttributeName.MDTConfiguration, avp.getData(), true);
    }
