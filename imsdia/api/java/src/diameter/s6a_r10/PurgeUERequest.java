...
/**
   ...
   */
public class PurgeUERequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new PurgeUERequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public PurgeUERequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 321, 16777251);
    }

    /**
     * Constructs a PurgeUERequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public PurgeUERequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a PurgeUERequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public PurgeUERequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    PurgeUERequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any PURFlags.
     */
    public boolean containsPURFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.PURFlags);
    }

    /**
     * Gets the PURFlags.
     */
    public PURFlags getPURFlags() throws NoSuchAttributeException {
        return (PURFlags)_data.getContainer().get(S6a_r10AttributeName.PURFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setPURFlags(PURFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.PURFlags, avp.getData(), true);
    }
    ...
    private void validate() throws WrongCommandTypeException {
        if (getCommandCode() != 321 || !isRequest()) {
