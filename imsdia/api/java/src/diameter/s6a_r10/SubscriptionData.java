...
public class SubscriptionData extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsSubscriberStatus() {
        return _data.getContainer().contains(S6a_r10AttributeName.SubscriberStatus);
    }
    ...
    public SubscriberStatus getSubscriberStatus() throws NoSuchAttributeException {
        return (SubscriberStatus)_data.getContainer().get(S6a_r10AttributeName.SubscriberStatus, 0);
    }
    ...
    public void setSubscriberStatus(SubscriberStatus avp) {
        _data.getContainer().add(S6a_r10AttributeName.SubscriberStatus, avp.getData(), true);
    }
    ...
    public boolean containsMSISDN() {
        return _data.getContainer().contains(S6a_r10AttributeName.MSISDN);
    }
    ...
    public MSISDN getMSISDN() throws NoSuchAttributeException {
        return (MSISDN)_data.getContainer().get(S6a_r10AttributeName.MSISDN, 0);
    }
    ...
    public void setMSISDN(MSISDN avp) {
        _data.getContainer().add(S6a_r10AttributeName.MSISDN, avp.getData(), true);
    }
    ...
    public boolean containsSTNSR() {
        return _data.getContainer().contains(S6a_r10AttributeName.STNSR);
    }
    ...
    public STNSR getSTNSR() throws NoSuchAttributeException {
        return (STNSR)_data.getContainer().get(S6a_r10AttributeName.STNSR, 0);
    }
    ...
    public void setSTNSR(STNSR avp) {
        _data.getContainer().add(S6a_r10AttributeName.STNSR, avp.getData(), true);
    }
    ...
    public boolean containsICSIndicator() {
        return _data.getContainer().contains(S6a_r10AttributeName.ICSIndicator);
    }
    ...
    public ICSIndicator getICSIndicator() throws NoSuchAttributeException {
        return (ICSIndicator)_data.getContainer().get(S6a_r10AttributeName.ICSIndicator, 0);
    }
    ...
    public void setICSIndicator(ICSIndicator avp) {
        _data.getContainer().add(S6a_r10AttributeName.ICSIndicator, avp.getData(), true);
    }
    ...
    public boolean containsNetworkAccessMode() {
        return _data.getContainer().contains(S6a_r10AttributeName.NetworkAccessMode);
    }
    ...
    public NetworkAccessMode getNetworkAccessMode() throws NoSuchAttributeException {
        return (NetworkAccessMode)_data.getContainer().get(S6a_r10AttributeName.NetworkAccessMode, 0);
    }
    ...
    public void setNetworkAccessMode(NetworkAccessMode avp) {
        _data.getContainer().add(S6a_r10AttributeName.NetworkAccessMode, avp.getData(), true);
    }
    ...
    public boolean containsOperatorDeterminedBarring() {
        return _data.getContainer().contains(S6a_r10AttributeName.OperatorDeterminedBarring);
    }
    ...
    public OperatorDeterminedBarring getOperatorDeterminedBarring() throws NoSuchAttributeException {
        return (OperatorDeterminedBarring)_data.getContainer().get(S6a_r10AttributeName.OperatorDeterminedBarring, 0);
    }
    ...
    public void setOperatorDeterminedBarring(OperatorDeterminedBarring avp) {
        _data.getContainer().add(S6a_r10AttributeName.OperatorDeterminedBarring, avp.getData(), true);
    }
    ...
    public boolean containsHPLMNODB() {
        return _data.getContainer().contains(S6a_r10AttributeName.HPLMNODB);
    }
    ...
    public HPLMNODB getHPLMNODB() throws NoSuchAttributeException {
        return (HPLMNODB)_data.getContainer().get(S6a_r10AttributeName.HPLMNODB, 0);
    }
    ...
    public void setHPLMNODB(HPLMNODB avp) {
        _data.getContainer().add(S6a_r10AttributeName.HPLMNODB, avp.getData(), true);
    }
    ...
    public int countRegionalSubscriptionZoneCode() {
        return _data.getContainer().count(S6a_r10AttributeName.RegionalSubscriptionZoneCode);
    }
    ...
    public RegionalSubscriptionZoneCode getRegionalSubscriptionZoneCode(int index) throws NoSuchAttributeException {
        return (RegionalSubscriptionZoneCode)_data.getContainer().get(S6a_r10AttributeName.RegionalSubscriptionZoneCode, index);
    }
    ...
    public void addRegionalSubscriptionZoneCode(RegionalSubscriptionZoneCode avp) {
        _data.getContainer().add(S6a_r10AttributeName.RegionalSubscriptionZoneCode, avp.getData(), false);
    }
    ...
    public boolean containsAccessRestrictionData() {
        return _data.getContainer().contains(S6a_r10AttributeName.AccessRestrictionData);
    }
    ...
    public AccessRestrictionData getAccessRestrictionData() throws NoSuchAttributeException {
        return (AccessRestrictionData)_data.getContainer().get(S6a_r10AttributeName.AccessRestrictionData, 0);
    }
    ...
    public void setAccessRestrictionData(AccessRestrictionData avp) {
        _data.getContainer().add(S6a_r10AttributeName.AccessRestrictionData, avp.getData(), true);
    }
    ...
    public boolean containsLCSInfo() {
        return _data.getContainer().contains(S6a_r10AttributeName.LCSInfo);
    }
    ...
    public LCSInfo getLCSInfo() throws NoSuchAttributeException {
        return (LCSInfo)_data.getContainer().get(S6a_r10AttributeName.LCSInfo, 0);
    }
    ...
    public void setLCSInfo(LCSInfo avp) {
        _data.getContainer().add(S6a_r10AttributeName.LCSInfo, avp.getData(), true);
    }
    ...
    public boolean containsTeleserviceList() {
        return _data.getContainer().contains(S6a_r10AttributeName.TeleserviceList);
    }
    ...
    public TeleserviceList getTeleserviceList() throws NoSuchAttributeException {
        return (TeleserviceList)_data.getContainer().get(S6a_r10AttributeName.TeleserviceList, 0);
    }
    ...
    public void setTeleserviceList(TeleserviceList avp) {
        _data.getContainer().add(S6a_r10AttributeName.TeleserviceList, avp.getData(), true);
    }
    ...
    public boolean containsCallBarringInforList() {
        return _data.getContainer().contains(S6a_r10AttributeName.CallBarringInforList);
    }
    ...
    public CallBarringInforList getCallBarringInforList() throws NoSuchAttributeException {
        return (CallBarringInforList)_data.getContainer().get(S6a_r10AttributeName.CallBarringInforList, 0);
    }
    ...
    public void setCallBarringInforList(CallBarringInforList avp) {
        _data.getContainer().add(S6a_r10AttributeName.CallBarringInforList, avp.getData(), true);
    }
    ...
    public boolean containsAPNConfigurationProfile() {
        return _data.getContainer().contains(S6a_r10AttributeName.APNConfigurationProfile);
    }
    ...
    public APNConfigurationProfile getAPNConfigurationProfile() throws NoSuchAttributeException {
        return (APNConfigurationProfile)_data.getContainer().get(S6a_r10AttributeName.APNConfigurationProfile, 0);
    }
    ...
    public void setAPNConfigurationProfile(APNConfigurationProfile avp) {
        _data.getContainer().add(S6a_r10AttributeName.APNConfigurationProfile, avp.getData(), true);
    }
    ...
    public boolean containsRATFrequencySelectionPriorityID() {
        return _data.getContainer().contains(S6a_r10AttributeName.RATFrequencySelectionPriorityID);
    }
    ...
    public RATFrequencySelectionPriorityID getRATFrequencySelectionPriorityID() throws NoSuchAttributeException {
        return (RATFrequencySelectionPriorityID)_data.getContainer().get(S6a_r10AttributeName.RATFrequencySelectionPriorityID, 0);
    }
    ...
    public void setRATFrequencySelectionPriorityID(RATFrequencySelectionPriorityID avp) {
        _data.getContainer().add(S6a_r10AttributeName.RATFrequencySelectionPriorityID, avp.getData(), true);
    }
    ...
    public boolean containsTraceData() {
        return _data.getContainer().contains(S6a_r10AttributeName.TraceData);
    }
    ...
    public TraceData getTraceData() throws NoSuchAttributeException {
        return (TraceData)_data.getContainer().get(S6a_r10AttributeName.TraceData, 0);
    }
    ...
    public void setTraceData(TraceData avp) {
        _data.getContainer().add(S6a_r10AttributeName.TraceData, avp.getData(), true);
    }
    ...
    public boolean containsGPRSSubscriptionData() {
        return _data.getContainer().contains(S6a_r10AttributeName.GPRSSubscriptionData);
    }
    ...
    public GPRSSubscriptionData getGPRSSubscriptionData() throws NoSuchAttributeException {
        return (GPRSSubscriptionData)_data.getContainer().get(S6a_r10AttributeName.GPRSSubscriptionData, 0);
    }
    ...
    public void setGPRSSubscriptionData(GPRSSubscriptionData avp) {
        _data.getContainer().add(S6a_r10AttributeName.GPRSSubscriptionData, avp.getData(), true);
    }
    ...
    public int countCSGSubscriptionData() {
        return _data.getContainer().count(S6a_r10AttributeName.CSGSubscriptionData);
    }
    ...
    public CSGSubscriptionData getCSGSubscriptionData(int index) throws NoSuchAttributeException {
        return (CSGSubscriptionData)_data.getContainer().get(S6a_r10AttributeName.CSGSubscriptionData, index);
    }
    ...
    public void addCSGSubscriptionData(CSGSubscriptionData avp) {
        _data.getContainer().add(S6a_r10AttributeName.CSGSubscriptionData, avp.getData(), false);
    }
    ...
    public boolean containsRoamingRestrictedDueToUnsupportedFeature() {
        return _data.getContainer().contains(S6a_r10AttributeName.RoamingRestrictedDueToUnsupportedFeature);
    }
    ...
    public RoamingRestrictedDueToUnsupportedFeature getRoamingRestrictedDueToUnsupportedFeature() throws NoSuchAttributeException {
        return (RoamingRestrictedDueToUnsupportedFeature)_data.getContainer().get(S6a_r10AttributeName.RoamingRestrictedDueToUnsupportedFeature, 0);
    }
    ...
    public void setRoamingRestrictedDueToUnsupportedFeature(RoamingRestrictedDueToUnsupportedFeature avp) {
        _data.getContainer().add(S6a_r10AttributeName.RoamingRestrictedDueToUnsupportedFeature, avp.getData(), true);
    }
    ...
    public boolean containsSubscribedPeriodicRAUTAUTimer() {
        return _data.getContainer().contains(S6a_r10AttributeName.SubscribedPeriodicRAUTAUTimer);
    }
    ...
    public SubscribedPeriodicRAUTAUTimer getSubscribedPeriodicRAUTAUTimer() throws NoSuchAttributeException {
        return (SubscribedPeriodicRAUTAUTimer)_data.getContainer().get(S6a_r10AttributeName.SubscribedPeriodicRAUTAUTimer, 0);
    }
    ...
    public void setSubscribedPeriodicRAUTAUTimer(SubscribedPeriodicRAUTAUTimer avp) {
        _data.getContainer().add(S6a_r10AttributeName.SubscribedPeriodicRAUTAUTimer, avp.getData(), true);
    }
    ...
    public boolean containsMPSPriority() {
        return _data.getContainer().contains(S6a_r10AttributeName.MPSPriority);
    }
    ...
    public MPSPriority getMPSPriority() throws NoSuchAttributeException {
        return (MPSPriority)_data.getContainer().get(S6a_r10AttributeName.MPSPriority, 0);
    }
    ...
    public void setMPSPriority(MPSPriority avp) {
        _data.getContainer().add(S6a_r10AttributeName.MPSPriority, avp.getData(), true);
    }
    ...
    public boolean containsVPLMNLIPAAllowed() {
        return _data.getContainer().contains(S6a_r10AttributeName.VPLMNLIPAAllowed);
    }
    ...
    public VPLMNLIPAAllowed getVPLMNLIPAAllowed() throws NoSuchAttributeException {
        return (VPLMNLIPAAllowed)_data.getContainer().get(S6a_r10AttributeName.VPLMNLIPAAllowed, 0);
    }
    ...
    public void setVPLMNLIPAAllowed(VPLMNLIPAAllowed avp) {
        _data.getContainer().add(S6a_r10AttributeName.VPLMNLIPAAllowed, avp.getData(), true);
    }
    ...
    public boolean containsRelayNodeIndicator() {
        return _data.getContainer().contains(S6a_r10AttributeName.RelayNodeIndicator);
    }
    ...
    public RelayNodeIndicator getRelayNodeIndicator() throws NoSuchAttributeException {
        return (RelayNodeIndicator)_data.getContainer().get(S6a_r10AttributeName.RelayNodeIndicator, 0);
    }
    ...
    public void setRelayNodeIndicator(RelayNodeIndicator avp) {
        _data.getContainer().add(S6a_r10AttributeName.RelayNodeIndicator, avp.getData(), true);
    }
    ...
    public boolean containsMDTUserConsent() {
        return _data.getContainer().contains(S6a_r10AttributeName.MDTUserConsent);
    }
    ...
    public MDTUserConsent getMDTUserConsent() throws NoSuchAttributeException {
        return (MDTUserConsent)_data.getContainer().get(S6a_r10AttributeName.MDTUserConsent, 0);
    }
    ...
    public void setMDTUserConsent(MDTUserConsent avp) {
        _data.getContainer().add(S6a_r10AttributeName.MDTUserConsent, avp.getData(), true);
    }
