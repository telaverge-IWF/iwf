...
public class MIP6AgentInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countMIPHomeAgentAddress() {
        return _data.getContainer().count(S6a_r10AttributeName.MIPHomeAgentAddress);
    }
    ...
    public MIPHomeAgentAddress getMIPHomeAgentAddress(int index) throws NoSuchAttributeException {
        return (MIPHomeAgentAddress)_data.getContainer().get(S6a_r10AttributeName.MIPHomeAgentAddress, index);
    }
    ...
    public void addMIPHomeAgentAddress(MIPHomeAgentAddress avp) {
        _data.getContainer().add(S6a_r10AttributeName.MIPHomeAgentAddress, avp.getData(), false);
    }
    ...
    public boolean containsMIPHomeAgentHost() {
        return _data.getContainer().contains(S6a_r10AttributeName.MIPHomeAgentHost);
    }
    ...
    public MIPHomeAgentHost getMIPHomeAgentHost() throws NoSuchAttributeException {
        return (MIPHomeAgentHost)_data.getContainer().get(S6a_r10AttributeName.MIPHomeAgentHost, 0);
    }
    ...
    public void setMIPHomeAgentHost(MIPHomeAgentHost avp) {
        _data.getContainer().add(S6a_r10AttributeName.MIPHomeAgentHost, avp.getData(), true);
    }
    ...
    public boolean containsMIP6HomeLinkPrefix() {
        return _data.getContainer().contains(S6a_r10AttributeName.MIP6HomeLinkPrefix);
    }
    ...
    public MIP6HomeLinkPrefix getMIP6HomeLinkPrefix() throws NoSuchAttributeException {
        return (MIP6HomeLinkPrefix)_data.getContainer().get(S6a_r10AttributeName.MIP6HomeLinkPrefix, 0);
    }
    ...
    public void setMIP6HomeLinkPrefix(MIP6HomeLinkPrefix avp) {
        _data.getContainer().add(S6a_r10AttributeName.MIP6HomeLinkPrefix, avp.getData(), true);
    }
