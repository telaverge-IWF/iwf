...
public class ServiceType extends com.intellinet.diameter.GroupedAVP {
    ...
    public ServiceTypeIdentity getServiceTypeIdentity() throws NoSuchAttributeException {
        return (ServiceTypeIdentity)_data.getContainer().get(S6a_r10AttributeName.ServiceTypeIdentity, 0);
    }
    ...
    public void setServiceTypeIdentity(ServiceTypeIdentity avp) {
        _data.getContainer().add(S6a_r10AttributeName.ServiceTypeIdentity, avp.getData(), true);
    }
    ...
    public boolean containsGMLCRestriction() {
        return _data.getContainer().contains(S6a_r10AttributeName.GMLCRestriction);
    }
    ...
    public GMLCRestriction getGMLCRestriction() throws NoSuchAttributeException {
        return (GMLCRestriction)_data.getContainer().get(S6a_r10AttributeName.GMLCRestriction, 0);
    }
    ...
    public void setGMLCRestriction(GMLCRestriction avp) {
        _data.getContainer().add(S6a_r10AttributeName.GMLCRestriction, avp.getData(), true);
    }
