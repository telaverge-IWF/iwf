...
public class GPRSSubscriptionData extends com.intellinet.diameter.GroupedAVP {
    ...
    public CompleteDataListIncludedIndicator getCompleteDataListIncludedIndicator() throws NoSuchAttributeException {
        return (CompleteDataListIncludedIndicator)_data.getContainer().get(S6a_r10AttributeName.CompleteDataListIncludedIndicator, 0);
    }
    ...
    public void setCompleteDataListIncludedIndicator(CompleteDataListIncludedIndicator avp) {
        _data.getContainer().add(S6a_r10AttributeName.CompleteDataListIncludedIndicator, avp.getData(), true);
    }
    ...
    public int countPDPContext() {
        return _data.getContainer().count(S6a_r10AttributeName.PDPContext);
    }
    ...
    public PDPContext getPDPContext(int index) throws NoSuchAttributeException {
        return (PDPContext)_data.getContainer().get(S6a_r10AttributeName.PDPContext, index);
    }
    ...
    public void addPDPContext(PDPContext avp) {
        _data.getContainer().add(S6a_r10AttributeName.PDPContext, avp.getData(), false);
    }
