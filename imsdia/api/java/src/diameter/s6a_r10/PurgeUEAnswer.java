...
/** 
   ...
   */
public class PurgeUEAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new PurgeUEAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public PurgeUEAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 321, 16777251);
    }

    /**
     * Constructs a PurgeUEAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public PurgeUEAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a PurgeUEAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public PurgeUEAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    PurgeUEAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any PUAFlags.
     */
    public boolean containsPUAFlags() {
        return _data.getContainer().contains(S6a_r10AttributeName.PUAFlags);
    }

    /**
     * Gets the PUAFlags.
     */
    public PUAFlags getPUAFlags() throws NoSuchAttributeException {
        return (PUAFlags)_data.getContainer().get(S6a_r10AttributeName.PUAFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setPUAFlags(PUAFlags avp) {
        _data.getContainer().add(S6a_r10AttributeName.PUAFlags, avp.getData(), true);
    }
