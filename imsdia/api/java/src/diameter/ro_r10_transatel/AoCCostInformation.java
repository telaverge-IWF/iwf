...
public class AoCCostInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsAccumulatedCost() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AccumulatedCost);
    }
    ...
    public AccumulatedCost getAccumulatedCost() throws NoSuchAttributeException {
        return (AccumulatedCost)_data.getContainer().get(Ro_r10_transatelAttributeName.AccumulatedCost, 0);
    }
    ...
    public void setAccumulatedCost(AccumulatedCost avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AccumulatedCost, avp.getData(), true);
    }
    ...
    public int countIncrementalCost() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.IncrementalCost);
    }
    ...
    public IncrementalCost getIncrementalCost(int index) throws NoSuchAttributeException {
        return (IncrementalCost)_data.getContainer().get(Ro_r10_transatelAttributeName.IncrementalCost, index);
    }
    ...
    public void addIncrementalCost(IncrementalCost avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.IncrementalCost, avp.getData(), false);
    }
