...
public class IMInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsTotalNumberOfMessagesSent() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TotalNumberOfMessagesSent);
    }
    ...
    public TotalNumberOfMessagesSent getTotalNumberOfMessagesSent() throws NoSuchAttributeException {
        return (TotalNumberOfMessagesSent)_data.getContainer().get(Ro_r10_transatelAttributeName.TotalNumberOfMessagesSent, 0);
    }
    ...
    public void setTotalNumberOfMessagesSent(TotalNumberOfMessagesSent avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TotalNumberOfMessagesSent, avp.getData(), true);
    }
    ...
    public boolean containsTotalNumberOfMessagesExploded() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TotalNumberOfMessagesExploded);
    }
    ...
    public TotalNumberOfMessagesExploded getTotalNumberOfMessagesExploded() throws NoSuchAttributeException {
        return (TotalNumberOfMessagesExploded)_data.getContainer().get(Ro_r10_transatelAttributeName.TotalNumberOfMessagesExploded, 0);
    }
    ...
    public void setTotalNumberOfMessagesExploded(TotalNumberOfMessagesExploded avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TotalNumberOfMessagesExploded, avp.getData(), true);
    }
    ...
    public boolean containsNumberOfMessagesSuccessfullySent() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullySent);
    }
    ...
    public NumberOfMessagesSuccessfullySent getNumberOfMessagesSuccessfullySent() throws NoSuchAttributeException {
        return (NumberOfMessagesSuccessfullySent)_data.getContainer().get(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullySent, 0);
    }
    ...
    public void setNumberOfMessagesSuccessfullySent(NumberOfMessagesSuccessfullySent avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullySent, avp.getData(), true);
    }
    ...
    public boolean containsNumberOfMessagesSuccessfullyExploded() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullyExploded);
    }
    ...
    public NumberOfMessagesSuccessfullyExploded getNumberOfMessagesSuccessfullyExploded() throws NoSuchAttributeException {
        return (NumberOfMessagesSuccessfullyExploded)_data.getContainer().get(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullyExploded, 0);
    }
    ...
    public void setNumberOfMessagesSuccessfullyExploded(NumberOfMessagesSuccessfullyExploded avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.NumberOfMessagesSuccessfullyExploded, avp.getData(), true);
    }
