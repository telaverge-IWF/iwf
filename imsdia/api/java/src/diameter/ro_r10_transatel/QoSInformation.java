...
public class QoSInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsQoSClassIdentifier() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.QoSClassIdentifier);
    }
    ...
    public QoSClassIdentifier getQoSClassIdentifier() throws NoSuchAttributeException {
        return (QoSClassIdentifier)_data.getContainer().get(Ro_r10_transatelAttributeName.QoSClassIdentifier, 0);
    }
    ...
    public void setQoSClassIdentifier(QoSClassIdentifier avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.QoSClassIdentifier, avp.getData(), true);
    }
    ...
    public boolean containsMaxRequestedBandwidthUL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MaxRequestedBandwidthUL);
    }
    ...
    public MaxRequestedBandwidthUL getMaxRequestedBandwidthUL() throws NoSuchAttributeException {
        return (MaxRequestedBandwidthUL)_data.getContainer().get(Ro_r10_transatelAttributeName.MaxRequestedBandwidthUL, 0);
    }
    ...
    public void setMaxRequestedBandwidthUL(MaxRequestedBandwidthUL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MaxRequestedBandwidthUL, avp.getData(), true);
    }
    ...
    public boolean containsMaxRequestedBandwidthDL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MaxRequestedBandwidthDL);
    }
    ...
    public MaxRequestedBandwidthDL getMaxRequestedBandwidthDL() throws NoSuchAttributeException {
        return (MaxRequestedBandwidthDL)_data.getContainer().get(Ro_r10_transatelAttributeName.MaxRequestedBandwidthDL, 0);
    }
    ...
    public void setMaxRequestedBandwidthDL(MaxRequestedBandwidthDL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MaxRequestedBandwidthDL, avp.getData(), true);
    }
    ...
    public boolean containsGuaranteedBitrateUL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.GuaranteedBitrateUL);
    }
    ...
    public GuaranteedBitrateUL getGuaranteedBitrateUL() throws NoSuchAttributeException {
        return (GuaranteedBitrateUL)_data.getContainer().get(Ro_r10_transatelAttributeName.GuaranteedBitrateUL, 0);
    }
    ...
    public void setGuaranteedBitrateUL(GuaranteedBitrateUL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GuaranteedBitrateUL, avp.getData(), true);
    }
    ...
    public boolean containsGuaranteedBitrateDL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.GuaranteedBitrateDL);
    }
    ...
    public GuaranteedBitrateDL getGuaranteedBitrateDL() throws NoSuchAttributeException {
        return (GuaranteedBitrateDL)_data.getContainer().get(Ro_r10_transatelAttributeName.GuaranteedBitrateDL, 0);
    }
    ...
    public void setGuaranteedBitrateDL(GuaranteedBitrateDL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GuaranteedBitrateDL, avp.getData(), true);
    }
    ...
    public boolean containsBearerIdentifier() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.BearerIdentifier);
    }
    ...
    public BearerIdentifier getBearerIdentifier() throws NoSuchAttributeException {
        return (BearerIdentifier)_data.getContainer().get(Ro_r10_transatelAttributeName.BearerIdentifier, 0);
    }
    ...
    public void setBearerIdentifier(BearerIdentifier avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.BearerIdentifier, avp.getData(), true);
    }
    ...
    public boolean containsAllocationRetentionPriority() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AllocationRetentionPriority);
    }
    ...
    public AllocationRetentionPriority getAllocationRetentionPriority() throws NoSuchAttributeException {
        return (AllocationRetentionPriority)_data.getContainer().get(Ro_r10_transatelAttributeName.AllocationRetentionPriority, 0);
    }
    ...
    public void setAllocationRetentionPriority(AllocationRetentionPriority avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AllocationRetentionPriority, avp.getData(), true);
    }
    ...
    public boolean containsAPNAggregateMaxBitrateUL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateUL);
    }
    ...
    public APNAggregateMaxBitrateUL getAPNAggregateMaxBitrateUL() throws NoSuchAttributeException {
        return (APNAggregateMaxBitrateUL)_data.getContainer().get(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateUL, 0);
    }
    ...
    public void setAPNAggregateMaxBitrateUL(APNAggregateMaxBitrateUL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateUL, avp.getData(), true);
    }
    ...
    public boolean containsAPNAggregateMaxBitrateDL() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateDL);
    }
    ...
    public APNAggregateMaxBitrateDL getAPNAggregateMaxBitrateDL() throws NoSuchAttributeException {
        return (APNAggregateMaxBitrateDL)_data.getContainer().get(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateDL, 0);
    }
    ...
    public void setAPNAggregateMaxBitrateDL(APNAggregateMaxBitrateDL avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.APNAggregateMaxBitrateDL, avp.getData(), true);
    }
