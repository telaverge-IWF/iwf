...
public class ReAuthRequest extends com.intellinet.diameter.Command {
    ...
    public boolean containsGSUPoolIdentifier() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.GSUPoolIdentifier);
    }
    ...
    public GSUPoolIdentifier getGSUPoolIdentifier() throws NoSuchAttributeException {
        return (GSUPoolIdentifier)_data.getContainer().get(Ro_r10_transatelAttributeName.GSUPoolIdentifier, 0);
    }
    ...
    public void setGSUPoolIdentifier(GSUPoolIdentifier avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GSUPoolIdentifier, avp.getData(), true);
    }
