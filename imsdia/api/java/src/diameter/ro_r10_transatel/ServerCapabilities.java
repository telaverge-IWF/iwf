...
public class ServerCapabilities extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countMandatoryCapability() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.MandatoryCapability);
    }
    ...
    public MandatoryCapability getMandatoryCapability(int index) throws NoSuchAttributeException {
        return (MandatoryCapability)_data.getContainer().get(Ro_r10_transatelAttributeName.MandatoryCapability, index);
    }
    ...
    public void addMandatoryCapability(MandatoryCapability avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MandatoryCapability, avp.getData(), false);
    }
    ...
    public int countOptionalCapability() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.OptionalCapability);
    }
    ...
    public OptionalCapability getOptionalCapability(int index) throws NoSuchAttributeException {
        return (OptionalCapability)_data.getContainer().get(Ro_r10_transatelAttributeName.OptionalCapability, index);
    }
    ...
    public void addOptionalCapability(OptionalCapability avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.OptionalCapability, avp.getData(), false);
    }
    ...
    public int countServerName() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.ServerName);
    }
    ...
    public ServerName getServerName(int index) throws NoSuchAttributeException {
        return (ServerName)_data.getContainer().get(Ro_r10_transatelAttributeName.ServerName, index);
    }
    ...
    public void addServerName(ServerName avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ServerName, avp.getData(), false);
    }
