...
public class RequestedServiceUnit extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsCCMoney() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.CCMoney);
    }
    ...
    public CCMoney getCCMoney() throws NoSuchAttributeException {
        return (CCMoney)_data.getContainer().get(Ro_r10_transatelAttributeName.CCMoney, 0);
    }
    ...
    public void setCCMoney(CCMoney avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.CCMoney, avp.getData(), true);
    }
