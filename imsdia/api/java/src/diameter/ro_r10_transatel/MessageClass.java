...
public class MessageClass extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsClassIdentifier() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.ClassIdentifier);
    }
    ...
    public ClassIdentifier getClassIdentifier() throws NoSuchAttributeException {
        return (ClassIdentifier)_data.getContainer().get(Ro_r10_transatelAttributeName.ClassIdentifier, 0);
    }
    ...
    public void setClassIdentifier(ClassIdentifier avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ClassIdentifier, avp.getData(), true);
    }
    ...
    public boolean containsTokenText() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TokenText);
    }
    ...
    public TokenText getTokenText() throws NoSuchAttributeException {
        return (TokenText)_data.getContainer().get(Ro_r10_transatelAttributeName.TokenText, 0);
    }
    ...
    public void setTokenText(TokenText avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TokenText, avp.getData(), true);
    }
