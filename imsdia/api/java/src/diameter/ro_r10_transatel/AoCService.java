...
public class AoCService extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsAoCServiceObligatoryType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AoCServiceObligatoryType);
    }
    ...
    public AoCServiceObligatoryType getAoCServiceObligatoryType() throws NoSuchAttributeException {
        return (AoCServiceObligatoryType)_data.getContainer().get(Ro_r10_transatelAttributeName.AoCServiceObligatoryType, 0);
    }
    ...
    public void setAoCServiceObligatoryType(AoCServiceObligatoryType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AoCServiceObligatoryType, avp.getData(), true);
    }
    ...
    public boolean containsAoCServiceType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AoCServiceType);
    }
    ...
    public AoCServiceType getAoCServiceType() throws NoSuchAttributeException {
        return (AoCServiceType)_data.getContainer().get(Ro_r10_transatelAttributeName.AoCServiceType, 0);
    }
    ...
    public void setAoCServiceType(AoCServiceType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AoCServiceType, avp.getData(), true);
    }
