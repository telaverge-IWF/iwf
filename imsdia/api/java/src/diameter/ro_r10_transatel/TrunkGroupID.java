...
public class TrunkGroupID extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsIncomingTrunkGroupID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.IncomingTrunkGroupID);
    }
    ...
    public IncomingTrunkGroupID getIncomingTrunkGroupID() throws NoSuchAttributeException {
        return (IncomingTrunkGroupID)_data.getContainer().get(Ro_r10_transatelAttributeName.IncomingTrunkGroupID, 0);
    }
    ...
    public void setIncomingTrunkGroupID(IncomingTrunkGroupID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.IncomingTrunkGroupID, avp.getData(), true);
    }
    ...
    public boolean containsOutgoingTrunkGroupID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.OutgoingTrunkGroupID);
    }
    ...
    public OutgoingTrunkGroupID getOutgoingTrunkGroupID() throws NoSuchAttributeException {
        return (OutgoingTrunkGroupID)_data.getContainer().get(Ro_r10_transatelAttributeName.OutgoingTrunkGroupID, 0);
    }
    ...
    public void setOutgoingTrunkGroupID(OutgoingTrunkGroupID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.OutgoingTrunkGroupID, avp.getData(), true);
    }
