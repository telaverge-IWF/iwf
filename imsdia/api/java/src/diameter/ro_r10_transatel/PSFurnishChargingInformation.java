...
public class PSFurnishChargingInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public PSFreeFormatData getPSFreeFormatData() throws NoSuchAttributeException {
        return (PSFreeFormatData)_data.getContainer().get(Ro_r10_transatelAttributeName.PSFreeFormatData, 0);
    }
    ...
    public void setPSFreeFormatData(PSFreeFormatData avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PSFreeFormatData, avp.getData(), true);
    }
    ...
    public boolean containsPSAppendFreeFormatData() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PSAppendFreeFormatData);
    }
    ...
    public PSAppendFreeFormatData getPSAppendFreeFormatData() throws NoSuchAttributeException {
        return (PSAppendFreeFormatData)_data.getContainer().get(Ro_r10_transatelAttributeName.PSAppendFreeFormatData, 0);
    }
    ...
    public void setPSAppendFreeFormatData(PSAppendFreeFormatData avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PSAppendFreeFormatData, avp.getData(), true);
    }
