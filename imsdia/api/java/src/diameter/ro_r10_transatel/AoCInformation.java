...
public class AoCInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsAoCCostInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AoCCostInformation);
    }
    ...
    public AoCCostInformation getAoCCostInformation() throws NoSuchAttributeException {
        return (AoCCostInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.AoCCostInformation, 0);
    }
    ...
    public void setAoCCostInformation(AoCCostInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AoCCostInformation, avp.getData(), true);
    }
    ...
    public boolean containsAoCSubscriptionInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.AoCSubscriptionInformation);
    }
    ...
    public AoCSubscriptionInformation getAoCSubscriptionInformation() throws NoSuchAttributeException {
        return (AoCSubscriptionInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.AoCSubscriptionInformation, 0);
    }
    ...
    public void setAoCSubscriptionInformation(AoCSubscriptionInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AoCSubscriptionInformation, avp.getData(), true);
    }
