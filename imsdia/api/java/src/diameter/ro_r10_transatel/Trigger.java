...
public class Trigger extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countTriggerType() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.TriggerType);
    }
    ...
    public TriggerType getTriggerType(int index) throws NoSuchAttributeException {
        return (TriggerType)_data.getContainer().get(Ro_r10_transatelAttributeName.TriggerType, index);
    }
    ...
    public void addTriggerType(TriggerType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TriggerType, avp.getData(), false);
    }
