...
public class RecipientInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsDestinationInterface() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.DestinationInterface);
    }
    ...
    public DestinationInterface getDestinationInterface() throws NoSuchAttributeException {
        return (DestinationInterface)_data.getContainer().get(Ro_r10_transatelAttributeName.DestinationInterface, 0);
    }
    ...
    public void setDestinationInterface(DestinationInterface avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.DestinationInterface, avp.getData(), true);
    }
    ...
    public int countRecipientReceivedAddress() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.RecipientReceivedAddress);
    }
    ...
    public RecipientReceivedAddress getRecipientReceivedAddress(int index) throws NoSuchAttributeException {
        return (RecipientReceivedAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.RecipientReceivedAddress, index);
    }
    ...
    public void addRecipientReceivedAddress(RecipientReceivedAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RecipientReceivedAddress, avp.getData(), false);
    }
    ...
    public boolean containsRecipientSCCPAddress() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.RecipientSCCPAddress);
    }
    ...
    public RecipientSCCPAddress getRecipientSCCPAddress() throws NoSuchAttributeException {
        return (RecipientSCCPAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.RecipientSCCPAddress, 0);
    }
    ...
    public void setRecipientSCCPAddress(RecipientSCCPAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RecipientSCCPAddress, avp.getData(), true);
    }
