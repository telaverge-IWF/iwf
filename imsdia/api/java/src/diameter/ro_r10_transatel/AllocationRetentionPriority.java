...
public class AllocationRetentionPriority extends com.intellinet.diameter.GroupedAVP {
    ...
    public PriorityLevel getPriorityLevel() throws NoSuchAttributeException {
        return (PriorityLevel)_data.getContainer().get(Ro_r10_transatelAttributeName.PriorityLevel, 0);
    }
    ...
    public void setPriorityLevel(PriorityLevel avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PriorityLevel, avp.getData(), true);
    }
    ...
    public boolean containsPreemptionCapability() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PreemptionCapability);
    }
    ...
    public PreemptionCapability getPreemptionCapability() throws NoSuchAttributeException {
        return (PreemptionCapability)_data.getContainer().get(Ro_r10_transatelAttributeName.PreemptionCapability, 0);
    }
    ...
    public void setPreemptionCapability(PreemptionCapability avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PreemptionCapability, avp.getData(), true);
    }
    ...
    public boolean containsPreemptionVulnerability() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PreemptionVulnerability);
    }
    ...
    public PreemptionVulnerability getPreemptionVulnerability() throws NoSuchAttributeException {
        return (PreemptionVulnerability)_data.getContainer().get(Ro_r10_transatelAttributeName.PreemptionVulnerability, 0);
    }
    ...
    public void setPreemptionVulnerability(PreemptionVulnerability avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PreemptionVulnerability, avp.getData(), true);
    }
