...
public class MultipleServicesCreditControl extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsGrantedServiceUnit() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.GrantedServiceUnit);
    }
    ...
    public GrantedServiceUnit getGrantedServiceUnit() throws NoSuchAttributeException {
        return (GrantedServiceUnit)_data.getContainer().get(Ro_r10_transatelAttributeName.GrantedServiceUnit, 0);
    }
    ...
    public void setGrantedServiceUnit(GrantedServiceUnit avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GrantedServiceUnit, avp.getData(), true);
    }
    ...
    public boolean containsRequestedServiceUnit() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.RequestedServiceUnit);
    }
    ...
    public RequestedServiceUnit getRequestedServiceUnit() throws NoSuchAttributeException {
        return (RequestedServiceUnit)_data.getContainer().get(Ro_r10_transatelAttributeName.RequestedServiceUnit, 0);
    }
    ...
    public void setRequestedServiceUnit(RequestedServiceUnit avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RequestedServiceUnit, avp.getData(), true);
    }
    ...
    public int countUsedServiceUnit() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.UsedServiceUnit);
    }
    ...
    public UsedServiceUnit getUsedServiceUnit(int index) throws NoSuchAttributeException {
        return (UsedServiceUnit)_data.getContainer().get(Ro_r10_transatelAttributeName.UsedServiceUnit, index);
    }
    ...
    public void addUsedServiceUnit(UsedServiceUnit avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.UsedServiceUnit, avp.getData(), false);
    }
    ...
    public int countServiceIdentifier() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.ServiceIdentifier);
    }
    ...
    public ServiceIdentifier getServiceIdentifier(int index) throws NoSuchAttributeException {
        return (ServiceIdentifier)_data.getContainer().get(Ro_r10_transatelAttributeName.ServiceIdentifier, index);
    }
    ...
    public void addServiceIdentifier(ServiceIdentifier avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ServiceIdentifier, avp.getData(), false);
    }
    ...
    public int countGSUPoolReference() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.GSUPoolReference);
    }
    ...
    public GSUPoolReference getGSUPoolReference(int index) throws NoSuchAttributeException {
        return (GSUPoolReference)_data.getContainer().get(Ro_r10_transatelAttributeName.GSUPoolReference, index);
    }
    ...
    public void addGSUPoolReference(GSUPoolReference avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GSUPoolReference, avp.getData(), false);
    }
    ...
    public boolean containsValidityTime() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.ValidityTime);
    }
    ...
    public ValidityTime getValidityTime() throws NoSuchAttributeException {
        return (ValidityTime)_data.getContainer().get(Ro_r10_transatelAttributeName.ValidityTime, 0);
    }
    ...
    public void setValidityTime(ValidityTime avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ValidityTime, avp.getData(), true);
    }
    ...
    public boolean containsFinalUnitIndication() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.FinalUnitIndication);
    }
    ...
    public FinalUnitIndication getFinalUnitIndication() throws NoSuchAttributeException {
        return (FinalUnitIndication)_data.getContainer().get(Ro_r10_transatelAttributeName.FinalUnitIndication, 0);
    }
    ...
    public void setFinalUnitIndication(FinalUnitIndication avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.FinalUnitIndication, avp.getData(), true);
    }
    ...
    public boolean containsTimeQuotaThreshold() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TimeQuotaThreshold);
    }
    ...
    public TimeQuotaThreshold getTimeQuotaThreshold() throws NoSuchAttributeException {
        return (TimeQuotaThreshold)_data.getContainer().get(Ro_r10_transatelAttributeName.TimeQuotaThreshold, 0);
    }
    ...
    public void setTimeQuotaThreshold(TimeQuotaThreshold avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TimeQuotaThreshold, avp.getData(), true);
    }
    ...
    public boolean containsVolumeQuotaThreshold() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.VolumeQuotaThreshold);
    }
    ...
    public VolumeQuotaThreshold getVolumeQuotaThreshold() throws NoSuchAttributeException {
        return (VolumeQuotaThreshold)_data.getContainer().get(Ro_r10_transatelAttributeName.VolumeQuotaThreshold, 0);
    }
    ...
    public void setVolumeQuotaThreshold(VolumeQuotaThreshold avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.VolumeQuotaThreshold, avp.getData(), true);
    }
    ...
    public boolean containsQuotaHoldingTime() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.QuotaHoldingTime);
    }
    ...
    public QuotaHoldingTime getQuotaHoldingTime() throws NoSuchAttributeException {
        return (QuotaHoldingTime)_data.getContainer().get(Ro_r10_transatelAttributeName.QuotaHoldingTime, 0);
    }
    ...
    public void setQuotaHoldingTime(QuotaHoldingTime avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.QuotaHoldingTime, avp.getData(), true);
    }
    ...
    public int countReportingReason() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.ReportingReason);
    }
    ...
    public ReportingReason getReportingReason(int index) throws NoSuchAttributeException {
        return (ReportingReason)_data.getContainer().get(Ro_r10_transatelAttributeName.ReportingReason, index);
    }
    ...
    public void addReportingReason(ReportingReason avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ReportingReason, avp.getData(), false);
    }
    ...
    public boolean containsTrigger() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Trigger);
    }
    ...
    public Trigger getTrigger() throws NoSuchAttributeException {
        return (Trigger)_data.getContainer().get(Ro_r10_transatelAttributeName.Trigger, 0);
    }
    ...
    public void setTrigger(Trigger avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Trigger, avp.getData(), true);
    }
    ...
    public boolean containsRefundInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.RefundInformation);
    }
    ...
    public RefundInformation getRefundInformation() throws NoSuchAttributeException {
        return (RefundInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.RefundInformation, 0);
    }
    ...
    public void setRefundInformation(RefundInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RefundInformation, avp.getData(), true);
    }
    ...
    public int countAFCorrelationInformation() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.AFCorrelationInformation);
    }
    ...
    public AFCorrelationInformation getAFCorrelationInformation(int index) throws NoSuchAttributeException {
        return (AFCorrelationInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.AFCorrelationInformation, index);
    }
    ...
    public void addAFCorrelationInformation(AFCorrelationInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.AFCorrelationInformation, avp.getData(), false);
    }
    ...
    public int countEnvelope() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.Envelope);
    }
    ...
    public Envelope getEnvelope(int index) throws NoSuchAttributeException {
        return (Envelope)_data.getContainer().get(Ro_r10_transatelAttributeName.Envelope, index);
    }
    ...
    public void addEnvelope(Envelope avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Envelope, avp.getData(), false);
    }
