...
public class MBMSInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsTMGI() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TMGI);
    }
    ...
    public TMGI getTMGI() throws NoSuchAttributeException {
        return (TMGI)_data.getContainer().get(Ro_r10_transatelAttributeName.TMGI, 0);
    }
    ...
    public void setTMGI(TMGI avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TMGI, avp.getData(), true);
    }
    ...
    public boolean containsMBMSServiceType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MBMSServiceType);
    }
    ...
    public MBMSServiceType getMBMSServiceType() throws NoSuchAttributeException {
        return (MBMSServiceType)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMSServiceType, 0);
    }
    ...
    public void setMBMSServiceType(MBMSServiceType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMSServiceType, avp.getData(), true);
    }
    ...
    public boolean containsMBMSUserServiceType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MBMSUserServiceType);
    }
    ...
    public MBMSUserServiceType getMBMSUserServiceType() throws NoSuchAttributeException {
        return (MBMSUserServiceType)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMSUserServiceType, 0);
    }
    ...
    public void setMBMSUserServiceType(MBMSUserServiceType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMSUserServiceType, avp.getData(), true);
    }
    ...
    public boolean containsFileRepairSupported() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.FileRepairSupported);
    }
    ...
    public FileRepairSupported getFileRepairSupported() throws NoSuchAttributeException {
        return (FileRepairSupported)_data.getContainer().get(Ro_r10_transatelAttributeName.FileRepairSupported, 0);
    }
    ...
    public void setFileRepairSupported(FileRepairSupported avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.FileRepairSupported, avp.getData(), true);
    }
    ...
    public boolean containsRequiredMBMSBearerCapabilities() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.RequiredMBMSBearerCapabilities);
    }
    ...
    public RequiredMBMSBearerCapabilities getRequiredMBMSBearerCapabilities() throws NoSuchAttributeException {
        return (RequiredMBMSBearerCapabilities)_data.getContainer().get(Ro_r10_transatelAttributeName.RequiredMBMSBearerCapabilities, 0);
    }
    ...
    public void setRequiredMBMSBearerCapabilities(RequiredMBMSBearerCapabilities avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RequiredMBMSBearerCapabilities, avp.getData(), true);
    }
    ...
    public boolean containsMBMS2G3GIndicator() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MBMS2G3GIndicator);
    }
    ...
    public MBMS2G3GIndicator getMBMS2G3GIndicator() throws NoSuchAttributeException {
        return (MBMS2G3GIndicator)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMS2G3GIndicator, 0);
    }
    ...
    public void setMBMS2G3GIndicator(MBMS2G3GIndicator avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMS2G3GIndicator, avp.getData(), true);
    }
    ...
    public boolean containsRAI() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.RAI);
    }
    ...
    public RAI getRAI() throws NoSuchAttributeException {
        return (RAI)_data.getContainer().get(Ro_r10_transatelAttributeName.RAI, 0);
    }
    ...
    public void setRAI(RAI avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RAI, avp.getData(), true);
    }
    ...
    public int countMBMSServiceArea() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.MBMSServiceArea);
    }
    ...
    public MBMSServiceArea getMBMSServiceArea(int index) throws NoSuchAttributeException {
        return (MBMSServiceArea)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMSServiceArea, index);
    }
    ...
    public void addMBMSServiceArea(MBMSServiceArea avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMSServiceArea, avp.getData(), false);
    }
    ...
    public boolean containsMBMSSessionIdentity() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MBMSSessionIdentity);
    }
    ...
    public MBMSSessionIdentity getMBMSSessionIdentity() throws NoSuchAttributeException {
        return (MBMSSessionIdentity)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMSSessionIdentity, 0);
    }
    ...
    public void setMBMSSessionIdentity(MBMSSessionIdentity avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMSSessionIdentity, avp.getData(), true);
    }
    ...
    public boolean containsCNIPMulticastDistribution() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.CNIPMulticastDistribution);
    }
    ...
    public CNIPMulticastDistribution getCNIPMulticastDistribution() throws NoSuchAttributeException {
        return (CNIPMulticastDistribution)_data.getContainer().get(Ro_r10_transatelAttributeName.CNIPMulticastDistribution, 0);
    }
    ...
    public void setCNIPMulticastDistribution(CNIPMulticastDistribution avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.CNIPMulticastDistribution, avp.getData(), true);
    }
    ...
    public boolean containsMBMSGWAddress() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MBMSGWAddress);
    }
    ...
    public MBMSGWAddress getMBMSGWAddress() throws NoSuchAttributeException {
        return (MBMSGWAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.MBMSGWAddress, 0);
    }
    ...
    public void setMBMSGWAddress(MBMSGWAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MBMSGWAddress, avp.getData(), true);
    }
