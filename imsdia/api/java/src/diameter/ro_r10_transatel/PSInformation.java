...
public class PSInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsPDNConnectionID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PDNConnectionID);
    }
    ...
    public PDNConnectionID getPDNConnectionID() throws NoSuchAttributeException {
        return (PDNConnectionID)_data.getContainer().get(Ro_r10_transatelAttributeName.PDNConnectionID, 0);
    }
    ...
    public void setPDNConnectionID(PDNConnectionID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PDNConnectionID, avp.getData(), true);
    }
    ...
    public boolean containsNodeId() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.NodeId);
    }
    ...
    public NodeId getNodeId() throws NoSuchAttributeException {
        return (NodeId)_data.getContainer().get(Ro_r10_transatelAttributeName.NodeId, 0);
    }
    ...
    public void setNodeId(NodeId avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.NodeId, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPPDPType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPPDPType);
    }
    ...
    public Ro3GPPPDPType getRo3GPPPDPType() throws NoSuchAttributeException {
        return (Ro3GPPPDPType)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPPDPType, 0);
    }
    ...
    public void setRo3GPPPDPType(Ro3GPPPDPType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPPDPType, avp.getData(), true);
    }
    ...
    public int countPDPAddress() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.PDPAddress);
    }
    ...
    public PDPAddress getPDPAddress(int index) throws NoSuchAttributeException {
        return (PDPAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.PDPAddress, index);
    }
    ...
    public void addPDPAddress(PDPAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PDPAddress, avp.getData(), false);
    }
    ...
    public boolean containsPDPAddressPrefixLength() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PDPAddressPrefixLength);
    }
    ...
    public PDPAddressPrefixLength getPDPAddressPrefixLength() throws NoSuchAttributeException {
        return (PDPAddressPrefixLength)_data.getContainer().get(Ro_r10_transatelAttributeName.PDPAddressPrefixLength, 0);
    }
    ...
    public void setPDPAddressPrefixLength(PDPAddressPrefixLength avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PDPAddressPrefixLength, avp.getData(), true);
    }
    ...
    public boolean containsDynamicAddressFlag() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.DynamicAddressFlag);
    }
    ...
    public DynamicAddressFlag getDynamicAddressFlag() throws NoSuchAttributeException {
        return (DynamicAddressFlag)_data.getContainer().get(Ro_r10_transatelAttributeName.DynamicAddressFlag, 0);
    }
    ...
    public void setDynamicAddressFlag(DynamicAddressFlag avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.DynamicAddressFlag, avp.getData(), true);
    }
    ...
    public boolean containsDynamicAddressFlagExtension() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.DynamicAddressFlagExtension);
    }
    ...
    public DynamicAddressFlagExtension getDynamicAddressFlagExtension() throws NoSuchAttributeException {
        return (DynamicAddressFlagExtension)_data.getContainer().get(Ro_r10_transatelAttributeName.DynamicAddressFlagExtension, 0);
    }
    ...
    public void setDynamicAddressFlagExtension(DynamicAddressFlagExtension avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.DynamicAddressFlagExtension, avp.getData(), true);
    }
    ...
    public boolean containsGGSNAddress() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.GGSNAddress);
    }
    ...
    public GGSNAddress getGGSNAddress() throws NoSuchAttributeException {
        return (GGSNAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.GGSNAddress, 0);
    }
    ...
    public void setGGSNAddress(GGSNAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.GGSNAddress, avp.getData(), true);
    }
    ...
    public boolean containsSGWAddress() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.SGWAddress);
    }
    ...
    public SGWAddress getSGWAddress() throws NoSuchAttributeException {
        return (SGWAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.SGWAddress, 0);
    }
    ...
    public void setSGWAddress(SGWAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.SGWAddress, avp.getData(), true);
    }
    ...
    public boolean containsCGAddress() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.CGAddress);
    }
    ...
    public CGAddress getCGAddress() throws NoSuchAttributeException {
        return (CGAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.CGAddress, 0);
    }
    ...
    public void setCGAddress(CGAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.CGAddress, avp.getData(), true);
    }
    ...
    public boolean containsServingNodeType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.ServingNodeType);
    }
    ...
    public ServingNodeType getServingNodeType() throws NoSuchAttributeException {
        return (ServingNodeType)_data.getContainer().get(Ro_r10_transatelAttributeName.ServingNodeType, 0);
    }
    ...
    public void setServingNodeType(ServingNodeType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ServingNodeType, avp.getData(), true);
    }
    ...
    public boolean containsSGWChange() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.SGWChange);
    }
    ...
    public SGWChange getSGWChange() throws NoSuchAttributeException {
        return (SGWChange)_data.getContainer().get(Ro_r10_transatelAttributeName.SGWChange, 0);
    }
    ...
    public void setSGWChange(SGWChange avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.SGWChange, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPIMSIMCCMNC() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPIMSIMCCMNC);
    }
    ...
    public Ro3GPPIMSIMCCMNC getRo3GPPIMSIMCCMNC() throws NoSuchAttributeException {
        return (Ro3GPPIMSIMCCMNC)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPIMSIMCCMNC, 0);
    }
    ...
    public void setRo3GPPIMSIMCCMNC(Ro3GPPIMSIMCCMNC avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPIMSIMCCMNC, avp.getData(), true);
    }
    ...
    public boolean containsIMSIUnauthenticatedFlag() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.IMSIUnauthenticatedFlag);
    }
    ...
    public IMSIUnauthenticatedFlag getIMSIUnauthenticatedFlag() throws NoSuchAttributeException {
        return (IMSIUnauthenticatedFlag)_data.getContainer().get(Ro_r10_transatelAttributeName.IMSIUnauthenticatedFlag, 0);
    }
    ...
    public void setIMSIUnauthenticatedFlag(IMSIUnauthenticatedFlag avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.IMSIUnauthenticatedFlag, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPGGSNMCCMNC() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPGGSNMCCMNC);
    }
    ...
    public Ro3GPPGGSNMCCMNC getRo3GPPGGSNMCCMNC() throws NoSuchAttributeException {
        return (Ro3GPPGGSNMCCMNC)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPGGSNMCCMNC, 0);
    }
    ...
    public void setRo3GPPGGSNMCCMNC(Ro3GPPGGSNMCCMNC avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPGGSNMCCMNC, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPNSAPI() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPNSAPI);
    }
    ...
    public Ro3GPPNSAPI getRo3GPPNSAPI() throws NoSuchAttributeException {
        return (Ro3GPPNSAPI)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPNSAPI, 0);
    }
    ...
    public void setRo3GPPNSAPI(Ro3GPPNSAPI avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPNSAPI, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPSessionStopIndicator() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPSessionStopIndicator);
    }
    ...
    public Ro3GPPSessionStopIndicator getRo3GPPSessionStopIndicator() throws NoSuchAttributeException {
        return (Ro3GPPSessionStopIndicator)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPSessionStopIndicator, 0);
    }
    ...
    public void setRo3GPPSessionStopIndicator(Ro3GPPSessionStopIndicator avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPSessionStopIndicator, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPSelectionMode() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPSelectionMode);
    }
    ...
    public Ro3GPPSelectionMode getRo3GPPSelectionMode() throws NoSuchAttributeException {
        return (Ro3GPPSelectionMode)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPSelectionMode, 0);
    }
    ...
    public void setRo3GPPSelectionMode(Ro3GPPSelectionMode avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPSelectionMode, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPChargingCharacteristics() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPChargingCharacteristics);
    }
    ...
    public Ro3GPPChargingCharacteristics getRo3GPPChargingCharacteristics() throws NoSuchAttributeException {
        return (Ro3GPPChargingCharacteristics)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPChargingCharacteristics, 0);
    }
    ...
    public void setRo3GPPChargingCharacteristics(Ro3GPPChargingCharacteristics avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPChargingCharacteristics, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPSGSNMCCMNC() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPSGSNMCCMNC);
    }
    ...
    public Ro3GPPSGSNMCCMNC getRo3GPPSGSNMCCMNC() throws NoSuchAttributeException {
        return (Ro3GPPSGSNMCCMNC)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPSGSNMCCMNC, 0);
    }
    ...
    public void setRo3GPPSGSNMCCMNC(Ro3GPPSGSNMCCMNC avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPSGSNMCCMNC, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPMSTimeZone() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPMSTimeZone);
    }
    ...
    public Ro3GPPMSTimeZone getRo3GPPMSTimeZone() throws NoSuchAttributeException {
        return (Ro3GPPMSTimeZone)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPMSTimeZone, 0);
    }
    ...
    public void setRo3GPPMSTimeZone(Ro3GPPMSTimeZone avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPMSTimeZone, avp.getData(), true);
    }
    ...
    public boolean containsUserCSGInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.UserCSGInformation);
    }
    ...
    public UserCSGInformation getUserCSGInformation() throws NoSuchAttributeException {
        return (UserCSGInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.UserCSGInformation, 0);
    }
    ...
    public void setUserCSGInformation(UserCSGInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.UserCSGInformation, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPRATType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPRATType);
    }
    ...
    public Ro3GPPRATType getRo3GPPRATType() throws NoSuchAttributeException {
        return (Ro3GPPRATType)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPRATType, 0);
    }
    ...
    public void setRo3GPPRATType(Ro3GPPRATType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPRATType, avp.getData(), true);
    }
    ...
    public boolean containsPSFurnishChargingInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PSFurnishChargingInformation);
    }
    ...
    public PSFurnishChargingInformation getPSFurnishChargingInformation() throws NoSuchAttributeException {
        return (PSFurnishChargingInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.PSFurnishChargingInformation, 0);
    }
    ...
    public void setPSFurnishChargingInformation(PSFurnishChargingInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PSFurnishChargingInformation, avp.getData(), true);
    }
    ...
    public boolean containsPDPContextType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PDPContextType);
    }
    ...
    public PDPContextType getPDPContextType() throws NoSuchAttributeException {
        return (PDPContextType)_data.getContainer().get(Ro_r10_transatelAttributeName.PDPContextType, 0);
    }
    ...
    public void setPDPContextType(PDPContextType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PDPContextType, avp.getData(), true);
    }
    ...
    public boolean containsOfflineCharging() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.OfflineCharging);
    }
    ...
    public OfflineCharging getOfflineCharging() throws NoSuchAttributeException {
        return (OfflineCharging)_data.getContainer().get(Ro_r10_transatelAttributeName.OfflineCharging, 0);
    }
    ...
    public void setOfflineCharging(OfflineCharging avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.OfflineCharging, avp.getData(), true);
    }
    ...
    public int countTrafficDataVolumes() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.TrafficDataVolumes);
    }
    ...
    public TrafficDataVolumes getTrafficDataVolumes(int index) throws NoSuchAttributeException {
        return (TrafficDataVolumes)_data.getContainer().get(Ro_r10_transatelAttributeName.TrafficDataVolumes, index);
    }
    ...
    public void addTrafficDataVolumes(TrafficDataVolumes avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TrafficDataVolumes, avp.getData(), false);
    }
    ...
    public int countServiceDataContainer() {
        return _data.getContainer().count(Ro_r10_transatelAttributeName.ServiceDataContainer);
    }
    ...
    public ServiceDataContainer getServiceDataContainer(int index) throws NoSuchAttributeException {
        return (ServiceDataContainer)_data.getContainer().get(Ro_r10_transatelAttributeName.ServiceDataContainer, index);
    }
    ...
    public void addServiceDataContainer(ServiceDataContainer avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.ServiceDataContainer, avp.getData(), false);
    }
    ...
    public boolean containsTerminalInformation() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.TerminalInformation);
    }
    ...
    public TerminalInformation getTerminalInformation() throws NoSuchAttributeException {
        return (TerminalInformation)_data.getContainer().get(Ro_r10_transatelAttributeName.TerminalInformation, 0);
    }
    ...
    public void setTerminalInformation(TerminalInformation avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.TerminalInformation, avp.getData(), true);
    }
    ...
    public boolean containsStartTime() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.StartTime);
    }
    ...
    public StartTime getStartTime() throws NoSuchAttributeException {
        return (StartTime)_data.getContainer().get(Ro_r10_transatelAttributeName.StartTime, 0);
    }
    ...
    public void setStartTime(StartTime avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.StartTime, avp.getData(), true);
    }
    ...
    public boolean containsStopTime() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.StopTime);
    }
    ...
    public StopTime getStopTime() throws NoSuchAttributeException {
        return (StopTime)_data.getContainer().get(Ro_r10_transatelAttributeName.StopTime, 0);
    }
    ...
    public void setStopTime(StopTime avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.StopTime, avp.getData(), true);
    }
    ...
    public boolean containsDiagnostics() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Diagnostics);
    }
    ...
    public Diagnostics getDiagnostics() throws NoSuchAttributeException {
        return (Diagnostics)_data.getContainer().get(Ro_r10_transatelAttributeName.Diagnostics, 0);
    }
    ...
    public void setDiagnostics(Diagnostics avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Diagnostics, avp.getData(), true);
    }
    ...
    public boolean containsLowPriorityIndicator() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LowPriorityIndicator);
    }
    ...
    public LowPriorityIndicator getLowPriorityIndicator() throws NoSuchAttributeException {
        return (LowPriorityIndicator)_data.getContainer().get(Ro_r10_transatelAttributeName.LowPriorityIndicator, 0);
    }
    ...
    public void setLowPriorityIndicator(LowPriorityIndicator avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LowPriorityIndicator, avp.getData(), true);
    }
