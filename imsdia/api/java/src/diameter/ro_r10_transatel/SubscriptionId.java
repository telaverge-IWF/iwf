...
public class SubscriptionId extends com.intellinet.diameter.GroupedAVP {
    ...
    public SubscriptionIdType getSubscriptionIdType() throws NoSuchAttributeException {
        return (SubscriptionIdType)_data.getContainer().get(Ro_r10_transatelAttributeName.SubscriptionIdType, 0);
    }
    ...
    public void setSubscriptionIdType(SubscriptionIdType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.SubscriptionIdType, avp.getData(), true);
    }
    ...
    public SubscriptionIdData getSubscriptionIdData() throws NoSuchAttributeException {
        return (SubscriptionIdData)_data.getContainer().get(Ro_r10_transatelAttributeName.SubscriptionIdData, 0);
    }
    ...
    public void setSubscriptionIdData(SubscriptionIdData avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.SubscriptionIdData, avp.getData(), true);
    }
