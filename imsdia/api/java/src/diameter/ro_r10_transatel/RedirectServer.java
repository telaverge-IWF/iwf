...
public class RedirectServer extends com.intellinet.diameter.GroupedAVP {
    ...
    public RedirectAddressType getRedirectAddressType() throws NoSuchAttributeException {
        return (RedirectAddressType)_data.getContainer().get(Ro_r10_transatelAttributeName.RedirectAddressType, 0);
    }
    ...
    public void setRedirectAddressType(RedirectAddressType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RedirectAddressType, avp.getData(), true);
    }
    ...
    public RedirectServerAddress getRedirectServerAddress() throws NoSuchAttributeException {
        return (RedirectServerAddress)_data.getContainer().get(Ro_r10_transatelAttributeName.RedirectServerAddress, 0);
    }
    ...
    public void setRedirectServerAddress(RedirectServerAddress avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.RedirectServerAddress, avp.getData(), true);
    }
