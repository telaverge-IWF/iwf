...
public class AddressDomain extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsDomainName() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.DomainName);
    }
    ...
    public DomainName getDomainName() throws NoSuchAttributeException {
        return (DomainName)_data.getContainer().get(Ro_r10_transatelAttributeName.DomainName, 0);
    }
    ...
    public void setDomainName(DomainName avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.DomainName, avp.getData(), true);
    }
