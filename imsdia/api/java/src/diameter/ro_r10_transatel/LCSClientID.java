...
public class LCSClientID extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsLCSClientType() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSClientType);
    }
    ...
    public LCSClientType getLCSClientType() throws NoSuchAttributeException {
        return (LCSClientType)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSClientType, 0);
    }
    ...
    public void setLCSClientType(LCSClientType avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSClientType, avp.getData(), true);
    }
    ...
    public boolean containsLCSClientExternalID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSClientExternalID);
    }
    ...
    public LCSClientExternalID getLCSClientExternalID() throws NoSuchAttributeException {
        return (LCSClientExternalID)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSClientExternalID, 0);
    }
    ...
    public void setLCSClientExternalID(LCSClientExternalID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSClientExternalID, avp.getData(), true);
    }
    ...
    public boolean containsLCSClientDialedByMS() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSClientDialedByMS);
    }
    ...
    public LCSClientDialedByMS getLCSClientDialedByMS() throws NoSuchAttributeException {
        return (LCSClientDialedByMS)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSClientDialedByMS, 0);
    }
    ...
    public void setLCSClientDialedByMS(LCSClientDialedByMS avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSClientDialedByMS, avp.getData(), true);
    }
    ...
    public boolean containsLCSClientName() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSClientName);
    }
    ...
    public LCSClientName getLCSClientName() throws NoSuchAttributeException {
        return (LCSClientName)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSClientName, 0);
    }
    ...
    public void setLCSClientName(LCSClientName avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSClientName, avp.getData(), true);
    }
    ...
    public boolean containsLCSAPN() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSAPN);
    }
    ...
    public LCSAPN getLCSAPN() throws NoSuchAttributeException {
        return (LCSAPN)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSAPN, 0);
    }
    ...
    public void setLCSAPN(LCSAPN avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSAPN, avp.getData(), true);
    }
    ...
    public boolean containsLCSRequestorID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSRequestorID);
    }
    ...
    public LCSRequestorID getLCSRequestorID() throws NoSuchAttributeException {
        return (LCSRequestorID)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSRequestorID, 0);
    }
    ...
    public void setLCSRequestorID(LCSRequestorID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSRequestorID, avp.getData(), true);
    }
