...
public class LCSInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsLCSClientID() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LCSClientID);
    }
    ...
    public LCSClientID getLCSClientID() throws NoSuchAttributeException {
        return (LCSClientID)_data.getContainer().get(Ro_r10_transatelAttributeName.LCSClientID, 0);
    }
    ...
    public void setLCSClientID(LCSClientID avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LCSClientID, avp.getData(), true);
    }
    ...
    public boolean containsLocationEstimate() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.LocationEstimate);
    }
    ...
    public LocationEstimate getLocationEstimate() throws NoSuchAttributeException {
        return (LocationEstimate)_data.getContainer().get(Ro_r10_transatelAttributeName.LocationEstimate, 0);
    }
    ...
    public void setLocationEstimate(LocationEstimate avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.LocationEstimate, avp.getData(), true);
    }
    ...
    public boolean containsPositioningData() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.PositioningData);
    }
    ...
    public PositioningData getPositioningData() throws NoSuchAttributeException {
        return (PositioningData)_data.getContainer().get(Ro_r10_transatelAttributeName.PositioningData, 0);
    }
    ...
    public void setPositioningData(PositioningData avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.PositioningData, avp.getData(), true);
    }
    ...
    public boolean containsRo3GPPIMSI() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.Ro3GPPIMSI);
    }
    ...
    public Ro3GPPIMSI getRo3GPPIMSI() throws NoSuchAttributeException {
        return (Ro3GPPIMSI)_data.getContainer().get(Ro_r10_transatelAttributeName.Ro3GPPIMSI, 0);
    }
    ...
    public void setRo3GPPIMSI(Ro3GPPIMSI avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.Ro3GPPIMSI, avp.getData(), true);
    }
    ...
    public boolean containsMSISDN() {
        return _data.getContainer().contains(Ro_r10_transatelAttributeName.MSISDN);
    }
    ...
    public MSISDN getMSISDN() throws NoSuchAttributeException {
        return (MSISDN)_data.getContainer().get(Ro_r10_transatelAttributeName.MSISDN, 0);
    }
    ...
    public void setMSISDN(MSISDN avp) {
        _data.getContainer().add(Ro_r10_transatelAttributeName.MSISDN, avp.getData(), true);
    }
