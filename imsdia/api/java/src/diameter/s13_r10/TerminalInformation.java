...
/**
 * The Terminal-Information AVP (AVP code 1401) is of type Grouped, and contains the 
...
public class TerminalInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsIMEI() {
        return _data.getContainer().contains(S13_r10AttributeName.IMEI);
    }
    ...
    public IMEI getIMEI() throws NoSuchAttributeException {
        return (IMEI)_data.getContainer().get(S13_r10AttributeName.IMEI, 0);
    }
    ...
    public void setIMEI(IMEI avp) {
        _data.getContainer().add(S13_r10AttributeName.IMEI, avp.getData(), true);
    }
    ...
    public boolean containsS133GPP2MEID() {
        return _data.getContainer().contains(S13_r10AttributeName.S133GPP2MEID);
    }
    ...
    public S133GPP2MEID getS133GPP2MEID() throws NoSuchAttributeException {
        return (S133GPP2MEID)_data.getContainer().get(S13_r10AttributeName.S133GPP2MEID, 0);
    }
    ...
    public void setS133GPP2MEID(S133GPP2MEID avp) {
        _data.getContainer().add(S13_r10AttributeName.S133GPP2MEID, avp.getData(), true);
    }
    ...
    public boolean containsSoftwareVersion() {
        return _data.getContainer().contains(S13_r10AttributeName.SoftwareVersion);
    }
    ...
    public SoftwareVersion getSoftwareVersion() throws NoSuchAttributeException {
        return (SoftwareVersion)_data.getContainer().get(S13_r10AttributeName.SoftwareVersion, 0);
    }
    ...
    public void setSoftwareVersion(SoftwareVersion avp) {
        _data.getContainer().add(S13_r10AttributeName.SoftwareVersion, avp.getData(), true);
    }
