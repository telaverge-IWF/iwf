 ...
 */
public class ASAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new ASAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public ASAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 274, 1);
    }

    /**
     * Constructs a ASAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public ASAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a ASAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public ASAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    ASAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
