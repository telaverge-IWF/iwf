...
public class AuthenticationInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countEUTRANVector() {
        return _data.getContainer().count(S6aAttributeName.EUTRANVector);
    }
    ...
    public EUTRANVector getEUTRANVector(int index) throws NoSuchAttributeException {
        return (EUTRANVector)_data.getContainer().get(S6aAttributeName.EUTRANVector, index);
    }
    ...
    public void addEUTRANVector(EUTRANVector avp) {
        _data.getContainer().add(S6aAttributeName.EUTRANVector, avp.getData(), false);
    }
    ...
    public int countUTRANVector() {
        return _data.getContainer().count(S6aAttributeName.UTRANVector);
    }
    ...
    public UTRANVector getUTRANVector(int index) throws NoSuchAttributeException {
        return (UTRANVector)_data.getContainer().get(S6aAttributeName.UTRANVector, index);
    }
    ...
    public void addUTRANVector(UTRANVector avp) {
        _data.getContainer().add(S6aAttributeName.UTRANVector, avp.getData(), false);
    }
    ...
    public int countGERANVector() {
        return _data.getContainer().count(S6aAttributeName.GERANVector);
    }
    ...
    public GERANVector getGERANVector(int index) throws NoSuchAttributeException {
        return (GERANVector)_data.getContainer().get(S6aAttributeName.GERANVector, index);
    }
    ...
    public void addGERANVector(GERANVector avp) {
        _data.getContainer().add(S6aAttributeName.GERANVector, avp.getData(), false);
    }
