...
public class LCSPrivacyException extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countExternalClient() {
        return _data.getContainer().count(S6aAttributeName.ExternalClient);
    }
    ...
    public ExternalClient getExternalClient(int index) throws NoSuchAttributeException {
        return (ExternalClient)_data.getContainer().get(S6aAttributeName.ExternalClient, index);
    }
    ...
    public void addExternalClient(ExternalClient avp) {
        _data.getContainer().add(S6aAttributeName.ExternalClient, avp.getData(), false);
    }
    ...
    public int countPLMNClient() {
        return _data.getContainer().count(S6aAttributeName.PLMNClient);
    }
    ...
    public PLMNClient getPLMNClient(int index) throws NoSuchAttributeException {
        return (PLMNClient)_data.getContainer().get(S6aAttributeName.PLMNClient, index);
    }
    ...
    public void addPLMNClient(PLMNClient avp) {
        _data.getContainer().add(S6aAttributeName.PLMNClient, avp.getData(), false);
    }
    ...
    public int countServiceType() {
        return _data.getContainer().count(S6aAttributeName.ServiceType);
    }
    ...
    public ServiceType getServiceType(int index) throws NoSuchAttributeException {
        return (ServiceType)_data.getContainer().get(S6aAttributeName.ServiceType, index);
    }
    ...
    public void addServiceType(ServiceType avp) {
        _data.getContainer().add(S6aAttributeName.ServiceType, avp.getData(), false);
    }
