...
public class LCSInfo extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countGMLCNumber() {
        return _data.getContainer().count(S6aAttributeName.GMLCNumber);
    }
    ...
    public GMLCNumber getGMLCNumber(int index) throws NoSuchAttributeException {
        return (GMLCNumber)_data.getContainer().get(S6aAttributeName.GMLCNumber, index);
    }
    ...
    public void addGMLCNumber(GMLCNumber avp) {
        _data.getContainer().add(S6aAttributeName.GMLCNumber, avp.getData(), false);
    }
    ...
    public int countLCSPrivacyException() {
        return _data.getContainer().count(S6aAttributeName.LCSPrivacyException);
    }
    ...
    public LCSPrivacyException getLCSPrivacyException(int index) throws NoSuchAttributeException {
        return (LCSPrivacyException)_data.getContainer().get(S6aAttributeName.LCSPrivacyException, index);
    }
    ...
    public void addLCSPrivacyException(LCSPrivacyException avp) {
        _data.getContainer().add(S6aAttributeName.LCSPrivacyException, avp.getData(), false);
    }
    ...
    public int countMOLR() {
        return _data.getContainer().count(S6aAttributeName.MOLR);
    }
    ...
    public MOLR getMOLR(int index) throws NoSuchAttributeException {
        return (MOLR)_data.getContainer().get(S6aAttributeName.MOLR, index);
    }
    ...
    public void addMOLR(MOLR avp) {
        _data.getContainer().add(S6aAttributeName.MOLR, avp.getData(), false);
    }
