...
*/
public class ResetAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new ResetAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public ResetAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 322, 16777251);
    }

    /**
     * Constructs a ResetAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public ResetAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a ResetAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public ResetAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    ResetAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
