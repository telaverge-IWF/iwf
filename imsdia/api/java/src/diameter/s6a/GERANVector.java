...
public class GERANVector extends com.intellinet.diameter.GroupedAVP {
    ...
    public SRES getSRES() throws NoSuchAttributeException {
        return (SRES)_data.getContainer().get(S6aAttributeName.SRES, 0);
    }
    ...
    public void setSRES(SRES avp) {
        _data.getContainer().add(S6aAttributeName.SRES, avp.getData(), true);
    }
    ...
    public Kc getKc() throws NoSuchAttributeException {
        return (Kc)_data.getContainer().get(S6aAttributeName.Kc, 0);
    }
    ...
    public void setKc(Kc avp) {
        _data.getContainer().add(S6aAttributeName.Kc, avp.getData(), true);
    }
