...
/**
   * The Cancel-Location-Answer (CLA) command, indicated by the Command-Code 
   * field set to 317 and the 'R' bit cleared in the Command Flags field, 
   * is sent from MME or SGSN to HSS.
   */
public class CancelLocationAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new CancelLocationAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public CancelLocationAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 317, 16777251);
    }

    /**
     * Constructs a CancelLocationAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public CancelLocationAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a CancelLocationAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public CancelLocationAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    CancelLocationAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
