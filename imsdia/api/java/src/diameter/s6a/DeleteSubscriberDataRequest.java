...
public class DeleteSubscriberDataRequest extends com.intellinet.diameter.Command {
    ...
    public DSRFlags getDSRFlags() throws NoSuchAttributeException {
        return (DSRFlags)_data.getContainer().get(S6aAttributeName.DSRFlags, 0);
    }
    ...
    public void setDSRFlags(DSRFlags avp) {
        _data.getContainer().add(S6aAttributeName.DSRFlags, avp.getData(), true);
    }
    ...
    public boolean containsTraceReference() {
        return _data.getContainer().contains(S6aAttributeName.TraceReference);
    }
    ...
    public int countTSCode() {
        return _data.getContainer().count(S6aAttributeName.TSCode);
    }
    ...
    public TSCode getTSCode(int index) throws NoSuchAttributeException {
        return (TSCode)_data.getContainer().get(S6aAttributeName.TSCode, index);
    }
    ...
    public void addTSCode(TSCode avp) {
        _data.getContainer().add(S6aAttributeName.TSCode, avp.getData(), false);
    }
    ...
    public int countSSCode() {
        return _data.getContainer().count(S6aAttributeName.SSCode);
    }
    ...
    public SSCode getSSCode(int index) throws NoSuchAttributeException {
        return (SSCode)_data.getContainer().get(S6aAttributeName.SSCode, index);
    }
    ...
    public void addSSCode(SSCode avp) {
        _data.getContainer().add(S6aAttributeName.SSCode, avp.getData(), false);
    }
    ...
    public int countContextIdentifier() {
        return _data.getContainer().count(S6aAttributeName.ContextIdentifier);
    }
    ...
    public ContextIdentifier getContextIdentifier(int index) throws NoSuchAttributeException {
        return (ContextIdentifier)_data.getContainer().get(S6aAttributeName.ContextIdentifier, index);
    }
    ...
    public void addContextIdentifier(ContextIdentifier avp) {
        _data.getContainer().add(S6aAttributeName.ContextIdentifier, avp.getData(), false);
    }
