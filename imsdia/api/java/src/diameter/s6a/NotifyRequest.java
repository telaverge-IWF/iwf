...
public class NotifyRequest extends com.intellinet.diameter.Command {
    ...
    public boolean containsNORFlags() {
        return _data.getContainer().contains(S6aAttributeName.NORFlags);
    }
    ...
    public NORFlags getNORFlags() throws NoSuchAttributeException {
        return (NORFlags)_data.getContainer().get(S6aAttributeName.NORFlags, 0);
    }
    ...
    public void setNORFlags(NORFlags avp) {
        _data.getContainer().add(S6aAttributeName.NORFlags, avp.getData(), true);
    }
    ...
    public boolean containsContextIdentifier() {
        return _data.getContainer().contains(S6aAttributeName.ContextIdentifier);
    }
    ...
    public boolean containsServiceSelection() {
        return _data.getContainer().contains(S6aAttributeName.ServiceSelection);
    }
    ...
    public boolean containsAlertReason() {
        return _data.getContainer().contains(S6aAttributeName.AlertReason);
    }
    ...
    public AlertReason getAlertReason() throws NoSuchAttributeException {
        return (AlertReason)_data.getContainer().get(S6aAttributeName.AlertReason, 0);
    }
    ...
    public void setAlertReason(AlertReason avp) {
        _data.getContainer().add(S6aAttributeName.AlertReason, avp.getData(), true);
    }
