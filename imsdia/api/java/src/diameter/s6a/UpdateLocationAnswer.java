...
public class UpdateLocationAnswer extends com.intellinet.diameter.Command {
    ...
    public boolean containsULAFlags() {
        return _data.getContainer().contains(S6aAttributeName.ULAFlags);
    }
    ...
    public ULAFlags getULAFlags() throws NoSuchAttributeException {
        return (ULAFlags)_data.getContainer().get(S6aAttributeName.ULAFlags, 0);
    }
    ...
    public void setULAFlags(ULAFlags avp) {
        _data.getContainer().add(S6aAttributeName.ULAFlags, avp.getData(), true);
    }
    ...
    public boolean containsSubscriptionData() {
        return _data.getContainer().contains(S6aAttributeName.SubscriptionData);
    }
    ...
    public SubscriptionData getSubscriptionData() throws NoSuchAttributeException {
        return (SubscriptionData)_data.getContainer().get(S6aAttributeName.SubscriptionData, 0);
    }
    ...
    public void setSubscriptionData(SubscriptionData avp) {
        _data.getContainer().add(S6aAttributeName.SubscriptionData, avp.getData(), true);
    }
