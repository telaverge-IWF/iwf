...
*/
public class NotifyAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new NotifyAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public NotifyAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 323, 16777251);
    }

    /**
     * Constructs a NotifyAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public NotifyAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a NotifyAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public NotifyAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    NotifyAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
