...
public class FinalUnitIndication extends com.intellinet.diameter.GroupedAVP {
    ...
    public FinalUnitAction getFinalUnitAction() throws NoSuchAttributeException {
        return (FinalUnitAction)_data.getContainer().get(DccaAttributeName.FinalUnitAction, 0);
    }
    ...
    public void setFinalUnitAction(FinalUnitAction avp) {
        _data.getContainer().add(DccaAttributeName.FinalUnitAction, avp.getData(), true);
    }
    ...
    public int countRestrictionFilterRule() {
        return _data.getContainer().count(DccaAttributeName.RestrictionFilterRule);
    }
    ...
    public RestrictionFilterRule getRestrictionFilterRule(int index) throws NoSuchAttributeException {
        return (RestrictionFilterRule)_data.getContainer().get(DccaAttributeName.RestrictionFilterRule, index);
    }
    ...
    public void addRestrictionFilterRule(RestrictionFilterRule avp) {
        _data.getContainer().add(DccaAttributeName.RestrictionFilterRule, avp.getData(), false);
    }
    ...
    public int countFilterId() {
        return _data.getContainer().count(DccaAttributeName.FilterId);
    }
    ...
    public FilterId getFilterId(int index) throws NoSuchAttributeException {
        return (FilterId)_data.getContainer().get(DccaAttributeName.FilterId, index);
    }
    ...
    public void addFilterId(FilterId avp) {
        _data.getContainer().add(DccaAttributeName.FilterId, avp.getData(), false);
    }
    ...
    public boolean containsRedirectServer() {
        return _data.getContainer().contains(DccaAttributeName.RedirectServer);
    }
    ...
    public RedirectServer getRedirectServer() throws NoSuchAttributeException {
        return (RedirectServer)_data.getContainer().get(DccaAttributeName.RedirectServer, 0);
    }
    ...
    public void setRedirectServer(RedirectServer avp) {
        _data.getContainer().add(DccaAttributeName.RedirectServer, avp.getData(), true);
    }
