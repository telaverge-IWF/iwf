...
public class CreditControlRequest extends com.intellinet.diameter.Command {
    ...
    public ServiceContextId getServiceContextId() throws NoSuchAttributeException {
        return (ServiceContextId)_data.getContainer().get(DccaAttributeName.ServiceContextId, 0);
    }
    ...
    public void setServiceContextId(ServiceContextId avp) {
        _data.getContainer().add(DccaAttributeName.ServiceContextId, avp.getData(), true);
    }
    ...
    public int countSubscriptionId() {
        return _data.getContainer().count(DccaAttributeName.SubscriptionId);
    }
    ...
    public SubscriptionId getSubscriptionId(int index) throws NoSuchAttributeException {
        return (SubscriptionId)_data.getContainer().get(DccaAttributeName.SubscriptionId, index);
    }
    ...
    public void addSubscriptionId(SubscriptionId avp) {
        _data.getContainer().add(DccaAttributeName.SubscriptionId, avp.getData(), false);
    }
    ...
    public boolean containsRequestedAction() {
        return _data.getContainer().contains(DccaAttributeName.RequestedAction);
    }
    ...
    public RequestedAction getRequestedAction() throws NoSuchAttributeException {
        return (RequestedAction)_data.getContainer().get(DccaAttributeName.RequestedAction, 0);
    }
    ...
    public void setRequestedAction(RequestedAction avp) {
        _data.getContainer().add(DccaAttributeName.RequestedAction, avp.getData(), true);
    }
    ...
    public boolean containsMultipleServicesIndicator() {
        return _data.getContainer().contains(DccaAttributeName.MultipleServicesIndicator);
    }
    ...
    public MultipleServicesIndicator getMultipleServicesIndicator() throws NoSuchAttributeException {
        return (MultipleServicesIndicator)_data.getContainer().get(DccaAttributeName.MultipleServicesIndicator, 0);
    }
    ...
    public void setMultipleServicesIndicator(MultipleServicesIndicator avp) {
        _data.getContainer().add(DccaAttributeName.MultipleServicesIndicator, avp.getData(), true);
    }
    ...
    /**
     * Returns number of ServiceParameterInfo instances.
     */
    public int countServiceParameterInfo() {
        return _data.getContainer().count(DccaAttributeName.ServiceParameterInfo);
    }

    /**
     * Gets one ServiceParameterInfo.
     *
     * @param index - the index of the attribute to return
     */
    public ServiceParameterInfo getServiceParameterInfo(int index) throws NoSuchAttributeException {
        return (ServiceParameterInfo)_data.getContainer().get(DccaAttributeName.ServiceParameterInfo, index);
    }

    /**
     * Adds one ServiceParameterInfo.
     *
     * @param avp - the attribute value
     */
    public void addServiceParameterInfo(ServiceParameterInfo avp) {
        _data.getContainer().add(DccaAttributeName.ServiceParameterInfo, avp.getData(), false);
    }
    ...
    public boolean containsCCCorrelationId() {
        return _data.getContainer().contains(DccaAttributeName.CCCorrelationId);
    }
    ...
    public CCCorrelationId getCCCorrelationId() throws NoSuchAttributeException {
        return (CCCorrelationId)_data.getContainer().get(DccaAttributeName.CCCorrelationId, 0);
    }
    ...
    public void setCCCorrelationId(CCCorrelationId avp) {
        _data.getContainer().add(DccaAttributeName.CCCorrelationId, avp.getData(), true);
    }
    ...
    public boolean containsUserEquipmentInfo() {
        return _data.getContainer().contains(DccaAttributeName.UserEquipmentInfo);
    }
    ...
    public UserEquipmentInfo getUserEquipmentInfo() throws NoSuchAttributeException {
        return (UserEquipmentInfo)_data.getContainer().get(DccaAttributeName.UserEquipmentInfo, 0);
    }
    ...
    public void setUserEquipmentInfo(UserEquipmentInfo avp) {
        _data.getContainer().add(DccaAttributeName.UserEquipmentInfo, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < countServiceParameterInfo(); ++i) {
            sb.append("    ServiceParameterInfo:");
            try {
                sb.append(getServiceParameterInfo(i)).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
