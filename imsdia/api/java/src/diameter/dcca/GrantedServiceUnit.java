...
public class GrantedServiceUnit extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsTariffTimeChange() {
        return _data.getContainer().contains(DccaAttributeName.TariffTimeChange);
    }
    ...
    public TariffTimeChange getTariffTimeChange() throws NoSuchAttributeException {
        return (TariffTimeChange)_data.getContainer().get(DccaAttributeName.TariffTimeChange, 0);
    }
    ...
    public void setTariffTimeChange(TariffTimeChange avp) {
        _data.getContainer().add(DccaAttributeName.TariffTimeChange, avp.getData(), true);
    }
    ...
    public boolean containsCCTime() {
        return _data.getContainer().contains(DccaAttributeName.CCTime);
    }
    ...
    public CCTime getCCTime() throws NoSuchAttributeException {
        return (CCTime)_data.getContainer().get(DccaAttributeName.CCTime, 0);
    }
    ...
    public void setCCTime(CCTime avp) {
        _data.getContainer().add(DccaAttributeName.CCTime, avp.getData(), true);
    }
    ...
    public boolean containsCCMoney() {
        return _data.getContainer().contains(DccaAttributeName.CCMoney);
    }
    ...
    public CCMoney getCCMoney() throws NoSuchAttributeException {
        return (CCMoney)_data.getContainer().get(DccaAttributeName.CCMoney, 0);
    }
    ...
    public void setCCMoney(CCMoney avp) {
        _data.getContainer().add(DccaAttributeName.CCMoney, avp.getData(), true);
    }
    ...
    public boolean containsCCTotalOctets() {
        return _data.getContainer().contains(DccaAttributeName.CCTotalOctets);
    }
    ...
    public CCTotalOctets getCCTotalOctets() throws NoSuchAttributeException {
        return (CCTotalOctets)_data.getContainer().get(DccaAttributeName.CCTotalOctets, 0);
    }
    ...
    public void setCCTotalOctets(CCTotalOctets avp) {
        _data.getContainer().add(DccaAttributeName.CCTotalOctets, avp.getData(), true);
    }
    ...
    public boolean containsCCInputOctets() {
        return _data.getContainer().contains(DccaAttributeName.CCInputOctets);
    }
    ...
    public CCInputOctets getCCInputOctets() throws NoSuchAttributeException {
        return (CCInputOctets)_data.getContainer().get(DccaAttributeName.CCInputOctets, 0);
    }
    ...
    public void setCCInputOctets(CCInputOctets avp) {
        _data.getContainer().add(DccaAttributeName.CCInputOctets, avp.getData(), true);
    }
    ...
    public boolean containsCCOutputOctets() {
        return _data.getContainer().contains(DccaAttributeName.CCOutputOctets);
    }
    ...
    public CCOutputOctets getCCOutputOctets() throws NoSuchAttributeException {
        return (CCOutputOctets)_data.getContainer().get(DccaAttributeName.CCOutputOctets, 0);
    }
    ...
    public void setCCOutputOctets(CCOutputOctets avp) {
        _data.getContainer().add(DccaAttributeName.CCOutputOctets, avp.getData(), true);
    }
    ...
    public boolean containsCCServiceSpecificUnits() {
        return _data.getContainer().contains(DccaAttributeName.CCServiceSpecificUnits);
    }
    ...
    public CCServiceSpecificUnits getCCServiceSpecificUnits() throws NoSuchAttributeException {
        return (CCServiceSpecificUnits)_data.getContainer().get(DccaAttributeName.CCServiceSpecificUnits, 0);
    }
    ...
    public void setCCServiceSpecificUnits(CCServiceSpecificUnits avp) {
        _data.getContainer().add(DccaAttributeName.CCServiceSpecificUnits, avp.getData(), true);
    }
