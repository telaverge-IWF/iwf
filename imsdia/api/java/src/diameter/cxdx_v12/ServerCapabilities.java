...
public class ServerCapabilities extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countMandatoryCapability() {
        return _data.getContainer().count(Cxdx_v12AttributeName.MandatoryCapability);
    }
    ...
    public MandatoryCapability getMandatoryCapability(int index) throws NoSuchAttributeException {
        return (MandatoryCapability)_data.getContainer().get(Cxdx_v12AttributeName.MandatoryCapability, index);
    }
    ...
    public void addMandatoryCapability(MandatoryCapability avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.MandatoryCapability, avp.getData(), false);
    }
    ...
    public int countOptionalCapability() {
        return _data.getContainer().count(Cxdx_v12AttributeName.OptionalCapability);
    }
    ...
    public OptionalCapability getOptionalCapability(int index) throws NoSuchAttributeException {
        return (OptionalCapability)_data.getContainer().get(Cxdx_v12AttributeName.OptionalCapability, index);
    }
    ...
    public void addOptionalCapability(OptionalCapability avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.OptionalCapability, avp.getData(), false);
    }
    ...
    public int countServerName() {
        return _data.getContainer().count(Cxdx_v12AttributeName.ServerName);
    }
    ...
    public ServerName getServerName(int index) throws NoSuchAttributeException {
        return (ServerName)_data.getContainer().get(Cxdx_v12AttributeName.ServerName, index);
    }
    ...
    public void addServerName(ServerName avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.ServerName, avp.getData(), false);
    }
