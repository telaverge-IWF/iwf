 ...
 */
public class UserAuthorizationRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new UserAuthorizationRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public UserAuthorizationRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 300, 16777216);
    }

    /**
     * Constructs a UserAuthorizationRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public UserAuthorizationRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a UserAuthorizationRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public UserAuthorizationRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    UserAuthorizationRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    public VisitedNetworkIdentifier getVisitedNetworkIdentifier() throws NoSuchAttributeException {
        return (VisitedNetworkIdentifier)_data.getContainer().get(Cxdx_v12AttributeName.VisitedNetworkIdentifier, 0);
    }
    ...
    public void setVisitedNetworkIdentifier(VisitedNetworkIdentifier avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.VisitedNetworkIdentifier, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any UARFlags.
     */
    public boolean containsUARFlags() {
        return _data.getContainer().contains(Cxdx_v12AttributeName.UARFlags);
    }

    /**
     * Gets the UARFlags.
     */
    public UARFlags getUARFlags() throws NoSuchAttributeException {
        return (UARFlags)_data.getContainer().get(Cxdx_v12AttributeName.UARFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setUARFlags(UARFlags avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.UARFlags, avp.getData(), true);
    }
    ...
    /**
     * Tests whether there is any UserAuthorizationType.
     */
    public boolean containsUserAuthorizationType() {
        return _data.getContainer().contains(Cxdx_v12AttributeName.UserAuthorizationType);
    }

    /**
     * Gets the UserAuthorizationType.
     */
    public UserAuthorizationType getUserAuthorizationType() throws NoSuchAttributeException {
        return (UserAuthorizationType)_data.getContainer().get(Cxdx_v12AttributeName.UserAuthorizationType, 0);
    }

    /**
     * Sets the UserAuthorizationType.
     *
     * @param avp - the attribute value
     */
    public void setUserAuthorizationType(UserAuthorizationType avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.UserAuthorizationType, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        if (containsUserAuthorizationType()) {
            sb.append("    UserAuthorizationType:");
            try {
                sb.append(getUserAuthorizationType()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
    ...
    private void validate() throws WrongCommandTypeException {
        if (getCommandCode() != 300 || !isRequest()) {
