 ...
 */
public class LocationInfoRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new LocationInfoRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public LocationInfoRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 302, 16777216);
    }

    /**
     * Constructs a LocationInfoRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public LocationInfoRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a LocationInfoRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public LocationInfoRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    LocationInfoRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any OriginatingRequest.
     */
    public boolean containsOriginatingRequest() {
        return _data.getContainer().contains(Cxdx_v12AttributeName.OriginatingRequest);
    }

    /**
     * Gets the OriginatingRequest.
     */
    public OriginatingRequest getOriginatingRequest() throws NoSuchAttributeException {
        return (OriginatingRequest)_data.getContainer().get(Cxdx_v12AttributeName.OriginatingRequest, 0);
    }

    /**
     * Sets the OriginatingRequest.
     *
     * @param avp - the attribute value
     */
    public void setOriginatingRequest(OriginatingRequest avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.OriginatingRequest, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        if (containsOriginatingRequest()) {
            sb.append("    OriginatingRequest:");
            try {
                sb.append(getOriginatingRequest()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[said present but missing]\n");
            }
        }
    ...
    private void validate() throws WrongCommandTypeException {
        if (getCommandCode() != 302 || !isRequest()) {
