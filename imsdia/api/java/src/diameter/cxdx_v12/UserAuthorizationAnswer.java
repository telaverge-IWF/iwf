 ...
 */
public class UserAuthorizationAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new UserAuthorizationAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public UserAuthorizationAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 300, 16777216);
    }

    /**
     * Constructs a UserAuthorizationAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public UserAuthorizationAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a UserAuthorizationAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public UserAuthorizationAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    UserAuthorizationAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
