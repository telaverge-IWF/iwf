...
public class AssociatedRegisteredIdentities extends com.intellinet.diameter.GroupedAVP {
    /**
     * Constructs a new AssociatedRegisteredIdentities.
     */
    public AssociatedRegisteredIdentities() {}

    AssociatedRegisteredIdentities(com.intellinet.diameter.GroupedData data) {
        super(data);
    }
