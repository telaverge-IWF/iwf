...
public class SupportedFeatures extends com.intellinet.diameter.GroupedAVP {
    ...
    public FeatureListID getFeatureListID() throws NoSuchAttributeException {
        return (FeatureListID)_data.getContainer().get(Cxdx_v12AttributeName.FeatureListID, 0);
    }
    ...
    public void setFeatureListID(FeatureListID avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.FeatureListID, avp.getData(), true);
    }
    ...
    public FeatureList getFeatureList() throws NoSuchAttributeException {
        return (FeatureList)_data.getContainer().get(Cxdx_v12AttributeName.FeatureList, 0);
    }
    ...
    public void setFeatureList(FeatureList avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.FeatureList, avp.getData(), true);
    }
