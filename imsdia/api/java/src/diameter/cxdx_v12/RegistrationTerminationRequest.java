 ...
 */
public class RegistrationTerminationRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new RegistrationTerminationRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public RegistrationTerminationRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 304, 16777216);
    }

    /**
     * Constructs a RegistrationTerminationRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public RegistrationTerminationRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a RegistrationTerminationRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public RegistrationTerminationRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    RegistrationTerminationRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Gets the DeregistrationReason.
     */
    public DeregistrationReason getDeregistrationReason() throws NoSuchAttributeException {
        return (DeregistrationReason)_data.getContainer().get(Cxdx_v12AttributeName.DeregistrationReason, 0);
    }

    /**
     * Sets the DeregistrationReason.
     *
     * @param avp - the attribute value
     */
    public void setDeregistrationReason(DeregistrationReason avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.DeregistrationReason, avp.getData(), true);
    }
    ...
    public String toString() {
        ...
        sb.append("    DeregistrationReason:");
            try {
                sb.append(getDeregistrationReason()).append('\n');
            } catch (NoSuchAttributeException x) {
                sb.append("[required but missing]\n");
            }
