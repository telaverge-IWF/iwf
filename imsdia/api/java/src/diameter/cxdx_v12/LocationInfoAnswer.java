 ...
 * RFC 3588 [6].
 */
public class LocationInfoAnswer extends com.intellinet.diameter.Command {
    /**
     * Constructs a new LocationInfoAnswer command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public LocationInfoAnswer(boolean error, boolean retrans) {
        super(false, true, error, retrans, 302, 16777216);
    }

    /**
     * Constructs a LocationInfoAnswer command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public LocationInfoAnswer(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a LocationInfoAnswer command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public LocationInfoAnswer(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    LocationInfoAnswer(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    /**
     * Tests whether there is any LIAFlags.
     */
    public boolean containsLIAFlags() {
        return _data.getContainer().contains(Cxdx_v12AttributeName.LIAFlags);
    }

    /**
     * Gets the LIAFlags.
     */
    public LIAFlags getLIAFlags() throws NoSuchAttributeException {
        return (LIAFlags)_data.getContainer().get(Cxdx_v12AttributeName.LIAFlags, 0);
    }
     ...
     * @param avp - the attribute value
     */
    public void setLIAFlags(LIAFlags avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.LIAFlags, avp.getData(), true);
    }
    ...
    public boolean containsServerCapabilities() {
        return _data.getContainer().contains(Cxdx_v12AttributeName.ServerCapabilities);
    }
    ...
    public ServerCapabilities getServerCapabilities() throws NoSuchAttributeException {
        return (ServerCapabilities)_data.getContainer().get(Cxdx_v12AttributeName.ServerCapabilities, 0);
    }
    ...
    public void setServerCapabilities(ServerCapabilities avp) {
        _data.getContainer().add(Cxdx_v12AttributeName.ServerCapabilities, avp.getData(), true);
    }
