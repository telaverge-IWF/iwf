...
public class LCSClientName extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsLCSDataCodingScheme() {
        return _data.getContainer().contains(Ro_r10AttributeName.LCSDataCodingScheme);
    }
    ...
    public LCSDataCodingScheme getLCSDataCodingScheme() throws NoSuchAttributeException {
        return (LCSDataCodingScheme)_data.getContainer().get(Ro_r10AttributeName.LCSDataCodingScheme, 0);
    }
    ...
    public void setLCSDataCodingScheme(LCSDataCodingScheme avp) {
        _data.getContainer().add(Ro_r10AttributeName.LCSDataCodingScheme, avp.getData(), true);
    }
    ...
    public boolean containsLCSNameString() {
        return _data.getContainer().contains(Ro_r10AttributeName.LCSNameString);
    }
    ...
    public LCSNameString getLCSNameString() throws NoSuchAttributeException {
        return (LCSNameString)_data.getContainer().get(Ro_r10AttributeName.LCSNameString, 0);
    }
    ...
    public void setLCSNameString(LCSNameString avp) {
        _data.getContainer().add(Ro_r10AttributeName.LCSNameString, avp.getData(), true);
    }
    ...
    public boolean containsLCSFormatIndicator() {
        return _data.getContainer().contains(Ro_r10AttributeName.LCSFormatIndicator);
    }
    ...
    public LCSFormatIndicator getLCSFormatIndicator() throws NoSuchAttributeException {
        return (LCSFormatIndicator)_data.getContainer().get(Ro_r10AttributeName.LCSFormatIndicator, 0);
    }
    ...
    public void setLCSFormatIndicator(LCSFormatIndicator avp) {
        _data.getContainer().add(Ro_r10AttributeName.LCSFormatIndicator, avp.getData(), true);
    }
