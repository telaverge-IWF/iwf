...
public class CreditControlAnswer extends com.intellinet.diameter.Command {
    ...
    public CCRequestType getCCRequestType() throws NoSuchAttributeException {
        return (CCRequestType)_data.getContainer().get(Ro_r10AttributeName.CCRequestType, 0);
    }
    ...
    public void setCCRequestType(CCRequestType avp) {
        _data.getContainer().add(Ro_r10AttributeName.CCRequestType, avp.getData(), true);
    }
    ...
    public CCRequestNumber getCCRequestNumber() throws NoSuchAttributeException {
        return (CCRequestNumber)_data.getContainer().get(Ro_r10AttributeName.CCRequestNumber, 0);
    }
    ...
    public void setCCRequestNumber(CCRequestNumber avp) {
        _data.getContainer().add(Ro_r10AttributeName.CCRequestNumber, avp.getData(), true);
    }
    ...
    public boolean containsCCSessionFailover() {
        return _data.getContainer().contains(Ro_r10AttributeName.CCSessionFailover);
    }
    ...
    public CCSessionFailover getCCSessionFailover() throws NoSuchAttributeException {
        return (CCSessionFailover)_data.getContainer().get(Ro_r10AttributeName.CCSessionFailover, 0);
    }
    ...
    public void setCCSessionFailover(CCSessionFailover avp) {
        _data.getContainer().add(Ro_r10AttributeName.CCSessionFailover, avp.getData(), true);
    }
    ...
    public int countMultipleServicesCreditControl() {
        return _data.getContainer().count(Ro_r10AttributeName.MultipleServicesCreditControl);
    }
    ...
    public MultipleServicesCreditControl getMultipleServicesCreditControl(int index) throws NoSuchAttributeException {
        return (MultipleServicesCreditControl)_data.getContainer().get(Ro_r10AttributeName.MultipleServicesCreditControl, index);
    }
    ...
    public void addMultipleServicesCreditControl(MultipleServicesCreditControl avp) {
        _data.getContainer().add(Ro_r10AttributeName.MultipleServicesCreditControl, avp.getData(), false);
    }
    ...
    public boolean containsCostInformation() {
        return _data.getContainer().contains(Ro_r10AttributeName.CostInformation);
    }
    ...
    public CostInformation getCostInformation() throws NoSuchAttributeException {
        return (CostInformation)_data.getContainer().get(Ro_r10AttributeName.CostInformation, 0);
    }
    ...
    public void setCostInformation(CostInformation avp) {
        _data.getContainer().add(Ro_r10AttributeName.CostInformation, avp.getData(), true);
    }
    ...
    public boolean containsLowBalanceIndication() {
        return _data.getContainer().contains(Ro_r10AttributeName.LowBalanceIndication);
    }
    ...
    public LowBalanceIndication getLowBalanceIndication() throws NoSuchAttributeException {
        return (LowBalanceIndication)_data.getContainer().get(Ro_r10AttributeName.LowBalanceIndication, 0);
    }
    ...
    public void setLowBalanceIndication(LowBalanceIndication avp) {
        _data.getContainer().add(Ro_r10AttributeName.LowBalanceIndication, avp.getData(), true);
    }
    ...
    public boolean containsRemainingBalance() {
        return _data.getContainer().contains(Ro_r10AttributeName.RemainingBalance);
    }
    ...
    public RemainingBalance getRemainingBalance() throws NoSuchAttributeException {
        return (RemainingBalance)_data.getContainer().get(Ro_r10AttributeName.RemainingBalance, 0);
    }
    ...
    public void setRemainingBalance(RemainingBalance avp) {
        _data.getContainer().add(Ro_r10AttributeName.RemainingBalance, avp.getData(), true);
    }
    ...
    public boolean containsCreditControlFailureHandling() {
        return _data.getContainer().contains(Ro_r10AttributeName.CreditControlFailureHandling);
    }
    ...
    public CreditControlFailureHandling getCreditControlFailureHandling() throws NoSuchAttributeException {
        return (CreditControlFailureHandling)_data.getContainer().get(Ro_r10AttributeName.CreditControlFailureHandling, 0);
    }
    ...
    public void setCreditControlFailureHandling(CreditControlFailureHandling avp) {
        _data.getContainer().add(Ro_r10AttributeName.CreditControlFailureHandling, avp.getData(), true);
    }
    ...
    public boolean containsDirectDebitingFailureHandling() {
        return _data.getContainer().contains(Ro_r10AttributeName.DirectDebitingFailureHandling);
    }
    ...
    public DirectDebitingFailureHandling getDirectDebitingFailureHandling() throws NoSuchAttributeException {
        return (DirectDebitingFailureHandling)_data.getContainer().get(Ro_r10AttributeName.DirectDebitingFailureHandling, 0);
    }
    ...
    public void setDirectDebitingFailureHandling(DirectDebitingFailureHandling avp) {
        _data.getContainer().add(Ro_r10AttributeName.DirectDebitingFailureHandling, avp.getData(), true);
    }
    ...
    public boolean containsServiceInformation() {
        return _data.getContainer().contains(Ro_r10AttributeName.ServiceInformation);
    }
    ...
    public ServiceInformation getServiceInformation() throws NoSuchAttributeException {
        return (ServiceInformation)_data.getContainer().get(Ro_r10AttributeName.ServiceInformation, 0);
    }
    ...
    public void setServiceInformation(ServiceInformation avp) {
        _data.getContainer().add(Ro_r10AttributeName.ServiceInformation, avp.getData(), true);
    }
