...
public class SMSInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsSMSNode() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMSNode);
    }
    ...
    public SMSNode getSMSNode() throws NoSuchAttributeException {
        return (SMSNode)_data.getContainer().get(Ro_r10AttributeName.SMSNode, 0);
    }
    ...
    public void setSMSNode(SMSNode avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMSNode, avp.getData(), true);
    }
    ...
    public boolean containsClientAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.ClientAddress);
    }
    ...
    public ClientAddress getClientAddress() throws NoSuchAttributeException {
        return (ClientAddress)_data.getContainer().get(Ro_r10AttributeName.ClientAddress, 0);
    }
    ...
    public void setClientAddress(ClientAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.ClientAddress, avp.getData(), true);
    }
    ...
    public boolean containsOriginatorSCCPAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.OriginatorSCCPAddress);
    }
    ...
    public OriginatorSCCPAddress getOriginatorSCCPAddress() throws NoSuchAttributeException {
        return (OriginatorSCCPAddress)_data.getContainer().get(Ro_r10AttributeName.OriginatorSCCPAddress, 0);
    }
    ...
    public void setOriginatorSCCPAddress(OriginatorSCCPAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.OriginatorSCCPAddress, avp.getData(), true);
    }
    ...
    public boolean containsSMSCAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMSCAddress);
    }
    ...
    public SMSCAddress getSMSCAddress() throws NoSuchAttributeException {
        return (SMSCAddress)_data.getContainer().get(Ro_r10AttributeName.SMSCAddress, 0);
    }
    ...
    public void setSMSCAddress(SMSCAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMSCAddress, avp.getData(), true);
    }
    ...
    public boolean containsDataCodingScheme() {
        return _data.getContainer().contains(Ro_r10AttributeName.DataCodingScheme);
    }
    ...
    public DataCodingScheme getDataCodingScheme() throws NoSuchAttributeException {
        return (DataCodingScheme)_data.getContainer().get(Ro_r10AttributeName.DataCodingScheme, 0);
    }
    ...
    public void setDataCodingScheme(DataCodingScheme avp) {
        _data.getContainer().add(Ro_r10AttributeName.DataCodingScheme, avp.getData(), true);
    }
    ...
    public boolean containsSMDischargeTime() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMDischargeTime);
    }
    ...
    public SMDischargeTime getSMDischargeTime() throws NoSuchAttributeException {
        return (SMDischargeTime)_data.getContainer().get(Ro_r10AttributeName.SMDischargeTime, 0);
    }
    ...
    public void setSMDischargeTime(SMDischargeTime avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMDischargeTime, avp.getData(), true);
    }
    ...
    public boolean containsSMMessageType() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMMessageType);
    }
    ...
    public SMMessageType getSMMessageType() throws NoSuchAttributeException {
        return (SMMessageType)_data.getContainer().get(Ro_r10AttributeName.SMMessageType, 0);
    }
    ...
    public void setSMMessageType(SMMessageType avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMMessageType, avp.getData(), true);
    }
    ...
    public boolean containsOriginatorInterface() {
        return _data.getContainer().contains(Ro_r10AttributeName.OriginatorInterface);
    }
    ...
    public OriginatorInterface getOriginatorInterface() throws NoSuchAttributeException {
        return (OriginatorInterface)_data.getContainer().get(Ro_r10AttributeName.OriginatorInterface, 0);
    }
    ...
    public void setOriginatorInterface(OriginatorInterface avp) {
        _data.getContainer().add(Ro_r10AttributeName.OriginatorInterface, avp.getData(), true);
    }
    ...
    public boolean containsReplyPathRequested() {
        return _data.getContainer().contains(Ro_r10AttributeName.ReplyPathRequested);
    }
    ...
    public ReplyPathRequested getReplyPathRequested() throws NoSuchAttributeException {
        return (ReplyPathRequested)_data.getContainer().get(Ro_r10AttributeName.ReplyPathRequested, 0);
    }
    ...
    public void setReplyPathRequested(ReplyPathRequested avp) {
        _data.getContainer().add(Ro_r10AttributeName.ReplyPathRequested, avp.getData(), true);
    }
    ...
    public boolean containsSMStatus() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMStatus);
    }
    ...
    public SMStatus getSMStatus() throws NoSuchAttributeException {
        return (SMStatus)_data.getContainer().get(Ro_r10AttributeName.SMStatus, 0);
    }
    ...
    public void setSMStatus(SMStatus avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMStatus, avp.getData(), true);
    }
    ...
    public boolean containsSMUserDataHeader() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMUserDataHeader);
    }
    ...
    public SMUserDataHeader getSMUserDataHeader() throws NoSuchAttributeException {
        return (SMUserDataHeader)_data.getContainer().get(Ro_r10AttributeName.SMUserDataHeader, 0);
    }
    ...
    public void setSMUserDataHeader(SMUserDataHeader avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMUserDataHeader, avp.getData(), true);
    }
    ...
    public boolean containsNumberOfMessagesSent() {
        return _data.getContainer().contains(Ro_r10AttributeName.NumberOfMessagesSent);
    }
    ...
    public NumberOfMessagesSent getNumberOfMessagesSent() throws NoSuchAttributeException {
        return (NumberOfMessagesSent)_data.getContainer().get(Ro_r10AttributeName.NumberOfMessagesSent, 0);
    }
    ...
    public void setNumberOfMessagesSent(NumberOfMessagesSent avp) {
        _data.getContainer().add(Ro_r10AttributeName.NumberOfMessagesSent, avp.getData(), true);
    }
    ...
    public int countRecipientInfo() {
        return _data.getContainer().count(Ro_r10AttributeName.RecipientInfo);
    }
    ...
    public RecipientInfo getRecipientInfo(int index) throws NoSuchAttributeException {
        return (RecipientInfo)_data.getContainer().get(Ro_r10AttributeName.RecipientInfo, index);
    }
    ...
    public void addRecipientInfo(RecipientInfo avp) {
        _data.getContainer().add(Ro_r10AttributeName.RecipientInfo, avp.getData(), false);
    }
    ...
    public boolean containsOriginatorReceivedAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.OriginatorReceivedAddress);
    }
    ...
    public OriginatorReceivedAddress getOriginatorReceivedAddress() throws NoSuchAttributeException {
        return (OriginatorReceivedAddress)_data.getContainer().get(Ro_r10AttributeName.OriginatorReceivedAddress, 0);
    }
    ...
    public void setOriginatorReceivedAddress(OriginatorReceivedAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.OriginatorReceivedAddress, avp.getData(), true);
    }
    ...
    public boolean containsSMServiceType() {
        return _data.getContainer().contains(Ro_r10AttributeName.SMServiceType);
    }
    ...
    public SMServiceType getSMServiceType() throws NoSuchAttributeException {
        return (SMServiceType)_data.getContainer().get(Ro_r10AttributeName.SMServiceType, 0);
    }
    ...
    public void setSMServiceType(SMServiceType avp) {
        _data.getContainer().add(Ro_r10AttributeName.SMServiceType, avp.getData(), true);
    }
