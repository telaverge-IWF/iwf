...
public class AoCSubscriptionInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countAoCService() {
        return _data.getContainer().count(Ro_r10AttributeName.AoCService);
    }
    ...
    public AoCService getAoCService(int index) throws NoSuchAttributeException {
        return (AoCService)_data.getContainer().get(Ro_r10AttributeName.AoCService, index);
    }
    ...
    public void addAoCService(AoCService avp) {
        _data.getContainer().add(Ro_r10AttributeName.AoCService, avp.getData(), false);
    }
    ...
    public boolean containsAoCFormat() {
        return _data.getContainer().contains(Ro_r10AttributeName.AoCFormat);
    }
    ...
    public AoCFormat getAoCFormat() throws NoSuchAttributeException {
        return (AoCFormat)_data.getContainer().get(Ro_r10AttributeName.AoCFormat, 0);
    }
    ...
    public void setAoCFormat(AoCFormat avp) {
        _data.getContainer().add(Ro_r10AttributeName.AoCFormat, avp.getData(), true);
    }
    ...
    public boolean containsPreferredAoCCurrency() {
        return _data.getContainer().contains(Ro_r10AttributeName.PreferredAoCCurrency);
    }
    ...
    public PreferredAoCCurrency getPreferredAoCCurrency() throws NoSuchAttributeException {
        return (PreferredAoCCurrency)_data.getContainer().get(Ro_r10AttributeName.PreferredAoCCurrency, 0);
    }
    ...
    public void setPreferredAoCCurrency(PreferredAoCCurrency avp) {
        _data.getContainer().add(Ro_r10AttributeName.PreferredAoCCurrency, avp.getData(), true);
    }
