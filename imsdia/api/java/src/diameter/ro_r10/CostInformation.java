...
public class CostInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsCostUnit() {
        return _data.getContainer().contains(Ro_r10AttributeName.CostUnit);
    }
    ...
    public CostUnit getCostUnit() throws NoSuchAttributeException {
        return (CostUnit)_data.getContainer().get(Ro_r10AttributeName.CostUnit, 0);
    }
    ...
    public void setCostUnit(CostUnit avp) {
        _data.getContainer().add(Ro_r10AttributeName.CostUnit, avp.getData(), true);
    }
