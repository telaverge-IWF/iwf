...
public class Envelope extends com.intellinet.diameter.GroupedAVP {
    ...
    public EnvelopeStartTime getEnvelopeStartTime() throws NoSuchAttributeException {
        return (EnvelopeStartTime)_data.getContainer().get(Ro_r10AttributeName.EnvelopeStartTime, 0);
    }
    ...
    public void setEnvelopeStartTime(EnvelopeStartTime avp) {
        _data.getContainer().add(Ro_r10AttributeName.EnvelopeStartTime, avp.getData(), true);
    }
    ...
    public boolean containsEnvelopeEndTime() {
        return _data.getContainer().contains(Ro_r10AttributeName.EnvelopeEndTime);
    }
    ...
    public EnvelopeEndTime getEnvelopeEndTime() throws NoSuchAttributeException {
        return (EnvelopeEndTime)_data.getContainer().get(Ro_r10AttributeName.EnvelopeEndTime, 0);
    }
    ...
    public void setEnvelopeEndTime(EnvelopeEndTime avp) {
        _data.getContainer().add(Ro_r10AttributeName.EnvelopeEndTime, avp.getData(), true);
    }
