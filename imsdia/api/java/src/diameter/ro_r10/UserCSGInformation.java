...
public class UserCSGInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public CSGId getCSGId() throws NoSuchAttributeException {
        return (CSGId)_data.getContainer().get(Ro_r10AttributeName.CSGId, 0);
    }
    ...
    public void setCSGId(CSGId avp) {
        _data.getContainer().add(Ro_r10AttributeName.CSGId, avp.getData(), true);
    }
    ...
    public CSGAccessMode getCSGAccessMode() throws NoSuchAttributeException {
        return (CSGAccessMode)_data.getContainer().get(Ro_r10AttributeName.CSGAccessMode, 0);
    }
    ...
    public void setCSGAccessMode(CSGAccessMode avp) {
        _data.getContainer().add(Ro_r10AttributeName.CSGAccessMode, avp.getData(), true);
    }
    ...
    public boolean containsCSGMembershipIndication() {
        return _data.getContainer().contains(Ro_r10AttributeName.CSGMembershipIndication);
    }
    ...
    public CSGMembershipIndication getCSGMembershipIndication() throws NoSuchAttributeException {
        return (CSGMembershipIndication)_data.getContainer().get(Ro_r10AttributeName.CSGMembershipIndication, 0);
    }
    ...
    public void setCSGMembershipIndication(CSGMembershipIndication avp) {
        _data.getContainer().add(Ro_r10AttributeName.CSGMembershipIndication, avp.getData(), true);
    }
