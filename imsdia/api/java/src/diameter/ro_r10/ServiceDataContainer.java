...
public class ServiceDataContainer extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsAFCorrelationInformation() {
        return _data.getContainer().contains(Ro_r10AttributeName.AFCorrelationInformation);
    }
    ...
    public AFCorrelationInformation getAFCorrelationInformation() throws NoSuchAttributeException {
        return (AFCorrelationInformation)_data.getContainer().get(Ro_r10AttributeName.AFCorrelationInformation, 0);
    }
    ...
    public void setAFCorrelationInformation(AFCorrelationInformation avp) {
        _data.getContainer().add(Ro_r10AttributeName.AFCorrelationInformation, avp.getData(), true);
    }
    ...
    public boolean containsAccountingInputOctets() {
        return _data.getContainer().contains(Ro_r10AttributeName.AccountingInputOctets);
    }
    ...
    public AccountingInputOctets getAccountingInputOctets() throws NoSuchAttributeException {
        return (AccountingInputOctets)_data.getContainer().get(Ro_r10AttributeName.AccountingInputOctets, 0);
    }
    ...
    public void setAccountingInputOctets(AccountingInputOctets avp) {
        _data.getContainer().add(Ro_r10AttributeName.AccountingInputOctets, avp.getData(), true);
    }
    ...
    public boolean containsAccountingOutputOctets() {
        return _data.getContainer().contains(Ro_r10AttributeName.AccountingOutputOctets);
    }
    ...
    public AccountingOutputOctets getAccountingOutputOctets() throws NoSuchAttributeException {
        return (AccountingOutputOctets)_data.getContainer().get(Ro_r10AttributeName.AccountingOutputOctets, 0);
    }
    ...
    public void setAccountingOutputOctets(AccountingOutputOctets avp) {
        _data.getContainer().add(Ro_r10AttributeName.AccountingOutputOctets, avp.getData(), true);
    }
    ...
    public boolean containsAccountingInputPackets() {
        return _data.getContainer().contains(Ro_r10AttributeName.AccountingInputPackets);
    }
    ...
    public AccountingInputPackets getAccountingInputPackets() throws NoSuchAttributeException {
        return (AccountingInputPackets)_data.getContainer().get(Ro_r10AttributeName.AccountingInputPackets, 0);
    }
    ...
    public void setAccountingInputPackets(AccountingInputPackets avp) {
        _data.getContainer().add(Ro_r10AttributeName.AccountingInputPackets, avp.getData(), true);
    }
    ...
    public boolean containsAccountingOutputPackets() {
        return _data.getContainer().contains(Ro_r10AttributeName.AccountingOutputPackets);
    }
    ...
    public AccountingOutputPackets getAccountingOutputPackets() throws NoSuchAttributeException {
        return (AccountingOutputPackets)_data.getContainer().get(Ro_r10AttributeName.AccountingOutputPackets, 0);
    }
    ...
    public void setAccountingOutputPackets(AccountingOutputPackets avp) {
        _data.getContainer().add(Ro_r10AttributeName.AccountingOutputPackets, avp.getData(), true);
    }
    ...
    public boolean containsLocalSequenceNumber() {
        return _data.getContainer().contains(Ro_r10AttributeName.LocalSequenceNumber);
    }
    ...
    public LocalSequenceNumber getLocalSequenceNumber() throws NoSuchAttributeException {
        return (LocalSequenceNumber)_data.getContainer().get(Ro_r10AttributeName.LocalSequenceNumber, 0);
    }
    ...
    public void setLocalSequenceNumber(LocalSequenceNumber avp) {
        _data.getContainer().add(Ro_r10AttributeName.LocalSequenceNumber, avp.getData(), true);
    }
    ...
    public boolean containsServiceIdentifier() {
        return _data.getContainer().contains(Ro_r10AttributeName.ServiceIdentifier);
    }
    ...
    public ServiceIdentifier getServiceIdentifier() throws NoSuchAttributeException {
        return (ServiceIdentifier)_data.getContainer().get(Ro_r10AttributeName.ServiceIdentifier, 0);
    }
    ...
    public void setServiceIdentifier(ServiceIdentifier avp) {
        _data.getContainer().add(Ro_r10AttributeName.ServiceIdentifier, avp.getData(), true);
    }
    ...
    public boolean containsServiceSpecificInfo() {
        return _data.getContainer().contains(Ro_r10AttributeName.ServiceSpecificInfo);
    }
    ...
    public ServiceSpecificInfo getServiceSpecificInfo() throws NoSuchAttributeException {
        return (ServiceSpecificInfo)_data.getContainer().get(Ro_r10AttributeName.ServiceSpecificInfo, 0);
    }
    ...
    public void setServiceSpecificInfo(ServiceSpecificInfo avp) {
        _data.getContainer().add(Ro_r10AttributeName.ServiceSpecificInfo, avp.getData(), true);
    }
    ...
    public boolean containsTimeFirstUsage() {
        return _data.getContainer().contains(Ro_r10AttributeName.TimeFirstUsage);
    }
    ...
    public TimeFirstUsage getTimeFirstUsage() throws NoSuchAttributeException {
        return (TimeFirstUsage)_data.getContainer().get(Ro_r10AttributeName.TimeFirstUsage, 0);
    }
    ...
    public void setTimeFirstUsage(TimeFirstUsage avp) {
        _data.getContainer().add(Ro_r10AttributeName.TimeFirstUsage, avp.getData(), true);
    }
    ...
    public boolean containsTimeLastUsage() {
        return _data.getContainer().contains(Ro_r10AttributeName.TimeLastUsage);
    }
    ...
    public TimeLastUsage getTimeLastUsage() throws NoSuchAttributeException {
        return (TimeLastUsage)_data.getContainer().get(Ro_r10AttributeName.TimeLastUsage, 0);
    }
    ...
    public void setTimeLastUsage(TimeLastUsage avp) {
        _data.getContainer().add(Ro_r10AttributeName.TimeLastUsage, avp.getData(), true);
    }
    ...
    public boolean containsTimeUsage() {
        return _data.getContainer().contains(Ro_r10AttributeName.TimeUsage);
    }
    ...
    public TimeUsage getTimeUsage() throws NoSuchAttributeException {
        return (TimeUsage)_data.getContainer().get(Ro_r10AttributeName.TimeUsage, 0);
    }
    ...
    public void setTimeUsage(TimeUsage avp) {
        _data.getContainer().add(Ro_r10AttributeName.TimeUsage, avp.getData(), true);
    }
    ...
    public int countChangeCondition() {
        return _data.getContainer().count(Ro_r10AttributeName.ChangeCondition);
    }
    ...
    public ChangeCondition getChangeCondition(int index) throws NoSuchAttributeException {
        return (ChangeCondition)_data.getContainer().get(Ro_r10AttributeName.ChangeCondition, index);
    }
    ...
    public void addChangeCondition(ChangeCondition avp) {
        _data.getContainer().add(Ro_r10AttributeName.ChangeCondition, avp.getData(), false);
    }
