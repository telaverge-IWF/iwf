...
public class CreditControlRequest extends com.intellinet.diameter.Command {
    ...
    public ServiceContextId getServiceContextId() throws NoSuchAttributeException {
        return (ServiceContextId)_data.getContainer().get(Ro_r10AttributeName.ServiceContextId, 0);
    }
    ...
    public void setServiceContextId(ServiceContextId avp) {
        _data.getContainer().add(Ro_r10AttributeName.ServiceContextId, avp.getData(), true);
    }
    ...
    public boolean containsRequestedAction() {
        return _data.getContainer().contains(Ro_r10AttributeName.RequestedAction);
    }
    ...
    public RequestedAction getRequestedAction() throws NoSuchAttributeException {
        return (RequestedAction)_data.getContainer().get(Ro_r10AttributeName.RequestedAction, 0);
    }
    ...
    public void setRequestedAction(RequestedAction avp) {
        _data.getContainer().add(Ro_r10AttributeName.RequestedAction, avp.getData(), true);
    }
    ...
    public boolean containsAoCRequestType() {
        return _data.getContainer().contains(Ro_r10AttributeName.AoCRequestType);
    }
    ...
    public AoCRequestType getAoCRequestType() throws NoSuchAttributeException {
        return (AoCRequestType)_data.getContainer().get(Ro_r10AttributeName.AoCRequestType, 0);
    }
    ...
    public void setAoCRequestType(AoCRequestType avp) {
        _data.getContainer().add(Ro_r10AttributeName.AoCRequestType, avp.getData(), true);
    }
    ...
    public boolean containsMultipleServicesIndicator() {
        return _data.getContainer().contains(Ro_r10AttributeName.MultipleServicesIndicator);
    }
    ...
    public MultipleServicesIndicator getMultipleServicesIndicator() throws NoSuchAttributeException {
        return (MultipleServicesIndicator)_data.getContainer().get(Ro_r10AttributeName.MultipleServicesIndicator, 0);
    }
    ...
    public void setMultipleServicesIndicator(MultipleServicesIndicator avp) {
        _data.getContainer().add(Ro_r10AttributeName.MultipleServicesIndicator, avp.getData(), true);
    }
    ...
    public boolean containsCCCorrelationId() {
        return _data.getContainer().contains(Ro_r10AttributeName.CCCorrelationId);
    }
    ...
    public CCCorrelationId getCCCorrelationId() throws NoSuchAttributeException {
        return (CCCorrelationId)_data.getContainer().get(Ro_r10AttributeName.CCCorrelationId, 0);
    }
    ...
    public void setCCCorrelationId(CCCorrelationId avp) {
        _data.getContainer().add(Ro_r10AttributeName.CCCorrelationId, avp.getData(), true);
    }
