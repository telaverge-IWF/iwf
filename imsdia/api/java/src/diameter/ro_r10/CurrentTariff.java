...
/**
  ...
  * Used-Service-Unit AVP. The calculated cost is given in the Currency-Code 
  * AVP. The formula sums all the rating elements and multiplies the sum by 
  * the Scale-Factor AVP
 */
public class CurrentTariff extends com.intellinet.diameter.GroupedAVP {
    /**
     * Constructs a new CurrentTariff.
     */
    public CurrentTariff() {}

    CurrentTariff(com.intellinet.diameter.GroupedData data) {
        super(data);
    }
    ...
    public boolean containsScaleFactor() {
        return _data.getContainer().contains(Ro_r10AttributeName.ScaleFactor);
    }
    ...
    public ScaleFactor getScaleFactor() throws NoSuchAttributeException {
        return (ScaleFactor)_data.getContainer().get(Ro_r10AttributeName.ScaleFactor, 0);
    }
    ...
    public void setScaleFactor(ScaleFactor avp) {
        _data.getContainer().add(Ro_r10AttributeName.ScaleFactor, avp.getData(), true);
    }
    ...
    public int countRateElement() {
        return _data.getContainer().count(Ro_r10AttributeName.RateElement);
    }
    ...
    public RateElement getRateElement(int index) throws NoSuchAttributeException {
        return (RateElement)_data.getContainer().get(Ro_r10AttributeName.RateElement, index);
    }
    ...
    public void addRateElement(RateElement avp) {
        _data.getContainer().add(Ro_r10AttributeName.RateElement, avp.getData(), false);
    }
