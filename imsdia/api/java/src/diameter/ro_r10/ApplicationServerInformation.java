...
public class ApplicationServerInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsApplicationServer() {
        return _data.getContainer().contains(Ro_r10AttributeName.ApplicationServer);
    }
    ...
    public ApplicationServer getApplicationServer() throws NoSuchAttributeException {
        return (ApplicationServer)_data.getContainer().get(Ro_r10AttributeName.ApplicationServer, 0);
    }
    ...
    public void setApplicationServer(ApplicationServer avp) {
        _data.getContainer().add(Ro_r10AttributeName.ApplicationServer, avp.getData(), true);
    }
    ...
    public int countApplicationProvidedCalledPartyAddress() {
        return _data.getContainer().count(Ro_r10AttributeName.ApplicationProvidedCalledPartyAddress);
    }
    ...
    public ApplicationProvidedCalledPartyAddress getApplicationProvidedCalledPartyAddress(int index) throws NoSuchAttributeException {
        return (ApplicationProvidedCalledPartyAddress)_data.getContainer().get(Ro_r10AttributeName.ApplicationProvidedCalledPartyAddress, index);
    }
    ...
    public void addApplicationProvidedCalledPartyAddress(ApplicationProvidedCalledPartyAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.ApplicationProvidedCalledPartyAddress, avp.getData(), false);
    }
