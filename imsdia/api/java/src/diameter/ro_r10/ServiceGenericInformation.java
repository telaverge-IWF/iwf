...
public class ServiceGenericInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsApplicationServerID() {
        return _data.getContainer().contains(Ro_r10AttributeName.ApplicationServerID);
    }
    ...
    public ApplicationServerID getApplicationServerID() throws NoSuchAttributeException {
        return (ApplicationServerID)_data.getContainer().get(Ro_r10AttributeName.ApplicationServerID, 0);
    }
    ...
    public void setApplicationServerID(ApplicationServerID avp) {
        _data.getContainer().add(Ro_r10AttributeName.ApplicationServerID, avp.getData(), true);
    }
    ...
    public boolean containsApplicationServiceType() {
        return _data.getContainer().contains(Ro_r10AttributeName.ApplicationServiceType);
    }
    ...
    public ApplicationServiceType getApplicationServiceType() throws NoSuchAttributeException {
        return (ApplicationServiceType)_data.getContainer().get(Ro_r10AttributeName.ApplicationServiceType, 0);
    }
    ...
    public void setApplicationServiceType(ApplicationServiceType avp) {
        _data.getContainer().add(Ro_r10AttributeName.ApplicationServiceType, avp.getData(), true);
    }
    ...
    public boolean containsApplicationSessionID() {
        return _data.getContainer().contains(Ro_r10AttributeName.ApplicationSessionID);
    }
    ...
    public ApplicationSessionID getApplicationSessionID() throws NoSuchAttributeException {
        return (ApplicationSessionID)_data.getContainer().get(Ro_r10AttributeName.ApplicationSessionID, 0);
    }
    ...
    public void setApplicationSessionID(ApplicationSessionID avp) {
        _data.getContainer().add(Ro_r10AttributeName.ApplicationSessionID, avp.getData(), true);
    }
    ...
    public boolean containsDeliveryStatus() {
        return _data.getContainer().contains(Ro_r10AttributeName.DeliveryStatus);
    }
    ...
    public DeliveryStatus getDeliveryStatus() throws NoSuchAttributeException {
        return (DeliveryStatus)_data.getContainer().get(Ro_r10AttributeName.DeliveryStatus, 0);
    }
    ...
    public void setDeliveryStatus(DeliveryStatus avp) {
        _data.getContainer().add(Ro_r10AttributeName.DeliveryStatus, avp.getData(), true);
    }
