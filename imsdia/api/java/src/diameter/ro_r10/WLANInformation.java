...
public class WLANInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsWLANSessionId() {
        return _data.getContainer().contains(Ro_r10AttributeName.WLANSessionId);
    }
    ...
    public WLANSessionId getWLANSessionId() throws NoSuchAttributeException {
        return (WLANSessionId)_data.getContainer().get(Ro_r10AttributeName.WLANSessionId, 0);
    }
    ...
    public void setWLANSessionId(WLANSessionId avp) {
        _data.getContainer().add(Ro_r10AttributeName.WLANSessionId, avp.getData(), true);
    }
    ...
    public boolean containsPDGAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.PDGAddress);
    }
    ...
    public PDGAddress getPDGAddress() throws NoSuchAttributeException {
        return (PDGAddress)_data.getContainer().get(Ro_r10AttributeName.PDGAddress, 0);
    }
    ...
    public void setPDGAddress(PDGAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.PDGAddress, avp.getData(), true);
    }
    ...
    public boolean containsPDGChargingId() {
        return _data.getContainer().contains(Ro_r10AttributeName.PDGChargingId);
    }
    ...
    public PDGChargingId getPDGChargingId() throws NoSuchAttributeException {
        return (PDGChargingId)_data.getContainer().get(Ro_r10AttributeName.PDGChargingId, 0);
    }
    ...
    public void setPDGChargingId(PDGChargingId avp) {
        _data.getContainer().add(Ro_r10AttributeName.PDGChargingId, avp.getData(), true);
    }
    ...
    public boolean containsWAGAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.WAGAddress);
    }
    ...
    public WAGAddress getWAGAddress() throws NoSuchAttributeException {
        return (WAGAddress)_data.getContainer().get(Ro_r10AttributeName.WAGAddress, 0);
    }
    ...
    public void setWAGAddress(WAGAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.WAGAddress, avp.getData(), true);
    }
    ...
    public boolean containsWAGPLMNId() {
        return _data.getContainer().contains(Ro_r10AttributeName.WAGPLMNId);
    }
    ...
    public WAGPLMNId getWAGPLMNId() throws NoSuchAttributeException {
        return (WAGPLMNId)_data.getContainer().get(Ro_r10AttributeName.WAGPLMNId, 0);
    }
    ...
    public void setWAGPLMNId(WAGPLMNId avp) {
        _data.getContainer().add(Ro_r10AttributeName.WAGPLMNId, avp.getData(), true);
    }
    ...
    public boolean containsWLANRadioContainer() {
        return _data.getContainer().contains(Ro_r10AttributeName.WLANRadioContainer);
    }
    ...
    public WLANRadioContainer getWLANRadioContainer() throws NoSuchAttributeException {
        return (WLANRadioContainer)_data.getContainer().get(Ro_r10AttributeName.WLANRadioContainer, 0);
    }
    ...
    public void setWLANRadioContainer(WLANRadioContainer avp) {
        _data.getContainer().add(Ro_r10AttributeName.WLANRadioContainer, avp.getData(), true);
    }
    ...
    public boolean containsWLANUELocalIPAddress() {
        return _data.getContainer().contains(Ro_r10AttributeName.WLANUELocalIPAddress);
    }
    ...
    public WLANUELocalIPAddress getWLANUELocalIPAddress() throws NoSuchAttributeException {
        return (WLANUELocalIPAddress)_data.getContainer().get(Ro_r10AttributeName.WLANUELocalIPAddress, 0);
    }
    ...
    public void setWLANUELocalIPAddress(WLANUELocalIPAddress avp) {
        _data.getContainer().add(Ro_r10AttributeName.WLANUELocalIPAddress, avp.getData(), true);
    }
