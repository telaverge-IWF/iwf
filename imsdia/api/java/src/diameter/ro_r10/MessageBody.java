...
public class MessageBody extends com.intellinet.diameter.GroupedAVP {
    ...
    public ContentType getContentType() throws NoSuchAttributeException {
        return (ContentType)_data.getContainer().get(Ro_r10AttributeName.ContentType, 0);
    }
    ...
    public void setContentType(ContentType avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentType, avp.getData(), true);
    }
    ...
    public ContentLength getContentLength() throws NoSuchAttributeException {
        return (ContentLength)_data.getContainer().get(Ro_r10AttributeName.ContentLength, 0);
    }
    ...
    public void setContentLength(ContentLength avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentLength, avp.getData(), true);
    }
    ...
    public boolean containsContentDisposition() {
        return _data.getContainer().contains(Ro_r10AttributeName.ContentDisposition);
    }
    ...
    public ContentDisposition getContentDisposition() throws NoSuchAttributeException {
        return (ContentDisposition)_data.getContainer().get(Ro_r10AttributeName.ContentDisposition, 0);
    }
    ...
    public void setContentDisposition(ContentDisposition avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentDisposition, avp.getData(), true);
    }
    ...
    public boolean containsOriginator() {
        return _data.getContainer().contains(Ro_r10AttributeName.Originator);
    }
    ...
    public Originator getOriginator() throws NoSuchAttributeException {
        return (Originator)_data.getContainer().get(Ro_r10AttributeName.Originator, 0);
    }
    ...
    public void setOriginator(Originator avp) {
        _data.getContainer().add(Ro_r10AttributeName.Originator, avp.getData(), true);
    }
