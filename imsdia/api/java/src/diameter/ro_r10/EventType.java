...
public class EventType extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsSIPMethod() {
        return _data.getContainer().contains(Ro_r10AttributeName.SIPMethod);
    }
    ...
    public SIPMethod getSIPMethod() throws NoSuchAttributeException {
        return (SIPMethod)_data.getContainer().get(Ro_r10AttributeName.SIPMethod, 0);
    }
    ...
    public void setSIPMethod(SIPMethod avp) {
        _data.getContainer().add(Ro_r10AttributeName.SIPMethod, avp.getData(), true);
    }
    ...
    public boolean containsIMSEvent() {
        return _data.getContainer().contains(Ro_r10AttributeName.IMSEvent);
    }
    ...
    public IMSEvent getIMSEvent() throws NoSuchAttributeException {
        return (IMSEvent)_data.getContainer().get(Ro_r10AttributeName.IMSEvent, 0);
    }
    ...
    public void setIMSEvent(IMSEvent avp) {
        _data.getContainer().add(Ro_r10AttributeName.IMSEvent, avp.getData(), true);
    }
    ...
    public boolean containsExpires() {
        return _data.getContainer().contains(Ro_r10AttributeName.Expires);
    }
    ...
    public Expires getExpires() throws NoSuchAttributeException {
        return (Expires)_data.getContainer().get(Ro_r10AttributeName.Expires, 0);
    }
    ...
    public void setExpires(Expires avp) {
        _data.getContainer().add(Ro_r10AttributeName.Expires, avp.getData(), true);
    }
