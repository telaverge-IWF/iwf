...
public class ParticipantGroup extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsParticipantAccessPriority() {
        return _data.getContainer().contains(Ro_r10AttributeName.ParticipantAccessPriority);
    }
    ...
    public ParticipantAccessPriority getParticipantAccessPriority() throws NoSuchAttributeException {
        return (ParticipantAccessPriority)_data.getContainer().get(Ro_r10AttributeName.ParticipantAccessPriority, 0);
    }
    ...
    public void setParticipantAccessPriority(ParticipantAccessPriority avp) {
        _data.getContainer().add(Ro_r10AttributeName.ParticipantAccessPriority, avp.getData(), true);
    }
    ...
    public boolean containsUserParticipatingType() {
        return _data.getContainer().contains(Ro_r10AttributeName.UserParticipatingType);
    }
    ...
    public UserParticipatingType getUserParticipatingType() throws NoSuchAttributeException {
        return (UserParticipatingType)_data.getContainer().get(Ro_r10AttributeName.UserParticipatingType, 0);
    }
    ...
    public void setUserParticipatingType(UserParticipatingType avp) {
        _data.getContainer().add(Ro_r10AttributeName.UserParticipatingType, avp.getData(), true);
    }
