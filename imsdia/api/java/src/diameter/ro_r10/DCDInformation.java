...
public class DCDInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsContentID() {
        return _data.getContainer().contains(Ro_r10AttributeName.ContentID);
    }
    ...
    public ContentID getContentID() throws NoSuchAttributeException {
        return (ContentID)_data.getContainer().get(Ro_r10AttributeName.ContentID, 0);
    }
    ...
    public void setContentID(ContentID avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentID, avp.getData(), true);
    }
    ...
    public boolean containsContentproviderID() {
        return _data.getContainer().contains(Ro_r10AttributeName.ContentproviderID);
    }
    ...
    public ContentproviderID getContentproviderID() throws NoSuchAttributeException {
        return (ContentproviderID)_data.getContainer().get(Ro_r10AttributeName.ContentproviderID, 0);
    }
    ...
    public void setContentproviderID(ContentproviderID avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentproviderID, avp.getData(), true);
    }
