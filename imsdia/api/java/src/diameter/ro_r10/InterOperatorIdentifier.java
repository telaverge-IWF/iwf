...
public class InterOperatorIdentifier extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsOriginatingIOI() {
        return _data.getContainer().contains(Ro_r10AttributeName.OriginatingIOI);
    }
    ...
    public OriginatingIOI getOriginatingIOI() throws NoSuchAttributeException {
        return (OriginatingIOI)_data.getContainer().get(Ro_r10AttributeName.OriginatingIOI, 0);
    }
    ...
    public void setOriginatingIOI(OriginatingIOI avp) {
        _data.getContainer().add(Ro_r10AttributeName.OriginatingIOI, avp.getData(), true);
    }
    ...
    public boolean containsTerminatingIOI() {
        return _data.getContainer().contains(Ro_r10AttributeName.TerminatingIOI);
    }
    ...
    public TerminatingIOI getTerminatingIOI() throws NoSuchAttributeException {
        return (TerminatingIOI)_data.getContainer().get(Ro_r10AttributeName.TerminatingIOI, 0);
    }
    ...
    public void setTerminatingIOI(TerminatingIOI avp) {
        _data.getContainer().add(Ro_r10AttributeName.TerminatingIOI, avp.getData(), true);
    }
