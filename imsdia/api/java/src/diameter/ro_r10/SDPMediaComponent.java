...
public class SDPMediaComponent extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsSDPMediaName() {
        return _data.getContainer().contains(Ro_r10AttributeName.SDPMediaName);
    }
    ...
    public SDPMediaName getSDPMediaName() throws NoSuchAttributeException {
        return (SDPMediaName)_data.getContainer().get(Ro_r10AttributeName.SDPMediaName, 0);
    }
    ...
    public void setSDPMediaName(SDPMediaName avp) {
        _data.getContainer().add(Ro_r10AttributeName.SDPMediaName, avp.getData(), true);
    }
    ...
    public int countSDPMediaDescription() {
        return _data.getContainer().count(Ro_r10AttributeName.SDPMediaDescription);
    }
    ...
    public SDPMediaDescription getSDPMediaDescription(int index) throws NoSuchAttributeException {
        return (SDPMediaDescription)_data.getContainer().get(Ro_r10AttributeName.SDPMediaDescription, index);
    }
    ...
    public void addSDPMediaDescription(SDPMediaDescription avp) {
        _data.getContainer().add(Ro_r10AttributeName.SDPMediaDescription, avp.getData(), false);
    }
    ...
    public boolean containsLocalGWInsertedIndication() {
        return _data.getContainer().contains(Ro_r10AttributeName.LocalGWInsertedIndication);
    }
    ...
    public LocalGWInsertedIndication getLocalGWInsertedIndication() throws NoSuchAttributeException {
        return (LocalGWInsertedIndication)_data.getContainer().get(Ro_r10AttributeName.LocalGWInsertedIndication, 0);
    }
    ...
    public void setLocalGWInsertedIndication(LocalGWInsertedIndication avp) {
        _data.getContainer().add(Ro_r10AttributeName.LocalGWInsertedIndication, avp.getData(), true);
    }
    ...
    public boolean containsTranscoderInsertedIndication() {
        return _data.getContainer().contains(Ro_r10AttributeName.TranscoderInsertedIndication);
    }
    ...
    public TranscoderInsertedIndication getTranscoderInsertedIndication() throws NoSuchAttributeException {
        return (TranscoderInsertedIndication)_data.getContainer().get(Ro_r10AttributeName.TranscoderInsertedIndication, 0);
    }
    ...
    public void setTranscoderInsertedIndication(TranscoderInsertedIndication avp) {
        _data.getContainer().add(Ro_r10AttributeName.TranscoderInsertedIndication, avp.getData(), true);
    }
    ...
    public boolean containsIPRealmDefaultIndication() {
        return _data.getContainer().contains(Ro_r10AttributeName.IPRealmDefaultIndication);
    }
    ...
    public IPRealmDefaultIndication getIPRealmDefaultIndication() throws NoSuchAttributeException {
        return (IPRealmDefaultIndication)_data.getContainer().get(Ro_r10AttributeName.IPRealmDefaultIndication, 0);
    }
    ...
    public void setIPRealmDefaultIndication(IPRealmDefaultIndication avp) {
        _data.getContainer().add(Ro_r10AttributeName.IPRealmDefaultIndication, avp.getData(), true);
    }
    ...
    public boolean containsMediaInitiatorFlag() {
        return _data.getContainer().contains(Ro_r10AttributeName.MediaInitiatorFlag);
    }
    ...
    public MediaInitiatorFlag getMediaInitiatorFlag() throws NoSuchAttributeException {
        return (MediaInitiatorFlag)_data.getContainer().get(Ro_r10AttributeName.MediaInitiatorFlag, 0);
    }
    ...
    public void setMediaInitiatorFlag(MediaInitiatorFlag avp) {
        _data.getContainer().add(Ro_r10AttributeName.MediaInitiatorFlag, avp.getData(), true);
    }
    ...
    public boolean containsMediaInitiatorParty() {
        return _data.getContainer().contains(Ro_r10AttributeName.MediaInitiatorParty);
    }
    ...
    public MediaInitiatorParty getMediaInitiatorParty() throws NoSuchAttributeException {
        return (MediaInitiatorParty)_data.getContainer().get(Ro_r10AttributeName.MediaInitiatorParty, 0);
    }
    ...
    public void setMediaInitiatorParty(MediaInitiatorParty avp) {
        _data.getContainer().add(Ro_r10AttributeName.MediaInitiatorParty, avp.getData(), true);
    }
    ...
    public boolean containsAuthorizedQoS() {
        return _data.getContainer().contains(Ro_r10AttributeName.AuthorizedQoS);
    }
    ...
    public AuthorizedQoS getAuthorizedQoS() throws NoSuchAttributeException {
        return (AuthorizedQoS)_data.getContainer().get(Ro_r10AttributeName.AuthorizedQoS, 0);
    }
    ...
    public void setAuthorizedQoS(AuthorizedQoS avp) {
        _data.getContainer().add(Ro_r10AttributeName.AuthorizedQoS, avp.getData(), true);
    }
    ...
    public boolean containsAccessNetworkChargingIdentifierValue() {
        return _data.getContainer().contains(Ro_r10AttributeName.AccessNetworkChargingIdentifierValue);
    }
    ...
    public AccessNetworkChargingIdentifierValue getAccessNetworkChargingIdentifierValue() throws NoSuchAttributeException {
        return (AccessNetworkChargingIdentifierValue)_data.getContainer().get(Ro_r10AttributeName.AccessNetworkChargingIdentifierValue, 0);
    }
    ...
    public void setAccessNetworkChargingIdentifierValue(AccessNetworkChargingIdentifierValue avp) {
        _data.getContainer().add(Ro_r10AttributeName.AccessNetworkChargingIdentifierValue, avp.getData(), true);
    }
    ...
    public boolean containsSDPType() {
        return _data.getContainer().contains(Ro_r10AttributeName.SDPType);
    }
    ...
    public SDPType getSDPType() throws NoSuchAttributeException {
        return (SDPType)_data.getContainer().get(Ro_r10AttributeName.SDPType, 0);
    }
    ...
    public void setSDPType(SDPType avp) {
        _data.getContainer().add(Ro_r10AttributeName.SDPType, avp.getData(), true);
    }
