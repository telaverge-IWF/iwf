...
public class LocationType extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsLocationEstimateType() {
        return _data.getContainer().contains(Ro_r10AttributeName.LocationEstimateType);
    }
    ...
    public LocationEstimateType getLocationEstimateType() throws NoSuchAttributeException {
        return (LocationEstimateType)_data.getContainer().get(Ro_r10AttributeName.LocationEstimateType, 0);
    }
    ...
    public void setLocationEstimateType(LocationEstimateType avp) {
        _data.getContainer().add(Ro_r10AttributeName.LocationEstimateType, avp.getData(), true);
    }
    ...
    public boolean containsDeferredLocationEventType() {
        return _data.getContainer().contains(Ro_r10AttributeName.DeferredLocationEventType);
    }
    ...
    public DeferredLocationEventType getDeferredLocationEventType() throws NoSuchAttributeException {
        return (DeferredLocationEventType)_data.getContainer().get(Ro_r10AttributeName.DeferredLocationEventType, 0);
    }
    ...
    public void setDeferredLocationEventType(DeferredLocationEventType avp) {
        _data.getContainer().add(Ro_r10AttributeName.DeferredLocationEventType, avp.getData(), true);
    }
