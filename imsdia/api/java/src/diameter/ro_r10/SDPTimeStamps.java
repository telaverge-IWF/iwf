...
public class SDPTimeStamps extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsSDPOfferTimestamp() {
        return _data.getContainer().contains(Ro_r10AttributeName.SDPOfferTimestamp);
    }
    ...
    public SDPOfferTimestamp getSDPOfferTimestamp() throws NoSuchAttributeException {
        return (SDPOfferTimestamp)_data.getContainer().get(Ro_r10AttributeName.SDPOfferTimestamp, 0);
    }
    ...
    public void setSDPOfferTimestamp(SDPOfferTimestamp avp) {
        _data.getContainer().add(Ro_r10AttributeName.SDPOfferTimestamp, avp.getData(), true);
    }
    ...
    public boolean containsSDPAnswerTimestamp() {
        return _data.getContainer().contains(Ro_r10AttributeName.SDPAnswerTimestamp);
    }
    ...
    public SDPAnswerTimestamp getSDPAnswerTimestamp() throws NoSuchAttributeException {
        return (SDPAnswerTimestamp)_data.getContainer().get(Ro_r10AttributeName.SDPAnswerTimestamp, 0);
    }
    ...
    public void setSDPAnswerTimestamp(SDPAnswerTimestamp avp) {
        _data.getContainer().add(Ro_r10AttributeName.SDPAnswerTimestamp, avp.getData(), true);
    }
