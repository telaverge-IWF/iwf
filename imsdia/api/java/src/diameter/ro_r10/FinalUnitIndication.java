...
public class FinalUnitIndication extends com.intellinet.diameter.GroupedAVP {
    ...
    public FinalUnitAction getFinalUnitAction() throws NoSuchAttributeException {
        return (FinalUnitAction)_data.getContainer().get(Ro_r10AttributeName.FinalUnitAction, 0);
    }
    ...
    public void setFinalUnitAction(FinalUnitAction avp) {
        _data.getContainer().add(Ro_r10AttributeName.FinalUnitAction, avp.getData(), true);
    }
    ...
    public int countRestrictionFilterRule() {
        return _data.getContainer().count(Ro_r10AttributeName.RestrictionFilterRule);
    }
    ...
    public RestrictionFilterRule getRestrictionFilterRule(int index) throws NoSuchAttributeException {
        return (RestrictionFilterRule)_data.getContainer().get(Ro_r10AttributeName.RestrictionFilterRule, index);
    }
    ...
    public void addRestrictionFilterRule(RestrictionFilterRule avp) {
        _data.getContainer().add(Ro_r10AttributeName.RestrictionFilterRule, avp.getData(), false);
    }
    ...
    public boolean containsRedirectServer() {
        return _data.getContainer().contains(Ro_r10AttributeName.RedirectServer);
    }
    ...
    public RedirectServer getRedirectServer() throws NoSuchAttributeException {
        return (RedirectServer)_data.getContainer().get(Ro_r10AttributeName.RedirectServer, 0);
    }
    ...
    public void setRedirectServer(RedirectServer avp) {
        _data.getContainer().add(Ro_r10AttributeName.RedirectServer, avp.getData(), true);
    }
