...
public class UsedServiceUnit extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsReportingReason() {
        return _data.getContainer().contains(Ro_r10AttributeName.ReportingReason);
    }
    ...
    public ReportingReason getReportingReason() throws NoSuchAttributeException {
        return (ReportingReason)_data.getContainer().get(Ro_r10AttributeName.ReportingReason, 0);
    }
    ...
    public void setReportingReason(ReportingReason avp) {
        _data.getContainer().add(Ro_r10AttributeName.ReportingReason, avp.getData(), true);
    }
    ...
    public boolean containsTariffChangeUsage() {
        return _data.getContainer().contains(Ro_r10AttributeName.TariffChangeUsage);
    }
    ...
    public TariffChangeUsage getTariffChangeUsage() throws NoSuchAttributeException {
        return (TariffChangeUsage)_data.getContainer().get(Ro_r10AttributeName.TariffChangeUsage, 0);
    }
    ...
    public void setTariffChangeUsage(TariffChangeUsage avp) {
        _data.getContainer().add(Ro_r10AttributeName.TariffChangeUsage, avp.getData(), true);
    }
    ...
    public int countEventChargingTimeStamp() {
        return _data.getContainer().count(Ro_r10AttributeName.EventChargingTimeStamp);
    }
    ...
    public EventChargingTimeStamp getEventChargingTimeStamp(int index) throws NoSuchAttributeException {
        return (EventChargingTimeStamp)_data.getContainer().get(Ro_r10AttributeName.EventChargingTimeStamp, index);
    }
    ...
    public void addEventChargingTimeStamp(EventChargingTimeStamp avp) {
        _data.getContainer().add(Ro_r10AttributeName.EventChargingTimeStamp, avp.getData(), false);
    }
