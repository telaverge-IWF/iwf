...
public class Flows extends com.intellinet.diameter.GroupedAVP {
    ...
    public MediaComponentNumber getMediaComponentNumber() throws NoSuchAttributeException {
        return (MediaComponentNumber)_data.getContainer().get(Ro_r10AttributeName.MediaComponentNumber, 0);
    }
    ...
    public void setMediaComponentNumber(MediaComponentNumber avp) {
        _data.getContainer().add(Ro_r10AttributeName.MediaComponentNumber, avp.getData(), true);
    }
    ...
    public int countFlowNumber() {
        return _data.getContainer().count(Ro_r10AttributeName.FlowNumber);
    }
    ...
    public FlowNumber getFlowNumber(int index) throws NoSuchAttributeException {
        return (FlowNumber)_data.getContainer().get(Ro_r10AttributeName.FlowNumber, index);
    }
    ...
    public void addFlowNumber(FlowNumber avp) {
        _data.getContainer().add(Ro_r10AttributeName.FlowNumber, avp.getData(), false);
    }
