...
public class MMContentType extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsTypeNumber() {
        return _data.getContainer().contains(Ro_r10AttributeName.TypeNumber);
    }
    ...
    public TypeNumber getTypeNumber() throws NoSuchAttributeException {
        return (TypeNumber)_data.getContainer().get(Ro_r10AttributeName.TypeNumber, 0);
    }
    ...
    public void setTypeNumber(TypeNumber avp) {
        _data.getContainer().add(Ro_r10AttributeName.TypeNumber, avp.getData(), true);
    }
    ...
    public boolean containsAdditionalTypeInformation() {
        return _data.getContainer().contains(Ro_r10AttributeName.AdditionalTypeInformation);
    }
    ...
    public AdditionalTypeInformation getAdditionalTypeInformation() throws NoSuchAttributeException {
        return (AdditionalTypeInformation)_data.getContainer().get(Ro_r10AttributeName.AdditionalTypeInformation, 0);
    }
    ...
    public void setAdditionalTypeInformation(AdditionalTypeInformation avp) {
        _data.getContainer().add(Ro_r10AttributeName.AdditionalTypeInformation, avp.getData(), true);
    }
    ...
    public boolean containsContentSize() {
        return _data.getContainer().contains(Ro_r10AttributeName.ContentSize);
    }
    ...
    public ContentSize getContentSize() throws NoSuchAttributeException {
        return (ContentSize)_data.getContainer().get(Ro_r10AttributeName.ContentSize, 0);
    }
    ...
    public void setContentSize(ContentSize avp) {
        _data.getContainer().add(Ro_r10AttributeName.ContentSize, avp.getData(), true);
    }
    ...
    public int countAdditionalContentInformation() {
        return _data.getContainer().count(Ro_r10AttributeName.AdditionalContentInformation);
    }
    ...
    public AdditionalContentInformation getAdditionalContentInformation(int index) throws NoSuchAttributeException {
        return (AdditionalContentInformation)_data.getContainer().get(Ro_r10AttributeName.AdditionalContentInformation, index);
    }
    ...
    public void addAdditionalContentInformation(AdditionalContentInformation avp) {
        _data.getContainer().add(Ro_r10AttributeName.AdditionalContentInformation, avp.getData(), false);
    }
