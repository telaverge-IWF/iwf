 ...
 */
public class ReAuthRequest extends com.intellinet.diameter.Command {
    /**
     * Constructs a new ReAuthRequest command.
     *
     * @param error - whether this command carries an error indicator
     * @param retrans - whether this is a retransmission
     */
    public ReAuthRequest(boolean error, boolean retrans) {
        super(true, true, error, retrans, 258, 4);
    }

    /**
     * Constructs a ReAuthRequest command by decoding a byte array.
     *
     * @param buffer - the buffer that contains the encoded bytes
     */
    public ReAuthRequest(byte[] buffer) throws WrongCommandTypeException, CodecException {
        super(buffer);
        validate();
    }

    /**
     * Constructs a ReAuthRequest command from a GenericCommand.
     *
     * @param generic - the GenericCommand
     */
    public ReAuthRequest(GenericCommand generic) throws WrongCommandTypeException {
        super(generic.transfer());
        validate();
    }

    ReAuthRequest(com.intellinet.diameter.CommandData data) throws WrongCommandTypeException {
        super(data);
        validate();
    }
    ...
    public boolean containsGSUPoolIdentifier() {
        return _data.getContainer().contains(Ro_r10AttributeName.GSUPoolIdentifier);
    }
    ...
    public GSUPoolIdentifier getGSUPoolIdentifier() throws NoSuchAttributeException {
        return (GSUPoolIdentifier)_data.getContainer().get(Ro_r10AttributeName.GSUPoolIdentifier, 0);
    }
    ...
    public void setGSUPoolIdentifier(GSUPoolIdentifier avp) {
        _data.getContainer().add(Ro_r10AttributeName.GSUPoolIdentifier, avp.getData(), true);
    }
