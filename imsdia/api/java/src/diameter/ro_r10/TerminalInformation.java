...
public class TerminalInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public boolean containsIMEI() {
        return _data.getContainer().contains(Ro_r10AttributeName.IMEI);
    }
    ...
    public IMEI getIMEI() throws NoSuchAttributeException {
        return (IMEI)_data.getContainer().get(Ro_r10AttributeName.IMEI, 0);
    }
    ...
    public void setIMEI(IMEI avp) {
        _data.getContainer().add(Ro_r10AttributeName.IMEI, avp.getData(), true);
    }
    ...
    public boolean containsSoftwareVersion() {
        return _data.getContainer().contains(Ro_r10AttributeName.SoftwareVersion);
    }
    ...
    public SoftwareVersion getSoftwareVersion() throws NoSuchAttributeException {
        return (SoftwareVersion)_data.getContainer().get(Ro_r10AttributeName.SoftwareVersion, 0);
    }
    ...
    public void setSoftwareVersion(SoftwareVersion avp) {
        _data.getContainer().add(Ro_r10AttributeName.SoftwareVersion, avp.getData(), true);
    }
