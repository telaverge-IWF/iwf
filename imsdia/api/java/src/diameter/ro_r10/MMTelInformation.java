...
public class MMTelInformation extends com.intellinet.diameter.GroupedAVP {
    ...
    public int countSupplementaryService() {
        return _data.getContainer().count(Ro_r10AttributeName.SupplementaryService);
    }
    ...
    public SupplementaryService getSupplementaryService(int index) throws NoSuchAttributeException {
        return (SupplementaryService)_data.getContainer().get(Ro_r10AttributeName.SupplementaryService, index);
    }
    ...
    public void addSupplementaryService(SupplementaryService avp) {
        _data.getContainer().add(Ro_r10AttributeName.SupplementaryService, avp.getData(), false);
    }
    ...
    public boolean containsSubscriberRole() {
        return _data.getContainer().contains(Ro_r10AttributeName.SubscriberRole);
    }
    ...
    public SubscriberRole getSubscriberRole() throws NoSuchAttributeException {
        return (SubscriberRole)_data.getContainer().get(Ro_r10AttributeName.SubscriberRole, 0);
    }
    ...
    public void setSubscriberRole(SubscriberRole avp) {
        _data.getContainer().add(Ro_r10AttributeName.SubscriberRole, avp.getData(), true);
    }
