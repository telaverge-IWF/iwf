 ...
 ****************************************************************************
 *
 *  ID: $Id: re_stats.h,v 1.1 2011/05/20 04:15:48 vkumara Exp $
 *  LOG:
 *
 * ID: $Id: re_stats.h,v 1.1 2011/05/20 04:15:48 vkumara Exp $
 ****************************************************************************/
#ident "$Id: re_stats.h,v 1.1 2011/05/20 04:15:48 vkumara Exp $"

#if !defined(_REAPP_STATS_H_)
#define _REAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class ReStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the ReStats object pointer.
...
private:
     ...
     */
     ITS_UINT numPRQSent;        /*Number of Price Request sent*/
     ITS_UINT numPRSSent;        /*Number of Price Response sent*/
     ITS_UINT numPRQRecv;        /*Number of Price Request received*/
     ITS_UINT numPRSRecv;        /*Number of Price Response received*/

     ITS_UINT numTRQSent;        /*Number of Tariff Request sent*/
     ITS_UINT numTRSSent;        /*Number of Tariff Response sent*/
     ITS_UINT numTRQRecv;        /*Number of Tariff Request received*/
     ITS_UINT numTRSRecv;        /*Number of Tariff Response received*/

     ITS_UINT numSUQSent;        /*Number of ServiceUsageRequest sent*/
     ITS_UINT numSUSSent;        /*Number of ServiceUsageResponse  sent*/
     ITS_UINT numSUQRecv;        /*Number of ServiceUsageRequest received*/
     ITS_UINT numSUSRecv;        /*Number of ServiceUsageResponse  received*/

     /* Total Number of Messages Sent/Received
     */
     ITS_UINT numReMsgsSent;     /*Total number of request message sent*/
     ITS_UINT numRaMsgsSent;     /*Total number of answer message sent*/
     ITS_UINT numReMsgsRecv;     /*Total number of request message received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const ReStats& reStats);
