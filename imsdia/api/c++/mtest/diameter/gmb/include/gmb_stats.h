 ...
 *                                                                          *
 ****************************************************************************
 * LOG: $Log: gmb_stats.h,v $
 * LOG: Revision 1.1  2011/06/14 05:25:38  vkumara
 * LOG: Baseline for Gmb interface.
 * LOG:
 * LOG:
 * 
 * ID: $Id: gmb_stats.h,v 1.1 2011/06/14 05:25:38 vkumara Exp $
 ****************************************************************************/
#ident "$Id: gmb_stats.h,v 1.1 2011/06/14 05:25:38 vkumara Exp $"


#if !defined(_GMB__STATS_H_)
#define _GMB_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class GmbStats: public DiaStats
{
public:
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const GmbStats& nasreqStats);
