 ...
 * LOG:
 * 
 * ID: $Id: AbortSessionTest.cpp,v 1.1 2011/06/14 05:25:38 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/06/14 05:25:38 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the GmbAbortSessionRequest to the
 *      diameter stack. Create the GmbAbortSessionRequest object,
 ...
 *  See Also:
 ****************************************************************************/
int SendGmbAbortSessionRequest()
{
    ...
    GmbStats::GetGmbStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the GmbAbortSession request
 *      made by the diameter stack. Create the GmbAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendGmbAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    GmbStats::GetGmbStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
