 ...
 ****************************************************************************
 *
 * LOG: $Log: pr_stats.h,v $
 * LOG: Revision 1.1  2011/05/09 11:14:50  vkumara
 * LOG: Base line for Pr interface.
 * LOG:
 * LOG:
 * ID: $Id: pr_stats.h,v 1.1 2011/05/09 11:14:50 vkumara Exp $
 ****************************************************************************/
#ident "$Id: pr_stats.h,v 1.1 2011/05/09 11:14:50 vkumara Exp $"


#if !defined(_PR__STATS_H_)
#define _PR_STATS_H_
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const PrStats& nasreqStats);
