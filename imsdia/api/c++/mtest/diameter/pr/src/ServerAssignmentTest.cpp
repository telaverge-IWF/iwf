 ...
 * LOG:
 *
 * ID: $Id: ServerAssignmentTest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $
 ****************************************************************************/
#ident "$Id: ServerAssignmentTest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendPrServerAssignmentRequest()
{
    ...
    PrStats::GetPrStats()->UpdateSendStats(sar.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendPrServerAssignmentAnswer(const CommandImpl * impl1)
{
...
*/
    ...
    PrStats::GetPrStats()->UpdateSendStats(saa.getCommandCode(),ITS_FALSE);
    return ITS_SUCCESS;
}
