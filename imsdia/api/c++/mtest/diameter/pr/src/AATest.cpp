 ...
 * LOG:
 * LOG:
 * ID: $Id: AATest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the PrAARequest to the
 *      diameter stack. Create the  PrAARequest object,
...
int SendPrAARequest()
{
    ...
    AllocateSession(PR_INTERFACE_APP_ID, sIdx, sessIdString);
    ...
    PrStats::GetPrStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Pr AA request
 ...
 *  See Also:
 ****************************************************************************/
int SendPrAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    PrStats::GetPrStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
