 ...
 * LOG:
 * LOG:
 * ID: $Id: AbortSessionTest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/05/09 11:14:50 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the PrAbortSessionRequest to the
 *      diameter stack. Create the PrAbortSessionRequest object,
...
int SendPrAbortSessionRequest()
{
    ...
    diameter::pr::AbortSessionRequest asReq;
    ...
    AuthApplicationId authApplicationId(PR_INTERFACE_APP_ID);
    ...
    UserName userName("user@pr-network.com");
    ...
    PrStats::GetPrStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the PrAbortSession request
 *      made by the diameter stack. Create the PrAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendPrAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::pr::AbortSessionAnswer asAns;
    ...
    // prs completed successfully or whether an error occurred
    ...
    PrStats::GetPrStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
