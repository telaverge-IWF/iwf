 ...
 ****************************************************************************
 *
 * LOG: $Log: rs_stats.h,v $
 * LOG: Revision 1.1  2011/07/14 11:53:20  vkumara
 * LOG: Baseline for Rs interface.
 * LOG:
 * LOG:
 * ID: $Id: rs_stats.h,v 1.1 2011/07/14 11:53:20 vkumara Exp $
 ****************************************************************************/
#ident "$Id: rs_stats.h,v 1.1 2011/07/14 11:53:20 vkumara Exp $"


#if !defined(_RS__STATS_H_)
#define _RS_STATS_H_
...
private:
     ...
     */
     ...
     ITS_UINT numPNRSent;        /*Number of DE Request sent*/
     ITS_UINT numPNASent;        /*Number of DE Answer sent*/
     ITS_UINT numPNRRecv;        /*Number of DE Request received*/
     ITS_UINT numPNARecv;        /*Number of DE Answer received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const RsStats& nasreqStats);
