 ...
 * LOG:
 *
 * ID: $Id: PushProfileTest.cpp,v 1.1 2011/05/03 04:58:33 vkumara Exp $
 ****************************************************************************/
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxPushProfileRequest() 
{
    // [1]. create an instance of PushProfileRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swx::PushProfileRequest ppReq;
   ...
   // Create a Vendor-Specific-Application-Id AVP object
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(ppReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxPushProfileAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::swx::PushProfileAnswer ppAns;
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(ppAns.getCommandCode(), ITS_FALSE);
