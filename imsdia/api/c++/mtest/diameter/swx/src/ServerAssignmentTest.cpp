 ...
 * LOG:
 *
 * ID: $Id: ServerAssignmentTest.cpp,v 1.1 2011/05/03 04:58:33 vkumara Exp $
 ****************************************************************************/
#include <app.h>
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxServerAssignmentRequest() 
{
    ...
    diameter::swx::ServerAssignmentRequest saReq;
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(saReq.getCommandCode(), ITS_TRUE);
...
int SendSWxServerAssignmentAnswer(const CommandImpl * impl1) 
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swx::ServerAssignmentAnswer saAns;
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(saAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
