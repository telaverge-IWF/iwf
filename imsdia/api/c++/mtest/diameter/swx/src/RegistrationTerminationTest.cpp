 ...
 * LOG:
 *
 * ID: $Id: RegistrationTerminationTest.cpp,v 1.1 2011/05/03 04:58:33 vkumara Exp $
 ****************************************************************************/
#include <app.h>
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxRegistrationTerminationRequest() 
{
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(rtReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendSWxRegistrationTerminationAnswer(const CommandImpl * impl1) 
{
   ...
   // Create an instance of RegistrationTerminationrequest class
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(rta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
