 ...
 * LOG: 
 *
 * ID: $Id: MultimediaAuthenticationTest.cpp,v 1.1 2011/05/03 04:58:33 vkumara Exp $
 ****************************************************************************/
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxMultimediaAuthenticationRequest() 
{
    // [1]. Create an instance of MultimediaAuthenticationRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swx::MultimediaAuthenticationRequest maReq;
    ...
    AllocateSession(SWX_INTERFACE_APP_ID, sIdx, sessIdString);
   ...
   // [2.1.2.x] Required AVPs
    ...
    AuthApplicationId authApplicationId(SWX_INTERFACE_APP_ID);
    ...
    SWxStats::GetSWxStats()->UpdateSendStats(maReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 ...
 *  See Also:
 ****************************************************************************/
int SendSWxMultimediaAuthenticationAnswer(const CommandImpl * impl) 
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swx::MultimediaAuthenticationAnswer maAns;
   ...
   const SIPAuthDataItem &sipAuthData = mareq.getSIPAuthDataItem();
    ...
    // Update stats.
    SWxStats::GetSWxStats()->UpdateSendStats(maAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
