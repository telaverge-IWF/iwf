 ...
 ****************************************************************************
 *
 *  ID: $Id: swx_stats.h,v 1.1 2011/05/03 04:58:33 vkumara Exp $
 *
 *  LOG:
 *
 ****************************************************************************/
#ident "$Id: swx_stats.h,v 1.1 2011/05/03 04:58:33 vkumara Exp $"

#if !defined(_SWXAPP_STATS_H_)
#define _SWXAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class SWxStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the SWxStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const SWxStats& swxStats);
