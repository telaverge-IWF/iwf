 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 1.1 2011/06/29 06:36:51 vkumara Exp $
 ****************************************************************************/
#include <app.h>
 ...
 ****************************************************************************
 *  Purpose: This function sends the RA Req to the
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_DelegatedmodelRARequest()
{
    ...
    diameter::rr_delegatedmodel::RARequest raReq;
    ...
    raReq.setAuthSessionState(authSessionState);
   ...
   // The Specific-Action AVP (AVP code 513) is of type Enumerated.
    ...
    Rr_DelegatedmodelStats::GetRr_DelegatedmodelStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS; 
}
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_DelegatedmodelRAAnswer(const CommandImpl *impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_delegatedmodel::RAAnswer raAns;
    ...
    // }
    AuthSessionState authSessionState(AuthSessionState::STATE_MAINTAINED);
    raAns.setAuthSessionState(authSessionState);

    cout<<"RAA : "<<raAns<<endl;
    SendDiaAppMsg(raAns, sIdx);
    Rr_DelegatedmodelStats::GetRr_DelegatedmodelStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
