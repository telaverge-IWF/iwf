 ...
 * LOG:
 * LOG:
 * ID: $Id: UserDataTest.cpp,v 1.1 2011/06/29 06:36:51 vkumara Exp $
 ****************************************************************************/
#ident "$Id: UserDataTest.cpp,v 1.1 2011/06/29 06:36:51 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_DelegatedmodelUserDataRequest()
{
    // [1]. Create an instance of UserDataRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_delegatedmodel::UserDataRequest udReq;
   ...
   // [2.1.2.x] Required AVPs
    ...
    // This AVP Rr_DelegatedmodelOULD be placed as close to the Diameter header as possible.
    ...
    Rr_DelegatedmodelStats::GetRr_DelegatedmodelStats()->UpdateSendStats(udReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_DelegatedmodelUserDataAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_delegatedmodel::UserDataAnswer udAns;
    ...
    // AVPs' present in an UserDataAnswer command and
    // pass them by value to the corresponding data members set
    // methods of the UserDataAnswer object created
    // in step 1.
    ...
    // Update stats.
    Rr_DelegatedmodelStats::GetRr_DelegatedmodelStats()->UpdateSendStats(udAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
