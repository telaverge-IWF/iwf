 ...
 ****************************************************************************
 *
 * LOG: $Log: rr_delegatedmodel_stats.h,v $
 * LOG: Revision 1.1  2011/06/29 06:36:51  vkumara
 * LOG: Baseline for rr_delegatedmodel interface.
 * LOG:
 * LOG:
 * ID: $Id: rr_delegatedmodel_stats.h,v 1.1 2011/06/29 06:36:51 vkumara Exp $
 ****************************************************************************/
 #ident "$Id: rr_delegatedmodel_stats.h,v 1.1 2011/06/29 06:36:51 vkumara Exp $"


#if !defined(_Rr_DelegatedmodelAPP_STATS_H_)
#define _Rr_DelegatedmodelAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class Rr_DelegatedmodelStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the Rr_DelegatedmodelStats object pointer.
     ...
     *  See Also:
     *************************************************************************/
     static Rr_DelegatedmodelStats* GetRr_DelegatedmodelStats();
...
private:
     ...
     *  See Also:
     ************************************************************************/
     Rr_DelegatedmodelStats(const Rr_DelegatedmodelStats&);
     ...
     ************************************************************************/
     Rr_DelegatedmodelStats&
     operator=(const Rr_DelegatedmodelStats&);
};
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const Rr_DelegatedmodelStats& shStats);
