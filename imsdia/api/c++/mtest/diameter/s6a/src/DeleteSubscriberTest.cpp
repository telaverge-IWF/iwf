 ...
 * LOG: 
 * ID: $Id: DeleteSubscriberTest.cpp,v 1.3 2009/03/04 12:43:31 sureshj Exp $ 
 ***************************************************************************/
#ident "$Id: DeleteSubscriberTest.cpp,v 1.3 2009/03/04 12:43:31 sureshj Exp $"
...
int SendS6ADeleteSubDataRequest()
{
    ...
    diameter::s6a::DeleteSubscriberDataRequest dsdReq;
...
int SendS6ADeleteSubDataAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6a::DeleteSubscriberDataAnswer dsdAns;
