 ...
 * LOG:
 * ID: $Id: PurgeUETest.cpp,v 1.3 2009/03/04 12:44:43 sureshj Exp $  
 ****************************************************************************/
#ident "$Id: PurgeUETest.cpp,v 1.3 2009/03/04 12:44:43 sureshj Exp $"
...
int SendS6APurgeUERequest()
{
    ...
    diameter::s6a::PurgeUERequest PUReq;
...
int SendS6APurgeUEAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6a::PurgeUEAnswer PUAns;
