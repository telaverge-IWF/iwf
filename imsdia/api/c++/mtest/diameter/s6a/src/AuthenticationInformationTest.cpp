 ...
 * LOG: Initial commits.
 * LOG:
 * ID: $Id: AuthenticationInformationTest.cpp,v 1.5 2010/09/07 12:26:21 vkumara Exp $
 ***************************************************************************/
...
int SendS6AAuthenticationInformationRequest()
{
    ...
    diameter::s6a::AuthenticationInformationRequest AIReq;
...
int SendS6AAuthenticationInformationAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6a::AuthenticationInformationAnswer AIAns;
