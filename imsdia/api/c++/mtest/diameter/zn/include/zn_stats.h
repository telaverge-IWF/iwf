 ...
 ****************************************************************************
 *
 * LOG: $Log: zn_stats.h,v $
 * LOG: Revision 1.1  2011/06/02 04:26:21  vkumara
 * LOG: Baseline for Zn interface.
 * LOG:
 * LOG:
 * ID: $Id: zn_stats.h,v 1.1 2011/06/02 04:26:21 vkumara Exp $
 ****************************************************************************/
#ident "$Id: zn_stats.h,v 1.1 2011/06/02 04:26:21 vkumara Exp $"

#if !defined(_ZN_APP_STATS_H_)
#define _ZN_APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class ZnStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the ZnStats object pointer.
...
private:
     ...
     */
     ...
     ITS_UINT numBSRSent;        /*Number of MA Request sent*/
     ITS_UINT numBSASent;        /*Number of MA Answer sent*/
     ITS_UINT numBSRRecv;        /*Number of MA Request received*/
     ITS_UINT numBSARecv;        /*Number of MA Answer received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const ZnStats& znStats);
