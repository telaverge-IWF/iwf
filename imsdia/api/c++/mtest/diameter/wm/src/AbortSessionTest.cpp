 ...
 ****************************************************************************
 *  Purpose: This function sends the WmAbortSessionRequest to the
 *      diameter stack. Create the WmAbortSessionRequest object,
...
int SendWmAbortSessionRequest()
{
    ...
    diameter::wm::AbortSessionRequest asReq;
    ...
    WmStats::GetWmStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the WmAbortSession request
 *      made by the diameter stack. Create the WmAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendWmAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::wm::AbortSessionAnswer asAns;
    ...
    WmStats::GetWmStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
