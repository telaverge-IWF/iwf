 ...
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 1.3  2008/03/27 11:31:38  hbhatnagar
 * LOG: Converting 2.1 branch to CURRENT
 * LOG:
 * LOG: Revision 1.1.2.1  2007/03/02 10:05:51  hbhatnagar
 * LOG: Populated and added mandatory SubscriptionId AVP in AA Answer.
 * LOG:
 * LOG: Revision 1.1  2007/02/28 11:03:09  hbhatnagar
 * LOG: Baseline Demo Application for Wm Interface.
 * LOG:
 *
 * ID: $Id: AATest.cpp,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the WmAARequest to the
 *      diameter stack. Create the  WmAARequest object,
...
int SendWmAARequest()
{
    ...
    WmStats::GetWmStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Wm AA request
 *      made by the diameter stack. Create the WmAAAnswer
 ...
 *  See Also:
 ****************************************************************************/
int SendWmAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    WmStats::GetWmStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
