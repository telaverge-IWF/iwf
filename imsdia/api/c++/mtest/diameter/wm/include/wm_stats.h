 ...
 * LOG:
 *
 * ID: $Id: wm_stats.h,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: wm_stats.h,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $"


#if !defined(_WM__STATS_H_)
#define _WM_STATS_H_
...
public:
     ...
     *
     *  Return Value:
     *      Returns the WmStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const WmStats& nasreqStats);
