 ...
 ****************************************************************************
 *
 *  ID: $Id: rx_stats.h,v 3.1 2008/03/31 10:33:12 nvijikumar Exp $
 *
 *  LOG: $Log: rx_stats.h,v $
 ...
 *  LOG: Start GA 1.1
 *  LOG:
 *  LOG: Revision 1.2  2006/08/04 17:57:13  nvijikumar
 *  LOG: Chnages to update the stats for all Rx Interface messages.
 *  LOG:
 ...
 *
 ****************************************************************************/
#ident "$Id: rx_stats.h,v 3.1 2008/03/31 10:33:12 nvijikumar Exp $"

#if !defined(_RXAPP_STATS_H_)
#define _RXAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class RxStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the RxStats object pointer.
...
private:
     ...
     */
     ...
     ITS_UINT numSTRRecv;        /*Number of SessionTermination Request reced*/
     ITS_UINT numSTARecv;        /*Number of SessionTermination Answer received*/

     ITS_UINT numASRSent;        /*Number of AbortSession Request sent*/
     ITS_UINT numASASent;        /*Number of AbortSession Answer sent*/
     ITS_UINT numASRRecv;        /*Number of AbortSession Request reced*/
     ITS_UINT numASARecv;        /*Number of AbortSession Answer reced*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const RxStats& rxStats);
