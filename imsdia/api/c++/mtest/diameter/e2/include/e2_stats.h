 ...
 * LOG:
 *
 * ID: $Id: e2_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: e2_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $"

#if !defined(_E2APP_STATS_H_)
#define _E2APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class E2Stats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the E2Stats object pointer.
...
private:
     ...
     */
     ...
     ITS_UINT numUDRSent;        /*Number of UA Request sent*/
     ITS_UINT numUDASent;        /*Number of UA Answer sent*/
     ITS_UINT numUDRRecv;        /*Number of UA Request received*/
     ITS_UINT numUDARecv;        /*Number of UA Answer received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const E2Stats& cxStats);
