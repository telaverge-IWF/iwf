 ...
 *                                                                          *
 ****************************************************************************
 * LOG: $Log: gi_stats.h,v $
 * LOG: Revision 1.1  2011/05/26 08:57:24  vkumara
 * LOG: Baseline for Gi interface.
 * LOG:
 * LOG:
 *
 * ID: $Id: gi_stats.h,v 1.1 2011/05/26 08:57:24 vkumara Exp $
 ****************************************************************************/
#ident "$Id: gi_stats.h,v 1.1 2011/05/26 08:57:24 vkumara Exp $"


#if !defined(_GI__STATS_H_)
#define _GI_STATS_H_
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const GiStats& nasreqStats);
