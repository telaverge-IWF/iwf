 ...
 * LOG:
 *
 * ID: $Id: AATest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the GiAARequest to the
 *      diameter stack. Create the  GiAARequest object,
...
int SendGiAARequest()
{
    ...
    AllocateSession(GI_INTERFACE_APP_ID, sIdx, sessIdString);
 ...
 //     aaReq.setNASIdentifier(nASIdentifier);
    ...
    SendDiaAppMsg(aaReq, sIdx);
     ...
     GiStats::GetGiStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Gi AA request
 ...
 *  See Also:
 ****************************************************************************/
int SendGiAAAnswer(const CommandImpl * impl)
{
 ...
 //   aaAns.addSubscriptionId(subscriptionId);
    ...
    // Update stats.
     GiStats::GetGiStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
