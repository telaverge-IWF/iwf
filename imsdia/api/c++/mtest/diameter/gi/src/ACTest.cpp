 ...
 * LOG:
 *
 * ID: $Id: ACTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $
 ****************************************************************************/
#ident "$Id: ACTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendGiACRequest(int reqType, const diameter::CommandImpl* impl)
{
    ...
    // Authorization portion of an application
    // The AVP Code of Auth-Application-Id is 258.
    AuthApplicationId authId(GI_INTERFACE_APP_ID);
    ...
    GiStats::GetGiStats()->UpdateSendStats(acr.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendGiACAnswer(const CommandImpl *impl)
{
    ...
    SendDiaAppMsg(aca, sIdx);
     GiStats::GetGiStats()->UpdateSendStats(aca.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
