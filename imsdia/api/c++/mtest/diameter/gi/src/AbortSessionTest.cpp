 ...
 * LOG:
 *
 * ID: $Id: AbortSessionTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the GiAbortSessionRequest to the
 *      diameter stack. Create the GiAbortSessionRequest object,
...
int SendGiAbortSessionRequest()
{
    ...
    AuthApplicationId authApplicationId(GI_INTERFACE_APP_ID);
  ...
  //  UserName userName("user@gi-network.com");
  //  asReq.setUserName(userName);
    ...
    GiStats::GetGiStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the GiAbortSession request
 *      made by the diameter stack. Create the GiAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendGiAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    GiStats::GetGiStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
