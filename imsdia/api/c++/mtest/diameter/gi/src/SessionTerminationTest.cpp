 ...
 * LOG:
 *
 * ID: $Id: SessionTerminationTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 1.1 2011/05/26 08:57:24 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendGiSessionTerminationRequest()
{
    ...
    diameter::gi::STRequest stReq(false,false);
    ...
    SendDiaAppMsg(stReq, sIdx);
     GiStats::GetGiStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendGiSessionTerminationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::gi::STAnswer sta(false,false);
    ...
    // The AVP Code of User-Name AVP is 1.
    // The data type of User-Name AVP is UTF8String.
    UserName uname("user@gi-network.com");
    sta.setUserName(uname);

    cout << sta;

    SendDiaAppMsg(sta, sIdx);
    GiStats::GetGiStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
