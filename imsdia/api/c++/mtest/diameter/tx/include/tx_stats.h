 ...
 ****************************************************************************
 *
 *  ID: $Id: tx_stats.h,v 3.1 2008/03/31 10:33:13 nvijikumar Exp $
 *
 *  LOG: $Log: tx_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: tx_stats.h,v 3.1 2008/03/31 10:33:13 nvijikumar Exp $"

#if !defined(_TXAPP_STATS_H_)
#define _TXAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class TxStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the TxStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const TxStats& txStats);
