 ...
 * LOG:
 *
 * ID: $Id: STTest.cpp,v 3.1 2008/03/31 10:33:13 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
...
//    streq.addRouteRecord(routeRecord);
    ...
    TxStats::GetTxStats()->UpdateSendStats(streq.getCommandCode(), ITS_TRUE);
...
int SendTxSTAnswer(const CommandImpl * impl1)
{
    ...
    stans.setSessionIndex(streq.getSessionIndex());
...
//	stans.addProxyInfo(proxyInfo);
    ...
    TxStats::GetTxStats()->UpdateSendStats(stans.getCommandCode(), ITS_FALSE);
