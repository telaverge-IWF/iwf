 ...
 ****************************************************************************
 *
 *  ID: $Id: app_main.cpp,v 1.1.2.1 2013/03/04 04:44:05 pramana Exp $
 *  
 ...
 *
 ****************************************************************************/
#ident "$Id: app_main.cpp,v 1.1.2.1 2013/03/04 04:44:05 pramana Exp $"
...
int parseArguments(int argc, const char** args)
{
   ...
   for(; i < argc && flag ; i++)
   {
       ...
       {
          i++;
          if (strcasestr(args[i], "HSS") ||
              (strcasestr(args[i], "PCRF") && strcasestr(args[i], "H")))
          {
              runMode = RECEIVER;
          }
          else
