 ...
 ****************************************************************************
 *  Purpose: This function sends the WdAARequest to the
 *      diameter stack. Create the  WdAARequest object,
...
int SendWdAARequest()
{
    ...
    WdStats::GetWdStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Wd AA request
 ...
 *  See Also:
 ****************************************************************************/
int SendWdAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    WdStats::GetWdStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
