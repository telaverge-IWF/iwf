 ...
 * LOG:
 *
 * ID: $Id: SessionTerminationTest.cpp,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 3.1 2008/03/31 10:33:14 nvijikumar Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendWdSessionTerminationRequest()
{
    ...
    diameter::wd::SessionTerminationRequest stReq(false,false);
    ...
    WdStats::GetWdStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendWdSessionTerminationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::wd::SessionTerminationAnswer sta(false,false);
    ...
    // The AVP Code of User-Name AVP is 1.
    // The data type of User-Name AVP is UTF8String.
    UserName uname("user@wd-network.com");
    sta.setUserName(uname);

    cout << sta;

    SendDiaAppMsg(sta, sIdx);
    WdStats::GetWdStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
