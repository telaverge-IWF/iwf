...
int SendWdReAuthRequest()
{
    ...
    WdStats::GetWdStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendWdReAuthAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::wd::ReAuthAnswer raAns;
    ...
    WdStats::GetWdStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
