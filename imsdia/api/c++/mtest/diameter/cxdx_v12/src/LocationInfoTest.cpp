 ...
 * LOG: Added cxdx_v10
 * LOG:
 * LOG: Revision 1.1.2.1.2.1  2013/07/01 09:40:16  nazad
 ...
 * LOG:
 *
 * ID: $Id: LocationInfoTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $
 ****************************************************************************/
#ident "$Id: LocationInfoTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $"
...
int SendCxdxLocationInfoRequest()
{
    ...
    lir.setOriginatingRequest(OriginatingRequest(OriginatingRequest:: ORIGINATING));

    lir.setUserAuthorizationType(UserAuthorizationType(UserAuthorizationType:: REGISTRATION));

    lir.setSessionPriority(SessionPriority(SessionPriority:: PRIORITY0));
...
int SendCxdxLocationInfoAnswer(const CommandImpl * impl1)
{
    ...
    Json::Value* cfg = &(*m_jsonRoot1)["LocationInfoTestAnswer"];
    ...
    lia.setWildcardedPublicIdentity(WildcardedPublicIdentity("WcPI"));


    // Set LIA flags


    lia.setLIAFlags(LIAFlags(0u));    
