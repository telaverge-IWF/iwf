 ...
 * LOG: Added cxdx_v10
 * LOG:
 * LOG: Revision 1.1.2.1.2.1  2013/07/01 09:41:13  nazad
 ...
 * LOG:
 *
 * ID: $Id: PushProfileTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $
 ****************************************************************************/
#ident "$Id: PushProfileTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendCxdxPushProfileRequest()
{
    ...
    ppr.addSupportedFeatures(supportedFeatures);
    
    SIPAuthDataItem sipAD;
    sipAD.setSIPItemNumber(SIPItemNumber(1u));
    sipAD.setSIPAuthenticationScheme(SIPAuthenticationScheme("SCHEME"));
    sipAD.setSIPAuthenticate(SIPAuthenticate("SIP"));
    sipAD.setSIPAuthorization(SIPAuthorization("Authorization"));
    sipAD.setSIPAuthenticationContext(SIPAuthenticationContext("SIPAC"));
    sipAD.setConfidentialityKey(ConfidentialityKey("Key"));
    sipAD.setIntegrityKey(IntegrityKey("Key"));
    ppr.setSIPAuthDataItem(sipAD);
  
    sipAD.setFramedIPAddress(FramedIPAddress("172.16.12.221"));
    sipAD.setFramedIPv6Prefix(FramedIPv6Prefix("fe80::ea40:f2ff:fe3c:9001"));
    sipAD.setFramedInterfaceId(FramedInterfaceId(1u));

    UserData userData("userdatavalue");
    ppr.setUserData(userData);
  ...
  /*
    ...
    SendDiaAppMsg(ppr, sIdx);
    CxdxStats::GetCxdxStats()->UpdateSendStats(ppr.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendCxdxPushProfileAnswer(const CommandImpl * impl1)
{
    ...
    Json::Value* cfg = &(*m_jsonRoot1)["PushProfileTestAnswer"];
    ...
    ppa.setSessionIndex(rreq.getSessionIndex());
    ...
    ppa.addSupportedFeatures(supportedFeatures);
    ...
    SendDiaAppMsg(ppa, sIdx);
    CxdxStats::GetCxdxStats()->UpdateSendStats(ppa.getCommandCode(), ITS_FALSE);
