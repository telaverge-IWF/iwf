 ...
 * LOG: Added cxdx_v10
 * LOG:
 * LOG: Revision 1.1.2.1.2.1  2013/07/01 09:41:38  nazad
 ...
 * LOG:
 *
 * ID: $Id: RegistrationTerminationTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $
 ****************************************************************************/
#ident "$Id: RegistrationTerminationTest.cpp,v 1.1.2.1 2015/05/18 05:15:10 kpnithin Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendCxdxRegistrationTerminationRequest()
{
    ...
    associatedIdentities.addUserName(UserName("UserName"));
    rtr.setAssociatedIdentities(associatedIdentities);
    ...
    rtr.addSupportedFeatures(supportedFeatures);
    ...
    SendDiaAppMsg(rtr, sIdx);
    CxdxStats::GetCxdxStats()->UpdateSendStats(rtr.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendCxdxRegistrationTerminationAnswer(const CommandImpl * impl1)
{
   ...
   // Create an instance of RegistrationTerminationrequest class
    ...
    Json::Value* cfg = &(*m_jsonRoot1)["RegistrationTermiantionTestAnswer"];
    ...
    rta.setSessionIndex(rreq.getSessionIndex());
    ...
    AssociatedIdentities associatedIdentities;
    associatedIdentities.addUserName(UserName("UN"));
    rta.setAssociatedIdentities(associatedIdentities);
    ...
    rta.addSupportedFeatures(supportedFeatures);

    IdentitywithEmergencyRegistration IwER;
    IwER.setUserName(UserName("USER-NAME"));
    IwER.setPublicIdentity(PublicIdentity("PI"));
    rta.addIdentitywithEmergencyRegistration(IwER);
    ...
    SendDiaAppMsg(rta, sIdx);
    CxdxStats::GetCxdxStats()->UpdateSendStats(rta.getCommandCode(),ITS_FALSE);
    return (ITS_SUCCESS);
}
