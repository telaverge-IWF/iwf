 ...
 ****************************************************************************
 *
 * LOG: $Log: s6b_stats.h,v $
 * LOG: Revision 1.1  2011/04/27 12:14:11  vkumara
 * LOG: Draft for S6b interface.
 * LOG:
 * LOG:
 ****************************************************************************/
#ident "$Id: s6b_stats.h,v 1.1 2011/04/27 12:14:11 vkumara Exp $"


#if !defined(_S6B__S6BTS_H_)
#define _S6B_S6BTS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class S6bStats: public DiaStats
{
public:
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const S6bStats& nasreqStats);
