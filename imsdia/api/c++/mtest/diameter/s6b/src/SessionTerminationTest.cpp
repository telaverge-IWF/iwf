 ...
 *
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 1.1 2011/04/27 12:14:12 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendS6bSessionTerminationRequest()
{
    ...
    diameter::s6b::SessionTerminationRequest stReq(false,false);
    ...
    S6bStats::GetS6bStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendS6bSessionTerminationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6b::SessionTerminationAnswer sta(false,false);
    ...
    S6bStats::GetS6bStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
