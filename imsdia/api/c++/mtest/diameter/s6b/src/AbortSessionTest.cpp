 ...
 *
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/04/27 12:14:12 vkumara Exp $"
 ...
 *      diameter stack. Create the S6bAbortSessionRequest object,
 ...
 *  See Also:
 ****************************************************************************/
int SendS6bAbortSessionRequest()
{
    ...
    diameter::s6b::AbortSessionRequest asReq;
    ...
    S6bStats::GetS6bStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the S6bAbortSession request
 *      made by the diameter stack. Create the S6bAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendS6bAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6b::AbortSessionAnswer asAns;
    ...
    S6bStats::GetS6bStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
