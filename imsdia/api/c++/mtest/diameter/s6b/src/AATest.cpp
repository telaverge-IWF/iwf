 ...
 *
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/04/27 12:14:12 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the S6bAARequest to the
 *      diameter stack. Create the  S6bAARequest object,
...
int SendS6bAARequest()
{
    ...
    S6bStats::GetS6bStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the S6b AA request
 *      made by the diameter stack. Create the S6b AA Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendS6bAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    S6bStats::GetS6bStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
