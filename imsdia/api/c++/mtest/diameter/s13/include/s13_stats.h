 ...
 *                                                                          *
 ****************************************************************************
 * LOG: $Log: s13_stats.h,v $
 * LOG: Revision 1.1  2008/08/19 09:00:04  sureshj
 * LOG: Baseline demo application for s13 interface.
 * LOG:
 * ID: $Id: s13_stats.h,v 1.1 2008/08/19 09:00:04 sureshj Exp $ 
 ****************************************************************************/

#if !defined(_S13APP_STATS_H_)
#define _S13APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class S13Stats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the S13Stats object pointer.
...
private:
     ...
     */
     ...
     ITS_UINT numECRSent;        /*Number of UA Request sent*/
     ITS_UINT numECASent;        /*Number of UA Answer sent*/
     ITS_UINT numECRRecv;        /*Number of UA Request received*/
     ITS_UINT numECARecv;        /*Number of UA Answer received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const S13Stats& cxStats);
