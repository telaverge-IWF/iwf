 ...
 * LOG:
 *
 * ID: $Id: nasreq_stats.h,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: nasreq_stats.h,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $"


#if !defined(_NASREQ_3GPP2APP_STATS_H_)
#define _NASREQ_3GPP2APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class NasreqStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the NasreqStats object pointer.
     ...
     *  See Also:
     *************************************************************************/
     static NasreqStats* GetNasreqStats();
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const NasreqStats& nasreqStats);
