 ...
 * LOG:
 *
 * ID: $Id: AbortSessionTest.cpp,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendNasreqAbortSessionRequest()
{
    ...
    diameter::nasreq::ASRequest asReq;
    ...
    NasreqStats::GetNasreqStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendNasreqAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::nasreq::ASAnswer asAns;
    ...
    NasreqStats::GetNasreqStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
