 ...
 * LOG:
 *
 * ID: $Id: ReAuthTest.cpp,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: ReAuthTest.cpp,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $"
...
int SendNasreqReAuthRequest()
{
    ...
    NasreqStats::GetNasreqStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendNasreqReAuthAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::nasreq::RAAnswer raAns;
    ...
    NasreqStats::GetNasreqStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
