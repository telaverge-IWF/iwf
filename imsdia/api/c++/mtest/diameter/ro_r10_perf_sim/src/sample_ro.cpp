 ...
 * LOG: Revision 1.1.4.2.8.1  2015/05/19 03:10:49  jkchaitanya
 * LOG: changes for bug 6746
 * LOG:
 ...
 * LOG:
 *
 * ID: $Id: sample_ro.cpp,v 1.1.4.2.8.1 2015/05/19 03:10:49 jkchaitanya Exp $
 ****************************************************************************/
#ident "$Id: sample_ro.cpp,v 1.1.4.2.8.1 2015/05/19 03:10:49 jkchaitanya Exp $"
...
Json::Value parseS6aConfig()
{
    ...
    if (getcwd(cwd, sizeof(cwd)) != NULL)
    {
        ...
        APP_TRACE_DEBUG(("RO_IWF_CONFIG_FILE=%s",jsonFile));
