 ...
 * LOG:
 * LOG:
 * ID: $Id: MultimediaAuthTest.cpp,v 1.1 2011/06/02 04:10:02 vkumara Exp $
 ****************************************************************************/
#ident "$Id: MultimediaAuthTest.cpp,v 1.1 2011/06/02 04:10:02 vkumara Exp $"

#include <app.h>
#include <zh_defines.h>
#include <zh_stats.h>
#include <diameter/zh/MultimediaAuth.h>

using namespace std;
using namespace its;
using namespace diameter;
using namespace diameter::base;
using namespace diameter::zh;
...
int SendZhMultimediaAuthRequest()
{
  ...
  AllocateSession(ZH_INTERFACE_APP_ID, sIdx, sessIdString);
  maReq.setSessionId(diameter::base::SessionId(sessIdString));
   ...
   // [2.1.2.x] Required AVPs
    ...
    AuthApplicationId authApplicationId(ZH_INTERFACE_APP_ID);
    ...
    ZhStats::GetZhStats()->UpdateSendStats(maReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 ...
 *  See Also:
 ****************************************************************************/
int SendZhMultimediaAuthAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::zh::MultimediaAuthAnswer maAns;
   ...
   SendDiaAppMsg(maAns, sIdx);
    ...
    // Update stats.
    ZhStats::GetZhStats()->UpdateSendStats(maAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
