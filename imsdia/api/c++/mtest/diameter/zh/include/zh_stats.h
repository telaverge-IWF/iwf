 ...
 ****************************************************************************
 *
 * LOG: $Log: zh_stats.h,v $
 * LOG: Revision 1.1  2011/06/02 04:10:02  vkumara
 * LOG: Baseline for Zh interface.
 * LOG:
 * LOG:
 * ID: $Id: zh_stats.h,v 1.1 2011/06/02 04:10:02 vkumara Exp $
 ****************************************************************************/
#ident "$Id: zh_stats.h,v 1.1 2011/06/02 04:10:02 vkumara Exp $"

#if !defined(_ZH_APP_STATS_H_)
#define _ZH_APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class ZhStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the ZhStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const ZhStats& zhStats);
