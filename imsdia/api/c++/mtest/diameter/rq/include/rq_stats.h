 ...
 ****************************************************************************
 *
 *  ID: $Id: rq_stats.h,v 3.1 2008/03/31 10:33:11 nvijikumar Exp $
 *
 *  LOG: $Log: rq_stats.h,v $
 ...
 *  LOG:
 ****************************************************************************/
#ident "$Id: rq_stats.h,v 3.1 2008/03/31 10:33:11 nvijikumar Exp $"

#if !defined(_RQAPP_STATS_H_)
#define _RQAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class RqStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the RqStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const RqStats& rqStats);
