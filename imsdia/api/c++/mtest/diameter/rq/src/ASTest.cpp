 ...
 * LOG:
 *
 * ID: $Id: ASTest.cpp,v 3.1 2008/03/31 10:33:11 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
...
int SendRqASRequest() 
{
    ...
    asReq.addSessionBundleId(sessionBundleId);
    ...
    RqStats::GetRqStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendRqASAnswer(const CommandImpl * impl1)
{
    ...
    RqStats::GetRqStats()->UpdateSendStats(asans.getCommandCode(), ITS_FALSE);
