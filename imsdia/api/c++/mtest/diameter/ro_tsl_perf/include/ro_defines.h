 ...
 * LOG: Revision 1.1.2.1.2.2.2.1  2014/09/17 06:36:37  jkchaitanya
 * LOG: changes for bugs 4965 and 4978
 * LOG:
 * LOG: Revision 1.1.2.1.2.2  2014/07/31 12:14:08  jkchaitanya
 * LOG: changes for transparent followOn calls in load
 * LOG:
 * LOG: Revision 1.1.2.1.2.1  2014/07/30 10:37:08  jkchaitanya
 ...
 * LOG:
 *
 * ID: $Id: ro_defines.h,v 1.1.2.1.2.2.2.1 2014/09/17 06:36:37 jkchaitanya Exp $
 ****************************************************************************/
#ident "$Id: ro_defines.h,v 1.1.2.1.2.2.2.1 2014/09/17 06:36:37 jkchaitanya Exp $"
...
#include <diameter/ro_r10_transatel/AC.h>
...
enum _CallFlow
{
    ...
    LOCAL_CONTINUE_CALL,
    REMOTE_CONNECT_CALL,
    REMOTE_CONTINUE_CALL,
    TRANSPARENT_FOLLOW_ON_LOCAL_CALL,
    TRANSPARENT_FOLLOW_ON_REMOTE_CALL,
    FOLLOWON_CONTINUE_LOCAL_AND_CONNECT_LOCAL,
    FOLLOWON_CONTINUE_LOCAL_AND_CONNECT_REMOTE,
...
enum _scpAction
{
    ...
    CONTINUE,
    CONNECT,
    TRANSPARENT_FOLLOW_ON,
    FOLLOW_ON_CONTINUE,
    FOLLOW_ON_CONNECT
};

enum _capControlMode
{
    NO_CONTROL = 0,
    LOCAL_CONTROL,
    REMOTE_CONTROL
...
#define FOLLOWON_SECOND_CALL_CCTR_RCVD 2
 ...
 *  See Also:
 ****************************************************************************/
void PopulateServiceControl(ServiceControl &serviceCtrl, bool isRequest);
void PopulateCAPConnectInformation(CAPConnectInformation &CAPConnectInfo, bool isRequest);
