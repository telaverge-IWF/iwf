 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 1.1.4.2 2014/02/12 07:36:12 millayaraja Exp $
 ****************************************************************************/
#include <app.h>
...
int SendRoRARequest(std::string sessionId)
{
    ...
    diameter::ro_r10::ReAuthRequest raReq;
...
int SendRoRAAnswer(const CommandImpl *impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::ro_r10::ReAuthAnswer raAns;

    // Create an instance of  RA Request class 
    diameter::ro_r10:: ReAuthRequest rareq(*impl);
