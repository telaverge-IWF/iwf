 ...
 * LOG:
 * LOG: Revision 1.1.2.1.34.1  2013/02/26 08:54:32  jvikram
 ...
 * LOG:
 *
 * ID: $Id: ACTest.cpp,v 1.1.4.2 2014/02/12 07:36:12 millayaraja Exp $
 ****************************************************************************/
#include <app.h>
 ...
 *  See Also:
 ****************************************************************************/
int SendRoACRequest(int reqType, const diameter::CommandImpl* impl)
{
    ...
    // Authorization portion of an application
    // The AVP Code of Auth-Application-Id is 258.
    AuthApplicationId authId(RO_INTERFACE_APP_ID);
    ...
    RoStats::GetRoStats()->UpdateSendStats(acr.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
 ...
 *  See Also:
 ****************************************************************************/
int SendRoACAnswer(const CommandImpl *impl)
{
    ...
    RoStats::GetRoStats()->UpdateSendStats(aca.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
