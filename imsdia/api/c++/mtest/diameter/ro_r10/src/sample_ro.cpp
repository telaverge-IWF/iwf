 ...
 * LOG:
 * LOG: Revision 1.1.2.3  2014/02/12 07:25:36  millayaraja
 * LOG: added new interface for IWF ro_r10
 * LOG:
 ...
 * LOG:
 *
 * ID: $Id: sample_ro.cpp,v 1.1.4.2 2014/02/12 07:36:12 millayaraja Exp $
 ****************************************************************************/
#ident "$Id: sample_ro.cpp,v 1.1.4.2 2014/02/12 07:36:12 millayaraja Exp $"
...
Json::Value parseS6aConfig()
{
    ...
    char *jsonFile = getenv("RO_IWF_CONFIG_FILE");
    if (jsonFile == NULL )
    {
