 ...
 * LOG:
 * LOG:
 * ID: $Id: AATest.cpp,v 1.1 2011/05/09 11:12:55 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/05/09 11:12:55 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the WgAARequest to the
 *      diameter stack. Create the  WgAARequest object,
...
int SendWgAARequest()
{
    ...
    WgStats::GetWgStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Wg AA request
 ...
 *  See Also:
 ****************************************************************************/
int SendWgAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    WgStats::GetWgStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
