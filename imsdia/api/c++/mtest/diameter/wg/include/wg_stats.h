 ...
 ****************************************************************************
 *
 * LOG: $Log: wg_stats.h,v $
 * LOG: Revision 1.1  2011/05/09 11:12:55  vkumara
 * LOG: Base line for Wg interface.
 * LOG:
 * LOG:
 * ID: $Id: wg_stats.h,v 1.1 2011/05/09 11:12:55 vkumara Exp $
 ****************************************************************************/
#ident "$Id: wg_stats.h,v 1.1 2011/05/09 11:12:55 vkumara Exp $"


#if !defined(_WG__STATS_H_)
#define _WG_STATS_H_
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const WgStats& nasreqStats);
