 ...
 ****************************************************************************
 *
 *  ID: $Id: gy_stats.h,v 1.1 2011/03/10 09:27:34 vkumara Exp $
 *
 *  LOG: $Log: gy_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: gy_stats.h,v 1.1 2011/03/10 09:27:34 vkumara Exp $"

#if !defined(_GYAPP_CCATS_H_)
#define _GYAPP_CCATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class GyStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the GyStats object pointer.
...
private:
     ...
     */
     ITS_UINT numACRSent;        /*Number of Accounting Request sent*/
     ITS_UINT numACASent;        /*Number of Accounting  Answer sent*/
     ITS_UINT numACRRecv;        /*Number of Accounting  Request received*/
     ITS_UINT numACARecv;        /*Number of Accounting  Answer received*/
     ...
     */
     ITS_UINT numGqMsgsSent;     /*Total number of request message sent*/
     ITS_UINT numGaMsgsSent;     /*Total number of answer message sent*/
     ITS_UINT numGqMsgsRecv;     /*Total number of request message received*/
     ITS_UINT numGaMsgsRecv;     /*Total number of answer message received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const GyStats& gyStats);
