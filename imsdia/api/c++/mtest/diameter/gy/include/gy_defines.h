 ...
 ****************************************************************************
 *
 * LOG: $Log: gy_defines.h,v $
 * LOG: Revision 1.1  2011/03/10 09:27:34  vkumara
 * LOG: Sample Demo for Gy Interface
 * LOG:
 * LOG:
 *
 * ID: $Id: gy_defines.h,v 1.1 2011/03/10 09:27:34 vkumara Exp $
 ****************************************************************************/
#ident "$Id: gy_defines.h,v 1.1 2011/03/10 09:27:34 vkumara Exp $"

#ifndef _SAMPLE_GYAPP_DEFINE
#define _SAMPLE_GYAPP_DEFINE
...
/** 
 * The Application Worker Queue Id for Gy interface
 * (Worker: Thread with an associated TaskQueue)
 **/
#define GY_APP_TQ_INST           1

/** 
 * Standard CommandCode's defined by IANA
 * For Gy Interface
 **/
#define GY_CC_MSG_CMD_CODE        272
#define GY_AC_MSG_CMD_CODE        271
#define GY_RA_MSG_CMD_CODE        258
 ...
 ****************************************************************************
 *  Purpose: 
 *      Utility functions to send the Gy Protocol messages to 
 *      the diameter stack. These will create the appropriate Gy protocol 
...
extern int SendGyCreditControlRequest(int requestType,
                               const diameter::CommandImpl* impl = NULL);
extern int SendGyACRequest(int requestType,const diameter::CommandImpl* impl = NULL);
extern int SendGyRARequest();
 ...
 *  See Also:
 ****************************************************************************/
extern int SendGyCreditControlAnswer(const diameter::CommandImpl* impl );
extern int SendGyACAnswer(const diameter::CommandImpl *impl);
extern int SendGyRAAnswer(const diameter::CommandImpl *impl);

/*  implementation: public
 ****************************************************************************
 *  Purpose: 
 *      Utility functions to populate the Gy Protocol grouped AVPs. 
 *      These will populate the appropriate Gy protocol 
