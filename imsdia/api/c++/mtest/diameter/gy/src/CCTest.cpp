 ...
 * LOG:
 *
 * ID: $Id: CCTest.cpp,v 1.1 2011/03/10 09:27:34 vkumara Exp $
 ****************************************************************************/
...
{
    return SendGyCreditControlRequest(INITIAL);
}
 ...
 *  See Also:
 ****************************************************************************/
int SendGyCreditControlRequest(int requestType,
                               const diameter::CommandImpl* impl)
{
    ...
    AuthApplicationId authApplicationId(GY_INTERFACE_APP_ID);
    ...
    GyStats::GetGyStats()->UpdateSendStats(ccr.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
 ...
 *  See Also:
 ****************************************************************************/
int SendGyCreditControlAnswer(const diameter::CommandImpl* impl ) 
{
    ...
    GyStats::GetGyStats()->UpdateSendStats(cca.getCommandCode(),
                                                            ITS_FALSE);
          ...
          (PSFurnishChargingInformation &psFurnishChrgInfo)
{
    ...
    Gy3GPPChargingId ps3gppChargingId(1500u);
    psFurnishChrgInfo.setGy3GPPChargingId(ps3gppChargingId);
...
void PopulatePSInformation(PSInformation &psInfo) 
{
    ...
    // GGSN-Address constitutes a unique identifier for the PDP context).
    // The AVP Code for 3GPP-Charging-Id is 2
    Gy3GPPChargingId ims3gppChargingId(1500u); 
    psInfo.setGy3GPPChargingId(ims3gppChargingId);
    ...
    Gy3GPPPDPType ims3gppPdpType(1);
    psInfo.setGy3GPPPDPType(ims3gppPdpType);
    ...
    Gy3GPPIMSIMCCMNC imsiMccMnc("091080");
    psInfo.setGy3GPPIMSIMCCMNC(imsiMccMnc);
    ...
    Gy3GPPGGSNMCCMNC ggsnMccMnc("091040");
    psInfo.setGy3GPPGGSNMCCMNC(ggsnMccMnc);
    ...
    Gy3GPPNSAPI imsNSAPI("34"); // not clear
    psInfo.setGy3GPPNSAPI(imsNSAPI);
    ...
    Gy3GPPSessionStopIndicator sessStopInd("FF"); // not clear
    psInfo.setGy3GPPSessionStopIndicator(sessStopInd);
    ...
    Gy3GPPSelectionMode selectMode("FC"); // not clear
    psInfo.setGy3GPPSelectionMode(selectMode);
    ...
    Gy3GPPChargingCharacteristics chargingCharacter("F40F"); // not clear
    psInfo.setGy3GPPChargingCharacteristics(chargingCharacter);
    ...
    Gy3GPPSGSNMCCMNC sgsnMccMnc("091044");
    psInfo.setGy3GPPSGSNMCCMNC(sgsnMccMnc);
    ...
    Gy3GPPMSTimeZone msTimeZone("10");
    psInfo.setGy3GPPMSTimeZone(msTimeZone);
    ...
    Gy3GPPUserLocationInfo userLocation("CGI");
    psInfo.setGy3GPPUserLocationInfo(userLocation);
    ...
    Gy3GPPRATType ratType("WLAN"); 
    psInfo.setGy3GPPRATType(ratType);
...
void PopulateSDPMediaComponent(SDPMediaComponent &sdpMediaCompo)
{
    ...
    // The AVP Code for 3GPP-Charging-Id is 2.
    Gy3GPPChargingId ims3gppChargingId(1500u); 
    sdpMediaCompo.setGy3GPPChargingId(ims3gppChargingId);
...
void PopulateOriginatorAddress(OriginatorAddress &origAddr) 
{
    ...
    // The AVP Code for 3GPP-IMSI-MCC-MNC is 8.
    Gy3GPPIMSIMCCMNC imsiMccMnc("091080"); 
    addrDomain.setGy3GPPIMSIMCCMNC(imsiMccMnc);
