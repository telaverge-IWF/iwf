 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 1.1 2011/03/10 09:27:34 vkumara Exp $
 ****************************************************************************/
#include <app.h>
...
int SendGyRARequest()
{
    ...
    diameter::gy::ReAuthRequest raReq;
    ...
    AuthApplicationId authAppId(GY_INTERFACE_APP_ID);
    ...
    GyStats::GetGyStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS; 
}
 ...
 *  See Also:
 ****************************************************************************/
int SendGyRAAnswer(const CommandImpl *impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::gy::ReAuthAnswer raAns;
    ...
    GyStats::GetGyStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
