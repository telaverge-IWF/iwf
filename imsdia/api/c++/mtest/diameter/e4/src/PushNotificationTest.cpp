 ...
 * LOG: E4 3GPP2 interface demo for static and distributed
 * LOG:
 * LOG:
 *
 * ID: $Id: PushNotificationTest.cpp,v 3.3 2010/09/22 05:44:48 vkumara Exp $
 ****************************************************************************/
#ident "$Id: PushNotificationTest.cpp,v 3.3 2010/09/22 05:44:48 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendE4PushNotificationRequest()
{
    ...
    diameter::e4::PushNotificationRequest pnReq;
    ...
    pnReq.setAccessNetworkType(accessNetworkType);
    ...
    E4Stats::GetE4Stats()->UpdateSendStats(pnReq.getCommandCode(), ITS_TRUE);
...
int SendE4PushNotificationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::e4::PushNotificationAnswer pnAns;
    ...
    E4Stats::GetE4Stats()->UpdateSendStats(pnAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
