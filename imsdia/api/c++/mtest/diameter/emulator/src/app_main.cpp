 ...
 ****************************************************************************
 *
 *  ID: $Id: app_main.cpp,v 1.1.2.2 2013/04/04 12:40:53 vsarath Exp $
 *  
 *  LOG: $Log: app_main.cpp,v $
 *  LOG: Revision 1.1.2.2  2013/04/04 12:40:53  vsarath
 *  LOG: Updated for emulator
 *  LOG:
 ...
 *
 ****************************************************************************/
#ident "$Id: app_main.cpp,v 1.1.2.2 2013/04/04 12:40:53 vsarath Exp $"
...
int AppMain(int argc, const char** argv)
{
   ...
   // Get the json file name for configuration
   char *file;
   ...
   bool status = parseJsonConfigFile(file);
   if (status == false)
   {
       cout<<"Parsing of JSON file \""<<file<<"\" failed!"<<endl;
   }
   else
   {
       cout<<"Successfully parsed JSON file \""<<file<<"\""<<endl;
   }
