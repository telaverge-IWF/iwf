 ...
 ****************************************************************************
 *
 *  ID: $Id: s9_stats.h,v 1.1 2010/04/22 11:12:53 nvijikumar Exp $
 *
 *  LOG: $Log: s9_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: s9_stats.h,v 1.1 2010/04/22 11:12:53 nvijikumar Exp $"

#if !defined(_S9APP_CCATS_H_)
#define _S9APP_CCATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class S9Stats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the S9Stats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const S9Stats& s9Stats);
