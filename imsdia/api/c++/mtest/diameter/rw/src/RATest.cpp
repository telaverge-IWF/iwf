 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 1.1 2011/07/14 11:51:38 vkumara Exp $
 ****************************************************************************/
#ident "$Id: RATest.cpp,v 1.1 2011/07/14 11:51:38 vkumara Exp $"
...
int SendRwRARequest()
{
    ...
    RwStats::GetRwStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS; 
}
 ...
 *  See Also:
 ****************************************************************************/
int SendRwRAAnswer(const CommandImpl *impl)
{
    ...
    RwStats::GetRwStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
