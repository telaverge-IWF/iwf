 ...
 * LOG:
 *
 * ID: $Id: AbortSessionTest.cpp,v 1.1 2011/07/14 11:51:38 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/07/14 11:51:38 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the RwAbortSessionRequest to the
 *      diameter stack. Create the RwAbortSessionRequest object,
 ...
 *  See Also:
 ****************************************************************************/
int SendRwAbortSessionRequest()
{
    // 1. Create an instance of RwAbortSessionRequest class
    ...
    RwStats::GetRwStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the RwAbortSession request
 *      made by the diameter stack. Create the RwAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendRwAbortSessionAnswer(const CommandImpl * impl1)
{
    // 1. Create an instance of RwAbortSessionAnswer class
    // Command-Code = 274 and 'R' bit reset
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rw::ASAnswer asAns;

    // Create an instance of AbortSessionRequest class
    ...
    RwStats::GetRwStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
