 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 1.1 2010/07/29 09:17:44 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
...
int SendRxRARequest() 
{
    ...
    diameter::rx_ts29214::RARequest raReq;
    ...
    RxStats::GetRxStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
...
int SendRxRAAnswer(const CommandImpl *impl) 
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rx_ts29214::RAAnswer raAns;
    ...
    RxStats::GetRxStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
