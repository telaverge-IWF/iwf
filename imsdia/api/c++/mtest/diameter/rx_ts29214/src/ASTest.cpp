 ...
 * LOG:
 *
 * ID: $Id: ASTest.cpp,v 1.1 2010/07/29 09:17:44 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
...
int SendRxASRequest() 
{
    ...
    diameter::rx_ts29214::ASRequest asReq;
   ...
   // [2.2.x] Optional AVPs
    ...
    RxStats::GetRxStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
...
//	asans.addProxyInfo(proxyInfo);
    ...
    RxStats::GetRxStats()->UpdateSendStats(asans.getCommandCode(), ITS_FALSE);
