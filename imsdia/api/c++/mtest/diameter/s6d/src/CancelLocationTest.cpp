 ...
 * LOG:
 * LOG:							    	
 * ID: $Id: CancelLocationTest.cpp,v 1.1 2011/05/04 10:46:01 vkumara Exp $								    
 ****************************************************************************/
 ...
 *  See Also:
 ****************************************************************************/
int SendS6DCancelLocationRequest()
{
    // [1]. Create an instance of CancelLocationRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6d::CancelLocationRequest CLReq;
    ...
    S6DStats::GetS6DStats()->UpdateSendStats(CLReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendS6DCancelLocationAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6d::CancelLocationAnswer CLAns;
    ...
    // Update stats.
    S6DStats::GetS6DStats()->UpdateSendStats(CLAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
