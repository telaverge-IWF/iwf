 ...
 * LOG:
 * LOG: 
 * ID: $Id: InsertSubscriberDataTest.cpp,v 1.1 2011/05/04 10:46:01 vkumara Exp $ 								    	
 ****************************************************************************/
#ident "$Id: InsertSubscriberDataTest.cpp,v 1.1 2011/05/04 10:46:01 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendS6DInsertSubDataRequest()
{
    // [1]. Create an instance of InsertSubscriberDataRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6d::InsertSubscriberDataRequest IDReq;
    ...
    S6DStats::GetS6DStats()->UpdateSendStats(IDReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendS6DInsertSubDataAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6d::InsertSubscriberDataAnswer IDAns;
    ...
    // Update stats.
    S6DStats::GetS6DStats()->UpdateSendStats(IDAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
