 ...
 * LOG:
 * LOG:
 * ID: $Id: PurgeUETest.cpp,v 1.1 2011/05/04 10:46:01 vkumara Exp $  
 ****************************************************************************/
#ident "$Id: PurgeUETest.cpp,v 1.1 2011/05/04 10:46:01 vkumara Exp $"
...
int SendS6DPurgeUERequest()
{
    ...
    S6DStats::GetS6DStats()->UpdateSendStats(PUReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendS6DPurgeUEAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6d::PurgeUEAnswer PUAns;
    ...
    // Update stats.
    S6DStats::GetS6DStats()->UpdateSendStats(PUAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
