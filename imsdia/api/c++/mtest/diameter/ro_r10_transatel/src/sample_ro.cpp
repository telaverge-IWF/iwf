 ...
 * LOG: Revision 1.1.2.2.8.1  2015/03/27 04:28:55  jkchaitanya
 * LOG: changes to have option to discard CCRequest and not to repond with Answer instead of delay
 * LOG:
 * LOG: Revision 1.1.2.2  2014/04/14 08:46:47  jkchaitanya
 * LOG: changes for parsing json file from current path
 * LOG:
 ...
 * LOG:
 *
 * ID: $Id: sample_ro.cpp,v 1.1.2.2.8.1 2015/03/27 04:28:55 jkchaitanya Exp $
 ****************************************************************************/
#ident "$Id: sample_ro.cpp,v 1.1.2.2.8.1 2015/03/27 04:28:55 jkchaitanya Exp $"
            ...
            switch (impl->getCommandCode())
            {
                case RO_CC_MSG_CMD_CODE:
                    if(impl->isRequest())
                    {
                        ...
                        bool isAVPEnabled = (*cfg)["DiscardRequest"]["Enabled"].asBool();
                        if(!isAVPEnabled)
                        {
