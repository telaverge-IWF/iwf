 ...
 * LOG:
 *
 * ID: $Id: RATest.cpp,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
...
int SendGxRARequest()
{
    ...
    GxStats::GetGxStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS; 
}
...
int SendGxRAAnswer(const CommandImpl *impl)
{
    ...
    GxStats::GetGxStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
