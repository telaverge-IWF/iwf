 ...
 * LOG: Revision 3.2  2010/09/07 12:27:07  vkumara
 * LOG: Updated with V 9.3.0
 * LOG:
 * LOG: Revision 3.1  2008/03/31 10:33:10  nvijikumar
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 2.6  2007/02/21 07:00:30  hbhatnagar
 * LOG: Changed the value passed to ServiceIdentifier from string to unsigned int
 * LOG:
 * LOG: Revision 2.5  2006/12/22 10:12:50  nvijikumar
 * LOG: Passing correct appId to AllocateSession API
 * LOG:
 * LOG: Revision 2.4  2006/12/19 09:06:07  kamakshilk
 * LOG: New architecture to work with static and distributed
 * LOG:
 * LOG: Revision 2.3  2006/11/02 11:21:05  kamakshilk
 * LOG: Added containsDestinationHost() before doing a get
 * LOG:
 ...
 * LOG: Start GA 1.1
 * LOG:
 * LOG: Revision 1.3  2006/09/12 09:53:26  kamakshilk
 ...
 * LOG:
 *
 * ID: $Id: CCTest.cpp,v 3.2 2010/09/07 12:27:07 vkumara Exp $
 ****************************************************************************/
#include <app.h>
...
int SendGxCCRequest() 
{
    ...
    {
    AllocateSession(GX_INTERFACE_APP_ID,sIdx,sessIdString);
    ...
    GxStats::GetGxStats()->UpdateSendStats(ccReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
...
int SendGxCCAnswer(const diameter::CommandImpl* impl)
{
    ...
    GxStats::GetGxStats()->UpdateSendStats(ccAns.getCommandCode(), ITS_FALSE);
