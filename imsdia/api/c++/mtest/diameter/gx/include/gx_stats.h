 ...
 ****************************************************************************
 *
 *  ID: $Id: gx_stats.h,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $
 *
 *  LOG: $Log: gx_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: gx_stats.h,v 3.1 2008/03/31 10:33:10 nvijikumar Exp $"

#if !defined(_GXAPP_CCATS_H_)
#define _GXAPP_CCATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class GxStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the GxStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const GxStats& gxStats);
