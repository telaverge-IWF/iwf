 ...
 ****************************************************************************
 *
 * LOG: $Log: swa_stats.h,v $
 * LOG: Revision 1.1  2011/04/27 12:24:40  vkumara
 * LOG: Draft for SWa interface.
 * LOG:
 * LOG:
 ****************************************************************************/
#ident "$Id: swa_stats.h,v 1.1 2011/04/27 12:24:40 vkumara Exp $"


#if !defined(_SWA__SWATS_H_)
#define _SWA_SWATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class SWaStats: public DiaStats
{
public:
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const SWaStats& nasreqStats);
