 ...
 * LOG:
 *
 * ID: $Id: CCTest.cpp,v 3.2 2010/06/24 08:35:58 nvijikumar Exp $
 ****************************************************************************/
...
{
    return SendRfRoCreditControlRequest(INITIAL);
}
 ...
 *  See Also:
 ****************************************************************************/
int SendRfRoCreditControlRequest(int requestType,
                               const diameter::CommandImpl* impl)
{
    ...
    {
        num =0;
        AllocateSession(RFRO_INTERFACE_APP_ID,sIdx,sessIdString);
    ...
    RfRoStats::GetRfRoStats()->UpdateSendStats(ccr.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
 ...
 *  See Also:
 ****************************************************************************/
int SendRfRoCreditControlAnswer(const diameter::CommandImpl* impl ) 
{
    ...
    RfRoStats::GetRfRoStats()->UpdateSendStats(cca.getCommandCode(),
                                                            ITS_FALSE);
