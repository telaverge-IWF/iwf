 ...
 ****************************************************************************
 *
 *  ID: $Id: rfro_stats.h,v 3.1 2008/03/31 10:33:11 nvijikumar Exp $
 *
 *  LOG: $Log: rfro_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: rfro_stats.h,v 3.1 2008/03/31 10:33:11 nvijikumar Exp $"

#if !defined(_RFROAPP_CCATS_H_)
#define _RFROAPP_CCATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class RfRoStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the RfRoStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const RfRoStats& rfroStats);
