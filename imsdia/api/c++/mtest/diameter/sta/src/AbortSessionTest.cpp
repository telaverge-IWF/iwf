 ...
 *
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/04/27 12:01:39 vkumara Exp $"
 ...
 *      diameter stack. Create the STaAbortSessionRequest object,
 ...
 *  See Also:
 ****************************************************************************/
int SendSTaAbortSessionRequest()
{
    ...
    diameter::sta::AbortSessionRequest asReq;
    ...
    STaStats::GetSTaStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the STaAbortSession request
 *      made by the diameter stack. Create the STaAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendSTaAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::sta::AbortSessionAnswer asAns;
    ...
    STaStats::GetSTaStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
