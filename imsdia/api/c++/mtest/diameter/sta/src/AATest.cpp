 ...
 *
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/04/27 12:01:39 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the STaAARequest to the
 *      diameter stack. Create the  STaAARequest object,
...
int SendSTaAARequest()
{
    ...
    STaStats::GetSTaStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the STa AA request
 *      made by the diameter stack. Create the STa AA Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendSTaAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    STaStats::GetSTaStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
