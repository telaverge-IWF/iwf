 ...
 *
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 1.1 2011/04/27 12:01:40 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendSTaSessionTerminationRequest()
{
    ...
    diameter::sta::SessionTerminationRequest stReq(false,false);
    ...
    STaStats::GetSTaStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendSTaSessionTerminationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::sta::SessionTerminationAnswer sta(false,false);
    ...
    STaStats::GetSTaStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
