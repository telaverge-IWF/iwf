 ...
 * LOG:
 ****************************************************************************/
#ident "$Id: ReAuthTest.cpp,v 1.1 2011/04/27 12:01:39 vkumara Exp $"
...
int SendSTaReAuthRequest()
{
    ...
    STaStats::GetSTaStats()->UpdateSendStats(staReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendSTaReAuthAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::sta::ReAuthAnswer staAns;
    ...
    STaStats::GetSTaStats()->UpdateSendStats(staAns.getCommandCode(), ITS_FALSE);
