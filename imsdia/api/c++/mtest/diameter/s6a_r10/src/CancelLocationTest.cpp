 ...
 * LOG:							    	
 * ID: $Id: CancelLocationTest.cpp,v 1.1.6.2.8.1 2015/01/07 12:35:37 rsanjay Exp $								    	
 ****************************************************************************/
...
int SendS6ACancelLocationRequest()
{
    ...
    diameter::s6a_r10::CancelLocationRequest CLReq;
    ...
    // Optional AVPs
    // Set CLR Flags
     CLRFlags clrFlags(1u);
     CLReq.setCLRFlags(clrFlags);
...
int SendS6ACancelLocationAnswer(const CommandImpl * impl)
{
    ...
    Json::Value* cfg = &(*m_jsonRoot1)["CancelLocationAnswer"];
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::s6a_r10::CancelLocationAnswer CLAns;
...
int SendS6ACancelLocationRequest(string dh,string uname) 
{
    // [1]. Create an instance of CancelLocationRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    ...
    // This AVP SHOULD be placed as close to the Diameter header
    // The AVP Code of Destination-Host is 293.
    DestinationHost DestinationHost(dh); 
    CLReq.setDestinationHost(DestinationHost);
