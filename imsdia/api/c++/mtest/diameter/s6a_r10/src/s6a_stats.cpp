 ...
 * LOG:
 * LOG: Revision 1.1.2.2  2013/01/31 04:33:04  brajappa
 * LOG: deprecated ostrstream is removed and ostream is used
 * LOG:
 ...
 * LOG:
 * ID: $Id: s6a_stats.cpp,v 1.1.6.2 2014/02/12 08:06:13 millayaraja Exp $
 ***************************************************************************/
 ...
 ****************************************************************************/
void
S6AStats::CalcTPS(std::ostream& oss)
{
    Print(oss);
