 ...
 ****************************************************************************
 *
 * LOG: $Log: a4_stats.h,v $
 * LOG: Revision 1.1  2011/06/29 06:39:46  vkumara
 * LOG: Baseline for a4 interface.
 * LOG:
 * LOG:
 * ID: $Id: a4_stats.h,v 1.1 2011/06/29 06:39:46 vkumara Exp $
 ****************************************************************************/
 #ident "$Id: a4_stats.h,v 1.1 2011/06/29 06:39:46 vkumara Exp $"


#if !defined(_A4APP_STATS_H_)
#define _A4APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class A4Stats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the A4Stats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const A4Stats& shStats);
