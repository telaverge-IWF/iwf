 ...
 * LOG:
 * LOG:
 * ID: $Id: UserDataTest.cpp,v 1.1 2011/06/29 06:39:46 vkumara Exp $
 ****************************************************************************/
#ident "$Id: UserDataTest.cpp,v 1.1 2011/06/29 06:39:46 vkumara Exp $"
...
int SendA4UserDataRequest()
{
   ...
   // [2.1.2.x] Required AVPs
    ...
    // This AVP A4OULD be placed as close to the Diameter header as possible.
  ...
  //    cin >> ipAddress ;
    ...
    cout<<endl<<"UDR : "<< udReq <<endl;

    // Send object to stack.
    SendDiaAppMsg(udReq, sIdx);

   A4Stats::GetA4Stats()->UpdateSendStats(udReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendA4UserDataAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::a4::UserDataAnswer udAns;
 ...
 //  udAns.setAccessNetworkType(accessNetworkType);
  ...
  //  cin >> ipAddress ;
    ...
    if (appMode == UNIT_TEST)
    cout<<endl<<"UDA : "<< udAns <<endl;

    // Send Object to stack.
    SendDiaAppMsg(udAns, sIdx);

    // Update stats.
    A4Stats::GetA4Stats()->UpdateSendStats(udAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
