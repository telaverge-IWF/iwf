 ...
 ****************************************************************************
 *
 * LOG: $Log: rr_requestmodel_stats.h,v $
 * LOG: Revision 1.1  2011/06/29 06:33:13  vkumara
 * LOG: Baseline for rr_requestmodel interface.
 * LOG:
 * LOG:
 * ID: $Id: rr_requestmodel_stats.h,v 1.1 2011/06/29 06:33:13 vkumara Exp $
 ****************************************************************************/
#ident "$Id: rr_requestmodel_stats.h,v 1.1 2011/06/29 06:33:13 vkumara Exp $"


#if !defined(_RR_REQUESTMODEL__STATS_H_)
#define _RR_REQUESTMODEL_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class Rr_requestmodelStats: public DiaStats
{
public:
     ...
     *  See Also:
     *************************************************************************/
     static Rr_requestmodelStats* GetRr_requestmodelStats();
...
private:
     ...
     *  See Also:
     ************************************************************************/
     Rr_requestmodelStats(const Rr_requestmodelStats&);
     ...
     ************************************************************************/
     Rr_requestmodelStats&
     operator=(const Rr_requestmodelStats&);
};
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const Rr_requestmodelStats& nasreqStats);
