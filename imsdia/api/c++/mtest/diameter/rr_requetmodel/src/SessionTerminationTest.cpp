 ...
 * LOG:
 *
 * ID: $Id: SessionTerminationTest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_requestmodelSTRequest()
{
    // 1. Create an instance of SessionTerminationRequest class
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_requestmodel::STRequest stReq(false,false);

    // 2. Create the instances of the classes describing the various
    // AVPs' present in an SessionTerminationRequest command and
    // pass them by value to the corresponding data members set
    // methods of the SessionTerminationRequest object created
    // in step 1.
    ...
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendRr_requestmodelSTAnswer(const CommandImpl * impl1)
{
    // 1. Create an instance of SessionTerminationAnswer class
    // The Session-Termination-Answer command is sent by a server
    // in response to the Session-Termination-Request command with
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_requestmodel::STAnswer sta(false,false);
    ...
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
