 ...
 * LOG:
 *
 * ID: $Id: AATest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the Rr_requestmodelAARequest to the
 *      diameter stack. Create the  Rr_requestmodelAARequest object,
...
int SendRr_requestmodelAARequest()
{
    ...
    AllocateSession(RR_REQUESTMODEL_INTERFACE_APP_ID, sIdx, sessIdString);
    ...
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the Rr_requestmodel AA request
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_requestmodelAAAnswer(const CommandImpl * impl)
{
    // 1. Create an instance of Rr_requestmodelAAAnswer class
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_requestmodel::AAAnswer aaAns;

    // Create an instance of Rr_requestmodelAARequest class to get host and
    // session details
...
//    const AuthSessionState &authSessState = aareq.getAuthSessionState();
    ...
    // Update stats.
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
