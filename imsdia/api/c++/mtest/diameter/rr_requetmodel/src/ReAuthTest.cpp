 ...
 * LOG:
 *
 * ID: $Id: ReAuthTest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $
 ****************************************************************************/
#ident "$Id: ReAuthTest.cpp,v 1.1 2011/06/29 06:33:13 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_requestmodelRARequest()
{
    // [1]. create an instance of ReAuthRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::rr_requestmodel::RARequest raReq;
   ...
   // The Specific-Action AVP (AVP code 513) is of type Enumerated.
    ...
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendRr_requestmodelRAAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::rr_requestmodel::RAAnswer raAns;
    ...
    Rr_requestmodelStats::GetRr_requestmodelStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
