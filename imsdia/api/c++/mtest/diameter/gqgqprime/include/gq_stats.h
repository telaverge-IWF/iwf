 ...
 ****************************************************************************
 *
 *  ID: $Id: gq_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $
 *
 *  LOG: $Log: gq_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: gq_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $"

#if !defined(_GQGQAPP_STATS_H_)
#define _GQGQAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class GqgqStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the GqgqStats object pointer.
...
private:
     ...
     */
     ...
     ITS_UINT numASRSent;        /*Number of Abort Session Request sent*/
     ITS_UINT numASASent;        /*Number of Abort Session Answer sent*/
     ITS_UINT numASRRecv;        /*Number of Abort Session Request received*/
     ITS_UINT numASARecv;        /*Number of Abort Session Answer received*/
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const GqgqStats& gqgqStats);
