 ...
 * LOG:
 *
 * ID: $Id: sample_sender.cpp,v 1.1.2.1 2013/01/28 15:54:23 pramana Exp $
 ****************************************************************************/
#ident "$Id: sample_sender.cpp,v 1.1.2.1 2013/01/28 15:54:23 pramana Exp $"
...
void DisplayThreadFunc2(its::ThreadPoolThread* thr, void* arg)
{
    ...
    while (1)
    {
        ...
        if (displayMode == 0)
        {
            ...
            DISPLAY_TXT_COL (" ", "5. Total rejected messages ",   appStats.m_failedCalls);
            DISPLAY_EMPTY_LINE ();
            DISPLAY_LINE();
            DISPLAY_LINE();
            DISPLAY_EMPTY_LINE ();
