 ...
 * LOG: 
 *
 * ID: $Id: eap_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: eap_stats.h,v 3.1 2008/03/31 10:33:09 nvijikumar Exp $"

#if !defined(_EAP_3GPP2APP_STATS_H_)
#define _EAP_3GPP2APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class EapStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the EapStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const EapStats& eapStats);
