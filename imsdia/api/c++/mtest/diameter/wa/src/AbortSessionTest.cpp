 ...
 *
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/04/18 09:44:11 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the WaAbortSessionRequest to the
...
int SendWaAbortSessionRequest()
{
    ...
    diameter::wa::AbortSessionRequest asReq;
    ...
    WaStats::GetWaStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the WaAbortSession request
 *      made by the diameter stack. Create the WaAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendWaAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::wa::AbortSessionAnswer asAns;
    ...
    WaStats::GetWaStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
