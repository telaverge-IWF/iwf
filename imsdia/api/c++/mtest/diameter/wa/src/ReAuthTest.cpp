 ...
 * LOG:
 ****************************************************************************/
#ident "$Id: ReAuthTest.cpp,v 1.1 2011/04/18 09:44:11 vkumara Exp $"
...
int SendWaReAuthRequest()
{
    ...
    WaStats::GetWaStats()->UpdateSendStats(raReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendWaReAuthAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::wa::ReAuthAnswer raAns;
    ...
    WaStats::GetWaStats()->UpdateSendStats(raAns.getCommandCode(), ITS_FALSE);
