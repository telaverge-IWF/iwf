 ...
 * LOG:
 *
 * ID: $Id: ACTest.cpp,v 1.2 2011/04/25 05:28:03 nvijikumar Exp $
 ****************************************************************************/
#include <app.h>
 ...
 *  See Also:
 ****************************************************************************/
int SendWaACRequest(int reqType, const diameter::CommandImpl* impl)
{
    ...
    // Authorization portion of an application
    // The AVP Code of Auth-Application-Id is 258.
    AuthApplicationId authId(WA_INTERFACE_APP_ID);
    ...
    WaStats::GetWaStats()->UpdateSendStats(acr.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
 ...
 *  See Also:
 ****************************************************************************/
int SendWaACAnswer(const CommandImpl *impl)
{
    ...
    WaStats::GetWaStats()->UpdateSendStats(aca.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS; 
