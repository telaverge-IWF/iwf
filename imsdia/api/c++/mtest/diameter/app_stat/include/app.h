 ...
 *
 * LOG: $Log: app.h,v $
 * LOG: Revision 3.2.42.1.8.1  2014/02/12 07:05:29  millayaraja
 * LOG: changes done for conditional compilation for IWF/DRE and IWF specific changes
 * LOG:
 * LOG: Revision 3.2.42.1  2013/04/07 03:58:51  cprem
 ...
 *
 ****************************************************************************/
#ident "$Id: app.h,v 3.2.42.1.8.1 2014/02/12 07:05:29 millayaraja Exp $"
...
#ifdef FOR_IWF
extern std::string sessionIdForCallFlow;
extern ITS_UINT opfromserv;
#endif
