 ...
 ****************************************************************************
 *
 *  ID: $Id: app_common.cpp,v 3.3.70.2.4.1 2013/07/31 07:30:02 vsarath Exp $
 *
 *  LOG: $Log: app_common.cpp,v $
 *  LOG: Revision 3.3.70.2.4.1  2013/07/31 07:30:02  vsarath
 *  LOG: Fix for coverity warnings
 *  LOG:
 *  LOG: Revision 3.3.70.2  2013/04/07 03:58:51  cprem
 *  LOG: Changes made to fix test-tool crash during switchover of DRE
 *  LOG:
 *  LOG: Revision 3.3.70.1  2013/02/27 08:49:06  jvikram
 ...
 *
 ****************************************************************************/
#ident "$Id: app_common.cpp,v 3.3.70.2.4.1 2013/07/31 07:30:02 vsarath Exp $"
#include <iostream>
#include <its++.h>
...
int ReadDump()
{
    ...
    //Coverity Issue fix - 10953 - Resource leak
    fclose(fp);
    return size;
}
