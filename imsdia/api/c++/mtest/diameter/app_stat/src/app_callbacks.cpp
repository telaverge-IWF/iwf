 ...
 * LOG: Revision 3.2.64.1.6.1  2014/10/28 11:52:12  jkchaitanya
 * LOG: commented out the socket binding implemented for simulex
 * LOG:
 * LOG: Revision 3.2.64.1  2014/02/12 07:07:15  millayaraja
 ...
 * LOG:
 *
 * ID: $Id: app_callbacks.cpp,v 3.2.64.1.6.1 2014/10/28 11:52:12 jkchaitanya Exp $
 ****************************************************************************/
#ident "$Id: app_callbacks.cpp,v 3.2.64.1.6.1 2014/10/28 11:52:12 jkchaitanya Exp $"
...
//    RegisterApplicationWithStack(regAppId);
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        if (work)
        {
            ret = workerPool->DispatchOnThread(ent,  (ITS_ThreadCallFunc)ScenarioRecvThreadFunc, NULL);
