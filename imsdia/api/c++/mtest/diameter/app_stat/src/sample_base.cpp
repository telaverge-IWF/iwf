 ...
 * LOG:
 *
 * ID: $Id: sample_base.cpp,v 3.4.92.1 2014/02/12 07:07:15 millayaraja Exp $
 ****************************************************************************/
#ident "$Id: sample_base.cpp,v 3.4.92.1 2014/02/12 07:07:15 millayaraja Exp $"
...
int SendReAuthRequest() 
{
    ...
    if(opfromserv == 8)
    {
        //NOTE: To simulate RAR case for CallFlow 8 
        rar.setSessionId(SessionId(sessionIdForCallFlow));
    }
    else
    {
