 ...
 * LOG: Revision 3.8.44.1.8.1  2014/02/12 07:07:15  millayaraja
 * LOG: changes done for conditional compilation for IWF/DRE and IWF specific changes
 * LOG:
 * LOG: Revision 3.8.44.1  2013/02/21 11:58:50  ncshivakumar
 * LOG: iremoved 3rd parameter from SetLocalHostInfo as it does not accept ip address now
 * LOG:
 ...
 * LOG:
 *
 * ID: $Id: app_mml.cpp,v 3.8.44.1.8.1 2014/02/12 07:07:15 millayaraja Exp $
 ****************************************************************************/
