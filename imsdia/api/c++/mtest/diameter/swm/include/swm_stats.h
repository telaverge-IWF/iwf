 ...
 ****************************************************************************
 *
 * LOG: $Log: swm_stats.h,v $
 * LOG: Revision 1.1  2011/05/03 04:54:00  vkumara
 * LOG: SWm interface support.
 * LOG:
 * LOG:
 ****************************************************************************/
#ident "$Id: swm_stats.h,v 1.1 2011/05/03 04:54:00 vkumara Exp $"


#if !defined(_SWM__SWMTS_H_)
#define _SWM_SWMTS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class SWmStats: public DiaStats
{
public:
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const SWmStats& nasreqStats);
