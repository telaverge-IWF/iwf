 ...
 *
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 1.1 2011/05/03 04:54:00 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the SWmAARequest to the
 *      diameter stack. Create the  SWmAARequest object,
...
int SendSWmAARequest()
{
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(aaReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the SWm AA request
 *      made by the diameter stack. Create the SWm AA Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendSWmAAAnswer(const CommandImpl * impl)
{
    ...
    // Update stats.
    SWmStats::GetSWmStats()->UpdateSendStats(aaAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
