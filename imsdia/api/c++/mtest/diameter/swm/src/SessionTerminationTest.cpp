 ...
 *
 ****************************************************************************/
#ident "$Id: SessionTerminationTest.cpp,v 1.1 2011/05/03 04:54:00 vkumara Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendSWmSessionTerminationRequest()
{
    ...
    diameter::swm::SessionTerminationRequest stReq(false,false);
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(stReq.getCommandCode(),
                                                                ITS_TRUE);
    return ITS_SUCCESS;
}
...
int SendSWmSessionTerminationAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swm::SessionTerminationAnswer sta(false,false);
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(sta.getCommandCode(), ITS_FALSE);
    return (ITS_SUCCESS);
}
