 ...
 *
 ****************************************************************************/
#ident "$Id: AbortSessionTest.cpp,v 1.1 2011/05/03 04:54:00 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the StaAbortSessionRequest to the
 *      diameter stack. Create the SWmAbortSessionRequest object,
 ...
 *  See Also:
 ****************************************************************************/
int SendSWmAbortSessionRequest()
{
    ...
    diameter::swm::AbortSessionRequest asReq;
    ...
    UserName userName("user@swm-network.com");
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(asReq.getCommandCode(), ITS_TRUE);
...
/*.implementation:public
 ****************************************************************************
 *  Purpose: This function sends the Answer to the SWmAbortSession request
 *      made by the diameter stack. Create the SWmAbortSession Answer
 ...
 *  See Also:
 ****************************************************************************/
int SendSWmAbortSessionAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swm::AbortSessionAnswer asAns;
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(asAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
