 ...
 *
 ****************************************************************************/
#ident "$Id: DiameterEAPTest.cpp,v 1.1 2011/05/03 04:54:00 vkumara Exp $"
 ...
 ****************************************************************************
 *  Purpose: This function sends the  SWmDiameterEAPRequest to the
 *      diameter stack. Create the  SWmDiameterEAPRequest object,
...
int SendSWmDiameterEAPRequest()
{
    ...
    AllocateSession(SWM_INTERFACE_APP_ID, sIdx, sessIdString);
    ...
    SWmStats::GetSWmStats()->UpdateSendStats(staDerReq.getCommandCode(), ITS_TRUE);
    return ITS_SUCCESS;
}
/*.implementation:public
 ****************************************************************************
 *  Purpose:
 *      This function sends the Answer to the SWmDiameterEAPRequest 
 *      made by the diameter stack. Create the SWmDiameterEAPAnswer
 ...
 *  See Also:
 ****************************************************************************/
int SendSWmDiameterEAPAnswer(const CommandImpl * impl)
{
    ...
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::swm::DiameterEAPAnswer staDerAns;
    ...
    // Update stats.
    SWmStats::GetSWmStats()->UpdateSendStats(staDerAns.getCommandCode(), ITS_FALSE);
    return ITS_SUCCESS;
}
