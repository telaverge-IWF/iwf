 ...
 * LOG:
 *
 * ID: $Id: cx_stats.h,v 3.1 2008/03/31 10:33:07 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: cx_stats.h,v 3.1 2008/03/31 10:33:07 nvijikumar Exp $"

#if !defined(_CX_3GPP2APP_STATS_H_)
#define _CX_3GPP2APP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class CxStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the CxStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const CxStats& cxStats);
