 ...
 * LOG:
 *
 * ID: $Id: PushProfileTest.cpp,v 3.1 2008/03/31 10:33:07 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: PushProfileTest.cpp,v 3.1 2008/03/31 10:33:07 nvijikumar Exp $"
 ...
 *  See Also:
 ****************************************************************************/
int SendCxPushProfileRequest()
{
    // [1]. create an instance of PushProfileRequest.
    // Optional param error - whether this command carries an error indicator.
    // Optional param retrans - whether this is a retransmission.
    diameter::cx_3gpp2::PushProfileRequest ppReq;
    ...
    ppReq.setSessionId(diameter::base::SessionId(sessIdString));

    ppReq.setSessionIndex(sIdx);
   ...
   // Create a Vendor-Specific-Application-Id AVP object
    ...
    ppReq.addSupportedFeatures(supportedFeatures);

    cout<<ppReq;

    SendDiaAppMsg(ppReq, sIdx);
    CxStats::GetCxStats()->UpdateSendStats(ppReq.getCommandCode(), ITS_TRUE);
 ...
 *  See Also:
 ****************************************************************************/
int SendCxPushProfileAnswer(const CommandImpl * impl1)
{
    ...
    // Optional param error - whether this command carries an error indicator
    // Optional param retrans - whether this is a retransmission
    diameter::cx_3gpp2::PushProfileAnswer ppAns;
    ...
    const VendorSpecificApplicationId &vsAppId = 
                                 ppreq.getVendorSpecificApplicationId();
    const SupportedFeatures &supportedFeatures = ppreq.getSupportedFeatures();
    ...
    ppAns.setSessionIndex(ppreq.getSessionIndex());
    ...
    ppAns.addSupportedFeatures(supportedFeatures);

    cout<<ppAns;

    SendDiaAppMsg(ppAns, sIdx);
    CxStats::GetCxStats()->UpdateSendStats(ppAns.getCommandCode(), ITS_FALSE);
