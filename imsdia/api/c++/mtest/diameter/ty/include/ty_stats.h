 ...
 ****************************************************************************
 *
 *  ID: $Id: ty_stats.h,v 3.1 2008/03/31 10:33:13 nvijikumar Exp $
 *
 *  LOG: $Log: ty_stats.h,v $
 ...
 *
 ****************************************************************************/
#ident "$Id: ty_stats.h,v 3.1 2008/03/31 10:33:13 nvijikumar Exp $"

#if !defined(_TY_APP_STATS_H_)
#define _TYAPP_STATS_H_

#include <strstream>
#include <sys/timeb.h>
#include <dia_stats.h>

class TyStats: public DiaStats
{
public:
     ...
     *
     *  Return Value:
     *      Returns the TyStats object pointer.
 ...
 *  See Also:
 ************************************************************************/
std::ostream& operator<< (std::ostream& os, const TyStats& tyStats);
