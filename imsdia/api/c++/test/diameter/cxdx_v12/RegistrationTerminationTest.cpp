...
void testRegistrationTerminationRequest() {
    diameter::cxdx_v12::RegistrationTerminationRequest request;
...
void testRegistrationTerminationAnswer() {
    diameter::cxdx_v12::RegistrationTerminationAnswer answer;
    ...
    answer.addIdentitywithEmergencyRegistration(IdentitywithEmergencyRegistration(...));
