...
void testCreditControlRequest() {
    diameter::ro_r10_transatel::CreditControlRequest request;
...
void testCreditControlAnswer() {
    diameter::ro_r10_transatel::CreditControlAnswer answer;
    ...
    answer.setServiceControl(diameter::transatel_custom_avps::ServiceControl(...));
    // add more AVP as ANY values
}
