...
#include <diameter/s6a_r11/AuthenticationInformation.h>

void testAuthenticationInformationRequest() {
    diameter::s6a_r11::AuthenticationInformationRequest request;
...
void testAuthenticationInformationAnswer() {
    diameter::s6a_r11::AuthenticationInformationAnswer answer;
