...
#include <diameter/s6a_r11/CancelLocation.h>

void testCancelLocationRequest() {
    diameter::s6a_r11::CancelLocationRequest request;
...
void testCancelLocationAnswer() {
    diameter::s6a_r11::CancelLocationAnswer answer;
