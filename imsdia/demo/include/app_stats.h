 ...
 ****************************************************************************
 *
 *  ID: $Id: app_stats.h,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $
 *
 ...
 *  LOG: Start GA 1.1
 *  LOG:
 *  LOG: Revision 1.4  2006/06/08 09:53:41  yranade
 *  LOG: Missing inits
 *  LOG:
 *  LOG: Revision 1.3  2006/06/07 15:02:02  tpanda
 *  LOG: Code added for Load test
 *  LOG:
 *  LOG: Revision 1.2  2006/04/25 15:20:57  nvijikumar
 *  LOG: Code Enhancements (Documentation, Flowerboxes)
 *  LOG:
 *  LOG: Revision 1.1  2006/04/17 16:05:36  yranade
 *  LOG: Interface to collect statistics.
 *  LOG:
 *
 ****************************************************************************/
#ident "$Id: app_stats.h,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $"

#if !defined(_APP_STATS_H_)
#define _APP_STATS_H_
