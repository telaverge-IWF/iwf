 ...
 ****************************************************************************
 *
 *  ID: $Id: app_common.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $
 *
 ...
 *
 ****************************************************************************/
#ident "$Id: app_common.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $"
...
SendToStack(Command* impl)
{
    ...
    APPStats::GetAPPStats()->UpdateSendStats(impl->getCommandCode(), isReq);
