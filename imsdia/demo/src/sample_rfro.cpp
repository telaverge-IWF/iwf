 ...
 * LOG:
 *
 * ID: $Id: sample_rfro.cpp,v 3.1 2008/03/31 10:33:24 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: sample_rfro.cpp,v 3.1 2008/03/31 10:33:24 nvijikumar Exp $"
...
void PopulatePSInformation(PSInformation &psInfo) 
{
    ...
    // [1.1.4] Populate optional parameter 3GPP-GPRS-Negotiated-QoS-Profile. 
    // Set 3GPP-GPRS-Negotiated-QoS-Profile AVP.
    // The data type of 3GPP-GPRS-Negotiated-QoS-Profile is UTF8String.
    // This QoS Profile applied by GGSN.
    // syntax:"<Release indication><realese specific QoS IE UTF8 encoding>"
    // Refer TS 29.061 and 24.008
    // The AVP Code for 3GPP-GPRS-Negotiated-QoS-Profile is 5.
    RfRo3GPPGPRSNegotiatedQoSProfile
           gprsQoSProf("05040c3f571feaff4040fffd3f3f11");
    psInfo.setRfRo3GPPGPRSNegotiatedQoSProfile(gprsQoSProf);
    ...
    // [1.1.17] Populate optional parameter 3GPP-CAMEL-Charging-Info. 
    // Set 3GPP-CAMEL-Charging-Info AVP.
    // The data type of 3GPP-CAMEL-Charging-Info is OctetString.
    // This is used to copy any CAMEL information present in S-CDR(s).
    // Refer 3GPP TS 29.060 (7.7.17)
    // The AVP Code for 3GPP-CAMEL-Charging-Info is 24.
    RfRo3GPPCAMELChargingInfo camelChargingInfo("04"); // not clear
    psInfo.setRfRo3GPPCAMELChargingInfo(camelChargingInfo);
