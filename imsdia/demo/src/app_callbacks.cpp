 ...
 * LOG:
 *
 * ID: $Id: app_callbacks.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: app_callbacks.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $"
    ...
    */
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        */
        ...
        if (work)
        {
             ...
             */
            ret = workerPool->DispatchOnThread(ent, BaseThreadFunc, NULL);
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        if (work)
        {
             ...
             */
            ret = workerPool->DispatchOnThread(ent, ShThreadFunc, NULL);
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        if (work)
        {
             ...
             */
            ret = workerPool->DispatchOnThread(ent, CxDxThreadFunc, NULL);
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        if (work)
        {
            ret = workerPool->DispatchOnThread(ent, GqThreadFunc, NULL);
    ...
    if (workerPool->GetFirstAvailThread(ent) == ITS_SUCCESS)
    {
        ...
        */
        ...
        if (work)
        {
             ...
             */
            ret = workerPool->DispatchOnThread(ent, RfRoThreadFunc, NULL);
...
AppPostFunc()
{
    ...
    /*
     * Disable Diameter Stack Tracing
     */
     ...
     */
    DiaTrace::GetDiaTrace()->Delete();
    ODiaTrace::GetODiaTrace()->Delete();
