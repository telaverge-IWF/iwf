 ...
 * LOG:
 *
 * ID: $Id: sample_base.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: sample_base.cpp,v 3.1 2008/03/31 10:33:23 nvijikumar Exp $"
            ...
            try
            {
                ...
                else
                {
                   ...
                   switch (dMsg->GetMessageType())
                   {
                      ...
                      HandleIndicationWithCommand(impl);
                      break;
...
int SendAccountingRequest() 
{
    ...
    //acr.addVendorSpecificApplicationId(venSAId);
...
int SendAccountingAnswer(const CommandImpl *impl1)
{
    ...
    // The AVP Code of Accounting-Record-Type is 480.
    AccountingRecordType accr(AccountingRecordType::START_RECORD);
    aca.setAccountingRecordType(accr);
    ...
    // accounting records
    // The AVP Code of Acct-Interim-Interval is 85.
    AcctInterimInterval accInter(0u);
