 ...
 *                                                                          *
 ****************************************************************************
 * ID: $Id: app_main.cpp,v 3.1 2008/03/31 10:33:02 nvijikumar Exp $
 *
 * LOG: $Log: app_main.cpp,v $
 * LOG: Revision 3.1  2008/03/31 10:33:02  nvijikumar
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 1.5  2006/11/17 07:18:56  kamakshilk
 * LOG: Registere API and Release indication added
 * LOG:
 * LOG: Revision 1.4  2006/11/16 13:58:17  kamakshilk
 * LOG: InitDiaDictParser() API added
 * LOG:
 * LOG: Revision 1.3  2006/11/14 09:48:21  kamakshilk
        ...
        if (ev.msg_type == DIAMETER_MSG)
        {
            ...
            {        
                ...
                if(impl)
                {
                    ...
                    switch(ReceiveAppId)
                    {
                    case RX_INTERFACE_APP_ID:
                        RxMessage(impl,RecivesIdx);
                    break;
                    default:
