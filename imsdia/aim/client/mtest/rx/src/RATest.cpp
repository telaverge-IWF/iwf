 ...
 * LOG:
 * LOG:
 * ID: $Id: RATest.cpp,v 3.1 2008/03/31 10:33:02 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: RATest.cpp,v 3.1 2008/03/31 10:33:02 nvijikumar Exp $"
...
unsigned int sIdxRxRa = 0;
string sessIdStringRxRa;
IDSCLApi apiRxRa;
...
int SendRxRARequest() 
{
    ...
    AuthApplicationId authAppId(RX_INTERFACE_APP_ID);
    ...
    raReq.setSpecificAction(specAction);
    ...
    SubscriptionIdData subscriptionIdData("UserInfo");
    subscriptionId.setSubscriptionIdData(subscriptionIdData);
   
    // Set the SubscriptionId AVP.
    raReq.addSubscriptionId(subscriptionId);
    ...
    apiRxRa.Send(raReq, sIdxRxRa, RX_INTERFACE_APP_ID);
 ...
 *  See Also:
 ****************************************************************************/
int SendRxRAAnswer(const CommandImpl *impl) 
{
    ...
    apiRxRa.Send(raAns, sIdxRxRa, RX_INTERFACE_APP_ID);
