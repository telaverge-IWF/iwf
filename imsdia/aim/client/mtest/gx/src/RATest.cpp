 ...
 * LOG:
 * LOG: Revision 1.3  2006/11/17 07:06:48  kamakshilk
 * LOG: get for Optional AVPs removed
 * LOG:
 ...
 * LOG:
 * LOG:
 * ID: $Id: RATest.cpp,v 3.1 2008/03/31 10:33:01 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: RATest.cpp,v 3.1 2008/03/31 10:33:01 nvijikumar Exp $"
...
int SendGxRARequest()
{
    ...
    apiGx.Send(raReq, sIdxGx, GX_INTERFACE_APP_ID);
 ...
 *  See Also:
 ****************************************************************************/
int SendGxRAAnswer(const CommandImpl *impl)
{
    ...
    apiGx.Send(raAns, sIdxGx, GX_INTERFACE_APP_ID);
