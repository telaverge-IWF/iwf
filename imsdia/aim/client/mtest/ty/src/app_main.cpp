 ...
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 1.5  2006/11/17 07:36:13  kamakshilk
 * LOG: ReleaseSession added
 * LOG:
 * LOG: Revision 1.4  2006/11/16 13:56:37  kamakshilk
 * LOG: InitDiaDictParser() API added
 * LOG:
 * LOG: Revision 1.3  2006/11/14 09:49:21  kamakshilk
        ...
        if (ev.msg_type == DIAMETER_MSG)
        {
            ...
            {        
                ...
                if(impl)
                {
                    ...
                    switch(ReceiveAppId)
                    {
                    case TY_INTERFACE_APP_ID:
                        TyMessage(impl,RecivesIdx);
                    break;
                    default:
