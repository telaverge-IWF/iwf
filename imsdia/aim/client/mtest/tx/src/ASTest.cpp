 ...
 * LOG:
 * LOG:
 * ID: $Id: ASTest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: ASTest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $"
...
unsigned int sIdxTxAs = 0;
string sessIdStringTxAs;
IDSCLApi apiTxAs;
...
//    asreq.addRouteRecord(routeRecord);
    ...
    apiTxAs.Send(asreq, sIdxTxAs, TX_INTERFACE_APP_ID);
...
//	asans.addProxyInfo(proxyInfo);
    ...
    apiTxAs.Send(asans, sIdxTxAs, TX_INTERFACE_APP_ID);
    return (ITS_SUCCESS);
