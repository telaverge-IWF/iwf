 ...
 * LOG: Start GA 3.0
 * LOG:
 * LOG: Revision 1.5  2006/11/17 07:21:52  kamakshilk
 * LOG: Registere API and Release indication added
 * LOG:
 * LOG: Revision 1.4  2006/11/16 13:48:20  kamakshilk
 * LOG: InitDiaDictParser() API added
 * LOG:
 * LOG: Revision 1.3  2006/11/14 09:49:03  kamakshilk
        ...
        if (ev.msg_type == DIAMETER_MSG)
        {
            ...
            {        
                ...
                if(impl)
                {
                    ...
                    switch(ReceiveAppId)
                    {
                    case TX_INTERFACE_APP_ID:
                        TxMessage(impl,RecivesIdx);
                    break;
                    default:
