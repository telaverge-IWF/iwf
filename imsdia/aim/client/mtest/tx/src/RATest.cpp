...
unsigned int sIdxTxRa = 0;
string sessIdStringTxRa;
IDSCLApi apiTxRa;
...
//    rareq.addRouteRecord(routeRecord);
    ...
    apiTxRa.Send(rareq, sIdxTxRa, TX_INTERFACE_APP_ID);
    return (ITS_SUCCESS);
...
//    raans.addProxyInfo(proxyInfo);
    ...
    apiTxRa.Send(raans, sIdxTxRa, TX_INTERFACE_APP_ID);
