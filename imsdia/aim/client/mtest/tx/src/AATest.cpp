 ...
 * LOG:
 * LOG:
 * ID: $Id: AATest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: AATest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $"
...
unsigned int sIdxTxAa = 0;
string sessIdStringTxAa;
IDSCLApi apiTxAa;
...
int SendTxAARequest()
{
    ...
    apiTxAa.AllocateSessionIndex(10000, sIdxTxAa, sessIdStringTxAa);
    aareq.setSessionId(SessionId(sessIdStringTxAa));
    ...
    // Send Encoded Message to the IDS.

    std::cout << aareq << std::endl;

    apiTxAa.Send(aareq, sIdxTxAa, TX_INTERFACE_APP_ID);
...
int SendTxAAAnswer(const CommandImpl * impl1)
{
    ...
    apiTxAa.Send(aaans, sIdxTxAa, TX_INTERFACE_APP_ID);
