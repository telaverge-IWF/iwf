 ...
 * LOG:
 * LOG:
 * ID: $Id: ServerAssignmentTest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $
 ****************************************************************************/
#ident "$Id: ServerAssignmentTest.cpp,v 3.1 2008/03/31 10:33:03 nvijikumar Exp $"
...
unsigned int sIdxWxSa = 0;
string sessIdStringWxSa;
IDSCLApi apiWxSa;
...
int SendWxServerAssignmentRequest() 
{
    ...
    apiWxSa.AllocateSessionIndex(10000, sIdxWxSa, sessIdStringWxSa);
    saReq.setSessionId(diameter::base::SessionId(sessIdStringWxSa));
    ...
    std::cout << saReq << std::endl;

    apiWxSa.Send(saReq, sIdxWxSa, WX_INTERFACE_APP_ID);
    return ITS_SUCCESS;
}
...
int SendWxServerAssignmentAnswer(const CommandImpl * impl1) 
{
    ...
    std::cout << saAns << std::endl;

    apiWxSa.Send(saAns, sIdxWxSa, WX_INTERFACE_APP_ID);
    return ITS_SUCCESS;
}
