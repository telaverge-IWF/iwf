...
int
send_diaClearedNotification_trap(int alarmId, char *faultText)
{
...
int
send_diaWarningNotification_trap(int alarmId, char *faultText)
{
    unsigned long alarmTime;
    int alarmType;
    int probableCause;
...
int
send_diaMinorNotification_trap(int alarmId, char *faultText)
{
    unsigned long alarmTime;
    int alarmType;
    int probableCause;
...
int
send_diaMajorNotification_trap(int alarmId, char *faultText)
{
...
int
send_diaCriticalNotification_trap(int alarmId, char *faultText)
{
   unsigned long alarmTime;
    int alarmType;
    int probableCause;
...
int
send_diaInfoNotification_trap(int alarmId, char *faultText)
{
    unsigned long alarmTime;
    int alarmType;
    int probableCause;
