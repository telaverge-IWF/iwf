...
############################################################################
#
#  ID: $Id: config.vars.gnu,v 9.2 2008/06/17 06:45:04 nvijikumar Exp $
#
# LOG: $Log: config.vars.gnu,v $
# LOG: Revision 9.2  2008/06/17 06:45:04  nvijikumar
# LOG: config files modified for ITU over TTC and ITU over PRC split Stacks.
...
# LOG:
# LOG: Revision 7.2.4.3  2003/07/04 06:12:59  gururaj
# LOG: Added flag USE_HEAP for Solaris
# LOG:
# LOG: Revision 7.2.4.2  2003/03/16 04:24:35  pmandal
# LOG: add missing PROTOCOL definition to config.vars
# LOG:
# LOG: Revision 7.2.4.1  2003/03/16 04:15:22  pmandal
# LOG: add flags for shared libraries(linux platform)
# LOG:
...
ARFLAGS=   cruv
SHAREDAR=  ld
SHAREDARFLAGS=-E --whole-archive -shared -o
CP=        cp
RM=        rm -f
CC=        gcc
CXX=       g++
...
MV=        mv
INCLS=     -I. -I$(ITS_ROOT)/common/include
DEFINES=   -D$(PROTOCOL) -D_REENTRANT -DUSE_HEAP -DUSING_FLEX -DPLATFORM=$(PLATFORM) \
           -D$(PLATFORM) -DHAVE_NAMESPACES -DHAVE_STD_NAMESPACE
#
# SCCP type
#
