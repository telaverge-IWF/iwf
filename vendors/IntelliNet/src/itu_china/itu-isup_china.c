 ...
 ****************************************************************************  
 *
 *  ID: $Id: itu-isup_china.c,v 9.1 2005/03/23 12:54:57 cvsadmin Exp $
 *
 ...
 * LOG: Merge from PR6.
 * LOG:
 * LOG: Revision 6.2  2002/03/21 16:12:51  ssharma
 * LOG: Remove warnings.
 * LOG:
 * LOG: Revision 6.1  2002/02/28 16:14:39  mmiers
 * LOG: Begin PR7.
 * LOG:
 * LOG: Revision 1.3.2.2  2002/04/05 19:37:44  ssharma
 * LOG: Add parameter to timeout handling procedures.
 * LOG:
 * LOG: Revision 1.3.2.1  2002/03/22 16:22:58  ssharma
 * LOG: Fix a printf.
 * LOG:
 * LOG: Revision 1.3  2002/02/19 23:04:07  ssharma
 * LOG: Fix traces, .ini file after functional test.
 * LOG:
 * LOG: Revision 1.2  2002/02/13 21:19:15  mmiers
...
VSS7DLLAPI ITS_Class isupCHINA_VARIANT_Class = (ITS_Class)&isupCHINA_ClassRec;            
...
{
    printf("\n CHINA_SetMsgProc: mtype %x, state %x\n", msgType, state);
 ...
 ****************************************************************************/ 
int
CHINA_SetTimeoutProc(ITS_Class V_Class, HASH_Table TimeoutProcTable,
