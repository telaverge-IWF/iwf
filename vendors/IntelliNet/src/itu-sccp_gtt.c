 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-sccp_gtt.c,v 9.2 2007/01/11 12:43:38 yranade Exp $
 *
 * LOG: $Log: itu-sccp_gtt.c,v $
...
#ident "$Id: itu-sccp_gtt.c,v 9.2 2007/01/11 12:43:38 yranade Exp $"
 ...
 ****************************************************************************/
int
SCCP_GTTTranslate_CCITT(MTP3_HEADER *mtp3,
                        ...
                        ITS_SCCP_IE *ies, int ieCount)
{
    ...
    PEG_IncrPeg(CCITT_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_REQUEST);
                                               ...
                                               NULL, (void *)&data)) != ITS_SUCCESS)
    {
        ...
        SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.routingFailureNoTransAddr++;
    ...
    {
        PEG_IncrPeg(CCITT_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_FAILURE);

        /* Q752 Implementation Routing Failure No translation for this specific address */
        SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.routingFailureNoTransSpecificAddr++;
    ...
    else
    {
        *dpc = data.dpc;
        ...
        PEG_IncrPeg(CCITT_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_SUCCESS);
 ...
 ****************************************************************************/
int
SCCP_UserIntervention_CCITT(MTP3_HEADER *mtp3,
                            ITS_OCTET addrInd,
                            ITS_UINT pc, ITS_OCTET ssn,
                            ITS_OCTET *gttInfo, ITS_USHORT gttLen,
                            SCCP_ADDR* transAddr,
