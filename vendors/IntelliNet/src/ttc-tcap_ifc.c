 ...
 ****************************************************************************
 *
 *  ID: $Id: ttc-tcap_ifc.c,v 9.1 2007/01/11 12:43:41 yranade Exp $
 *
 * LOG: $Log: ttc-tcap_ifc.c,v $
...
#ident "$Id: ttc-tcap_ifc.c,v 9.1 2007/01/11 12:43:41 yranade Exp $"
 ...
 ****************************************************************************/
int
INTELLINET_SendComp_TTC(ITS_HANDLE handle, ITS_HDR *hdr, TCAP_CPT *cpt)
{
    ITS_EVENT ev;
    int ret;

    if (!LICENSE_VerifyCapability(ITS_LIC_CAP_TTC_TCAP))
    {
    ...
    ret = TRANSPORT_PutEvent(ITS_TCAP_TTC_SRC, &ev);
 ...
 ****************************************************************************/
int
INTELLINET_SendDlg_TTC(ITS_HANDLE handle, ITS_HDR *hdr, TCAP_DLG *dlg)
{
    ITS_EVENT ev;
    int ret;
    ...
    PEG_IncrPeg(TTC_TCAP_Pegs, PEG_TCAP_APP_DLG_SENT);
