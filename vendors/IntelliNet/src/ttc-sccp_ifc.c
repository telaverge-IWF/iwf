 ...
 ****************************************************************************
 *
 *  ID: $Id: ttc-sccp_ifc.c,v 9.4 2008/07/18 05:45:33 ssingh Exp $
 *
 * LOG: $Log: ttc-sccp_ifc.c,v $
 ...
 * LOG:
 * LOG: Revision 1.1.2.3  2007/02/13 04:00:58  raghavendrabk
 * LOG: Changed alarm format to put family at beginning
 * LOG:
 * LOG: Revision 1.1.2.2  2007/02/02 14:18:05  raghavendrabk
...
#ident "$Id: ttc-sccp_ifc.c,v 9.4 2008/07/18 05:45:33 ssingh Exp $"
 ...
 ****************************************************************************/
int
INTELLINET_SendSCCPEvent_TTC(ITS_HANDLE handle, ITS_OCTET type, ITS_HDR *hdr,
                               ...
                               SCCP_MSG_DESC* desc)
{
    ...
    if (!LICENSE_VerifyCapability(ITS_LIC_CAP_TTC_SCCP))
    {
        ...
        SCCP_Alarm_TTC(427, __FILE__, __LINE__, "family=%s", "TTC");
 ...
 ****************************************************************************/
int
INTELLINET_SendUOS_TTC(ITS_HANDLE handle, ITS_OCTET ni,
                         ITS_UINT pc, ITS_OCTET ssn)
{
    ...
    SCCP_Alarm_TTC(428, __FILE__, __LINE__, "family=%s:pc=%x:ssn=%x", "TTC", pc, ssn);
 ...
 ****************************************************************************/
int
INTELLINET_SendUIS_TTC(ITS_HANDLE handle, ITS_OCTET ni,
                         ITS_UINT pc, ITS_OCTET ssn)
{
    ITS_SCCP_IE lies[32];
    ITS_OCTET addrInd;
    ...
    SCCP_Alarm_TTC(429, __FILE__, __LINE__, "family=%s:pc=%x:ssn=%x", "TTC", pc, ssn);
 ...
 ****************************************************************************/
int
INTELLINET_SetCongestion_TTC(ITS_HANDLE handle,
                               ITS_UINT pc, ITS_OCTET ssn, ITS_OCTET cong)
{
    ...
    PEG_IncrPeg(TTC_SCCP_Pegs, PEG_SCCP_LOCAL_SS_CONGESTED);
    ...
    SCCP_Alarm_TTC(430, __FILE__, __LINE__, "family=%s:pc=%x:ssn=%x", "TTC", pc, ssn);
