 ...
 ****************************************************************************
 *
 * ID: $Id: itu-isup_dis.c,v 1.3.60.1 2014/09/17 07:01:58 jsarvesh Exp $
 *
 * LOG: $Log: itu-isup_dis.c,v $
 * LOG: Revision 1.3.60.1  2014/09/17 07:01:58  jsarvesh
 * LOG: Changes done for removing warnings
 * LOG:
 * LOG: Revision 1.3.54.1  2014/09/15 07:23:32  jsarvesh
 * LOG: Changes done for removing Warnings
 * LOG:
 * LOG: Revision 1.3  2007/01/11 12:43:37  yranade
 ...
 * LOG:
 * LOG: Revision 1.2  2005/07/19 09:30:13  mmanikandan
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_Register_CCITT(ISUPDIS_MESSAGE *ctxt)
{
    int i = 0;
    ITS_EVENT evt;
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_Deregister_CCITT(ISUPDIS_MESSAGE *ctxt)
{
    ITS_EVENT evt;
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_PriPostInit_CCITT(TPOOL_THREAD* thr, ITS_HANDLE hnd)
{
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_BkPostInit_CCITT(TPOOL_THREAD* thr, ITS_HANDLE hnd)
{
    ISUPBackupHand_ = hnd;
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_PriRecvMsg_CCITT(TPOOL_THREAD *thr, ITS_EVENT *event)
{
    ...
    switch (msg.msg_type)
    {
        case MTP3_MSG:
        {
            ...
            TRANSPORT_PutEvent(ITS_ISUP_CCITT_SRC, &evt);
            break;
        }
        case MANAGEMENT_MSG:
        {
        ...
        {
            return !ITS_SUCCESS;
            /* TODO : Need to handle default condition */
        }
    }
...
ISUPDIS_DLLAPI ITS_INT
ISUPDIS_BkRecvMsg_CCITT(TPOOL_THREAD *thr, ITS_EVENT *event)
{
    ITS_INT ret = ITS_SUCCESS;
    ISUPDIS_MESSAGE msg;
