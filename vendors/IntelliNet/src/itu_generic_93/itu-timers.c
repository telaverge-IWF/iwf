 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-timers.c,v 9.1 2005/03/23 12:54:58 cvsadmin Exp $
 *
 * LOG: $Log: itu-timers.c,v $
 * LOG: Revision 9.1  2005/03/23 12:54:58  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.3  2005/03/21 13:54:07  cvsadmin
 * LOG: PR6.4.2 Source Propagated to Current
 * LOG:
 * LOG: Revision 7.1.4.1.6.1  2004/01/05 10:10:45  sjaddu
 * LOG: Merged code from tcs isup branch.
 * LOG:
 * LOG: Revision 7.1.4.1.2.1  2003/11/24 06:40:44  akumar
 * LOG: bug fix cycle.
 * LOG:
 * LOG: Revision 7.1.4.1  2003/05/07 11:03:13  ssingh
 ...
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 1.4  2002/08/01 15:57:49  ssharma
 * LOG: Merge from ISUP_PR7 branch.
 * LOG:
 * LOG: Revision 1.3.2.1  2002/07/10 19:34:16  ssharma
 * LOG: Changes for redundancy.
 * LOG:
 * LOG: Revision 1.3  2002/05/22 18:37:39  mmiers
 * LOG: Add newline at end of file.  Fix parenthesis problem.
 * LOG:
 * LOG: Revision 1.2  2002/05/20 15:46:49  sjaddu
 * LOG: Merge from PR6.
 * LOG:
 * LOG: Revision 1.1.2.5  2002/04/02 23:53:54  ssharma
 * LOG: Completion of phase 2, coding standards conformance.
 * LOG:
 * LOG: Revision 1.1.2.4  2002/03/22 16:24:12  ssharma
 * LOG: Warning removal, CGRS related changes.
 * LOG:
 * LOG: Revision 1.1.2.3  2002/03/19 17:28:39  ssharma
 * LOG: Misc changes to timer traces and add RSC timer.
 * LOG:
 * LOG: Revision 1.1.2.2  2002/03/14 15:31:06  ssharma
 * LOG: Change signature of Validate_RangeStatus, add CSC state machines.
 * LOG:
 * LOG: Revision 1.1.2.1  2002/03/07 20:12:48  ssharma
...
__ISUP_StartRELTimers(ISUP_CIC_INFO *cic_rec, ISUP_OPC_DPC_INFO *config_info)
{
    ...
    if (cic_rec->cntT1 < (ITS_OCTET)max_restarts)
    {
        ...
        if (ret != ITS_SUCCESS)
        {
            ISUP_ERROR(("BLO Timers: Failed to start T1. pcic 0x%08x,"
                        " vcic %d.\n", cic_rec->pcic, cic_rec->vcic));
            return ret;
        }
        cic_rec->cntT1++;
    ...
    if (!ISUP_PndgTmrExists(cic_rec, ITS_ISUP_TIMER_T5))
    {
        ...
        if (ret != ITS_SUCCESS)
        {
            ISUP_ERROR(("BLO Timers: Failed to start T5. pcic 0x%08x,"
                        " vcic %d.\n", cic_rec->pcic, cic_rec->vcic));
            return ret;
        }
    }
