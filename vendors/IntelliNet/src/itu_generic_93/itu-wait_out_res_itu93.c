 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_out_res_itu93.c,v 9.2 2005/04/06 07:17:23 ssingh Exp $
 *
 * LOG: $Log: itu-wait_out_res_itu93.c,v $
...
/*
 * Functions for handling messages in the Wait_Outgoing_RES state for ITU93 
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an NRM received in the WAIT_OUTGOING_RES state 
 *      is done here. The message is forwarded to the application if received 
 *      from the network, or vice versa.
 *
 *  Input Parameters:
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received NRM in WAIT_OUT_RES from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_DEBUG(("Received NRM in WAIT_OUT_RES from APP, pcic 0x%08x, vcic %d.\n",
                     cic_rec->pcic, cic_rec->vcic));
        /* Send to L3 */
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    if (src == ISUP_SRC_L3_ITU)
    {
        ...
        ISUP_Alarm_CCITT(3498, __FILE__, __LINE__, "pcic %x", cic_rec->pcic);
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an UCIC received in the WAIT_OUT_RES state is done
 *      here.
 *
 *  Input Parameters:
 *      msg - the ISUP msg received by the stack as an ITS_EVENT.
