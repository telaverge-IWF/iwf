 ...
 ****************************************************************************
 *
 *  ID: $Id: ansi-slm.c,v 9.5 2008/06/04 10:30:24 ssingh Exp $  
 *
 * LOG: $Log: ansi-slm.c,v $
 * LOG: Revision 9.5  2008/06/04 10:30:24  ssingh
 * LOG: ALU porting, B-0100LX-LUSG-00 (june 04,2008 base)
 * LOG:
 * LOG: Revision 9.4  2008/05/25 17:21:10  kramesh
 * LOG: Whizible Bug Id: 916. Linkset Deactivation Issue.
 * LOG:
 * LOG: Revision 9.3  2007/01/11 12:43:35  yranade
 * LOG: Merge changes from 6.5.3 and Lucent branches
 * LOG:
 * LOG: Revision 9.2.6.5  2007/05/18 09:50:01  raghavendrabk
 * LOG: Changes for Alarm Optimisation
 * LOG:
 * LOG: Revision 9.2.6.4  2007/05/11 10:37:46  raghavendrabk
 * LOG: MTP3_Alarm_ANSI 2127 hadled properly
 * LOG:
 * LOG: Revision 9.2.6.3  2007/02/02 14:07:09  raghavendrabk
 * LOG: Parallel Stack changes for Alarms and Statistics
 * LOG:
 * LOG: Revision 9.2.6.2  2006/10/07 13:35:49  ssingh
 * LOG: BSG parallel stack support, linkset Family check added
 * LOG:
 * LOG: Revision 9.2.6.1  2005/11/11 22:50:00  randresol
...
#ident "$Id: ansi-slm.c,v 9.5 2008/06/04 10:30:24 ssingh Exp $"
 ...
 *  --------------------------------------------------------------------------
 *  kramesh    05-25-2008   BugId: 916    Linkset deactivation/reactivation  
 *                                        Issue. 
 *
 ****************************************************************************/
int
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SLM_TRIGGER_ACTIVATE_LINK_SET:      /* from MGMT */
        if ((ls = LINKSET_FindLinkSet(linkSet)) == NULL)
        {
            ...
            MTP3_Alarm_ANSI(2023, __FILE__, __LINE__, "ls=%x:family=%s", linkSet, "ANSI");
...
#if 0
		/* FixME: This procedure is used to automatically activate the links
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SLM_TRIGGER_L2_IN_SERVICE:          /* from L2 */
        /*MTP3_Alarm_ANSI(2127, __FILE__, __LINE__, "ls=%x:link=%x:family=%s", linkSet, linkCode,"ANSI"); */
        ...
        if (ln->activityState == LINK_ACTIVITY_ACTIVATING_RESTORING)
        {
           ...
           /*MTP3_Alarm_ANSI(2128, __FILE__, __LINE__,
    ...
    case SLM_TRIGGER_L2_OUT_OF_SERVICE:      /* from L2 */
        MTP3_Alarm_ANSI(2109, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
                        linkSet, linkCode, "ANSI");
    ...
    case SLM_TRIGGER_START_LINK:             /* from LSLA: from LSLR */
        if (ln->activityState == LINK_ACTIVITY_ACTIVATING_RESTORING)
        {
            ...
            MTP3_Alarm_ANSI(2105, __FILE__, __LINE__,
    ...
    case SLM_TRIGGER_T17:
        if (ln->activityState == LINK_ACTIVITY_WAIT_1)
        {
            ...
            /*MTP3_Alarm_ANSI(2106, __FILE__, __LINE__,
                           "ls=%x:link=%x:family=%s", linkSet, linkCode, "ANSI");   */
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SLM_TRIGGER_DEACTIVATE_LINK:      /* from LSAC */
        ...
        MTP3_Alarm_ANSI(2109, __FILE__, __LINE__, "ls=%x:link=%x:family=%",
                        linkSet, linkCode, "ANSI");
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SLM_TRIGGER_DETERMINE_TERMINAL:     /* from LSLA: from LSLR */
        ...
        {
            /*MTP3_Alarm_ANSI(2034, __FILE__, __LINE__, "ls=%x:link=%x:family=%s", linkSet, linkCode, "ANSI"); */
            break;
        }
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    case SLM_TRIGGER_DETERMINE_DATA_LINK:    /* from LSLA: from LSLR */
        ...
        {
            /*MTP3_Alarm_ANSI(2039, __FILE__, __LINE__, "ls=%x:link=%x:family=%s", linkSet, linkCode, "ANSI");*/
            break;
        }
    ...
    case SLM_TRIGGER_CONNECTION_ORDER:       /* from HMDT */
        ...
        if (linkSet == ITS_SS7_DEFAULT_LINK_SET)
        {
            ...
            /*MTP3_Alarm_ANSI(2040, __FILE__, __LINE__, "family=%s", "ANSI");*/
