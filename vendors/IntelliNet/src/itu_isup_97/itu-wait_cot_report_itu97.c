 ...
 *                                                                          *
 ****************************************************************************
 * ID: $Id: itu-wait_cot_report_itu97.c,v 9.1 2005/03/23 12:55:01 cvsadmin Exp
 * $
 * LOG: $Log: itu-wait_cot_report_itu97.c,v $
 ...
 * LOG:
 * LOG: Revision 1.3.2.1.6.1.12.2  2005/02/08 12:43:49  ssingh
 * LOG: Peg increament after receiving Unexpected Msg in given FSM state.
 * LOG: Bug# 1448. (Ramesh KV, Abhijit Dutta)
 * LOG:
 * LOG: Revision 1.3.2.1.6.1.12.1  2004/12/29 14:58:44  csireesh
 * LOG: ISUP OAM Changes
 * LOG:
 * LOG: Revision 1.3.2.1.6.1  2004/01/05 10:10:46  sjaddu
 * LOG: Merged code from tcs isup branch.
 * LOG:
 * LOG: Revision 1.3.2.1.2.1  2003/09/05 09:50:42  akumar
 * LOG: Modifications for msg based redundancy scheme.
 * LOG:
 * LOG: Revision 1.3.2.1  2003/05/07 11:05:31  ssingh
 * LOG: Latest Changes propped from Current to 6.3
 * LOG:
 * LOG: Revision 8.1  2003/02/13 17:44:31  yranade
 * LOG: Begin PR6.4
 * LOG:
 * LOG: Revision 1.3  2003/01/27 13:40:16  akumar
 * LOG: Fixed Error propping up in cc compiler
 * LOG:
 * LOG: Revision 1.2  2003/01/22 09:06:42  akumar
 * LOG: Added new file to handle variant 97 messages in WAIT_FOR_COT_REPORT.
 * LOG:
 *****************************************************************************/
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an LOP received in the WAIT_COT_REPORT state
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_IN_COT_REPORT from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_IN_COT_REPORT from APP, pcic 0x%08x, vcic %d.\n",
                                  cic_rec->pcic, cic_rec->vcic));
                              ...
                              ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    if (src == ISUP_SRC_L3_ITU)
    {
        ISUP_ERROR(("Rcvd Unexpected msg 0x%02x from MTP3 in WAIT_IN_COT_REPORT. "
 ...
 *      for the WAIT_IN_COT_REPORT state, based on the msgType received.
 *
 *  Input Parameters:
...
__ISUP_GetMsgProc_WaitCotReport_ITU97(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_ACM:
