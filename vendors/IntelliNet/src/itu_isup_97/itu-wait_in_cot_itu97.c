 ...
 *                                                                          *
 ****************************************************************************
 * ID: $Id: itu-wait_in_cot_itu97.c,v 9.2 2005/04/06 06:51:03 ssingh Exp $
 * LOG:$Log: itu-wait_in_cot_itu97.c,v $
 ...
 * LOG:
 * LOG:Revision 1.2.2.1.6.1.12.2  2005/02/08 12:43:49  ssingh
 * LOG:Peg increament after receiving Unexpected Msg in given FSM state.
 * LOG:Bug# 1448. (Ramesh KV, Abhijit Dutta)
 * LOG:
 * LOG:Revision 1.2.2.1.6.1.12.1  2004/12/29 14:58:44  csireesh
 * LOG:ISUP OAM Changes
 * LOG:
 * LOG:Revision 1.2.2.1.6.1  2004/01/05 10:10:46  sjaddu
 * LOG:Merged code from tcs isup branch.
 * LOG:
 * LOG:Revision 1.2.2.1.2.1  2003/09/05 09:50:42  akumar
 * LOG:Modifications for msg based redundancy scheme.
 * LOG:
 * LOG:Revision 1.2.2.1  2003/05/07 11:05:32  ssingh
 * LOG:Latest Changes propped from Current to 6.3
 * LOG:
 * LOG:Revision 8.1  2003/02/13 17:44:31  yranade
 * LOG:Begin PR6.4
 * LOG:
 * LOG:Revision 1.2  2003/01/27 13:40:16  akumar
 * LOG:Fixed Error propping up in cc compiler
 * LOG:
 * LOG:Revision 1.1  2003/01/22 09:12:33  akumar
 * LOG:Added new file to handle variant 97 messages in WAIT_IN_COT state
 * LOG:
 *****************************************************************************/
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an LOP received in the WAIT_IN_COT state
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_IN_COT from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_IN_COT from APP, pcic 0x%08x, vcic %d.\n",
                                  cic_rec->pcic, cic_rec->vcic));
 ...
 *      for the WAIT_IN_COT state, based on the msgType received.
 *
 *  Input Parameters:
...
__ISUP_GetMsgProc_WaitIncomingCot_ITU97(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_ACM:
