 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_out_rlc_itu97.c,v 9.2 2005/04/06 06:51:03 ssingh Exp $
 *
 * LOG: $Log: itu-wait_out_rlc_itu97.c,v $
 ...
 * LOG: Begin PR6.2
 * LOG:
 * LOG: Revision 1.1  2002/06/18 22:24:29  hbalimid
 * LOG: LOP handling in Wait_Out_Rlc
 * LOG:
 *
 *****************************************************************************/
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an LOP received in the WAIT_OUTGOING_RLC state
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_OUT_RLC from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_OUT_RLC from APP, pcic 0x%08x, vcic %d.\n",
                     cic_rec->pcic, cic_rec->vcic));
...
__ISUP_GetMsgProc_WaitOutgoingRlc_ITU97(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_ACM:
