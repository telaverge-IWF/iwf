 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_out_gra_itu97.c,v 9.2 2005/04/06 06:51:03 ssingh Exp $
 *
 * LOG: $Log: itu-wait_out_gra_itu97.c,v $
 ...
 * LOG:
 * LOG: Revision 7.2.4.1.2.1  2003/09/05 09:51:57  akumar
 ...
 * LOG:
 * LOG: Revision 1.1.2.1  2002/07/03 19:36:05  hbalimid
 * LOG: New state wait_out_gra added.
 * LOG:
 *****************************************************************************/
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an LOP received in the WAIT_OUTGOING_GRA state
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_OUT_GRA from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_DEBUG(("Received LOP in WAIT_OUT_GRA from APP, pcic 0x%08x, vcic %d.\n",
                     cic_rec->pcic, cic_rec->vcic));
...
__ISUP_GetMsgProc_WaitOutgoingGra_ITU97(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_ACM:
