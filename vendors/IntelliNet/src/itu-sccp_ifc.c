 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-sccp_ifc.c,v 9.3 2008/06/04 10:36:34 ssingh Exp $
 *
 * LOG: $Log: itu-sccp_ifc.c,v $
 * LOG: Revision 9.3  2008/06/04 10:36:34  ssingh
 * LOG: ALU porting, B-0100LX-LUSG-00 (june 04,2008 base)
 * LOG:
 * LOG: Revision 9.2  2007/01/11 12:43:38  yranade
 * LOG: Merge changes from 6.5.3 and Lucent branches
 * LOG:
 * LOG: Revision 9.1.10.3  2007/02/13 03:57:06  raghavendrabk
 * LOG: Changed alarm format to put family at beginning
 * LOG:
 * LOG: Revision 9.1.10.2  2007/02/02 14:25:19  raghavendrabk
...
#ident "$Id: itu-sccp_ifc.c,v 9.3 2008/06/04 10:36:34 ssingh Exp $"
 ...
 ****************************************************************************/
int
INTELLINET_SendSCCPEvent_CCITT(ITS_HANDLE handle, ITS_OCTET type, ITS_HDR *hdr,
                               ...
                               SCCP_MSG_DESC* desc)
{
    ...
    if (!LICENSE_VerifyCapability(ITS_LIC_CAP_ITU_SCCP))
    {
        ...
        SCCP_Alarm_CCITT(427, __FILE__, __LINE__, "family=%s", "CCITT");
 ...
 ****************************************************************************/
int
INTELLINET_SendUOS_CCITT(ITS_HANDLE handle, ITS_OCTET ni,
                         ITS_UINT pc, ITS_OCTET ssn)
{
    ...
    SCCP_Alarm_CCITT(428, __FILE__, __LINE__,
                      "family=%s:pc=%x:ssn=%x", "CCITT", pc, ssn);
 ...
 ****************************************************************************/
int
INTELLINET_SendUIS_CCITT(ITS_HANDLE handle, ITS_OCTET ni,
                         ITS_UINT pc, ITS_OCTET ssn)
{
    ITS_SCCP_IE lies[32];
    ITS_OCTET addrInd;
    ...
    SCCP_Alarm_CCITT(429, __FILE__, __LINE__,
                      "family=%s:pc=%x:ssn=%x", "CCITT", pc, ssn);
 ...
 ****************************************************************************/
int
INTELLINET_SetCongestion_CCITT(ITS_HANDLE handle,
                               ITS_UINT pc, ITS_OCTET ssn, ITS_OCTET cong)
{
    ...
    PEG_IncrPeg(CCITT_SCCP_Pegs, PEG_SCCP_LOCAL_SS_CONGESTED);
    ...
    SCCP_Alarm_CCITT(430, __FILE__, __LINE__,
                      "family=%s:pc=%x:ssn=%x", "CCITT", pc, ssn);
