 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-sclc.c,v 9.6.4.1.38.1 2014/09/17 07:01:58 jsarvesh Exp $
 *
 * LOG: $Log: itu-sclc.c,v $
 * LOG: Revision 9.6.4.1.38.1  2014/09/17 07:01:58  jsarvesh
 * LOG: Changes done for removing warnings
 * LOG:
 * LOG: Revision 9.6.4.1.34.1  2014/09/15 07:23:33  jsarvesh
 * LOG: Changes done for removing Warnings
 * LOG:
 * LOG: Revision 9.6.4.1  2009/03/11 05:54:02  ssodhi
 * LOG: printf -> SCCP_DEBUG
 * LOG:
 * LOG: Revision 9.6  2008/06/04 10:36:34  ssingh
 * LOG: ALU porting, B-0100LX-LUSG-00 (june 04,2008 base)
 * LOG:
 * LOG: Revision 9.5  2008/04/15 05:03:18  kramesh
 * LOG: Merged Persistent Branch Changes to current.
 * LOG:
 * LOG: Revision 9.4.2.1  2007/03/29 05:40:46  pspl
 * LOG: Rahul, Fix for SCCP reassembly timer not stopping reassembly
 * LOG:
 * LOG: Revision 9.4  2007/01/11 12:43:38  yranade
 * LOG: Merge changes from 6.5.3 and Lucent branches
 * LOG:
 * LOG: Revision 9.3.24.1  2006/09/29 14:58:43  mshanmugam
 * LOG: Propagation of redundancy modifications from Kineto Branch (kramesh).
 * LOG:
 * LOG: Revision 9.3.4.6  2007/07/27 13:08:47  kramesh
 * LOG: Ported the 16 bit pc changes from B-0100SL-CBSG-RST16 branch.
 * LOG: Ref SDS : ACC-FemtoBSG-16BitPC-SDS-GEN-V1.0
 * LOG:
 * LOG: Revision 9.3.4.5  2007/02/13 03:57:21  raghavendrabk
 * LOG: Changed alarm format to put family at beginning
 * LOG:
 * LOG: Revision 9.3.4.4  2007/02/02 14:25:39  raghavendrabk
...
#ident "$Id: itu-sclc.c,v 9.6.4.1.38.1 2014/09/17 07:01:58 jsarvesh Exp $"
                               ...
                               ITS_OCTET reason)
{
    ...
    case SCCP_MSG_LUDT:
        ...
        /* Q752 Implementation */
        /* LUDTS Sent */
        SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageLUDTSSent++;
                        ...
                        ITS_UINT pc, ITS_OCTET ssn)
{
    ...
    SCCP_DEBUG(("Intellinet Routing SCLCHandleSCRCMsg_CCITT %d \n", ssn));
    ...
    case SCCP_MSG_UDT:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageUDTRcvd++;
    ...
    case SCCP_MSG_XUDT:
       ...
       /* Q752 Implementation */
           SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageXUDTRcvd++;
            ...
            if (ies[i].param_id == SCCP_PRM_SEGMENTATION)
            {
                ...
                if (ies[i].param_data.segmentation.flags & SCCP_SEG_IS_FIRST)
                {
                                                 ...
                                                 != ITS_SUCCESS)
                    {
                         ...
                         /* Q752 Implementation */
                             SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.reassemblyErrNoReassemblySpace++;  /* 7.12 */
    ...
    case SCCP_MSG_UDTS:
        ...
        /* Q752 Implementation */ 
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageUDTSRcvd++;
    ...
    case SCCP_MSG_XUDTS:
        ...
        /* Q752 Implementation */ 
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageXUDTSRcvd++;
    ...
    case SCCP_MSG_LUDT:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageLUDTRcvd++;
    ...
    case SCCP_MSG_LUDTS:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageLUDTSRcvd++;
 ...
 *  Name      Date        Reference               Description
 *  --------------------------------------------------------------------------
 *  kramesh   27-07-07    Bug 6046		 Fix for LUDT Issue.
 *    
...
SCLCHandleAPPMsg_CCITT(ITS_EVENT* event)
{
    ...
    case SCCP_MSG_UDT:
        ...
        /* Q752 Implementation */ 
             SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageUDTSent++;
        ...
        if (mtp3 == NULL)
        {
            ...
            SCCP_Alarm_CCITT(633, __FILE__, __LINE__, "family=%s:mType=%s",
                             "CCITT", "UDT");
    ...
    case SCCP_MSG_XUDT:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageXUDTSent++;
    ...
    case SCCP_MSG_UDTS:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageUDTSSent++;
    ...
    case SCCP_MSG_XUDTS:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageXUDTSSent++;
    ...
    case SCCP_MSG_LUDT:
        ...
        /* Q752 Implementation */
            SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.messageLUDTSent++;
        ...
        if(dataLen > SCCP_LUDT_MAX)             
        {
            ...
            {
               SccpGenOmImage[omBuf.activeOm].SCCPGenPegs.segmentationErrSegFailed++; 
               return (ITS_EMISSMAND); 
            }  
