 ...
 ****************************************************************************
 *
 *  ID: $Id: prc-mtp3.c,v 1.6 2008/07/18 05:38:12 ssingh Exp $
 *
 * LOG: $Log: prc-mtp3.c,v $
 * LOG: Revision 1.6  2008/07/18 05:38:12  ssingh
 ...
 * LOG:
 * LOG: Revision 1.2.2.1  2007/07/06 07:34:07  pspl
 ...
 * LOG: Add prc files
 * LOG: 
 * LOG: Revision 1.1.4.9  2008/02/13 09:41:41  ssodhi
 * LOG: In MTP3_TransportPostInit Function, used ITS_TERM_EVENT to free
 * LOG: the event (to fix Purify Observations).
 * LOG:
 * LOG: Revision 1.1.4.8  2007/11/16 12:07:09  mshanmugam
 * LOG: to avoid more CPU utilisation in MTP3, we are not calling MTP3_TRACE_ENTRY when DEBUG is OFF
 * LOG:
 * LOG: Revision 1.1.4.7  2007/05/18 09:57:00  raghavendrabk
 * LOG: Changes for Alarm Optimisation
 * LOG:
 * LOG: Revision 1.1.4.6  2007/04/10 15:30:21  raghavendrabk
 * LOG: Check Validation for MTP3_PRC_TraceData
 * LOG:
 * LOG: Revision 1.1.4.5  2007/02/26 10:16:50  raghavendrabk
 * LOG: Fix for Pegduration timers not incrementing properly
 * LOG:
 * LOG: Revision 1.1.4.4  2007/02/06 12:02:13  ssingh
 * LOG: Fixing issue:: Accelero 6.7:: PRC links are not aligning (#5340)
 * LOG:
 * LOG: Revision 1.1.4.3  2007/02/05 06:00:36  clin
 * LOG: for MTP3_Resume, need to check each entry in ROUTE_Info, only care about
 * LOG: REMOTE_ROUTE entry
 * LOG:
 * LOG: Revision 1.1.4.2  2007/02/02 14:31:09  raghavendrabk
 ...
 * LOG:
 * LOG: Revision 9.3.8.6  2007/01/15 15:30:17  ssingh
 * LOG: taking back trigger given to OAM for mtp3 start
 * LOG:
 * LOG: Revision 9.3.8.5  2006/12/23 10:05:36  randresol
 * LOG: Modifications to allow TTC and ITU stacks to run in parallel
 * LOG:
 * LOG: Revision 9.3.8.4  2006/11/22 09:11:16  ssingh
 * LOG: moving mtp3 start to OAM/Application
 * LOG:
 * LOG: Revision 9.3.8.3  2006/09/26 06:51:08  mshanmugam
 * LOG: Removing the Q752 Compilation flag
 * LOG:
 * LOG: Revision 9.3.8.2  2006/08/18 12:25:11  mshanmugam
 * LOG: Added handling of duration related OMs for Q.752 Implementation.
 * LOG:
 * LOG: Revision 9.3.8.1  2006/04/11 09:18:49  ssingh
 * LOG: fix for Bug #3505 issue, porting from BSG 0.2+
 * LOG:
 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.11  2005/03/21 13:53:45  cvsadmin
 * LOG: PR6.4.2 Source Propagated to Current
 * LOG:
 * LOG: Revision 7.8.2.5.2.4.4.10  2005/02/24 09:31:29  mmanikandan
...
#ident "$Id: prc-mtp3.c,v 1.6 2008/07/18 05:38:12 ssingh Exp $"
...
#define MTP3_ALARM_FILE_NAME "prc-mtp3alarms.out"
...
static ITS_CHAR* MTP3_PRC_Timers[] =
{
    MTP3_T1_STRING,
    MTP3_T2_STRING,
    MTP3_T3_STRING,
...
TRACE_Data* MTP3_PRC_TraceData = NULL;

static ITS_UINT pegs[PEG_MTP3_NUM_PEGS_PRC];
static PEGS_DECL_SUBSYS(PRC_MTP3, pegs);
PEG_Manager *PRC_MTP3_Pegs = &PRC_MTP3_PEGS;

mtp3OmBuffer omBuf;

/* Function Prototype */
void PegMTP3DurationOMs_PRC();

TQUEUETRAN_Manager* __MTP3_PRC_RcvQueue = NULL;


THREAD_RET_TYPE     PRC_MTP3Thread(void *arg);
 ...
 * behavior control
 */
ITS_BOOLEAN MTP3_PRC_HandleSpareNIC = ITS_FALSE;
ITS_BOOLEAN MTP3_PRC_AutomaticTerminalAllocation = ITS_FALSE;
ITS_BOOLEAN MTP3_PRC_AutomaticDataLinkAllocation = ITS_FALSE;

/*static ITS_BOOLEAN behaviors[MTP3_NUM_BEHAVIORS];*/
BEHAVIORS_DECL_SUBSYS(PRC_MTP3, NULL);

/*static ITS_TIME timers[MTP3_NUM_TIMERS];*/
TIMERS_DECL_SUBSYS(PRC_MTP3, NULL);
 ...
 */
static MTP3_MgmtClassRec MTP3_MgmtClassRec_PRC =
{
    /* core part */
    {
    ...
    /* management part */
    {
        ...
        MTP3_GetGeneralCfg_PRC,
        MTP3_SetGeneralCfg_PRC,
        MTP3_GetLinksetEntry_PRC,
        MTP3_GetAllLinksetEntries_PRC,
        MTP3_SetLinksetEntry_PRC,
        MTP3_RemLinksetEntry_PRC,
        MTP3_GetLinksetStatus_PRC,
        MTP3_GetLinkInfo_PRC,
        MTP3_GetAllLinkEntries_PRC,
        MTP3_SetLinkEntry_PRC,
        MTP3_RemLinkEntry_PRC,
        MTP3_GetLinkStatus_PRC,
        MTP3_GetRouteEntry_PRC,
        MTP3_GetAllRouteEntries_PRC,
        MTP3_SetRouteEntry_PRC,
        MTP3_RemRouteEntry_PRC,
        MTP3_GetRouteStatus_PRC,
        MTP3_GetAllDestinationEntries_PRC,
        MTP3_SetDestinationEntry_PRC,
        MTP3_RemDestinationEntry_PRC,
        MTP3_GetDestinationStatus_PRC,
        MTP3_GetGeneralStats_PRC,
        MTP3_GetLinksetStats_PRC,
        MTP3_GetLinkStats_PRC,
        MTP3_GetRouteStats_PRC,
        MTP3_GetDestinationStats_PRC
    }
};

ITSSS7DLLAPI ITS_Class MTP3_MgmtClass_PRC =
    (ITS_Class)&MTP3_MgmtClassRec_PRC;
...
STPFunction_PRC()
{
    return BEHAVIORS_GetBehavior(&PRC_MTP3_Behaviors, MTP3_B_stpFunction);
}
 ...
 ****************************************************************************/
int
STPFunctionSet_PRC(ITS_BOOLEAN isStp)
{
    BEHAVIORS_SetBehavior(&PRC_MTP3_Behaviors, MTP3_B_stpFunction,
                           isStp);

    BEHAVIORS_CommitSharedBehaviors(DSM_MGMT_REC_PRC_MTP3_BEHAVIORS);
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_EnableUserPart_PRC(ITS_OCTET up, ITS_USHORT id)
{
    MTP3_DEBUG(("MTP3_EnableUserPart_PRC: up: %02x\n", up));

    if (MUTEX_AcquireMutex(&mtp3Gate) != ITS_SUCCESS)
    {
        MTP3_ERROR(("MTP3_EnableUserPart_PRC: Couldn't acquire mutex.\n"));
    ...
    {
        MTP3_ERROR(("MTP3_EnableUserPart_PRC: User Part out of range.\n"));
    ...
    MTP3_DEBUG(("MTP3_EnableUserPart_PRC: up %02x enabled\n", up));

    PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_USERPART_ENABLE);
...
{
    MTP3_DEBUG(("MTP3_DisableUserPart_PRC: up: %02x\n", up));

    if (MUTEX_AcquireMutex(&mtp3Gate) != ITS_SUCCESS)
    {
        MTP3_ERROR(("MTP3_DisableUserPart_PRC: Couldn't acquire mutex.\n"));
    ...
    if (up > MTP3_MAX_USER_PARTS)
    {
        MTP3_ERROR(("MTP3_DisableUserPart_PRC: User Part out of range.\n"));
    ...
    MTP3_DEBUG(("MTP3_DisableUserPart_PRC: up %02x disabled\n", up));

    PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_USERPART_DISABLE);
...
MTP3_UserPartOwner(ITS_OCTET up)
{
    ...
    MTP3_DEBUG(("MTP3_UserPartOwner_PRC: up: %02x\n", up));

    if (MUTEX_AcquireMutex(&mtp3Gate) != ITS_SUCCESS)
    {
        MTP3_ERROR(("MTP3_UserPartOwner_PRC: Couldn't acquire mutex.\n"));
    ...
    if (up > MTP3_MAX_USER_PARTS)
    {
        MTP3_ERROR(("MTP3_UserPartOwner_PRC: User Part out of range.\n"));
    ...
    MTP3_DEBUG(("MTP3_UserPartOwner_PRC: up %02x id %04x\n", up, id));
...
MTP3_GetGeneralCfg_PRC()
{
    ...
    ret->traceOn = (TRACE_IsLevelOn(MTP3_PRC_TraceData,
                                    MTP3_TRACE_DEBUG) &&
                    (TRACE_IsOutputOn(MTP3_PRC_TraceData,
                                      MTP3_TRACE_DEBUG,
                                      0) ||
                     TRACE_IsOutputOn(MTP3_PRC_TraceData,
                                      MTP3_TRACE_DEBUG,
                     ...
                     TRACE_IsOutputOn(MTP3_PRC_TraceData,
                                      MTP3_TRACE_DEBUG,
                                      2))) ||
                   (TRACE_IsLevelOn(MTP3_PRC_TraceData,
                                    MTP3_TRACE_WARNING) &&
                    (TRACE_IsOutputOn(MTP3_PRC_TraceData,
                                      MTP3_TRACE_WARNING,
                                      0) ||
                   ...
                   (TRACE_IsLevelOn(MTP3_PRC_TraceData,
                    ...
                    (TRACE_IsOutputOn(MTP3_PRC_TraceData,
                     ...
                     TRACE_IsOutputOn(MTP3_PRC_TraceData,
                                      MTP3_TRACE_ABORT,
                                      2)));
    ret->alarmLevel = MTP3_AlarmLevel_PRC;
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_SetGeneralCfg_PRC(MTP3GeneralCfg *data)
{
    if(MTP3_PRC_TraceData == NULL)
    {
      return !ITS_SUCCESS;
    }

    MTP3_AlarmLevel_PRC = data->alarmLevel;
...
MTP3_GetLinksetEntry_PRC(ITS_UINT linksetNumber)
{
    return (NULL);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI void
MTP3_GetAllLinksetEntries_PRC(ITS_UINT* numEntries,
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_SetLinksetEntry_PRC(MTP3LinksetInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_RemLinksetEntry_PRC(MTP3LinksetInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetLinksetStatus_PRC(ITS_UINT linksetNumber,
...
MTP3_GetLinkInfo_PRC(ITS_UINT ls, ITS_UINT lnk)
{
    return (NULL);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI void
MTP3_GetAllLinkEntries_PRC(ITS_UINT* numEntries,
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_SetLinkEntry_PRC(MTP3LinkInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_RemLinkEntry_PRC(MTP3LinkInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetLinkStatus_PRC(ITS_UINT ls, ITS_UINT lnk,
...
MTP3_GetRouteEntry_PRC(ITS_UINT dpc, ITS_OCTET ni,
                         ITS_UINT ls)
{
    return (NULL);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI void
MTP3_GetAllRouteEntries_PRC(ITS_UINT* numEntries,
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_SetRouteEntry_PRC(MTP3RouteInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_RemRouteEntry_PRC(MTP3RouteInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetRouteStatus_PRC(ITS_UINT dpc, ITS_OCTET ni,
                          ITS_UINT ls, 
 ...
 ****************************************************************************/
ITSSS7DLLAPI void
MTP3_GetAllDestinationEntries_PRC(ITS_UINT* numEntries, 
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_SetDestinationEntry_PRC(MTP3DestinationInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_RemDestinationEntry_PRC(MTP3DestinationInfo* data)
{
    return (ITS_SUCCESS);
}
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetDestinationStatus_PRC(ITS_UINT dpc, ITS_OCTET ni, 
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetGeneralStats_PRC(ITS_UINT **pegs, ITS_UINT *numPegs)
{
    *pegs = NULL;
    *numPegs = 0;
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetLinksetStats_PRC(ITS_UINT linksetNUmber, 
                           ITS_UINT **pegs,
                           ITS_UINT *numPegs)
{
    *pegs = NULL;
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetLinkStats_PRC(ITS_UINT linksetNUmber,
                        ITS_UINT lnkNumber,
                        ITS_UINT **pegs,
                        ITS_UINT *numPegs)
{
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetRouteStats_PRC(ITS_UINT dpc, ITS_OCTET ni,
 ...
 ****************************************************************************/
ITSSS7DLLAPI int
MTP3_GetDestinationStats_PRC(ITS_UINT dpc, ITS_OCTET ni, 
                               ITS_UINT **pegs,
                               ITS_UINT *numPegs)
{
    *pegs = NULL;
...
MTP3_Pause(ITS_POINTER object, ITS_POINTER userData, ITS_POINTER callData)
{
    ...
    MTP3_DEBUG(("MTP3_Pause_PRC:\n"));

    /*PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_MSG_PAUSE);*/

    if (ROUTE_LockForWrite(routeRWLock) != ITS_SUCCESS)
    {
        MTP3_WARNING(("Pause_PRC: link lock failed\n"));
            ...
            if (wasUp && !isUp)
            {
                     ...
                     count++, tmp = DSMQUEUE_NEXT(link->linkSet->routes, tmp) )
                {
                    ...
                    if (allDown)
                    {
                        ...
                        MTP3_DEBUG(("MTP3_Pause_PRC: setting state PC: %08x\n",
                                    rinfo->basic.dpc));

                        MTP3_PC_SET_VALUE(pause.affected, rinfo->basic.dpc);
			            rinfo->dest->status = DESTINATION_UNAVAILABLE;

                        MTP3_Alarm_PRC(2401, __FILE__, __LINE__,
                                        "pc=%x:family=%s", rinfo->basic.dpc, "PRC");
...
MTP3_Resume(ITS_POINTER object, ITS_POINTER userData, ITS_POINTER callData)
{
    ...
    MTP3_DEBUG(("MTP3_Resume_PRC:\n"));

    /*PEG_IncrPeg(PRC_MTP3_Pegs, PEG_MTP3_MSG_RESUME);*/
            ...
            if (!wasUp && isUp)
            {
                     ...
                     count++, tmp = DSMQUEUE_NEXT(link->linkSet->routes, tmp) )
                {
                    ...
                    if (firstUp)
                    {
                        if (rinfo->dest)
                        {
                            for (i = 0; i < rinfo->dest->numEntries; i++)
                            {
                                if (rinfo->dest->entries[i]->basic.type
                                                      == REMOTE_ROUTE)
                                {
                                    if (rinfo->dest->entries[i]->linkSet->linkSet
                                         != link->linkSet->linkSet &&
                                        rinfo->dest->entries[i]->linkSet->isUp)
                                    {
                                        firstUp = ITS_FALSE;
                                        break;
                                    }
                    ...
                    if (firstUp)
                    {
                        ...
                        MTP3_DEBUG(("MTP3_Resume_PRC: setting state PC: %08x\n",
                                    rinfo->basic.dpc));

                        MTP3_PC_SET_VALUE(resume.affected, rinfo->basic.dpc);

                        MTP3_Alarm_PRC(2402, __FILE__, __LINE__,
                                        "pc=%x:family=%s", rinfo->basic.dpc, "PRC");
...
MTP3_Status(ITS_POINTER object, ITS_POINTER userData, ITS_POINTER callData)
{
    ...
    MTP3_DEBUG(("MTP3_Status_PRC:\n"));

    /*PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_MSG_STATUS);*/

    if (ROUTE_LockForWrite(routeRWLock) != ITS_SUCCESS)
    {
        MTP3_WARNING(("Status_PRC: link lock failed\n"));
    ...
    if ((TRANSPORT_MASK(base) & ITS_SS7_MASK) && TRANSPORT_RES(base))
    {
             ...
             link != NULL; link = link->next)
        {
                 ...
                 count++, tmp = DSMQUEUE_NEXT(link->linkSet->routes, tmp) )
            {
                ...
                if (ITS_TRUE)
                {
                    MTP3_DEBUG(("MTP3_Status_PRC: get congestion PC: %08x SSN: %02xn\n",
...
MTP3_Register(ITS_POINTER object, ITS_POINTER userData, ITS_POINTER callData)
{
     ...
     */
    if (TRANSPORT_MASK(tc) & ITS_SS7_MASK_PRC &&
 ...
 ****************************************************************************/
void
MTP3_Alarms_PRC(ITS_POINTER object, ITS_POINTER userData, ITS_POINTER callData
)
{
    ALARM_Format    alarm;
...
#define MTP3_ALARM_OUTPUT 400    
    ...
    if (alarm.id >= PRC_MTP3_ALARM_START &&
        alarm.id <= PRC_MTP3_ALARM_END)
    {
 ...
 ****************************************************************************/
void
MTP3_FuncEntry_PRC(MTP3_SubSystems subsystem, MTP3_SubSystems src,
                     int trigger,
                     ...
                     char *file, int line)
{
    ...
    if (TRACE_IsLevelOn(MTP3_PRC_TraceData, MTP3_TRACE_DEBUG))
    {
        TRACE_RAW(MTP3_PRC_TraceData, MTP3_TRACE_DEBUG,
              ("%s", TRACE_Header(MTP3_PRC_TraceData, file, line)));
        TRACE_RAW(MTP3_PRC_TraceData, MTP3_TRACE_DEBUG,
...
InitSettings()
{
     ...
     */
    if (TRANSPORT_RES(__MTP3_PRC_RcvQueue) != NULL)
    {
        char value[ITS_PATH_MAX];
        RESFILE_Manager *res = TRANSPORT_RES(__MTP3_PRC_RcvQueue);
        char *name = TRANSPORT_NAME(__MTP3_PRC_RcvQueue);
         ...
         */
        PRC_MTP3_Timers.numTimers = MTP3_NUM_TIMERS;

        PRC_MTP3_Timers.timers = TIMERS_InitSharedTimerValues (
            DSM_MGMT_REC_PRC_MTP3_TIMERS, MTP3_NUM_TIMERS);
        ...
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T1, __ccitt_t1);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T2, __ccitt_t2);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T3, __ccitt_t3);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T4, __ccitt_t4);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T5, __ccitt_t5);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T6, __ccitt_t6);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T7, __ccitt_t7);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T8, __ccitt_t8);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T9, __ccitt_t9);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T10, __ccitt_t10);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T11, __ccitt_t11);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T12, __ccitt_t12);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T13, __ccitt_t13);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T14, __ccitt_t14);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T15, __ccitt_t15);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T16, __ccitt_t16);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T17, __ccitt_t17);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T18, __ccitt_t18);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T19, __ccitt_t19);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T20, __ccitt_t20);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T21, __ccitt_t21);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T22, __ccitt_t22);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T23, __ccitt_t23);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T24, __ccitt_t24);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T25, __ccitt_t25);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T26, __ccitt_t26);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T27, __ccitt_t27);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T28, __ccitt_t28);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T29, __ccitt_t29);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T30, __ccitt_t30);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T31, __ccitt_t31);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T32, __ccitt_t32);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T33, __ccitt_t33);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_T34, __ccitt_t34);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_SLT_T1, __ccitt_slt_t1);  
        TIMERS_SetTimerValue(&PRC_MTP3_Timers, MTP3_TIMER_SLT_T2, __ccitt_slt_t2);  

        TIMERS_CommitSharedTimerValues(DSM_MGMT_REC_PRC_MTP3_TIMERS);

        /* 
         * Initialize behavior control
         */

         PRC_MTP3_Behaviors.numBehaviors = MTP3_NUM_BEHAVIORS;

         PRC_MTP3_Behaviors.behaviors = 
              BEHAVIORS_InitSharedBehaviors(DSM_MGMT_REC_PRC_MTP3_BEHAVIORS,
                                            MTP3_NUM_BEHAVIORS);

         BEHAVIORS_SetBehavior(&PRC_MTP3_Behaviors, MTP3_B_stpFunction,
                                ITS_FALSE);

         BEHAVIORS_SetBehavior(&PRC_MTP3_Behaviors, MTP3_B_fullRestartNeeded,
                                 ITS_TRUE);

         BEHAVIORS_SetBehavior(&PRC_MTP3_Behaviors, MTP3_B_spRestarting,
                                ITS_FALSE);

         BEHAVIORS_SetBehavior(&PRC_MTP3_Behaviors, MTP3_B_sendingStatus,
                                ITS_FALSE);
        ...
        if (RESFILE_GetKeyValueOf(res, name, SPARE_NIC_STRING,
                                  value, ITS_PATH_MAX) == ITS_SUCCESS)
        {
            MTP3_PRC_HandleSpareNIC = strstr(value, "yes") != NULL ||
                                  ...
                                  value, ITS_PATH_MAX) == ITS_SUCCESS)
        {
            ...
            STPFunctionSet_PRC(isStpFunction);

        }
        if (RESFILE_GetKeyValueOf(res, name, AUTO_TERM_ALLOC_STRING,
                                  value, ITS_PATH_MAX) == ITS_SUCCESS)
        {
            MTP3_PRC_AutomaticTerminalAllocation =
                                        strstr(value, "yes") != NULL ||
                                        strstr(value, "YES") != NULL;
        }
        if (RESFILE_GetKeyValueOf(res, name, AUTO_LINK_ALLOC_STRING,
                                  value, ITS_PATH_MAX) == ITS_SUCCESS)
        {
            MTP3_PRC_AutomaticDataLinkAllocation =
                                        strstr(value, "yes") != NULL ||
                                        strstr(value, "YES") != NULL;
        }
 ...
 ****************************************************************************/
int
IMTP3_Initialize_PRC(ITS_SS7_HANDLE handle)
{
    int i, j;
    ITS_Class dbClass;
    ...
    if ((MTP3_PRC_TraceData = TRACE_Constructor("PRC-MTP3",
    ...
    /* CALLBACK_AddCallback(ALARM_Callbacks, MTP3_Alarms_PRC, NULL); */


    if ((__MTP3_PRC_RcvQueue = TQUEUETRAN_CreateTransport("PRC-MTP3",
                                                            ITS_MTP3_SRC,
                                                            ITS_MTP3)) == NULL)
    {
        ...
        CALLBACK_RemCallback(ALARM_Callbacks, MTP3_Alarms_PRC, NULL);
    ...
    {
        if (THREAD_CreateThread(&mtp3Thread[i], 0, PRC_MTP3Thread,
    ...
    //if (ITS_FindFeature("SCTP") == NULL)
    {
        ...
        {
            DBC_AddDoCommand(MTP3_Console_PRC);
        }
    }

    PEG_IncrPeg(PRC_MTP3_Pegs, PEG_MTP3_INITIALIZE);
 ...
 ****************************************************************************/
void
IMTP3_Terminate_PRC(ITS_SS7_HANDLE handle)
{
    int i;
    ITS_EVENT ev;
    void *status;
...
//    if (ITS_FindFeature("SCTP") == NULL)
    {
        if ((dbClass = ITS_FindFeature(DBC_CLASS_NAME)) != NULL)
        {
            DBC_RemDoCommand(MTP3_Console_PRC);
        }
    }
    ...
    PEG_IncrPeg(PRC_MTP3_Pegs, PEG_MTP3_TERMINATE);
    ...
    ITS_C_ASSERT(__MTP3_PRC_RcvQueue != NULL);
    TQUEUETRAN_DeleteTransport(__MTP3_PRC_RcvQueue);
    ...
    TRACE_Destructor(MTP3_PRC_TraceData);
}
 ...
 *                           v1.0.02           Measurement Introduced handling 
 *                           ID::D0010         of new Timer OAM Duration Timer. 
 *                                             This timer runs for every 10 sec.
 *                                             Expiry of this timer will invoke 
 *                                             function PegMTP3DuratiionOMs(). 
 *                                             and restarts the timer again.
 ****************************************************************************/
static int
HandleTimerEvent(ITS_TimerData *td)
{
    ...
    case MTP3_T1:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T1_EXPIRED);

        /* Delay to avoid message re-sequencing on changeover */
        return TCOC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T1,
                               NULL, 0,
    ...
    case MTP3_T2:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T2_EXPIRED);

        /* Waiting for changeover acknowledgment */
        return TCOC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T2,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T3:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T3_EXPIRED);

        /* Time controlled diversion -- delay to avoid
         * mis-sequencing on changeback */
        return TCBC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T3,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T4:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T4_EXPIRED);

        /* Waiting for changeback acknowledgment (first attempt) */
        return TCBC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T4,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T5:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T5_EXPIRED);

        /* Waiting for changeback acknowledgment (second attempt) */
        return TCBC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T5,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T6:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T6_EXPIRED);


        ret = TCRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T6,
                              ev.data, ev.len,
    ...
    case MTP3_T7:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T7_EXPIRED);

        return LSDA_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T7,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T8:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T8_EXPIRED);

        ret = RTPC_Main_PRC(MTP3_TIMER, SRM_TRIGGER_T8,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_CODE);
    ...
    case MTP3_T10:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T10_EXPIRED);

        ret = RSRT_Main_PRC(MTP3_TIMER, SRM_TRIGGER_T10,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_CODE);
    ...
    case MTP3_T11:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T11_EXPIRED);

        ret = TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T11,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
    ...
    case MTP3_T12:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T12_EXPIRED);

        return TLAC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T12,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T13:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T13_EXPIRED);

        return TLAC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T13,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T14:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T14_EXPIRED);

        return TLAC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T14,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T15:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T15_EXPIRED);

        ret = TRCC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T11,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_SET);
    ...
    case MTP3_T16:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T16_EXPIRED);

        ret = RCAT_Main_PRC(MTP3_TIMER, SRM_TRIGGER_T16,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_CODE);
    ...
    case MTP3_T17:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T17_EXPIRED);

        return LSAC_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T17,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    case MTP3_T18:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T18_EXPIRED); */

        ret = RTRC_Main_PRC(MTP3_TIMER, SRM_TRIGGER_T18,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_CODE);
    ...
    case MTP3_T19:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T19_EXPIRED); */

        return LSAC_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T19,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T20:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T22_EXPIRED);

        /* Increament peg for Timer T20 expired */
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T20_EXPIRED); */

        return TLAC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T20,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T21:
        ...
        PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T23_EXPIRED);

        /* Increament peg for Timer T21 expired */
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T21_EXPIRED); */

        return TLAC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T21,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T22:
        ...
        return TPRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T22,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T23:
        ...
        return TPRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T23,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T24:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T24_EXPIRED); */

        return TPRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T24,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    case MTP3_T25:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T25_EXPIRED); */

        return TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T25,
                               ev.data, ev.len,
                               ctxt.data.routeInfo.linkSet,
                               ITS_SS7_DEFAULT_LINK_SET);
    ...
    case MTP3_T26:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T26_EXPIRED); */

        return TPRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T26,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T27:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T27_EXPIRED); */

        return TPRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T27,
                               NULL, 0,
                               ITS_SS7_DEFAULT_LINK_SET,
                               ITS_SS7_DEFAULT_LINK_CODE);
    ...
    case MTP3_T28:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T28_EXPIRED); */

        ret = TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T28,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_SET);
    ...
    case MTP3_T29:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T29_EXPIRED); */

        ret = TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T29,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_SET);
    ...
    case MTP3_T30:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T30_EXPIRED); */

        ret = TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T30,
                              ev.data, ev.len,
                              ctxt.data.routeInfo.linkSet,
                              ITS_SS7_DEFAULT_LINK_SET);
    ...
    case MTP3_T31:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T31_EXPIRED); */

        return TSRC_Main_PRC(MTP3_TIMER, STM_TRIGGER_T31,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T32:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T32_EXPIRED); */

        return LSAC_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T32,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T33:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T33_EXPIRED); */

        return LSAC_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T33,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
    ...
    case MTP3_T34:
        ...
        /* PEG_IncrPeg(PRC_MTP3_Pegs,PEG_MTP3_T34_EXPIRED); */

        return LSAC_Main_PRC(MTP3_TIMER, SLM_TRIGGER_T34,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);

    case MTP3_SLT_T1:
        return SLTC_Main_PRC(MTP3_TIMER, SLT_TRIGGER_T1,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);

    case MTP3_SLT_T2:
        return SLTC_Main_PRC(MTP3_TIMER, SLT_TRIGGER_START_TEST,
                               NULL, 0,
                               ctxt.data.linkInfo.linkSet,
                               ctxt.data.linkInfo.linkCode);
        break;

    case OAM_DURATION_TIMER_PRC: 
        /* Invoke function PegMTP3DurationOMs to collect the duration oms */
        PegMTP3DurationOMs_PRC(); 

        /* Start the OAM Duration timer again... It should run continuously */
        tim_context.timerId = OAM_DURATION_TIMER_PRC;
...
PRC_MTP3Thread(void *arg)
{
    ...
    TRANSPORT_IS_ACTIVE(__MTP3_PRC_RcvQueue) = ITS_TRUE;

    while (cont &&
           TRANSPORT_CLASS_GET_NEXT_EVENT(ITS_OBJ_CLASS(__MTP3_PRC_RcvQueue))
                                                        (__MTP3_PRC_RcvQueue,
                                                         &mtp3Event)
           == ITS_SUCCESS)
    {
        ...
        case ITS_MTP3_SRC:
            ...
            TRANSPORT_IS_ACTIVE(__MTP3_PRC_RcvQueue) = ITS_FALSE;
        ...
        case ITS_ISUP_SRC:
            ...
            SMH_Main_PRC(MTP3_L4, MTP3_SMH_HMRT,
                           SMH_TRIGGER_L4_L3_MSG,
                           mtp3Event.data, mtp3Event.len,
                           ITS_SS7_DEFAULT_LINK_SET,
                           ITS_SS7_DEFAULT_LINK_CODE);

            ROUTE_UnlockRead(routeRWLock, __MTP3_PRC_RcvQueue);
            break;
        ...
        case ITS_TIMER_SRC:
        {
            ...
            /* Need to check whether the timer is OAM_DURATION_TIMER_PRC,
               if so there is no need to execute the following 
               LinkSet commit */

            if(ctxt.timerId != OAM_DURATION_TIMER_PRC)
        ...
        default:
            ...
            else
            {
                ...
                if (MTP2_ReceiveData_PRC(&mtp3Event, &linkSet, &linkCode,
                                           buf, &len) != ITS_SUCCESS)
                {
                    MTP3_WARNING(("Failed to receive L2 data\n"));

                    MTP3_Alarm_PRC(2405, __FILE__, __LINE__, "ls=%x:link=%x:family=%s", linkSet, linkCode, "PRC");
                }
                else
                {
                    ...
                    SMH_Main_PRC(MTP3_L2, MTP3_SMH_HMDT,
...
ItsEventToMTP3EventRec_PRC(ITS_EVENT ev)
{
    MTP3_EventRec evRec;
...
MTP3EventRecToItsEvent_PRC(MTP3_EventRec evRec)
{
    ITS_EVENT ev;
 ...
 ****************************************************************************/
ITSSS7DLLAPI void
MTP3_MembershipChangeCallBack_PRC(ITS_POINTER object, 
 ...
 *  Name    Date         Reference       Description
 *  ------------------------------------------------------------------------
 *  ssingh  10-04-2006   BugId: 3505       porting Delayed link alignment fix
 *                                         from BSG 0.2+
 *
 * mshanmugam  14-08-2006 ACC-PR66-SDS-GEN Q.752 SS7 Monitoring and Measurement
 *                        v1.0.02          Started new OAM_DURATION_TIMER
 *                        ID::D0010
 *
 ****************************************************************************/
int 
MTP3_TransportPostInit_PRC(TPOOL_THREAD *thr , ITS_HANDLE h)
{
...
int
INTELLINET_MTP3_Commit_PRC(FILE* fp)
{
    int count = 0;
    TRACE_Data* td = MTP3_PRC_TraceData;
    ...
    for (count = 0; count < (int)PRC_MTP3_Timers.numTimers; count++)
    {
        fprintf(fp,"\t\t\t\t\t%s = \"%lu\"\n",MTP3_PRC_Timers[count],
                                             PRC_MTP3_Timers.timers[count]);
    }

    fprintf(fp,"\t\t\t\t/>\n");
    fprintf(fp,"\t\t\t\t<BehaviorControl\n");
    fprintf(fp,"\t\t\t\t\t%s = \"%s\"\n",STP_FUNCTION_STRING,
            (BEHAVIORS_GetBehavior(&PRC_MTP3_Behaviors,
