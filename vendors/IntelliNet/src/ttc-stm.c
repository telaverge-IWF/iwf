 ...
 ****************************************************************************
 *
 *  ID: $Id: ttc-stm.c,v 9.7 2008/06/17 06:38:02 nvijikumar Exp $
 *
 * LOG: $Log: ttc-stm.c,v $
 ...
 * LOG:
 * LOG: Revision 9.4  2007/02/01 13:25:21  yranade
 * LOG: 2nd round of merge
 * LOG:
 * LOG: Revision 9.3  2007/01/11 12:43:41  yranade
 * LOG: Merge changes from 6.5.3 and Lucent branches
 * LOG:
 * LOG: Revision 9.2.8.19  2008/03/31 15:12:37  ssodhi
 * LOG: Reseting qPut flag also
 * LOG:
 * LOG: Revision 9.2.8.18  2008/03/31 06:16:14  ssodhi
 * LOG: Issue 376
 * LOG:
 * LOG: Revision 9.2.8.17  2008/03/28 14:13:11  ssodhi
 * LOG: TTC Issue 376
 * LOG:
 * LOG: Revision 9.2.8.16  2008/03/25 08:53:30  ssodhi
 * LOG: Fix for issue 376
 * LOG:
 * LOG: Revision 9.2.8.15  2008/02/21 13:20:33  skatta
 * LOG: Fix for issue #541
 * LOG:
 * LOG: Revision 9.2.8.14  2008/01/30 15:12:06  ssodhi
 * LOG: Fix for issue 376
 * LOG:
 * LOG: Revision 9.2.8.13  2008/01/23 13:15:13  ssodhi
 * LOG: Fix for issue #519
 * LOG:
 * LOG: Revision 9.2.8.12  2008/01/14 10:18:20  ssodhi
 * LOG: Code changes for Accelero Performance Enhancement - ALU BSG Project
 * LOG:
 * LOG: Revision 9.2.8.11  2007/12/22 05:41:02  skatta
 * LOG: Fix for Issue #407
 * LOG: Revision 9.2.8.10  2007/11/22 14:08:30  mshanmugam
 * LOG: Fix for BSG Redundancy Enhancement
 * LOG:
 * LOG: Revision 9.2.8.9  2007/10/05 11:20:00  mshanmugam
 * LOG: CPOT Stack support as per design Id D0060
 * LOG:
 * LOG: Revision 9.2.8.8  2007/07/24 06:33:33  raghavendrabk
 * LOG: Propagated the fix provided for issue 6171
 * LOG:
 * LOG: Revision 9.2.8.7  2007/06/14 05:54:22  raghavendrabk
 * LOG: Fix for Issue#6013 and Issue#6012
 * LOG:
 * LOG: Revision 9.2.8.6  2007/05/18 11:23:15  raghavendrabk
 * LOG: Changes for Alarm Optimisation
 * LOG:
 * LOG: Revision 9.2.8.5  2007/02/02 14:20:56  raghavendrabk
 * LOG: Parallel Stack changes for Alarms and Statistics
 * LOG:
 * LOG: Revision 9.2.8.4  2007/01/22 15:08:24  gharipriya
 * LOG: Fix for Issue ID:5115 (Removed the handling of TRW message, since TRW
 * LOG: message is not supported by TTC) merged from lucent maintenance branch.
 * LOG:
 * LOG: Revision 9.2.8.3  2007/01/18 14:44:32  ssingh
 * LOG: fix for issue#5179; link allignment problem
 * LOG:
 * LOG: Revision 9.2.8.2  2006/12/23 10:05:37  randresol
 * LOG: Modifications to allow TTC and ITU stacks to run in parallel
 * LOG:
 * LOG: Revision 9.2.8.1  2006/11/07 14:34:42  gharipriya
 * LOG: Fix for the Bug Id 4385. Link Inhibit and Uninhibit procedure removed
 * LOG: for TTC.
 * LOG:
 * LOG: Revision 9.2  2005/04/05 11:27:24  sjaddu
 * LOG: Implementation of changes based on design doc ACC651-SDS-PENH-1.0.02.
 * LOG:
 * LOG: Revision 9.1  2005/03/23 12:54:50  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
...
#ident "$Id: ttc-stm.c,v 9.7 2008/06/17 06:38:02 nvijikumar Exp $"
...
SPRestarting_TTC()
{
    return BEHAVIORS_GetBehavior(&TTC_MTP3_Behaviors, MTP3_B_spRestarting);
}
 ...
 ****************************************************************************/
int
SPRestartingSet_TTC(ITS_BOOLEAN isRestarting)
{
 ...
 ****************************************************************************/
ITS_BOOLEAN
FullRestartNeeded_TTC()
{
    return BEHAVIORS_GetBehavior(&TTC_MTP3_Behaviors, 
 ...
 ****************************************************************************/
int
FullRestartNeededSet_TTC(ITS_BOOLEAN restartNeeded)
{
...
SendingStatus_TTC()
{
    return BEHAVIORS_GetBehavior(&TTC_MTP3_Behaviors, MTP3_B_sendingStatus);
}
 ...
 ****************************************************************************/
int
SendingStatusSet_TTC(ITS_BOOLEAN status) 
{
 ...
 ****************************************************************************/
int 
STM_Main_TTC(MTP3_SubSystems src, MTP3_SubSystems dest,
               ...
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    if (trigger == SRM_TRIGGER_L2_MSG)
    {
        ...
        case SNMM_HC0_CHM:  /* changeover/changeback */
            ...
            case SNMM_HC1_COO:   /* changeover */
                return TLAC_Main_TTC(MTP3_SMH_HMDT,
                                      STM_TRIGGER_CHANGEOVER_ORDER,
                                      sif, len,
                                      linkSet, linkCode);

            case SNMM_HC1_COA:   /* changeover ack */
                return TCOC_Main_TTC(MTP3_SMH_HMDT,
            ...
            case SNMM_HC1_CBD:   /* changeback */
                return TCBC_Main_TTC(MTP3_SMH_HMDT,
        ...
        case SNMM_HC0_UFC:  /* user flow control */
            ...
            case SNMM_HC1_UPU:   /* user part unavailable */
                ...
                return TSFC_Main_TTC(MTP3_SMH_HMDT,
                                      STM_TRIGGER_UPU,
                                      sif, len,
    ...
    if (i == ent->entries[whichEntry]->linkSet->numLinks && !gotMatch)
    {
        ...
        if (idx > lastMatch)
        {
            MTP3_DEBUG(("No match found for alternate route  for linkSet "
                        "%d\n", linkSet));
            MTP3_Alarm_TTC(2466, __FILE__, __LINE__,"ls=%x:family=%s",linkSet, "TTC");
        }
    }
...
SetLinkUnavailable(ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    ret = TSRC_Main_TTC(MTP3_STM_TLAC,
    ...
    if (SPRestarting_TTC())
    {
        ret = TPRC_Main_TTC(MTP3_STM_TLAC,
                             STM_TRIGGER_LINK_UNAVAILABLE,
                             NULL, 0,
                             linkSet, linkCode);
...
int
SetLinkUnavailableTTC(ITS_OCTET linkSet, ITS_OCTET linkCode)
{
...
ForceUninhibitLink(ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    ret = HMRT_Main_TTC(MTP3_STM_TLAC,
 ...
 ****************************************************************************/
int
TLAC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TLAC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_ADJACENT_SP_RESTARTING: /* from TSRC */
        ...
        {            
            ...
            else if (ln->availableState == LINK_UNAVAILABLE)
            {
                ...
                {
                    ret = TCBC_Main_TTC(MTP3_STM_TLAC,
        ...
        else if (ln->availableState == LINK_UNAVAILABLE)
        {
            ...
            if (src == MTP3_STM_TCBC)
            {
                if (ln->stFlags & LINK_COO)
                {
                    ...
                    ret = TCOC_Main_TTC(MTP3_STM_TLAC,
                                         STM_TRIGGER_CHANGEOVER_ORDER,
                                         NULL, 0,
                                         linkSet, linkCode);
                    ...
                    PEG_IncrPeg(TTC_MTP3_Pegs,PEG_MTP3_SL_UNAVAILABLE);
                }
                else
                {
    ...
    case STM_TRIGGER_CHANGEOVER_EXECUTED:    /* from TCOC */
        ...
        if (ln->availableState == LINK_UNAVAILABLE)
        {
            ...
            {
                ret = LSAC_Main_TTC(MTP3_STM_TLAC,
    ...
    case STM_TRIGGER_LINK_IN_SERVICE:        /* from SLM */
        MTP3_Alarm_TTC(2526, __FILE__, __LINE__,
               "ls=%x:link=%x:family=%s",linkSet,linkCode, "TTC");
    ...
    case STM_TRIGGER_RP_OUTAGE:              /* from SLM */
        ...
        MTP3_Alarm_TTC(2403, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
    ...
    case STM_TRIGGER_RP_RECOVERD:            /* from SLM */
        ...
        MTP3_Alarm_TTC(2404, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
                        linkSet,linkCode, "TTC");
    ...
    case STM_TRIGGER_RESTART_BEGIN:          /* from TPRC */        
        ...
        for (i = 0; i < ITS_SS7_DEFAULT_LINK_SET; i++)
        {
            if ((ls = LINKSET_FindLinkSet(i)) == NULL ||
                 ls->adjacent == 0 || ls->family != FAMILY_JAPAN)
            {
                continue;
            }
            ...
            {                 
                ...
                else if (ln->availableState == LINK_UNAVAILABLE)
                {
                    ...
                    * they have.
                    */
                    if ((FullRestartNeeded_TTC() && SPRestarting_TTC()) ||
                        (ln->stFlags & LINK_FAILED) ||
                        (ln->stFlags & LINK_LOC_BLOCKED) ||
                        (ln->stFlags & LINK_REM_BLOCKED))
                    {
    ...
    case STM_TRIGGER_CHANGEOVER_ORDER:  /* from SMH */
        ...
        linkSet = MTP3_FindAdjacent_TTC(ni, pc1, linkSet);
        ...
        MTP3_Alarm_TTC(2510, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
                        linkSet,linkCode, "TTC");
    ...
    case STM_TRIGGER_EMERG_CHANGEOVER_ORDER:       /* from SMH */
        ...
        MTP3_Alarm_TTC(2512, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
                        linkSet,linkCode, "TTC");
    ...
    case STM_TRIGGER_T12:                    /* from timer control */
        ...
        if (ln->availableState == LINK_AVAILABLE)
        {
            ...
            else
            {
                ...
                MTP3_Alarm_TTC(2519, __FILE__, __LINE__, 
                                "ls=%x:link=%x:family=%s", linkSet,ln->linkCode, "TTC");
        ...
        else if (ln->availableState == LINK_UNAVAILABLE)
        {
            if (ln->timerRetryState.t12RetryOnOff)
            {
                ...
                {
                    ret = MGMT_Main_TTC(MTP3_STM_TLAC, 
                ...
                else
                {
                    ...
                    else
                    {
                       /* Build SNMM UNINHIBIT LINK and send */
                        ...
                        MTP3_Alarm_TTC(2519, __FILE__, __LINE__, 
                                "ls=%x:link=%x:family=%x", linkSet,ln->linkCode, "TTC");
    ...
    case STM_TRIGGER_T20:                    /* from timer control */
        ...
        if (ln->availableState == LINK_UNAVAILABLE)
        {
            if (ln->stFlags & LINK_LOC_INHIBITED)
            {
                ...
                MTP3_Alarm_TTC(2522, __FILE__, __LINE__,"ls=%x:link=%x:family=%s", linkSet,linkCode, "TTC");
    ...
    case STM_TRIGGER_T21:                    /* from timer control */
        ...
        if (ln->availableState == LINK_UNAVAILABLE)
        {
            if (ln->stFlags & LINK_REM_INHIBITED)
            {
                ...
                MTP3_Alarm_TTC(2523, __FILE__, __LINE__,
                                 "ls=%x:link=%x:family=%s", linkSet,linkCode, "TTC");
...
EmergencyState(ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    if (!SPRestarting_TTC() && !RemoteSPAccessible(ls->adjacent, ls->ni))
    {
        return (ITS_TRUE);
    }
               ...
               int firstMatch, int lastMatch)
{
    ...
    {   
        ...
        TRACE_RAW(MTP3_TTC_TraceData, MTP3_TRACE_DEBUG, ("%s\n", StrDump));
    }
        ...
        ri->priority <= ent->entries[current]->priority)
    {
         ...
         * like TTC.  Don't forget that you don't remove STPs for
...
StartTrafficRestart(ROUTE_Info *ri)
{
    ...
    if (STPFunction_TTC())
    {
#if 0 /* TRW message is not supported for TTC, since it follows the same
         implementation as ITU  Issue ID: 5115 */
 ...
 ****************************************************************************/
int
TSRC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TSRC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_RESTART_END:               /* from TPRC */
        ...
        for (i = 0; i < ITS_SS7_DEFAULT_LINK_SET; i++)
        {
            ...
            if (ls && ls->adjacent != 0 && ls->family == FAMILY_JAPAN)
            {
                /* Build SNMM traffic restart allowed */
                MTP3_HDR_SET_SIO(omtp3, MTP3_SIO_SNMM | ls->ni);
                MTP3_RL_SET_DPC_VALUE(omtp3.label, ls->adjacent);
        ...
        SendingStatusSet_TTC(ITS_FALSE);

        break;

    case STM_TRIGGER_RESTART_BEGIN:             /* from TPRC */

        PEG_IncrPeg(TTC_MTP3_Pegs, PEG_MTP3_RESTART);
        if (SPRestarting_TTC())
        {
            /*
    ...
    case STM_TRIGGER_CHANGEOVER_EXECUTED:       /* from TCOC */
        ...
        PEG_IncrPeg(TTC_MTP3_Pegs, PEG_MTP3_CHANGEOVER);

        /* if signalling links loaded */
        if (ln->isUp && ln->isAllowed && ln->testPassed)
        {
            LSAC_Main_TTC(MTP3_STM_TSRC,
    ...
    case STM_TRIGGER_LINK_UNAVAILABLE:          /* from TLAC */
        ...
        if (!isUp)
            PEG_IncrPeg(TTC_MTP3_Pegs,PEG_MTP3_SLS_UNAVAILABLE);
...
#if 0 /* TRW message is not supported by TTC, since it follows the same
         implementation as ITU Issue ID: 5115 */
                             ...
                             count++, tmp = DSMQUEUE_NEXT(ln->linkSet->routes, tmp) )
                        {
                            ...
                            */
                            ...
                            MTP3_DEBUG(("TSRC_Main_TTC: Route:\n"));
			    if (TRACE_IsLevelOn(MTP3_TTC_TraceData, MTP3_TRACE_DEBUG))
			    {   
				char StrDump[500];
				StrDump[0] = '\0';
				...
				TRACE_RAW(MTP3_TTC_TraceData, MTP3_TRACE_DEBUG, ("%s\n", StrDump));
                            ...
                            if (ri->isAllowed && !ri->isRestricted)
                            {
                                MTP3_DEBUG(("TSRC_Main_TTC: AvailableRoute\n"));
                                AvailableRoute(ln,
                                               ent, whichEntry,
                                               firstMatch, lastMatch);
                            }
                            ...
                            {
                                MTP3_DEBUG(("TSRC_Main_TTC: RestrictRoute\n"));
                                RestrictedRoute(ln,
                                                ent, whichEntry,
                                                firstMatch, lastMatch);
                            }
...
#if 0 /* TRW message is not valid for TTC, since it follows the same
         implementation as ITU Issue ID: 5115 */
    ...
    case STM_TRIGGER_LINK_CONGESTION_STATUS:    /* implementation dependent */
        ...
        if (ls != NULL)
        {
            ...
            if (sif[0] == L2_L3_CONGESTION_ONSET)
            {
                ...
                MTP2_SendData_TTC(linkSet, linkCode,
    ...
    case STM_TRIGGER_SENDING_STATUS_PHASE:      /* from TPRC */
        SendingStatusSet_TTC(ITS_TRUE);
        break;

    case STM_TRIGGER_SEND_TRW:                  /* from TPRC */
#if 0
/* TTC doesn't support TRW message Issue ID: 5115 */
    ...
    case STM_TRIGGER_TRAFFIC_RESTART_WAITING:   /* from HMDT */
        ...
        linkSet = MTP3_FindAdjacent_TTC(ni, pc, linkSet);
 ...
 ****************************************************************************/
int
TRCC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    MTP3_HEADER *mtp3 = (MTP3_HEADER *)&sif[1], omtp3;
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TRCC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_DEST_CONGESTION_STATUS:    /* from RTCC */
                                                 ...
                                                 ITS_SS7_DEFAULT_SLS)) != ITS_SUCCESS)
        {
            ...
            MTP3_Alarm_TTC(2477, __FILE__, __LINE__,"type=%s:dpc=%x:ni=%x:family=%s", "remote", pc,ni, "TTC");
 ...
 ****************************************************************************/
int
TCOC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    MTP3_TimerContext tc;
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TCOC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    if (ln != NULL)
    {
       MTP3_DEBUG(("**** TCOC: trigger: %d state:%d ***\n", trigger, ln->changeoverState));
    }
    ...
    case STM_TRIGGER_LINK_AVAILABLE:            /* from TLAC */
        if (ln->changeoverState == CHANGEOVER_WAIT_1)
        {
            ...
            {
                evRec = ItsEventToMTP3EventRec_TTC(*cocbEv);

                fetched = &evRec.event;

                MTP2_SendData_TTC(L2_LINK_SET(fetched),
    ...
    case STM_TRIGGER_EMERG_CHANGEOVER_ORDER:    /* from TLAC */
        ...
        PEG_IncrPeg(TTC_MTP3_Pegs, PEG_MTP3_EMER_CHANGEOVER);
        ...
        else if (ln->changeoverState == CHANGEOVER_WAIT_FOR_ACK)
        {
            ...
            {                              
                                                  ...
                                                  ITS_SS7_DEFAULT_SLS) != ITS_SUCCESS)
                {
                    ...
                    MTP3_Alarm_TTC(2482, __FILE__, __LINE__, "pc=%x:family=%s", ls->adjacent, "TTC");
    ...
    case STM_TRIGGER_BSNT:                      /* from L2 */
        ...
        if (ln->changeoverState == CHANGEOVER_WAIT_2)
        {
            ...
            MTP3_Alarm_TTC(2513, __FILE__, __LINE__,
    ...
    case STM_TRIGGER_BSNT_NOT_RETRIEVABLE:      /* from L2 */
        if (ln->changeoverState == CHANGEOVER_WAIT_2)
        {
            ...
            MTP3_Alarm_TTC(2515, __FILE__, __LINE__,
                            "ls=%x:link=%x:family=%s",
                             tls,tlc, "TTC");
...
{ 
    ...
    if (prev == NULL)
    {
        here  = ItsEventToMTP3EventRec_TTC(item->data);
        there = ItsEventToMTP3EventRec_TTC(next->data);
        /*
    ...
    here = ItsEventToMTP3EventRec_TTC(item->data);
    there = ItsEventToMTP3EventRec_TTC(next->data);
    before = ItsEventToMTP3EventRec_TTC(prev->data);
...
DsmQueueEntryToMTP3EventRec_TTC(DSMQUEUE_Entry entry)
{
    MTP3_EventRec evRec;
    ...
    for (i = 0; i < ls->numLinks; i++)
    {
        ...
        if (ls->links[i]->linkCode != linkCode)
        {
            ...
            for (i = 0, ent = &ln->cocbBuf->entries[ln->cocbBuf->firstEntry];
                 ...
                 i++)
            {
                evRec = DsmQueueEntryToMTP3EventRec_TTC(*ent);
 ...
 ****************************************************************************/
int
TCBC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{    
    MTP3_HEADER *mtp3 = (MTP3_HEADER *)&sif[1];
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TCBC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_CHANGEBACK_DECL:           /* from HMDT */
        ...
        MTP3_Alarm_TTC(2511, __FILE__, __LINE__, "ls=%x:link=%x:family=%s",
                        linkSet,linkCode, "TTC");
        ...
        PEG_IncrPeg(TTC_MTP3_Pegs, PEG_MTP3_CHANGEBACK);
...
*/
                    ...
                    MTP3_Alarm_TTC(2514, __FILE__, __LINE__,
                                    "ls=%x:link=%x:family=%s",linkSet,ln->linkCode, "TTC");
        ...
        else
        {
            ...
            MTP3_Alarm_TTC(2487, __FILE__, __LINE__, 
                             "ls=%x:link=%x:family=%s",tls, tlc, "TTC");
        }
        break;
 ...
 ****************************************************************************/
int
TFRC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TFRC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_ROUTE_UNAVAILABLE:         /* from TSRC */
                                                 ...
                                                 ITS_SS7_DEFAULT_SLS)) != ITS_SUCCESS)
        {
            ...
            MTP3_Alarm_TTC(2489, __FILE__, __LINE__, "pc=%x:family=%s",pc, "TTC");
    ...
    case STM_TRIGGER_ALTERNATE_ROUTE_DATA:      /* from TSRC */
        ...
        if (ri->forcedState == FORCE_REROUTING_WAIT_1)
        {
            ...
            RTAC_Main_TTC(MTP3_STM_TFRC,
                           SRM_TRIGGER_FORCED_REROUTE_END,
                           ev.data, ev.len,
                           oldLS, oldLC);

            RTRC_Main_TTC(MTP3_STM_TFRC,
                           SRM_TRIGGER_FORCED_REROUTE_END,
                           ev.data, ev.len,
                           oldLS, oldLC);
 ...
 ****************************************************************************/
int
TCRC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    MTP3_HEADER *mtp3 = (MTP3_HEADER *)&sif[1];
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TCRC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_T6:                    /* from timer control */
        ...
        if (ri->controlledState == CONT_REROUTING_WAIT_2)
        {
            ...
            RTAC_Main_TTC(MTP3_STM_TCRC,
                           SRM_TRIGGER_CONTROLLED_REROUTE_END,
                           sif, len,
                           linkSet, linkCode);

            RTRC_Main_TTC(MTP3_STM_TCRC,
                           SRM_TRIGGER_CONTROLLED_REROUTE_END,
                           sif, len,
                           linkSet, linkCode);
 ...
 ****************************************************************************/
int
TSFC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    ...
    ITS_EVENT ev;
    int ret;
    struct adj_sp_node *temp, *pre;
    struct timeval current_time = {0, 0};
    ITS_BOOLEAN adjSpAlreadyPresent = ITS_FALSE;
    ITS_UINT retVal;

    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TSFC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_DEST_CONGESTION_STATUS:    /* from TRCC, RTCC, TSRC */
         ...
         * priority less than congestion status */
        /* Generate MTP3 status indication to each user part
         */
        ...
        PEG_IncrPeg(TTC_MTP3_Pegs,PEG_MTP3_CONGESTION);
    ...
    case STM_TRIGGER_DEST_INACCESS:             /* from TSRC */
        ...
        else
        {
          ...
          else
          {
            ...
            {
              pre = (struct adj_sp_node *)malloc(sizeof(struct adj_sp_node));

              pre->adj_sig_point = apc;
              pre->SpImage[omBuf.activeOm].adjSPInaccess++;
              pre->adjSpInaccFlag = ITS_TRUE;

              pre->prev = temp;
              pre->next = NULL;

              if(pre->SpImage[omBuf.activeOm].timeStamp != 0)
              {
                /* Dont do anything... The SP is already in inaccessible state */
              }
              else
              {
                ...
                pre->SpImage[omBuf.activeOm].timeStamp = current_time.tv_sec;
              }
        ...
        PEG_IncrPeg(TTC_MTP3_Pegs, PEG_MTP3_ROUTESET_UNAVAILABLE);

        MTP3_Alarm_TTC(2401, __FILE__, __LINE__,"pc=%x:family=%s", apc, "TTC");
        ...
        if (ITS_RedundancyClass != NULL)
        {
                                ...
                                == ITS_STATE_BACKUP)
            {
                ...
                if(TRANSPORT_IS_ACTIVE(trCtl) == ITS_TRUE)
                {
                    ...
                    MTP3_DEBUG(("PAUSE_INDICATION: Sent PAUSE to Active Node...\n"));
                }
                else
                {
    ...
    case STM_TRIGGER_DEST_ACCESS:               /* from TSRC */
        ...
        MTP3_Alarm_TTC(2402, __FILE__, __LINE__, "pc=%x:family=%s", apc, "TTC");
        ...
        /* If the node state is Backup, we need to broadcast the
           ...
           CPOT Stack - CCITT SCCP over TTC MTP3
        */
 ...
 ****************************************************************************/
int
TPRC_Main_TTC(MTP3_SubSystems src, STM_Triggers trigger,
               ITS_OCTET *sif, ITS_USHORT len,
               ITS_OCTET linkSet, ITS_OCTET linkCode)
{
    MTP3_HEADER *mtp3 = (MTP3_HEADER *)&sif[1];
    ...
    MTP3_TRACE_ENTRY_TTC(MTP3_STM_TPRC, src, trigger, sif, len,
                          linkSet, linkCode);
    ...
    case STM_TRIGGER_T27: /* from timer control */
        ...
        LLSC_Main_TTC(MTP3_STM_TPRC,
                       SLM_TRIGGER_RESTART_BEGINS,
                       NULL, 0,
                       ITS_SS7_DEFAULT_LINK_SET,
                       ITS_SS7_DEFAULT_LINK_CODE);

        TSRC_Main_TTC(MTP3_STM_TPRC,
                       STM_TRIGGER_RESTART_BEGIN,
                       NULL, 0,
                       ITS_SS7_DEFAULT_LINK_SET,
                       ITS_SS7_DEFAULT_LINK_CODE);

        TSFC_Main_TTC(MTP3_STM_TPRC,
                       STM_TRIGGER_RESTART_BEGIN,
                       NULL, 0,
                       ITS_SS7_DEFAULT_LINK_SET,
                       ITS_SS7_DEFAULT_LINK_CODE);

        TLAC_Main_TTC(MTP3_STM_TPRC,
                       STM_TRIGGER_RESTART_BEGIN,
                       NULL, 0,
                       ITS_SS7_DEFAULT_LINK_SET,
                       ITS_SS7_DEFAULT_LINK_CODE);

        RSRT_Main_TTC(MTP3_STM_TPRC,
