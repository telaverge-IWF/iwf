 ...
 ****************************************************************************
 *
 *  ID: $Id: prc-sccp_gtt.c,v 1.5 2008/07/18 05:39:51 ssingh Exp $
 *
 * LOG: $Log: prc-sccp_gtt.c,v $
 ...
 * LOG: Add prc files
 * LOG:
 * LOG: Revision 1.1.2.2  2007/04/11 07:03:07  mshanmugam
...
#ident "$Id: prc-sccp_gtt.c,v 1.5 2008/07/18 05:39:51 ssingh Exp $"
 ...
 ****************************************************************************/
int
SCCP_GTTTranslate_PRC(MTP3_HEADER *mtp3,
                        ...
                        ITS_SCCP_IE *ies, int ieCount)
{
    ...
    PEG_IncrPeg(PRC_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_REQUEST);
                                               ...
                                               NULL, (void *)&data)) != ITS_SUCCESS)
    {
        ...
        SccpGenOmImage_PRC[omBuf.activeOm].SCCPGenPegs.routingFailureNoTransAddr++;
    ...
    {
        PEG_IncrPeg(PRC_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_FAILURE);

        /* Q752 Implementation Routing Failure No translation for this specific address */
        SccpGenOmImage_PRC[omBuf.activeOm].SCCPGenPegs.routingFailureNoTransSpecificAddr++;
    ...
    else
    {
        *dpc = data.dpc;
        ...
        PEG_IncrPeg(PRC_SCCP_Pegs, PEG_SCCP_REMOTE_GTT_SUCCESS);
 ...
 ****************************************************************************/
int
SCCP_UserIntervention_PRC(MTP3_HEADER *mtp3,
                            ITS_OCTET addrInd,
                            ITS_UINT pc, ITS_OCTET ssn,
                            ITS_OCTET *gttInfo, ITS_USHORT gttLen,
                            SCCP_ADDR* transAddr,
