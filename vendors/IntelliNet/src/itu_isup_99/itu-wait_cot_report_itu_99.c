 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_cot_report_itu_99.c,v 1.2 2006/01/09 06:44:52 omayor Exp $
 *
 *  LOG: $Log: itu-wait_cot_report_itu_99.c,v $
...
/*
 * Functions for handling messages in the Wait_COT_Report state for ITU-99
 * variant.
 */
 ...
 *      for the WAIT_COT_REPORT state, based on the msgType received.
 *
 *  Input Parameters:
...
__ISUP_GetMsgProc_WaitCotReport_ITU_99(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_APM:
