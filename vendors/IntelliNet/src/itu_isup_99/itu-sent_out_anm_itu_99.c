 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-sent_out_anm_itu_99.c,v 1.2 2006/01/09 06:44:52 omayor Exp $
 *
 *  LOG: $Log: itu-sent_out_anm_itu_99.c,v $
...
/*
 * Functions for handling messages in the Sent_Outgoing_ANM state for ITU_99
 * variant. 
 */
...
__ISUP_GetMsgProc_SentOutgoingAnm_ITU_99(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_APM:
