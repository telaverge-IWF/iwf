 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_out_anm_itu_99.c,v 1.2 2006/01/09 06:44:52 omayor Exp $
 *
 *  LOG: $Log: itu-wait_out_anm_itu_99.c,v $
...
/*
 * Functions for handling messages in the Wait_Outgoing_ANM state for ITU_99
 * variant. 
 */
...
__ISUP_GetMsgProc_WaitOutgoingAnm_ITU_99(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_APM:
