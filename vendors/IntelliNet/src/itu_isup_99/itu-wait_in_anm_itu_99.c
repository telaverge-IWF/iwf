 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_in_anm_itu_99.c,v 1.2 2006/01/09 06:44:52 omayor Exp $
 *
 *  LOG: $Log: itu-wait_in_anm_itu_99.c,v $
...
/*
 * Functions for handling messages in the Wait_Incoming_ANM state for ITU-99
 * variant.
 */
...
__ISUP_GetMsgProc_WaitIncomingAnm_ITU_99(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_APM:
