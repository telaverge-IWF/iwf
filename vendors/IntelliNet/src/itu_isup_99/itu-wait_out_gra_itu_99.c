 ...
 ****************************************************************************
 *
 *  ID: $Id: itu-wait_out_gra_itu_99.c,v 1.2 2006/01/09 06:44:52 omayor Exp $
 *
 *  LOG: $Log: itu-wait_out_gra_itu_99.c,v $
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an PRI received in the WAIT_OUTGOING_GRA state 
                          ...
                          ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received PRI in WAIT_OUT_GRA from MTP3, pcic 0x%08x, vcic %d.\n",
    ...
    {
        ISUP_ERROR(("Received PRI in WAIT_OUT_GRA from APP "
                    "pcic 0x%08x, vcic %d.\n", cic_rec->pcic, cic_rec->vcic));
...
__ISUP_GetMsgProc_WaitOutgoingGra_ITU_99(ITS_OCTET msgType)
{
    switch(msgType)
    {
    case ISUP_MSG_PRI:
