 ...
 *                                                                          *
 ****************************************************************************
 *  ID: $Id: ansi-wait_in_cot_and_iam_ansi95.c,v 9.2 2005/04/06 06:39:10 ssingh Exp $
 * LOG: $Log: ansi-wait_in_cot_and_iam_ansi95.c,v $
 ...
 * LOG:
 * LOG: Revision 1.5.2.1.2.1  2003/09/13 06:36:51  akumar
 ...
 * LOG:
 * LOG: Revision 1.3  2003/04/16 06:53:21  akumar
 ...
 ****************************************************************************
 *  Purpose:
 *      The processing for an FAC received in the WAIT_INCOMING_COT_AND_IAM state
                    ...
                    ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    {
        ISUP_DEBUG(("Received FAC in WAIT_INCOMING_COT_AND_IAM from MTP3,"
                     "pcic 0x%08x, vcic %d .\n",
    ...
    {
        ISUP_DEBUG(("Received FAC in WAIT_INCOMING_COT_AND_IAM from APP,"
                     "pcic 0x%08x, vcic %d. \n",
                     cic_rec->pcic, cic_rec->vcic));
                              ...
                              ISUP_OPC_DPC_INFO *config_info, ITS_OCTET src)
{
    ...
    if (src == ISUP_SRC_L3_ANSI)
    {
        ISUP_ERROR(("Rcvd Unexpected msg 0x%x from MTP3 in WAIT_INCOMING_COT_AND_IAM."
...
__ISUP_GetMsgProc_WaitIncomingCotAndIam_ANSI95(ITS_OCTET msgType)
{
    switch(msgType)
    {
