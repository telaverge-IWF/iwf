 ...
 ****************************************************************************
 *
 *  ID: $Id: test1.c,v 9.1 2005/03/23 12:55:22 cvsadmin Exp $
 *
 * LOG: $Log: test1.c,v $
 ...
 * LOG:
 * LOG: Revision 7.2  2002/11/09 23:44:44  randresol
...
#ident "$Id: test1.c,v 9.1 2005/03/23 12:55:22 cvsadmin Exp $"
...
TrafficGenerator(TPOOL_THREAD *thr)
{
    ...
    for (i = 0; ; i++)
    {
        ...
        if (sendTraffic)
        {
            ...
            {
                MTP3_RL_SET_DPC_VALUE(mtp3.label, 0x000110);
            }
