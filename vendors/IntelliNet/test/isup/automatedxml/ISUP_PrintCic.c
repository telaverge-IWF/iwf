 ...
 *                                                                          *
 ****************************************************************************
 * ID:$Id: ISUP_PrintCic.c,v 9.1 2005/03/23 12:55:05 cvsadmin Exp $
 ...
 * LOG:
 * LOG:Revision 1.5.2.3.6.1  2004/09/13 06:06:23  ssingh
 * LOG:Changes done to comply with ISUP Stack changes.
 * LOG:
 ...
 * LOG:
 * LOG:Revision 8.2  2003/03/15 14:09:41  ssingh
 * LOG:Added CRM/CRA state in CPCFsmState.
 * LOG:
 ...
 *
 *  Notes:
 *      For printing information, the function calls stack internals, like,
