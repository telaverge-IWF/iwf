...
#else
SS7DLLAPI int TCAP_AllocateDialogueId_CCITT(ITS_UINT *dialogue_id);
#endif
 ...
 * received.
 */
SS7DLLAPI int TCAP_FetchAddrs_CCITT(ITS_HANDLE handle, ITS_USHORT did,
                                    SCCP_ADDR *oaddr, SCCP_ADDR *daddr);
SS7DLLAPI int TCAP_SetAddrs_CCITT(ITS_HANDLE handle, ITS_USHORT did,
                                  SCCP_ADDR *oaddr, SCCP_ADDR *daddr);
SS7DLLAPI int TCAP_FetchQOS_CCITT(ITS_HANDLE handle, ITS_USHORT did,
                                  DLG_QOS *qos);
SS7DLLAPI int TCAP_SetQOS_CCITT(ITS_HANDLE handle, ITS_USHORT did,
                                DLG_QOS *qos);
