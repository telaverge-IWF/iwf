 ...
 ****************************************************************************
 *
 *  ID: $Id: printISUPMsg.h,v 9.2 2006/01/09 06:40:06 omayor Exp $
 *
...
void PrintApplicationTransportPar (const ITS_ISUP_IE *ie);
void PrintCcnrPossibleIndPar (const ITS_ISUP_IE *ie);
void PrintPivotCapabilityPar (const ITS_ISUP_IE *ie);
void PrintPivotRoutingIndPar (const ITS_ISUP_IE *ie);
void PrintCalledDirNumPar (const ITS_ISUP_IE *ie);
void PrintOriginalCalledInNumPar (const ITS_ISUP_IE *ie);
void PrintCalledGeodeticLocationPar (const ITS_ISUP_IE *ie);
void PrintHtrInfoPar (const ITS_ISUP_IE *ie);
void PrintNetworkRoutingNumPar (const ITS_ISUP_IE *ie);
void PrintQueryOnReleaseCapabilityPar (const ITS_ISUP_IE *ie);
void PrintPivotStatusPar (const ITS_ISUP_IE *ie);
void PrintPivotCounterPar (const ITS_ISUP_IE *ie);
void PrintPivotRoutingFrwdInfoPar (const ITS_ISUP_IE *ie);
void PrintPivotRoutingBkwdInfoPar (const ITS_ISUP_IE *ie);
void PrintRedirectCapabilityPar (const ITS_ISUP_IE *ie);
void PrintRedirectCounterPar (const ITS_ISUP_IE *ie);
void PrintRedirectStatusPar (const ITS_ISUP_IE *ie);
void PrintRedirectFrwdInfoPar (const ITS_ISUP_IE *ie);
void PrintRedirectBkwdInfoPar (const ITS_ISUP_IE *ie);
void PrintNumPortabilityFrwdInfoPar (const ITS_ISUP_IE *ie);
#endif
