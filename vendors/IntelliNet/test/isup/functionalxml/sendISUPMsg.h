 ...
 ****************************************************************************
 *
 *  ID: $Id: sendISUPMsg.h,v 9.2 2006/01/09 06:40:06 omayor Exp $
 *
 ...
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.2  2005/03/21 13:54:21  cvsadmin
...
/* Only in ITU99 variant */
#ifdef CCITT
int TestSendAPMRequest(ITS_HANDLE handle, ITS_HDR *hdr);
int TestSendSDMRequest(ITS_HANDLE handle, ITS_HDR *hdr);
int TestSendPRIRequest(ITS_HANDLE handle, ITS_HDR *hdr);
#endif
