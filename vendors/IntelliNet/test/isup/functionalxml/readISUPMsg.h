 ...
 ****************************************************************************
 *
 *  ID: $Id: readISUPMsg.h,v 9.2 2006/01/09 06:40:06 omayor Exp $
 *
 ...
 * LOG:
 * LOG: Revision 1.3.2.1  2002/07/31 19:14:19  ssingh
...
int ReadApplicationTransportPar(char *buf, ITS_ISUP_IE *ie);
int ReadCcnrPossibleIndPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotCapabilityPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotRoutingIndPar(char *buf, ITS_ISUP_IE *ie);
int ReadCalledDirNumPar(char *buf, ITS_ISUP_IE *ie);
int ReadOriginalCalledInNumPar(char *buf, ITS_ISUP_IE *ie);
int ReadCalledGeodeticLocationPar(char *buf, ITS_ISUP_IE *ie);
int ReadHtrInfoPar(char *buf, ITS_ISUP_IE *ie);
int ReadNetworkRoutingNumPar(char *buf, ITS_ISUP_IE *ie);
int ReadQueryOnReleaseCapabilityPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotStatusPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotCounterPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotRoutingFrwdInfoPar(char *buf, ITS_ISUP_IE *ie);
int ReadPivotRoutingBkwdInfoPar(char *buf, ITS_ISUP_IE *ie);
int ReadRedirectCapabilityPar(char *buf, ITS_ISUP_IE *ie);
int ReadRedirectCounterPar(char *buf, ITS_ISUP_IE *ie);
int ReadRedirectStatusPar(char *buf, ITS_ISUP_IE *ie);
int ReadRedirectFrwdInfoPar(char *buf, ITS_ISUP_IE *ie);
int ReadRedirectBkwdInfoPar(char *buf, ITS_ISUP_IE *ie);
int ReadNumPortabilityFrwdInfoPar(char *buf, ITS_ISUP_IE *ie); 
...
"(0x77) Redirect Counter (rsvd for natl use)", "(0x78) Application Transport",
"(0x79) Collect call request", "(0x7A) CCNR Possible Indicator",
"(0x7B) Pivot Capability", "(0x7C) Pivot Routing Indicator",
"(0x7D) Called Directory Number", "(0x7E) Redirect Capability",
"(0x7F) Original Called IN Num", "(0x80) Undefined parameter",
"(0x81) Called Geodetic Location", "(0x82) HTR Information",
"(0x83) Undefined parameter", "(0x84) Network Routing Num",
"(0x85) Query On Release Capability", "(0x86) Pivot Status",
"(0x87) Pivot Counter", "(0x88) Pivot Routing Forward Info",
"(0x89) Pivot Routing Backward Info", "(0x8A) Redirect Status",
"(0x8B) Redirect Forward Info", "(0x8C) Redirect Backward Info",
"(0x8D) Number Portabilty Forward Info", "(0x8E) Undefined parameter",
