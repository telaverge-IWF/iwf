 ...
 ****************************************************************************
 *
 *  ID: $Id: test2.c,v 9.1 2005/03/23 12:55:05 cvsadmin Exp $
 *
 * LOG: $Log: test2.c,v $
 * LOG: Revision 9.1  2005/03/23 12:55:05  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.2  2005/03/21 13:54:15  cvsadmin
 ...
 * LOG: Begin PR7.
 * LOG:
 * LOG: Revision 1.2  2002/02/27 23:07:44  mmiers
 * LOG: Post throughput testing.
 * LOG:
 * LOG: Revision 1.1  2002/02/14 22:13:09  mmiers
...
#ident "$Id: test2.c,v 9.1 2005/03/23 12:55:05 cvsadmin Exp $"
...
TrafficGenerator(TPOOL_THREAD *thr)
{
    ...
    for (i = 0; ; i++)
    {
        ...
        if (sendTraffic)
        {
            ...
            MTP3_RL_SET_OPC_VALUE(mtp3.label, 0x000101);
            MTP3_RL_SET_DPC_VALUE(mtp3.label, 0x000100);
        ...
        if (sendTraffic)
        {
            for (j = 0; j < repeat; j++)
            {
                ...
                MTP3_HDR_SET_SIO(mtp3, MTP3_NIC_NATIONAL | MTP3_SIO_SCCP);
                MTP3_RL_SET_OPC_VALUE(mtp3.label, 0x0009);
                MTP3_RL_SET_DPC_VALUE(mtp3.label, 0x0008);
                MTP3_RL_SET_SLS(mtp3.label, sndCnt);
