 ...
 ****************************************************************************
 *
 *  ID: $Id: printISUPMsg.c,v 9.1 2005/03/23 12:56:17 cvsadmin Exp $
 *
 * LOG: $Log: printISUPMsg.c,v $
 * LOG: Revision 9.1  2005/03/23 12:56:17  cvsadmin
 * LOG: Begin PR6.5
 * LOG:
 * LOG: Revision 8.2  2005/03/21 13:55:42  cvsadmin
...
ReceiveISUPMsg(ITS_HANDLE handle, ITS_EVENT *event)
{
    ...
    {
        printf("ReceiveISUPMsg: Error receiving ISUP msg, %s\n",
