 ...
 ****************************************************************************
 *
 *  ID: $Id: readISUPMsg.c,v 9.1 2005/03/23 12:56:17 cvsadmin Exp $
 *
 ...
 * LOG: Start PR5.
 * LOG:
 * LOG: Revision 3.2  2000/11/13 23:19:35  mmiers
...
ReadNetworkSpecificFacilityPar(char *buf, ITS_ISUP_IE *ie)
{
    ...
    /*f (lenNetwId == 1)
    {
        ...
        /*tOctetsFromStr(&(ie->param_data.networkSpecificFacility. \
                           ntwrk_type_plan), 1);
    }
    else if (lenNetwId > 1)*/
	if (lenNetwId >= 1)
            ...
            int *ieCount)
{
    ...
    *ieCount = 0;                    /* no. of IEs */
    ...
    while ( !feof(fp) )
    {
        ...
        printf("ReadISUPMsg: parCode = 0x%02x \n", parCode);
        switch ( parCode )
        {
