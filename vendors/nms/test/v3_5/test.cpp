 ...
 ****************************************************************************
 *
 *  ID: $Id: test.cpp,v 9.1 2005/03/23 12:56:18 cvsadmin Exp $
 *
 * LOG: $Log: test.cpp,v $
 ...
 * LOG: Start PR5.
 * LOG:
 * LOG: Revision 1.4  2001/02/08 23:32:31  hxing
 * LOG: Debug in solaris for isup integration
 * LOG:
 * LOG: Revision 1.3  2001/02/05 23:10:58  hxing
 * LOG: Remove warnings
 * LOG:
 * LOG: Revision 1.2  2000/12/14 19:58:54  hxing
 * LOG: Test with ANSI
 * LOG:
...
main(int argc, char **argv)
{
    ...
    ITS_AddFeature(itsNMS_ClassCCITT);
    ...
    ITS_RemFeature(itsNMS_ClassCCITT);
...
{ 
    ...
    {
        MTP3_RL_SET_DPC_VALUE(mtp3Hdr.label, 0x102);   
        MTP3_RL_SET_OPC_VALUE(mtp3Hdr.label, 0x101);
    ...
    {
        MTP3_RL_SET_DPC_VALUE(mtp3Hdr.label, 0x101);   
        MTP3_RL_SET_OPC_VALUE(mtp3Hdr.label, 0x102);
