...
* REV   DATE           WHO
* REV   DATE           WHO       Revision 8.2  2005/03/21 13:55:24  cvsadmin
...
*
* 42    4/27/:1 12:03p Jrego
* Merging MR419 to rel_5_0/Mainline.
*
* 44    4/26/:1 4:17p Jrego
* supporting limited pool option
*
* 43    4/25/:1 2:59p Jrego
*
* 41    4/12/:1 4:08p Jrego
* resolved merge conflicts (merging MR 123)
*
* 44    4/09/:1 4:40p Jrego
* added mem_intr function
*
* 43    3/27/:1 12:56p Jrego
* using CPKPRIO_URGENT for MEMORY messages
*
* 42    3/19/:1 11:09a Jrego
* defined MSGMEMORY_ (removed unused message types)
*
* 40    4/03/:1 2:24p Jrego
* Merging MR124 to rel_5_0/Mainline.
*
* 42    2/23/:1 3:51p Jrego
* added INTERFACE/RXSTART trap
*
* 39    11/30/:0 10:53a Jrego
* Merging PR404 to rel_5_0/Mainline.
*
* 41    11/27/:0 11:57a Jrego
* Added definition of CPKPRIO_MASK: mask to ensure within priority range
*
* 40    11/16/:0 3:40p Jrego
*
...
#ifdef SEMAPHORE
typedef struct SEMAPHORE_CREATE
{                               /* SEMAPHORE/CREATE PACKET */
    unsigned char   pktsvnum;   /* Trap packet  Service Number */
    unsigned char   pktssnum;   /* Trap packet  Sub-Service Number */
    short           pktccode;   /* Trap packet  Completion Code */
    unsigned char   pktcmsel;   /* Completion mode selection */
...
typedef struct SEMAPHORE_DESTROY
{                               /* SEMAPHORE/DESTROY PACKET */
    unsigned char   pktsvnum;   /* Trap packet  Service Number */
    unsigned char   pktssnum;   /* Trap packet  Sub-Service Number */
    short           pktccode;   /* Trap packet  Completion Code */
    unsigned char   pktcmsel;   /* Completion mode selection */
...
typedef struct SEMAPHORE_MODE
{                               /* SEMAPHORE/MODE PACKET */
    unsigned char   pktsvnum;   /* Trap packet  Service Number */
    unsigned char   pktssnum;   /* Trap packet  Sub-Service Number */
    short           pktccode;   /* Trap packet  Completion Code */
    unsigned char   pktcmsel;   /* Completion mode selection */
...
typedef struct SEMAPHORE_SIGNAL
{                               /* SEMAPHORE/SIGNAL PACKET */
    unsigned char   pktsvnum;   /* Trap packet  Service Number */
    unsigned char   pktssnum;   /* Trap packet  Sub-Service Number */
    short           pktccode;   /* Trap packet  Completion Code */
    unsigned char   pktcmsel;   /* Completion mode selection */
