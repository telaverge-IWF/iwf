...
/* ----- BIG ENDIAN host ----- */
#define NMSTX_CPTOH_S(x) ((unsigned short)(x))
#define NMSTX_CPTOH_L(x) ((unsigned long)(x))
#define NMSTX_HTOCP_S(x) ((unsigned short)(x))
#define NMSTX_HTOCP_L(x) ((unsigned long)(x))
...
#define NMSTX_LE2H_S(x) ((unsigned short)(x))
#define NMSTX_LE2H_L(x) ((unsigned long)(x))
#define NMSTX_H2LE_S(x) ((unsigned short)(x))
#define NMSTX_H2LE_L(x) ((unsigned long)(x))
