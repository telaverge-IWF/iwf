...
typedef struct _MTP3GenCfg
{
   ...
   U8 spare1;                   /* Alignment */
   U16 spare2;                  /* Make an even number of longs */
} MTP3GenCfg;
...
typedef S16 NMS_MTP3_STATUS;   /* redefine for portability */
...
NMS_MTP3_STATUS TXMTP3FUNC Mtp3MgmtInit       ( U8 board, U8 srcEnt, U8 srcInst );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3MgmtTerm       ( U8 board );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3MgmtCtrl       ( U8 board, S16 entity, U8 action );

NMS_MTP3_STATUS TXMTP3FUNC Mtp3InitGenCfg     ( MTP3GenCfg *pGencfg, U32 opc );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3SetGenCfg      ( U8 board, MTP3GenCfg *pGencfg );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3GetGenCfg      ( U8 board, MTP3GenCfg *pGencfg );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3InitNSapCfg    ( MTP3NSapCfg *pNSapCfg, U8 linkType );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3SetNSapCfg     ( U8 board, MTP3NSapCfg *pNSapCfg, S16 nSapNo );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3GetNSapCfg     ( U8 board, MTP3NSapCfg *pNSapCfg, S16 nSapNo );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3InitLinkCfg    ( U8 board, MTP3LinkCfg *pLinkCfg, S16 linkNo, U8 linkType, U32 dpc );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3SetLinkCfg     ( U8 board, MTP3LinkCfg *pLinkCfg );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3GetLinkCfg     ( U8 board, MTP3LinkCfg *pLinkCfg, S16 linkNo);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3InitLinkSetCfg ( MTP3LinkSetCfg *pLnkSetCfg, S16 linkSetNo, U32 dpc );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3SetLinkSetCfg  ( U8 board, MTP3LinkSetCfg *pLinkSetCfg );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3GetLinkSetCfg  ( U8 board, MTP3LinkSetCfg *pLinkSetCfg, S16 linkSetNo );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3InitRouteCfg   ( MTP3RouteCfg *pRouteCfg, S16 routeNo, U32 dpc, U8 swType );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3SetRouteCfg    ( U8 board, MTP3RouteCfg *pRouteCfg );
NMS_MTP3_STATUS TXMTP3FUNC Mtp3GetRouteCfg    ( U8 board, MTP3RouteCfg *pRouteCfg, U32 dpc );

NMS_MTP3_STATUS TXMTP3FUNC Mtp3GenStatus      ( U8 board, MTP3GenStatus *pStatus);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3NSapStatus     ( U8 board, S16 nsapNo, MTP3NSapStatus *pStatus);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3LinkStatus     ( U8 board, S16 linkNo, MTP3LinkStatus *pStatus);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3LinkSetStatus  ( U8 board, S16 linkSetNo, MTP3LinkSetStatus *pStatus);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3RouteStatus    ( U8 board, U32 dpc, MTP3RouteStatus *pStatus);

NMS_MTP3_STATUS TXMTP3FUNC Mtp3GenStats       ( U8 board, MTP3GenStats *pStats, Bool bReset);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3LinkStats      ( U8 board, S16 linkNo, MTP3LinkStats *pStats, Bool bReset);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3LinkSetStats   ( U8 board, S16 linkSetNo, MTP3LinkSetStats *pStats, Bool bReset);
NMS_MTP3_STATUS TXMTP3FUNC Mtp3RouteStats     ( U8 board, U32 dpc, MTP3RouteStats *pStats, Bool bReset);

/*-----------------3/8/00 10:08AM-------------------
 * JNTT only entry point.  This initiates a Route Test
 * by sending an SRT
 * --------------------------------------------------*/
NMS_MTP3_STATUS TXMTP3FUNC Mtp3RouteTest      ( U8 board, U32 dpc);
