...
* 
* 16    3/13/:1 3:16p Jrego
* Merging MR485 to rel_5_0/Mainline.
* 
* 18    3/12/:1 9:03p Tmckeown
* 
* 17    3/12/:1 7:29p Tmckeown
* 
* 15    1/16/:1 12:00p Tmckeown
* Merging PR382 to rel_5_0/Mainline.
* 
* 17    1/02/:1 12:06p Jrego
...
//---------------------------------------------------------------------------*/
#ifdef __STDC__
short           dpr_crea(void *userkey, void *libctx, unsigned short channel,
                         void **dprkey);
...
short           dpr_tx(void *dprkey, void *userkey, void *libctx, void *pkt,
                       void *txnotf);
