...
typedef struct {
    ...
    struct AGM_FILE_STATS file[AGM_MAX_FILES];
...
/*****************************************************************************
* Function - agmCloseBoard
*
* Description -
*
* Closes the link and the file descriptor to the board.
* Can be used with HotSwap to make sure that software connection to 
* the board is closed gracefully. 
*
* Returns - SUCCESS/FAILURE.
* (If board isn't opened return value is SUCCESS)
*****************************************************************************/
DWORD  agmCloseBoard (AGMHD agmhd, DWORD board);
...
/****************************************************************************
* Functions - __Nc_AgmClose() and __Nc_AgmOpen() provide notification for SNMP 
*
*****************************************************************************/

DWORD NMSAPI __Nc_AgmClose();
DWORD NMSAPI __Nc_AgmOpen();
