...
// Look for all NMS boards the EEPROM content
#include "nmshw.h"
...
/* Values for 'mode' parameter, default is 0 which means no echo cancel.    */
/* The first 2 bits define the filterlength and adapttime to use. If both   */
/* bits are zero, then echo canceller is disabled.                          */
...
typedef struct
{
    DWORD status;                 /* Echo canceller status flags            */
    DWORD ERL;                    /* Echo Return Loss                       */
    DWORD ERLE;                   /* Echo Return Loss Enhancement           */
    DWORD sndLevel;               /* Level of the sent singal               */
    DWORD rcvLevel;               /* Level of the received signal           */
    DWORD refPoint;               /* Reflection point location              */
