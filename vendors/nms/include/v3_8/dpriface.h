...
* 
* 20    3/13/:1 3:16p Jrego
* Merging MR485 to rel_5_0/Mainline.
* 
* 22    3/12/:1 9:03p Tmckeown
* 
* 21    3/12/:1 7:28p Tmckeown
* 
* 19    1/16/:1 12:00p Tmckeown
* Merging PR382 to rel_5_0/Mainline.
* 
* 21    1/02/:1 12:06p Jrego
* Checking in code from STG (diffs not yet complete)
* 
* 18    3/16/:0 12:58p Jrego
*
* 20    3/15/:0 11:34a Jrego
* using NMSTX_ALIGN_32 to control natural alignment
*
* 19    3/06/:0 4:59p Jrego
* padding only within #ifdef __sparc
*
* 18    2/29/:0 11:01a Jrego
...
#define CPIBUFSIZE      2044        /* max size of any Dual Port Ram buffer */
