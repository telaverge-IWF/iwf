...
* REV   DATE           WHO       Revision 9.1  2005/03/23 12:56:03  cvsadmin
 ...
 *---------------------------------------------------------------------------*/
    ...
    short TXXPORT TXVPDFUNC TxVpdDestroy(TX_HANDLE handle,
                                         unsigned short resource);
    short TXXPORT TXVPDFUNC TxVpdConfig(TX_HANDLE handle,
                                        unsigned short resource,
                                        TXVPD_CFG * cfg);
    short TXXPORT TXVPDFUNC TxVpdVport(TX_HANDLE handle,
                                       unsigned short resource,
                                       unsigned short vport_num,
                                       TXVPD_ADDR * addr);

    short TXXPORT TXVPDFUNC TxVpdAttach(TX_HANDLE handle,
                                        unsigned short vport_num,
                                        void *userkey,
                                        TXVPD_DPR_REQ * dprreq);
    short TXXPORT TXVPDFUNC TxVpdEnable(TX_HANDLE handle, void *userkey,
                                        unsigned long cpkey,
                                        TXVPD_DPR_REQ * dprreq);
    short TXXPORT TXVPDFUNC TxVpdDisable(TX_HANDLE handle, void *userkey,
                                         unsigned long cpkey,
                                         TXVPD_DPR_REQ * dprreq);
    short TXXPORT TXVPDFUNC TxVpdDetach(TX_HANDLE handle, void *userkey,
                                        unsigned long cpkey,
                                        TXVPD_DPR_REQ * dprreq);
    short TXXPORT TXVPDFUNC TxVpdTx(TX_HANDLE handle, unsigned short datalen,
                                    void *userkey, unsigned long cpkey,
                                    TXVPD_DPR_REQ * dprreq);
 ...
 *---------------------------------------------------------------------------*/
    short TXXPORT TXVPDFUNC TxVpdReqInit(TX_HANDLE handle,
                                         TXVPD_DPR_REQ * vpdreq,
                                         unsigned char msgnum);

    short TXXPORT TXVPDFUNC TxVpdResDflt(TXVPD_RES * res);
    short TXXPORT TXVPDFUNC TxVpdResDef(TXVPD_RES * res,
                                        unsigned short resource,
                                        unsigned char hw_type,
                                        unsigned char hw_num,
                                        unsigned char protocol);
    short TXXPORT TXVPDFUNC TxVpdResTdm(TXVPD_RES * res, unsigned char stream,
                                        unsigned char channel,
                                        unsigned char count);

    short TXXPORT TXVPDFUNC TxVpdCfgDflt(TXVPD_CFG * cfg,
                                         unsigned long rxfrm);
    short TXXPORT TXVPDFUNC TxVpdCfgHdlc(TXVPD_CFG * cfg,
                                         unsigned short logparms,
                                         unsigned long intclkbr);

    short TXXPORT TXVPDFUNC TxVpdAddrDef(TXVPD_ADDR * addr,
    ...
    TXXPORT short TXVPDFUNC TxVpdOpen(unsigned char board,
                                      TX_HANDLE * handle);
    TXXPORT short TXVPDFUNC TxVpdClose(TX_HANDLE handle);
    TXXPORT short TXVPDFUNC TxVpdControl(unsigned char msgtrc);

    TXXPORT short TXVPDFUNC TxVpdMvipCfg(TX_HANDLE handle,
                                         unsigned short main_mode,
                                         unsigned short sec8k_mode,
                                         unsigned short network);
    TXXPORT short TXVPDFUNC TxVpdT1E1Cfg(TX_HANDLE handle,
                                         unsigned char network,
                                         unsigned char framemode,
                                         unsigned char encoding,
                                         unsigned char linebldout,
    ...
    TXXPORT short TXVPDFUNC TxVpdDestroy(TX_HANDLE handle,
                                         unsigned short resource);
    TXXPORT short TXVPDFUNC TxVpdConfig(TX_HANDLE handle,
                                        unsigned short resource,
                                        TXVPD_CFG * cfg);
    TXXPORT short TXVPDFUNC TxVpdVport(TX_HANDLE handle,
                                       unsigned short resource,
                                       unsigned short vport_num,
                                       TXVPD_ADDR * addr);

    TXXPORT short TXVPDFUNC TxVpdAttach(TX_HANDLE handle,
                                        unsigned short vport_num,
                                        void *userkey,
                                        TXVPD_DPR_REQ * dprreq);
    TXXPORT short TXVPDFUNC TxVpdEnable(TX_HANDLE handle, void *userkey,
                                        unsigned long cpkey,
                                        TXVPD_DPR_REQ * dprreq);
    TXXPORT short TXVPDFUNC TxVpdDisable(TX_HANDLE handle, void *userkey,
                                         unsigned long cpkey,
                                         TXVPD_DPR_REQ * dprreq);
    TXXPORT short TXVPDFUNC TxVpdDetach(TX_HANDLE handle, void *userkey,
                                        unsigned long cpkey,
                                        TXVPD_DPR_REQ * dprreq);
 ...
 * TxVpd Packet Fill Functions
 *---------------------------------------------------------------------------*/
    TXXPORT short TXVPDFUNC TxVpdReqInit(TX_HANDLE handle,
                                         TXVPD_DPR_REQ * vpdreq,
                                         unsigned char msgnum);

    TXXPORT short TXVPDFUNC TxVpdResDflt(TXVPD_RES * res);
    TXXPORT short TXVPDFUNC TxVpdResDef(TXVPD_RES * res,
                                        unsigned short resource,
                                        unsigned char hw_type,
                                        unsigned char hw_num,
                                        unsigned char protocol);
    TXXPORT short TXVPDFUNC TxVpdResTdm(TXVPD_RES * res, unsigned char stream,
                                        unsigned char channel,
                                        unsigned char count);

    TXXPORT short TXVPDFUNC TxVpdCfgDflt(TXVPD_CFG * cfg,
                                         unsigned long rxfrm);
    TXXPORT short TXVPDFUNC TxVpdCfgHdlc(TXVPD_CFG * cfg,
                                         unsigned short logparms,
                                         unsigned long intclkbr);

    TXXPORT short TXVPDFUNC TxVpdAddrDef(TXVPD_ADDR * addr,
                                         unsigned char priority,
                                         unsigned char flags,
                                         unsigned char num_addrs,
                                         unsigned long addr1,
