...
#define AG_BOARDTYPE_AG8PCI  0x506   /* Obsolete  - gs */
#define AG_BOARDTYPE_CPCI_QT 0x507
#define AG_BOARDTYPE_CPCI_QE 0x508
#define AG_BOARDTYPE_4000T1  0x509
#define AG_BOARDTYPE_AG2QT   0x509   /* Obsolete  - gs */
#define AG_BOARDTYPE_4000E1  0x50A
#define AG_BOARDTYPE_AG2QE   0x50A   /* Obsolete  - gs */
...
\*------------------------------------------------------------------*/
    ...
    typedef struct nms_config_framer_parms NMS_CONFIG_FRAMER_PARMS ;
    ...
    typedef struct nms_config_channel_parms NMS_CONFIG_CHANNEL_PARMS ;
