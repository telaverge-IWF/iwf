...
typedef enum _HSM_MESSAGE
{
    ...
    HSM_CLOSE_CONNECTION,           /* Disconnect from HS Manager */

    /* messages coming to and from application        */
    /* responsible for the board software preparation */
    HSM_PREPARE_BOARD,              /* request to prepare Board        */
        HSM_BOARD_PREPARED,         /* reply - Board is prepared       */
        HSM_PREPARE_BOARD_FAILED,   /* reply - failed to prepare Board */
        HSM_FOREIGN_BOARD,          /* reply - board is foreign        */

    /* messages coming to HSM aware application */
    HSM_BOARD_READY,                /* Board is ready for application usage           */
    HSM_EXTRACT_PENDING,            /* request to close handles to driver             */
    HSM_EXTRACT_CANCELED,           /* request to close handles to driver is canceled */

    /* action messages to HSM */
    HSM_INSERT_BOARD,               /* Request to HSM to process board insertion  */
    HSM_EXTRACT_BOARD,              /* Request to HSM to process board extraction */

    /* queries and commands to HS Manager */
    HSM_QUERY_HSM_STATE,            /* query HS Manager state                  */
        HSM_REPLY_HSM_STATE,        /* reply to query HS Manager state         */
    HSM_QUERY_SLOT_INFO,            /* query logical slot information          */
        HSM_REPLY_SLOT_INFO,        /* reply to query slot                     */
    HSM_QUERY_SLOT_BY_IDENT_DATA,   /* get logical slot by identification data */
        HSM_REPLY_SLOT_BY_IDENT_DATA,/* reply to query ident. data             */

    HSM_WRONG_CODE,                 /* wrong message code */
    ...
    HSM_BOARD_PHYSICALLY_EXTRACTED, /* Board is physically extracted (P0) */
    HSM_BOARD_PHYSICALLY_INSERTED,  /* Board is physically inserted (S0)  */
    HSM_BOARD_CONFIGURED,           /* Board is configured (S1)           */
    HSM_BOARD_CONFIGURE_FAILED,	    /* Failed to configure board (S1F)    */
    HSM_BOARD_EXTRACTION_CONFIGURED,/* "Configured Board"   is in extraction state (S1E)   */
    HSM_BOARD_EXTRACTION_UNCONFIGURED,/* "Unconfigured Board" is in extraction state (S0E) */

    /* these messages come from Device Driver */
    HSM_DRIVER_NO_CHANNELS,         /* All channels are closed */
    ...
    HSM_S1_S1F,                     /* Failed to start device      */
    HSM_S1I_S1B,                    /* Board preparation requested */
    HSM_S1F_S0,             	    /* Extraction is authorized    */
    HSM_S1F_S1,                     /* Insert board command        */
    HSM_S1B_S0,                     /* Extraction is authorized    */
    HSM_S1B_S2,                     /* Board is ready              */
    HSM_S1B_S1BF,                   /* Failed to prepare board     */
    HSM_S1BF_S0,                    /* Extraction is authorized    */
    HSM_S1BF_S1I,                   /* Insert board command        */
    HSM_S2_S2R,                     /* Handle is opened            */
    HSM_S2R_P0,                     /* "Surprise extraction"       */
    HSM_S2R_S0,                     /* Extraction is authorized    */
    HSM_S2R_S2,                     /* Handle is closed            */
...
#define HSM_SET_BOARD_PREPARE_MESSAGE_MASK(mask) HSM_SET_BIT(mask,HSM_PREPARE_BOARD)
...
{	/* code returned by HS Manager functions */
    ...
    HSMC_FAIL                       /* operation failed for some other reason           */
                                    /* (usually wrong return code from TSI functions)   */
