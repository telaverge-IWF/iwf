...
* REV   DATE           WHO
* REV   DATE           WHO       Revision 8.2  2005/03/21 13:55:12  cvsadmin
...
* REV   DATE           WHO
* REV   DATE           WHO       Revision 5.1  2001/08/16 20:46:37  mmiers
* REV   DATE           WHO       Start PR6.
* REV   DATE           WHO
* REV   DATE           WHO       Revision 4.1  2001/05/04 16:22:07  mmiers
* REV   DATE           WHO       Start PR5.
* REV   DATE           WHO
* REV   DATE           WHO       Revision 1.1  2000/08/31 17:28:41  hxing
* REV   DATE           WHO       Add project for NMS SS7 2.12
...
unsigned short  TXXPORT TXCPIFUNC cpi_cptoh_s        (unsigned short src);
unsigned long   TXXPORT TXCPIFUNC cpi_cptoh_l        (unsigned long src);
unsigned short  TXXPORT TXCPIFUNC cpi_htocp_s        (unsigned short src);
unsigned long   TXXPORT TXCPIFUNC cpi_htocp_l        (unsigned long src);
...
TXXPORT unsigned short TXCPIFUNC cpi_cptoh_s        (unsigned short src);
TXXPORT unsigned long  TXCPIFUNC cpi_cptoh_l        (unsigned long src);
TXXPORT unsigned short TXCPIFUNC cpi_htocp_s        (unsigned short src);
TXXPORT unsigned long  TXCPIFUNC cpi_htocp_l        (unsigned long src);
