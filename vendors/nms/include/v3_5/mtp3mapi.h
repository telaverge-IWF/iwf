...
#define MTP3_CTRL_LINK_LPO      117 /* Emergency condition on */
#define MTP3_CTRL_LINK_LPR      118 /* Emergency condition off */
#define MTP3_CTRL_LINK_EMG      119 /* Start local processor outage */
#define MTP3_CTRL_LINK_NRM      120 /* End local processor outage */
...
typedef struct _MTP3GenCfg
{
   ...
   U16 spare3;                  /* Make an even number of longs */
} MTP3GenCfg;
...
typedef struct _MTP3LinkCfg
{
   ...
   U16 spare3;                  /* End structure on even 4-byte boundardy */
} MTP3LinkCfg;
