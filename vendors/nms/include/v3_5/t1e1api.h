...
TXXPORT short TXT1E1FUNC TxT1E1Open( TXBOARD_T board, unsigned short swint );

TXXPORT void TXT1E1FUNC TxT1E1Close( short handle );

TXXPORT short TXT1E1FUNC TxT1E1ConfigCarrier( short handle, unsigned char carrier,
                                                   TxT1E1Config *pConfig );

TXXPORT short TXT1E1FUNC TxT1E1CarrierStatus( short handle, unsigned char carrier,
                                                   unsigned char flags,
...
TXXPORT short TXT1E1FUNC TxT1E1PerfReport( short handle, unsigned char carrier,
                                                unsigned char flags,
                                                unsigned short *pCurrInterval,
                                                TxT1E1Stats *pCurrStats,
                                                unsigned short *pValidInterval,
...
TXXPORT short TXT1E1FUNC TxT1E1CtrlCarrier( short handle, unsigned char carrier,
                                                 unsigned char loopback,
                                                 unsigned char alarmState );

TXXPORT short TXT1E1FUNC TxT1E1ConditionChan( short handle, unsigned char carrier,
                                                   unsigned char channel,
                                                   unsigned char control,
                                                   unsigned char pattern );

TXXPORT short TXT1E1FUNC TxT1E1ConfigChan( short handle, unsigned char carrier,
                                                unsigned char channel,
                                                unsigned char transparent );

TXXPORT short TXT1E1FUNC TxT1E1ChannelStatus( short handle, unsigned char carrier,
                                                   unsigned long *pTransparent,
                                                   unsigned long *pRxABCD,
                                                   unsigned long *pTxABCD );

TXXPORT short TXT1E1FUNC TxT1E1SuperviseCarrier( short handle, unsigned char carrier,
