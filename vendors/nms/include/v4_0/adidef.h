...
*    . ADI ERRORS
*
*  Copyright (c) 1994-2004 NMS Communications. All rights reserved.
*****************************************************************************/
...
#include "nmshw.h" /* NMS boards EEPROM content */
...
#define ADI_DRIVER_ONLY     ((DWORD)-2)
#define ADI_AG_DRIVER_ONLY  ADI_DRIVER_ONLY    /* obsolete */
...
/*------ 'adiAssertSignal' indirect Values----------------------------------*/
#define ADI_SIGNAL_OBS_IDLE        0x10
#define ADI_SIGNAL_OBS_SEIZE       0x11
#define ADI_SIGNAL_OBS_PULSE_BREAK 0x12
#define ADI_SIGNAL_OBS_SEIZE_ACK   0x13
#define ADI_SIGNAL_OBS_FLASH       0x14
#define ADI_SIGNAL_OBS_ANSWER      0x15
#define ADI_SIGNAL_OBS_CLEAR       0x16
#define ADI_SIGNAL_OBS_BLOCK       0x17
...
#define ADI_COLLECT_QUIETLY 0x10000
...
#define ADI_ENCODE_GSM       24 /* MS GSM */

#define ADI_ENCODE_VOX_32    25 /* Special ADPCM 32kbs for QX boards (4 B/ms) */

#define ADI_ENCODE_G723_5    26 /* G.723 5.3 kbps/30 ms     */
#define ADI_ENCODE_G723_6    27 /* G.723 6.3 kbps/30 ms     */
#define ADI_ENCODE_G729A     28 /* G.729a  8 kbps/10 ms     */

/* Dsp file AMR.M54 */
#define ADI_ENCODE_AMR_475   32 /* AMR 4.75 kbps/20ms */
#define ADI_ENCODE_AMR_515   33 /* AMR 5.15 kbps/20ms */
#define ADI_ENCODE_AMR_59    34 /* AMR 5.90 kbps/20ms */
#define ADI_ENCODE_AMR_67    35 /* AMR 6.70 kbps/20ms */
#define ADI_ENCODE_AMR_74    36 /* AMR 7.40 kbps/20ms */
#define ADI_ENCODE_AMR_795   37 /* AMR 7.95 kbps/20ms */
#define ADI_ENCODE_AMR_102   38 /* AMR 10.2 kbps/20ms */
#define ADI_ENCODE_AMR_122   39 /* AMR 12.2 kbps/20ms */

/* Multi-Media audio and video codecs */
#define ADI_ENCODE_NATIVE_AMRNB      41 /* Native Audio AMRNB   */
#define ADI_ENCODE_NATIVE_G_723_1    42 /* Native Audio G.723.1 */
#define ADI_ENCODE_NATIVE_MPEG4      43 /* Native Video MPEG4   */
#define ADI_ENCODE_NATIVE_H_263      44 /* Native Video H.263   */
#define ADI_ENCODE_NATIVE_H_263P     45 /* Native Video H.263+  */
#define ADI_ENCODE_NATIVE_G_711      78 /* Native Audio G.711 */
#define ADI_ENCODE_NATIVE_H_264      91 /* Native Video H.264   */

/* EDTX = proprietary NMS Audio Format for Network/IVR play/record */
#define ADI_ENCODE_EDTX_MU_LAW     46 /* Extended DTX Audio G.711 Mu Law */
#define ADI_ENCODE_EDTX_A_LAW      47 /* Extended DTX Audio G.711 A Law  */

#define ADI_ENCODE_EDTX_G_726      48 /* Extended DTX Audio G.726 32k    */
#define ADI_ENCODE_EDTX_G_726_BE   62 /* Extended DTX Audio G.726 Big Endian */ 

#define ADI_ENCODE_EDTX_G_729a     49 /* Extended DTX Audio G.729a       */

#define ADI_ENCODE_EDTX_G_723      50 /* Extended DTX Audio G.723.1      */
#define ADI_ENCODE_EDTX_G_723_5    51 /* Extended DTX Audio G.723.1 5.3k */
#define ADI_ENCODE_EDTX_G_723_6    52 /* Extended DTX Audio G.723.1 6.3k */

#define ADI_ENCODE_EDTX_AMRNB      53 /* Extended DTX Audio AMR */
      /* following are for recording AMR EDTX from DSP where rate is required */
#define ADI_ENCODE_EDTX_AMRNB_475  54 /* Extended DTX Audio AMR 4.75 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_515  55 /* Extended DTX Audio AMR 5.15 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_59   56 /* Extended DTX Audio AMR 5.90 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_67   57 /* Extended DTX Audio AMR 6.70 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_74   58 /* Extended DTX Audio AMR 7.40 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_795  59 /* Extended DTX Audio AMR 7.95 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_102  60 /* Extended DTX Audio AMR 10.2 kbps/20ms*/
#define ADI_ENCODE_EDTX_AMRNB_122  61 /* Extended DTX Audio AMR 12.2 kbps/20ms*/



/* ADI Port modes set by adiPortConfig */
#define ADI_NATIVE       1 /* play/record direct to RTP if possible: requires */
                           /*  the encoding type to match the RTP endpoint    */
#define ADI_IVR_ONLY     2 /* play/record to IVR DSP only */
...
// frame formats for EDTX native record frames
#define VARIABLE_FRAME_SIZE_W_COMPRESSED_SILENCE 0
#define VARIABLE_FRAME_SIZE_W_EXPANDED_SILENCE   1
#define FIXED_FRAME_SIZE_W_COMPRESSED_SILENCE    2
#define FIXED_FRAME_SIZE_W_EXPANDED_SILENCE      3
typedef struct
{                          
   DWORD    size;          /*   size of this structure                      */
   DWORD    mode;          /* mode for play/rec: ADI_NATIVE or ADI_IVR_ONLY */ 
   DWORD    play_encoding; /* EDTX encoding type                            */  
   DWORD    rec_encoding;  /* EDTX encoding type                            */  
   DWORD    frameFormat;   /* frame format used in record buffers           */
   DWORD    include2833;   /* include RFC2833 markers in record buffers     */
   DWORD    payloadID;     /* payload ID for egress RTP                     */
   DWORD    nsPayload;     /* nonstd Payload indicator (AMR IF2) for egress */
   DWORD    vadFlag;       /* VAD enable/disable sending of SID frames      */
} ADI_NATIVE_CONTROL;
...
DWORD NMSAPI adiSetNativeInfo(    /* Setup ADI port play/record mode        */
  CTAHD               ctahd,      /*   context handle                       */
  DWORD               ingresshd,  /*   ingress (record) jitter filter handle*/ 
  DWORD               egresshd,   /*   egress (play) RTP filter handle      */
  ADI_NATIVE_CONTROL *settings);  /*   Native play/record control structure */
...
DWORD NMSAPI adiPlayMMFromMemory( /* Plays directly from memory             */
  CTAHD            ctahd,         /*   context handle                       */
  unsigned         encoding,      /*   encoding types (see above)           */
  void            *buffer,        /*   pointer to buffer area with data     */
  unsigned         bufsiz,        /*   size of the buffer in bytes          */
  DWORD            ephd,          /* MSPP EP handle */
  ADI_PLAY_PARMS  *parms );       /*   play parameters                      */
...
DWORD NMSAPI adiPlayMMAsync(      /* Application submits buffers            */
  CTAHD            ctahd,         /* context handle                         */
  unsigned         encoding,      /* encoding types                         */
  void            *buffer,        /* pointer to buffer area with data       */
  unsigned         bufsiz,        /* size of the buffer in bytes            */
...
typedef struct
{
    ...
    DWORD startonvideoIframe;     /* Native video i-frame start */
    DWORD maxtime;                /* Native record timeout(ms) */
    DWORD novideotime;            /* Native video record timeout(ms) at start*/
    DWORD videotimeout;           /* Native video record timeout(ms) in prog*/
} ADI_MM_RECORD_PARMS;
...
DWORD NMSAPI adiRecordMMToMemory( /* Records directly into a memory buffer  */
  CTAHD             ctahd,        /*   context handle                       */
  unsigned          encoding,     /*   encoding types (see above)           */
  void             *buffer,       /*   pointer to buffer area with data     */
  unsigned          bufsiz,       /*   size of the buffer in bytes          */
  DWORD             video_ephd,   /*   MSPP EP handle for video channel     */
  DWORD             audio_ephd,   /*   MSPP EP handle for audio channel     */
  ADI_MM_RECORD_PARMS *parms );   /*   record parameters                    */
...
DWORD NMSAPI adiRecordMMAsync(    /* Records directly into a memory buffer  */
  CTAHD             ctahd,        /*   context handle                       */
  unsigned          encoding,     /*   encoding types (see above)           */
  void             *buffer1,      /*   pointer to 1st target buffer         */
  unsigned          bufsiz,       /*   size of the buffer in bytes          */
...
DWORD NMSAPI adiCommandRecord(    /* Send data array to record DSP function */
  CTAHD             ctahd,        /*   context handle                       */
  WORD              data[],       /*   array of 16-bit data                 */
  DWORD             nwords );     /*   number of 16-bit data words          */
...
DWORD NMSAPI adiInsertDigit(      /* Insert a digit into the internal buffer*/
  CTAHD            ctahd,         /* context handle                         */
  char             digit);        /* Digit to enter into the buffer         */
...
#define ADI_MAX_TONE_DETECTORS 6
...
{                                 /* adiPlaceCall in ADI_PLACECALL_PARMS.   */
    ...
    DWORD precmask;     /* Precise tone mask.                               */
                        ...
                        #define ADI_CPMSK_PRECISE_425      0x0008
                        #define ADI_CPMSK_PRECISE_SITEXT   0x0010
                        #define ADI_CPMSK_PRECISE_TDD      0x0020
                        #define ADI_CPMSK_PRECISE_NU       0x0040
...
{                                 /* call control parameters:               */
    ...
    DWORD eventmask;              /*   report low-level call-control events:*/
          ...
          #define ADI_CC_REPTANSSUP     0x0080 /* Report Answer Supervision */
          #define ADI_CC_REPTHOLDIND    0x0100 /* ADIEVN_HOLD_INDICATION    */
    ...
    DWORD mediamask;              /*   functions to run during conversation:*/
          ...
          #define ADI_CC_RESVMF         0x0200 /* reserve MF detection      */
    ...
    DWORD debugmask;              /*   protocol debug (low-level events):   */
          ...
          #define ADI_CC_DBGTONES      0x0010 /* report all tone begin/ends */
} ADI_CALLCTL_PARMS;
...
{                                 /* parameters for echo cancelling:        */
    DWORD  size ;                 /*   size of this structure               */
    DWORD  mode ;                 /****   SEE BIT DEFINITIONS BELOW      ****/
...
/* Values for 'mode' parameter, default is 0.                               */
/* The first 2 bits define the filterlength and adapttime to use when       */
/* starting the echo canceler.  If both bits are zero, then echo canceller  */
/* is not started.  These 2 bits are ignored by adiModfiyEchoCanceler.      */

/*                BIT MASK TO CONTROL ECHO CANCELLER OPTIONS                */
#define ADI_ECHOCANCEL_DEFAULT    0x0001 /* Choose best length and adapt-   */
                                         /* time based on board type        */
#define ADI_ECHOCANCEL_CUSTOM     0x0002 /* Use specified len and adapttime */

#define ADI_ECHOCANCEL_WINDOW     0x0004 /* 0-disable, 1-enable             */
                                         /* adaptive filter length. For QX  */
                                         /* boards only, ignore by AG boards*/
#define ADI_ECHOCANCEL_SUPPRESS   0x0008 /* 0-disable, 1-enable             */
                                         /* residual echo suppressor        */
#define ADI_ECHOCANCEL_NO_RESET   0x0010 /* 0-reset, 1-don't reset          */
                                         /* filter taps to zero             */
#define ADI_ECHOCANCEL_NO_ADAPT   0x0020 /* 0-enable, 1-disable             */
                                         /* filter taps adaptation          */
#define ADI_ECHOCANCEL_BYPASS     0x0040 /* 0-no bypass, 1-bypass           */
                                         /* the echo canceller              */
#define ADI_ECHOCANCEL_STATUS     0x0080 /* 0-no request, 1-request status  */
                                         /* of the echo canceller           */
#define ADI_ECHOCANCEL_AUTOSTATUS 0x0100 /* 0-disable, 1-enable             */
                                         /* auto status event generation    */
                                         /* when status of EC changes       */
#define ADI_ECHOCANCEL_COMFORTNOISE 0x0200 /* 0-disable, 1-enable           */
...
#define ADI_BILLINGRATE_CHARGE_CPC       1 /* call is billed; but has       */
                                           /* called party control, or      */
#define ADI_BILLINGRATE_SEND_PULSE       2 /* send metering pulse           */
                                           /* malicious call trace enabled  */
...
DWORD NMSAPI adiSetBilling(       /* Set billing mode of an incoming call   */
  ...
  unsigned         rate);         /*   the requested rate                   */
                                              /* while accepting a call...  */
#define ADI_ACCEPT_PLAY_RING                1 /* play ringback tone         */
#define ADI_ACCEPT_QUIET                    2 /* play silence               */
#define ADI_ACCEPT_USER_AUDIO               3 /* user provides audio that   */
                                              /* stops when call answered   */
#define ADI_ACCEPT_USER_AUDIO_INTO_CONNECT  4 /* user provides audio that   */
                                              /* continues after answered   */
...
{                                 /* used by adiGetCallStatus()             */
    ...
    char  datetime [8];           /* date/time of call delivery  MMDDhhmm   */
...
#define ADI_CON_TDD_DETECTED      13  /* out-bound TTY/TDD detected         */
...
#define ADI_DIS_UNASSIGNED_NUMBER 28  /* called number is not allocated     */
...
#define ADI_DIS_CONGESTION        32  /* network responded with congestion  */
#define ADI_DIS_REJECTED          33  /* network responded with reject msg  */
#define ADI_DIS_PREEMPTED_REUSE   34  /* call preempted - trunk reused      */
#define ADI_DIS_PREEMPTED_IDLE    35  /* call preempted - trunk not reused  */
...
#define  ADI_CCDBG_RING_FALSE  0x000       /* disqualified                  */
                                           /*------ 'ADI_CC_DBGTONES' ------*/
#define  ADI_CCDBG_TONE_END    0x110       /* tones during placecall        */
#define  ADI_CCDBG_TONE_BEGIN  0x111       /*                               */
                                           /*----- 'ADI_CC_DBGRINGTONE' ----*/
...
#define  ADI_CCDBG_REANSWER     0x400      /* Reanswer (used in MFC-R2)     */
#define  ADI_CCDBG_CALL_TRACE   0x401      /* malicious call trace invoked  */
#define  ADI_CCDBG_TRUNK_OFFER  0x403      /* trunk offer                   */
#define  ADI_CCDBG_CANCEL_OFFER 0x404      /* cancel trunk offer            */
#define  ADI_CCDBG_RERING       0x405      /* rering                        */
...
DWORD NMSAPI adiDefineSignal(
  CTAHD            ctahd,
  WORD             patterns[],    /* array of WORD patterns                 */
  unsigned         npatterns);    /* number of elements in array            */
...
/*====== ECHO CANCELLATION =================================================*/
DWORD NMSAPI adiModifyEchoCanceller(
                                  /* Modify Echo Cancelling                 */
  CTAHD                ctahd,     /*   port handle                          */
  ADI_ECHOCANCEL_PARMS *parms);   /*   Echo Canceller parameters            */
...
DWORD NMSAPI adiCommandEchoCanceller (
                                  /* Send a command to Echo Canceller DSP   */
...
/* The following parameter IDs are provided for calling ctaGetParms()
...
DWORD NMSAPI adiGetBoardSlots32(    /* Returns configured timeslots on a board*/
    CTAHD          ctahd,         /* CT Access context handle               */
    unsigned       board,         /* AG board number                        */
    unsigned       mode,          /* ADI_VOICE_DUPLEX, ADI_FULL_DUPLEX      */
    unsigned       maxslot,       /* Maximum number of entries in array     */
    ADI_TIMESLOT32 *slotlist,     /* Returned array of timeslots            */
    unsigned      *numslots );    /* returned number of entries             */
...
#define ADI_BOARDTYPE_CG6000C_QUAD   30     /* CG 6000 cPCI */
#define ADI_BOARDTYPE_2000DPBX       31     /* AG2000 + VTG CPM */
#define ADI_BOARDTYPE_AG2000BRI      32     /* AG2000 Quad BRI */
#define ADI_BOARDTYPE_AG2000C        33     /* 24 port analog on cPCI */

/* New ADI Board Types will correspond to "OAM Product Number" in nmshw.h */
#define ADI_BOARDTYPE_CG6000         OAM_PRODUCT_NO_CG6000  /* CG 6000 PCI */
#define ADI_BOARDTYPE_CG6100C        OAM_PRODUCT_NO_CG6100C
#define ADI_BOARDTYPE_CG6500C        OAM_PRODUCT_NO_CG6500C
#define ADI_BOARDTYPE_CG6060         OAM_PRODUCT_NO_CG6060
#define ADI_BOARDTYPE_CG6060C        OAM_PRODUCT_NO_CG6060C
#define ADI_BOARDTYPE_CG6565         OAM_PRODUCT_NO_CG6565
#define ADI_BOARDTYPE_CG6565C        OAM_PRODUCT_NO_CG6565C
#define ADI_BOARDTYPE_CGHOST         OAM_PRODUCT_NO_CGHOST
...
#define ADI_TRUNKTYPE_BRI            10     /* BRI                        */
...
#define ADIEVN_RECORD_EVENT        0x12034

                                           /* Echo Cancel Events:            */
#define ADIEVN_ECHOCANCEL_STATUS   0x12035
#define ADIEVN_ECHOCANCEL_TONE     0x12036
...
#define ADIEVN_TONE_4_BEGIN        0x12076
#define ADIEVN_TONE_4_END          0x12077
#define ADIEVN_TONE_5_BEGIN        0x12078
#define ADIEVN_TONE_5_END          0x12079
#define ADIEVN_TONE_6_BEGIN        0x1207A
#define ADIEVN_TONE_6_END          0x1207B
...
#define ADIEVN_START_CC_ASSIST_DONE  0x12113
#define ADIEVN_STOP_CC_ASSIST_DONE   0x12114
...
#define ADIEVN_TONE_4_DETECT_DONE  0x12173
#define ADIEVN_TONE_5_DETECT_DONE  0x12174
#define ADIEVN_TONE_6_DETECT_DONE  0x12175
...
#define ADIERR_REC_BUFFER_TOO_BIG    0x1000b /* submitted a record buffer > max 
                                                buffer size for a variable rate 
                                                native record */
