/***************************************************************************\
 *
 *  nmshw.h - Definitions related to NMS Communications' hardware.
 *
 *
 * Copyright (c)1996-2002 NMS Communications Corporation. All rights reserved.
\***************************************************************************/
...
#define CGHOST_PRODUCT_TYPE_STRING "CGHOST"
#define CGHOST_DRIVER_NAME "cghost"
...
#define OAM_PRODUCT_NO_CG6500C               0x620
...
#define OAM_PRODUCT_NO_CGHOST                0x6FF  // host based pseudo device
...
#define AG_BOARDTYPE_4040    0x514   /* PCI version of AG 4040 */
#define AG_BOARDTYPE_4040C   0x515   /* cPCI version of AG 4040C */

/*-------------------------------------------------------------------------
* TX board entry for pciscan 
*-------------------------------------------------------------------------*/

#define TX_BOARDTYPE_4000    0x3430   /* PCI version of TX 4000 */
#define TX_BOARDTYPE_4000C   0x3431   /* cPCI version of TX 4000C */
...
#define AG_SUBTYPE_4040_NOLI  0x22
#define AG_SUBTYPE_4040_1TE   0x23
#define AG_SUBTYPE_4040_2TE   0x24
#define AG_SUBTYPE_4040_4TE   0x25
...
/*---------------------------------------------------------------------------
 *  RTM Assembly Level (EEPROM value).  This value is unique for each board variant.
 *
 *--------------------------------------------------------------------------*/
#define CG6060C_RTM_4_RJ45     51128
#define CG6060C_RTM_8_RJ45     51127
#define CG6565C_RTM_16_RJ21    51097
...
\*------------------------------------------------------------------*/
    ...
    #define NMS_ECHO_CHANNEL_BYPASS         0x80000007 /* hardware echo canceller */
    ...
    #define NMS_ECHO_CHANNEL_NLP            0x80000020  /* hardware echo canceller */
    #define NMS_ECHO_CHANNEL_AEC            0x80000021  /* hardware echo canceller */
    ...
    /*
     *   Per-channel control of hardware echo canceller on CG6060(C), CG6565(C)
     *
     */
    #define NMS_ECHO_BYPASS_DISABLE  0
    #define NMS_ECHO_BYPASS_ENABLE   1
    
    typedef struct
    {
        DWORD bypass;  // 0=no bypass, 1=echo canceller bypassed

    }  NMS_ECHO_CHANNEL_BYPASS_PARMS;

    #define NMS_ECHO_DISABLE_NLP     0
    #define NMS_ECHO_ENABLE_NLP      1
    ...
    #define NMS_ECHO_DISABLE_AEC     0
    #define NMS_ECHO_ENABLE_AEC      1
