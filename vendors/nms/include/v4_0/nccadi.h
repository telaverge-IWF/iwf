...
#define NCC_ALL_MEDIA (NCC_RESERVE_DTMF|NCC_RESERVE_SILENCE|\
                       NCC_RESERVE_CLEARDOWN|NCC_AUTO_DTMF|NCC_AUTO_ECHO)
#define NCC_ACCEPT_DTMF        0x0100 /* dtmf detection in accept           */
#define NCC_RESERVE_MF         0x0200 /* reserve mf detection               */
...
#define NCC_CPMSK_PRECISE_425    0x0008
#define NCC_CPMSK_PRECISE_SITEXT 0x0010
#define NCC_CPMSK_PRECISE_TDD    0x0020
#define NCC_CPMSK_PRECISE_NU     0x0040
