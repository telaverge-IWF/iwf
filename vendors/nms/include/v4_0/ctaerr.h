...
*  services.
*
*  Copyright (c) 1996-2005  NMS Communications.  All rights reserved.
*****************************************************************************/
 ...
 * C/S CTA errors
 */
#define CTAERR_LOAD_LIB             0x00000040 /* ERROR load CTA Core library */
#define CTAERR_SVR_COMM             0x00000041 /* server communication error  */
#define CTAERR_BAD_NAME             0x00000042 /* bad name parameter          */
#define CTAERR_ENUM_END             0x00000043 /* end of list reached         */
#define CTAERR_EVNT_BUF             0x00000044 /* event buffer size is small  */
#define CTAERR_INVALID_LIB          0x00000045 /* invalid CTA library is used */
#define CTAERR_NOSVC_ON_SERVER      0x00000046 /* service not avail. on server*/
#define CTAERR_INCOMPATIBLE_SERVICES 0x00000047/* services incompatible on 
                                                   different servers          */
...
#define CTA_GENERIC_ERRORS() \
        ...
        _TEXTCASE_(CTAERR_LOAD_LIB); \
        _TEXTCASE_(CTAERR_SVR_COMM); \
        _TEXTCASE_(CTAERR_BAD_NAME); \
        _TEXTCASE_(CTAERR_ENUM_END); \
        _TEXTCASE_(CTAERR_INVALID_LIB); \
        _TEXTCASE_(CTAERR_NOSVC_ON_SERVER); \
        _TEXTCASE_(CTAERR_INCOMPATIBLE_SERVICES);
...
/* Native record reasons */
#define CTA_REASON_NO_VIDEO      0x00001009 /* Native record no video ever 
                                                recorded                      */
#define CTA_REASON_MAXTIME_AUDIO 0x0000100a /* Native record audio max record 
                                                time reached                  */
#define CTA_REASON_MAXTIME_VIDEO 0x0000100b /* Native record video max record 
                                                time reached                  */
#define CTA_REASON_VIDEO_END     0x0000100c /* Native record video pkts stop
                                                (after pkts start)            */
#define CTA_REASON_NATIVE_COMPANION_RECORD_STOPPED 0x0000100d /* Native record 
                                                 stopped on companion channel */
...
#define CTA_GENERIC_REASONS() \
        ...
        _TEXTCASE_(CTA_REASON_NO_VIDEO); \
        _TEXTCASE_(CTA_REASON_MAXTIME_AUDIO); \
        _TEXTCASE_(CTA_REASON_MAXTIME_VIDEO); \
        _TEXTCASE_(CTA_REASON_VIDEO_END); \
        _TEXTCASE_(CTA_REASON_NATIVE_COMPANION_RECORD_STOPPED); 
