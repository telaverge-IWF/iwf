...
#define TUP_OVERRUN         0x1001
#define TUP_UNDERRUN        0x1002
#define TUP_UNBOUND         0x1003
#define TUP_BOARD           0x1004
#define TUP_DRIVER          0x1005
#define TUP_NOMSG           0x1006
#define TUP_NOTBOUND        0x1007
#define TUP_FAILED          0x1008 */
...
#define TUP_ADDRIND_NAT         0x00        /* National address indicator       */
#define TUP_ADDRIND_INT         0x01        /* International address indicator  */
...
typedef struct _TUPGenParms
{
    ...
    U32         txmonTimeout;           /* Time to wait for define of circuits to complete */
    ...
    PDesc       stkMgr;
    U32         traceFlags;              /* Trace flags for debug information */
    U8          chkptType;               /*  Turn on or off automatic check pointing */
#define TUP_CHKPT_NONE     0
#define TUP_CHKPT_AUTO     1
    U8          haState;                /* High availability state */
    U8          mcState;                /* Mate connection state */
    U8          spare2;
    TimerCfg    MtpPauseTmr;
} TUPGenParms;
...
typedef struct _TUPUSapCfg
{
    ...
    S16         QCongOnsetLvl1;         /* configurable onset value for level 0 */
    S16         QCongAbateLvl1;         /* configurable abatement value for level 1 */
    S16         QCongOnsetLvl2;         /* configurable onset value for level 1 */
    S16         QCongAbateLvl2;         /* configurable abatement value for level 2 */
    S16         QCongOnsetLvl3;         /* configurable onset value for level 2 */
    S16         QCongAbateLvl3;         /* configurable abatement value for level 3 */
    U16         spare1;                 /* Spare alignment */
    QTABLE      userQTble;              /* user queue cong. onset/abatement thersholds */
    QueueId     userQueue;              /* user queue ID */
    U8          userQcongLvl;           /* current user queue congestion level */
    U8          currInbCongLvl;         /* current inbound congestion level */
    U8          currOutbCongLvl;         /* current outbound congestion level */
} TUPUSapCfg;

/*Congestion event structure*/
typedef struct _TUPCongestionEvnt
{
    U32         userKey;
    QueueId     queueId;
    U8          congState;
...
typedef struct _TUPCircCfg
{
    ...
    U16         cic;                    /* cic */
    U16         spare1;                 /* Spare alignment */
    U32         altOrgPointCode;        /* originating point code */
    ...
    TimerCfg    t18;
    TimerCfg    t19;
    TimerCfg    t25;                    /* t25 timer - Group blocking  */
} TUPCircCfg;
...
#define TRACE_EVENT       1<<2
#define TRACE_DATA        1<<3
#define ENCODE_ERROR      1<<4
#define ENUM_WARNING      1<<5
#define INIT_ELMT_DBG     1<<6
#define TMR_TRACE         1<<7
...
void TXTUPMGMTFUNC TUPInitCircCfg(TUPCircCfg *cfg, U32 circId, U32 opc, U32 dpc);
...
S16  TXTUPMGMTFUNC TUPTraceControl(U8 board, Bool onOff, U32 flags);
