...
#define MTP3_UBIND_REQ      0x08
#define MTP3_UBIND_CFM      0x09
...
typedef struct stat_ind_s {
  ...
  U32     opc;           /* the Originating Point Code this status is about     */
...
typedef struct
{
    ...
    U32 rxLastErr;          /* error code from last failed receive request */
...
#define MTP3_UNBIND_FLAG_OFF    2
#define MTP3_UNBIND_FLAG_ON     3
...
#define MTP3_SUCCESS    0   /* API completed successfully; the same as CT Access success  */
