/*****************************************************************************
  ...
  PURPOSE:
      ...
      This file contains macros and function prototypes associated with 
      the OAM service.
...
#define OAM_MINORREV                        19

/*-----------------------------------------------------------------------------
  OAM API Compatibility Level Id
      Natural Access applications can compare this "hard coded" value against
      the value in the currently installed OAM service (as determined via
...
// "request" events inform app that something is about to happen.
#define OAMEVN_STOPBOARD_REQ    0x40002201
...
#define OAMERR_DB_NOT_FOUND         0x4000000A
...
typedef unsigned long HMOBJ;        // handle to a managed object
typedef unsigned long HOAMCLIENT;   // handle to an OAM client (caller-defined DWORD)
...
DWORD NMSAPI oamBoardLookupByShelfSlot( CTAHD ctahd, DWORD dwShelf, DWORD dwSlot, char *szName, DWORD dwNameSize );
DWORD NMSAPI oamBoardLookupByMACAddress( CTAHD ctahd, const char *szMACAddress, char *szName, DWORD dwNameSize );
...
DWORD NMSAPI oamBoardGetShelfSlot( CTAHD ctahd, const char *szName, DWORD *pdwShelf, DWORD *pdwSlot );
DWORD NMSAPI oamBoardGetMACAddress( CTAHD ctahd, const char *szName, char *szMACAddress, DWORD dwMACAddressSize, DWORD dwMACAddressIndex );
