...
#define VCE_ENCODE_GSM      24   /* MS GSM */

#define VCE_ENCODE_G723_5   26   /* G.723 5.3 kbps/30 ms */
#define VCE_ENCODE_G723_6   27   /* G.723 6.3 kbps/30 ms */
#define VCE_ENCODE_G729A    28   /* G.729a  8 kbps/10 ms */


/* Dsp file AMR.M54 */
#define VCE_ENCODE_AMR_475   32 /* AMR 4.75 kbps/20ms */
#define VCE_ENCODE_AMR_515   33 /* AMR 5.15 kbps/20ms */
#define VCE_ENCODE_AMR_59    34 /* AMR 5.90 kbps/20ms */
#define VCE_ENCODE_AMR_67    35 /* AMR 6.70 kbps/20ms */
#define VCE_ENCODE_AMR_74    36 /* AMR 7.40 kbps/20ms */
#define VCE_ENCODE_AMR_795   37 /* AMR 7.95 kbps/20ms */
#define VCE_ENCODE_AMR_102   38 /* AMR 10.2 kbps/20ms */
#define VCE_ENCODE_AMR_122   39 /* AMR 12.2 kbps/20ms */

/*  proprietary NMS Audio Format for Network/IVR play/record */
#define VCE_ENCODE_EDTX_MULAW      46 /* Extended DTX Audio G.711 Mu Law */
#define VCE_ENCODE_EDTX_ALAW       47 /* Extended DTX Audio G.711 A Law  */

#define VCE_ENCODE_EDTX_G726       48 /* Extended DTX Audio G.726 32k    */
#define VCE_ENCODE_EDTX_G726_BE    62 /* Extended DTX Audio G.726 32k Big Endian */ 

#define VCE_ENCODE_EDTX_G729A      49 /* Extended DTX Audio G.729a       */

#define VCE_ENCODE_EDTX_G723       50 /* Extended DTX Audio G.723.1      */
#define VCE_ENCODE_EDTX_G723_5     51 /* Extended DTX Audio G.723.1 5.3k */
#define VCE_ENCODE_EDTX_G723_6     52 /* Extended DTX Audio G.723.1 6.3k */

#define VCE_ENCODE_EDTX_AMRNB      53 /* Extended DTX Audio AMR */
/* following are for recording AMR EDTX from DSP where rate is required */
#define VCE_ENCODE_EDTX_AMRNB_475  54 /* Extended DTX Audio AMR 4.75 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_515  55 /* Extended DTX Audio AMR 5.15 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_59   56 /* Extended DTX Audio AMR 5.90 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_67   57 /* Extended DTX Audio AMR 6.70 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_74   58 /* Extended DTX Audio AMR 7.40 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_795  59 /* Extended DTX Audio AMR 7.95 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_102  60 /* Extended DTX Audio AMR 10.2 kbps/20ms*/
#define VCE_ENCODE_EDTX_AMRNB_122  61 /* Extended DTX Audio AMR 12.2 kbps/20ms*/
