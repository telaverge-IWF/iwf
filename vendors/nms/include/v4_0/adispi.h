...
DWORD NMSAPI adiSpiSetNativeInfo (  /* Setup Native playing/rocording */
    CTAHD            ctahd,      /* handle as obtained from adiOpenPort()    */
    DWORD            ingresshd,  /* MSP ingress filter handle */
    DWORD            egresshd,   /* MSP egress filter handle */ 
    ADI_NATIVE_CONTROL *parms,   /* pointer to native play/record parameters */
...
DWORD NMSAPI adiSpiPlayMMFromMemory (
    CTAHD           ctahd,
    unsigned        encoding,    /* encoding types                           */
    void           *buffer,      /* pointer to buffer area with data         */
    unsigned        bufsiz,      /* size of the buffer in bytes              */
...
DWORD NMSAPI adiSpiPlayMMAsync (
    CTAHD           ctahd,
    unsigned        encoding,    /* encoding types                           */
    void           *buffer,      /* pointer to buffer area with data         */
    unsigned        bufsiz,      /* size of the buffer in bytes              */
...
DWORD NMSAPI adiSpiRecordMMToMemory   (
    CTAHD             ctahd,
    unsigned          encoding,  /* encoding types                           */
    void             *buffer,    /* pointer to buffer area with data         */
    unsigned          bufsiz,    /* size of the buffer in bytes              */
...
DWORD NMSAPI adiSpiRecordMMAsync   (
    CTAHD             ctahd,
    unsigned          encoding,  /* encoding type                            */
    void             *buf1,      /* pointer to buffer area with data         */
    unsigned          bufsiz,    /* size of the buffer in bytes              */
    DWORD             video_ephd, /* MSPP EP handle for video channel        */
    DWORD             audio_ephd, /* MSPP EP handle for audio channel        */
    ADI_MM_RECORD_PARMS *parms,   /* pointers to record parameters            */
    WORD              source     /* calling application/service source id    */
                                 );

DWORD NMSAPI adiSpiCommandRecord   (
    CTAHD             ctahd,
...
DWORD NMSAPI adiSpiInsertDigit(  /* Insert a digit into the internal buffer  */
...
DWORD NMSAPI adiSpiStartCCAssist (
    CTAHD             ctahd,
    ADI_START_PARMS  *selparm,   /* Start parameters or NULL for defaults    */
    void             *reserved,
    WORD              source     /* calling application/service source id    */
...
DWORD NMSAPI adiSpiStopCCAssist  (
    CTAHD ctahd,
    WORD  source                /* calling application/service source id    */
                                 );
...
DWORD NMSAPI adiSpiDefineSignal  (
    CTAHD    ctahd,
...
/*====== ECHO CANCELLATION =================================================*/
DWORD NMSAPI adiSpiModifyEchoCanceller  (
    CTAHD                 ctahd,
    ADI_ECHOCANCEL_PARMS *parms, /* Echo canceling parameters                */
    WORD                  source /* calling application/service source id    */
                                       );
DWORD NMSAPI adiSpiCommandEchoCanceller  (
    CTAHD                 ctahd,
    WORD                  data[],  /*   array of 16 bit data      */
    DWORD                 nwords,  /*   number of 16-bit data words          */
    WORD                  source /* calling application/service source id    */
...
DWORD NMSAPI adiSpiGetBoardSlots32 (
    CTAHD           ctahd,     /* CTA context handle                     */
    unsigned        board,     /* AG board number                        */
    unsigned        mode,      /* ADI_VOICE_DUPLEX, ADI_FULL_DUPLEX      */
    unsigned        maxslot,   /* Maximum number of entries in array     */
