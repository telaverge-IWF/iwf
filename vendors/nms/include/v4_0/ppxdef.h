...
* 09/28/99 Add support for Lucent's HMIC switches 
*
...
#define PPX_ATI_SWITCH  0x1
#define PPX_FMIC_SWITCH 0x2
#define PPX_HMIC_SWITCH 0x3
 ...
 *                                 connection OR the switch is blocked 
 ...
 *                                 the "listener" OR the switch is blocked.
 *      PPXERR_NOT_TALKER        - The specified "talker" is incapable of 
 *                                 driving the output for the connection
 *      PPXERR_NOT_LISTENER      - The specified "listener" is incapable of 
 *                                 receiving output from the connection
...
/*****************************************************************************
 * Function - ppxCloseSwitch
 *
 * Description -
 * Force PPX to close a switch. 
 *
 * Returns -
 *  
 *   Immediate returns:
 ...
 *
 *****************************************************************************/
DWORD NMSAPI ppxCloseSwitch( CTAHD ctahd, unsigned switchnum );
...
#define PPXERR_NO_CFG_FILE               0x170010
