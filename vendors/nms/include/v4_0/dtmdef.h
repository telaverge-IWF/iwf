...
*  File - DTMDEF.H
*
*  Description - include file for the Digital Trunk Monitor (DTM) API
*
...
#define        DTM_BRI_STATE_NO_USED        0

/* cf ITU-T I.430 */
#define        DTM_BRI_STATE_F1            1
#define        DTM_BRI_STATE_F2            2
#define        DTM_BRI_STATE_F3            3
#define        DTM_BRI_STATE_F4            4
#define        DTM_BRI_STATE_F5            5
#define        DTM_BRI_STATE_F6            6
#define        DTM_BRI_STATE_F7            7
#define        DTM_BRI_STATE_F8            8

#define        DTM_BRI_STATE_G1           11
#define        DTM_BRI_STATE_G2           12
#define        DTM_BRI_STATE_G3           13
#define        DTM_BRI_STATE_G4           14

#define        DTM_BRI_TYPE_TE                4
#define        DTM_BRI_TYPE_NT                8


#define DTM_BRI_REPORT_STATE               0x02
#define DTM_BRI_REPORT_TYPE                0x04
#define DTM_BRI_REPORT_SLIPS               0x08
#define DTM_BRI_REPORT_ERRORS              0x10
#define DTM_BRI_REPORT_RX_TX               0x20
#define DTM_BRI_REPORT_CHANNELS            0x40

#define DTM_BRI_PROFILE           (DWORD)0x80000000
...
DWORD NMSAPI dtmGetTrunkStatus     (DTMHD dtmhd, DTM_TRUNK_STATUS *status,
                                     unsigned size);
DWORD NMSAPI dtmGetBriTrunkStatus  (DTMHD dtmhd, DTM_BRI_TRUNK_STATUS *status,
                                     unsigned size);
...
DWORD NMSAPI dtmAttachTrunkMonitor (CTAHD ctahd, unsigned board, unsigned trunk,
                                     DTMHD *dtmhd);
DWORD NMSAPI dtmSetLoopback        (DTMHD dtmhd, unsigned mode);
DWORD NMSAPI dtmGetLoopback        (DTMHD dtmhd, unsigned mode);
