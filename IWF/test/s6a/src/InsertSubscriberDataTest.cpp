 ...
 * LOG: 
 * ID: $Id: InsertSubscriberDataTest.cpp,v 1.1.2.1 2013/02/08 10:52:30 jvikas Exp $ 								    	
 ****************************************************************************/
#ident "$Id: InsertSubscriberDataTest.cpp,v 1.1.2.1 2013/02/08 10:52:30 jvikas Exp $"
...
int SendS6AInsertSubDataAnswer(const CommandImpl * impl)
{
    ...
    suppfeatures.setVendorId(VendorId(100));
    suppfeatures.setFeatureListID(FeatureListID(1000));
    suppfeatures.setFeatureList(FeatureList(200));
    ...
    EUTRANCellGlobalIdentity eutranCellGlobalIdentity("1234");
    mmeLocationInformation.setEUTRANCellGlobalIdentity(eutranCellGlobalIdentity);

    mmeLocationInformation.setTrackingAreaIdentity(TrackingAreaIdentity("TrackingAreaIdentity1"));
    mmeLocationInformation.setGeographicalInformation(GeographicalInformation("GeographicalInformation1"));
    mmeLocationInformation.setGeodeticInformation(GeodeticInformation("GeodeticInformation1"));
    ...
    sgsnLocationInformation.setGeographicalInformation(GeographicalInformation("GeographicalInformation1"));
    sgsnLocationInformation.setGeodeticInformation(GeodeticInformation("GeodeticInformation1"));
