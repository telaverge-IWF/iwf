 ...
 * LOG: Initial commits.
 * LOG:
 * ID: $Id: AuthenticationInformationTest.cpp,v 1.1.2.3 2013/03/19 10:04:53 jvikas Exp $
 ***************************************************************************/
...
int SendS6AAuthenticationInformationRequest()
{
    ...
    static long long imsi_number=singlton::arg[0];
        ...
        sprintf(imsi_to_print, "Sent AIR with IMSI: %s", userName.value().c_str());
   ...
   // The Requested-EUTRAN-Authentication-Infos AVP code is 173.
    ...
    ReSynchronizationInfo rsinfo2("123456789012345678901234567890");
    RUGAInfo.setReSynchronizationInfo(rsinfo2);
