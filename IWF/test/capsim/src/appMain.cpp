 ...
 * LOG: Revision 1.1.2.1.16.1  2014/12/04 05:09:24  jkchaitanya
 ...
 *
 ****************************************************************************/
#ident "$Id: appMain.cpp,v 1.1.2.1.16.1 2014/12/04 05:09:24 jkchaitanya Exp $"
...
extern uint64_t repeatImsiLimit;
...
int parseArguments(int argc, const char** args)
{
   ...
   for(; i < argc && flag; i++)
   {
       ...
       else if(strcmp(args[i], "repeatImsi") == 0)
       {
           repeatImsiLimit = atoi(args[++i]);
           printf("ImsiLimit To Repeat = %d\n", atoi(args[i]));
       }
