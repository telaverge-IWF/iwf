...
Json::Value parseMapConfig()
{
    ...
    if (jsonFile == NULL )
    {
        APP_TRACE_ERROR(("MAP_IWF_JSON is not exported"));
        exit(0);
    }
...
AsnObject* BuildUpdateGPRSLocV13() {
    ...
    if(!isNull)
    {
        ...
        char *end=NULL;
        imsiforload = strtoll(Imsi.c_str(),&end,10);
...
AsnObject* BuildSendAuthenticationInfoArg()
{
    ...
    if(isAVPEnabled)
    {
        ...
        if(!isNull)
        {
            map_v13::RAND rand(MAPUtils::StringToVector((*cfg)["re_synchronisationInfo"]["RAND"]["Value"].asString()));
            resync.SetRand(rand);
        }
        isNull = (*cfg)["re_synchronisationInfo"]["AUTS"]["Value"].isNull();
        if(!isNull)
        {
            map_v13::AUTS auts(MAPUtils::StringToVector((*cfg)["re_synchronisationInfo"]["AUTS"]["Value"].asString()));
            resync.SetAuts(auts);
        }
...
void BuildLocationInformation(map_v13::LocationInformation *li)
{
    ...
    if((!isNull) && isAVPEnabled)
    {
        ...
        if((!isNull) && isAVPEnabled)
        {
            map_v13::LocationInformationEPS::E_UTRAN_CGI eucgi(MAPUtils::StringToVector((*cfg)["SubscriberInfo"]["LocationInformation"]["LocationInformationEPS"]["E_UTRAN_CGI"]["Value"].asString()));
        ...
        if((!isNull) && isAVPEnabled)
        {
            map_v13::LocationInformationEPS::TA_Id taid(MAPUtils::StringToVector((*cfg)["SubscriberInfo"]["LocationInformation"]["LocationInformationEPS"]["TA_Id"]["Value"].asString()));
        ...
        if((!isNull) && isAVPEnabled)
        {
            map_v13::LocationInformationEPS::GeographicalInformation gi(MAPUtils::StringToVector((*cfg)["SubscriberInfo"]["LocationInformation"]["LocationInformationEPS"]["GeographicalInformation"]["Value"].asString()));
        ...
        if((!isNull) && isAVPEnabled)
        {
            map_v13::LocationInformationEPS::GeodeticInformation geoi(MAPUtils::StringToVector((*cfg)["SubscriberInfo"]["LocationInformation"]["LocationInformationEPS"]["GeodeticInformation"]["Value"].asString()));
...
AsnObject* BuildProvideSubscriberInfoResV13()
{
    ...
    if((!isNull) && isAVPEnabled)
    {
        map_v13::Time time(MAPUtils::StringToVector((*cfg)["SubscriberInfo"]["lastUE_ActivityTime"]["Value"].asString()));
