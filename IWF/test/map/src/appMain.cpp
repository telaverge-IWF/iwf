 ...
 * LOG: Revision 1.1.1.1.2.2.18.2  2015/05/25 05:11:54  jkchaitanya
 * LOG: Cap-Ro test tool enhancement to support automatic user configuration mode for automation purpose, Review 4059
 * LOG:
 * LOG: Revision 1.1.1.1.2.2.18.1  2015/04/29 06:35:57  rsanjay
 ...
 *
 ****************************************************************************/
#ident "$Id: appMain.cpp,v 1.1.1.1.2.2.18.2 2015/05/25 05:11:54 jkchaitanya Exp $"
...
int parseArguments(int argc, const char** args)
{
   ...
   for(; i < argc && flag; i++)
   {
       ...
       else if(strcmp(args[i], "noOfTimesISD") == 0)
       {
           itstest::noOfTimesISD  = atoi(args[++i]);
       }
...
void Usage(const char** args)
{
    ...
    printf("Number of Time ISD <value>");
    printf("\n");
    exit(0);
}
